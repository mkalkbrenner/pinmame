...
WRITE_HANDLER(crtc6845_address_w) { crtc6845[offset].address_latch = data & 0x1f; }
...
READ_HANDLER(crtc6845_register_0_r) { return crtc6845_register_r(0); }

WRITE_HANDLER(crtc6845_address_0_w) { crtc6845_address_w(0, data); }

WRITE_HANDLER(crtc6845_register_0_w) { crtc6845_register_w(0, data); }

READ_HANDLER(crtc6845_register_1_r) { return crtc6845_register_r(1); }

WRITE_HANDLER(crtc6845_address_1_w) { crtc6845_address_w(1, data); }

WRITE_HANDLER(crtc6845_register_1_w) { crtc6845_register_w(1, data); }

//Return current video start address
int
crtc6845_start_address_r(int offset) {
...
WRITE_HANDLER(crtc6845_address_w) { crtc6845_address_latch = data & 0x1f; }
