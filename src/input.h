...
#define __code_key_last  KEYCODE_MENU
    ...
    JOYCODE_4_START,
    JOYCODE_4_SELECT,
    JOYCODE_MOUSE_1_BUTTON1,
    JOYCODE_MOUSE_1_BUTTON2,
    JOYCODE_MOUSE_1_BUTTON3,
    JOYCODE_MOUSE_2_BUTTON1,
    JOYCODE_MOUSE_2_BUTTON2,
    JOYCODE_MOUSE_2_BUTTON3,
    JOYCODE_MOUSE_3_BUTTON1,
    JOYCODE_MOUSE_3_BUTTON2,
    JOYCODE_MOUSE_3_BUTTON3,
    JOYCODE_MOUSE_4_BUTTON1,
    JOYCODE_MOUSE_4_BUTTON2,
    JOYCODE_MOUSE_4_BUTTON3,
    JOYCODE_5_LEFT,
    JOYCODE_5_RIGHT,
    JOYCODE_5_UP,
    JOYCODE_5_DOWN, /* JOYCODEs 5-8 placed here, */
    JOYCODE_5_BUTTON1,
    JOYCODE_5_BUTTON2,
    JOYCODE_5_BUTTON3, /* after original joycode mouse button */
    JOYCODE_5_BUTTON4,
    JOYCODE_5_BUTTON5,
    JOYCODE_5_BUTTON6, /* so old cfg files won't be broken */
    JOYCODE_5_BUTTON7,
    JOYCODE_5_BUTTON8,
    JOYCODE_5_BUTTON9, /* as much by their addition */
    JOYCODE_5_BUTTON10,
    JOYCODE_5_START,
    JOYCODE_5_SELECT,
    JOYCODE_6_LEFT,
    ...
    JOYCODE_8_START,
    JOYCODE_8_SELECT,
    JOYCODE_MOUSE_5_BUTTON1,
    JOYCODE_MOUSE_5_BUTTON2,
    JOYCODE_MOUSE_5_BUTTON3,
    JOYCODE_MOUSE_6_BUTTON1,
    JOYCODE_MOUSE_6_BUTTON2,
    JOYCODE_MOUSE_6_BUTTON3,
    JOYCODE_MOUSE_7_BUTTON1,
    JOYCODE_MOUSE_7_BUTTON2,
    JOYCODE_MOUSE_7_BUTTON3,
    JOYCODE_MOUSE_8_BUTTON1,
    JOYCODE_MOUSE_8_BUTTON2,
    JOYCODE_MOUSE_8_BUTTON3,
...
#define SEQ_DEF_6(a, b, c, d, e, f)                                                                                    \
    {                                                                                                                  \
        a, b, c, d, e, f, CODE_NONE, CODE_NONE, CODE_NONE, CODE_NONE, CODE_NONE, CODE_NONE, CODE_NONE, CODE_NONE,      \
            CODE_NONE, CODE_NONE                                                                                       \
    }
