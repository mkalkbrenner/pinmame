...
int
YM2203_sh_start(const struct MachineSound* msound) {
    int i;
    double rate;

    if (AY8910_sh_start_ym(msound))
        return 1;
...
WRITE_HANDLER(YM2203_control_port_0_w) { YM2203Write(0, 0, data); }

WRITE_HANDLER(YM2203_control_port_1_w) { YM2203Write(1, 0, data); }

WRITE_HANDLER(YM2203_control_port_2_w) { YM2203Write(2, 0, data); }

WRITE_HANDLER(YM2203_control_port_3_w) { YM2203Write(3, 0, data); }

WRITE_HANDLER(YM2203_control_port_4_w) { YM2203Write(4, 0, data); }

WRITE_HANDLER(YM2203_write_port_0_w) { YM2203Write(0, 1, data); }

WRITE_HANDLER(YM2203_write_port_1_w) { YM2203Write(1, 1, data); }

WRITE_HANDLER(YM2203_write_port_2_w) { YM2203Write(2, 1, data); }

WRITE_HANDLER(YM2203_write_port_3_w) { YM2203Write(3, 1, data); }

WRITE_HANDLER(YM2203_write_port_4_w) { YM2203Write(4, 1, data); }
