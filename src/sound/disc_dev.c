...
/************************************************************************/
int
dsd_555_astbl_step(struct node_description* node) {
    ...
    if (node->input[0]) {
        ...
        do {
            if (context->flip_flop) {
                ...
                cWaveNext =
                    vC
                    + ((node->input[1] - vC) * (1 - exp(-(t / ((node->input[2] + node->input[3]) * node->input[4])))));
                t = 0;
                ...
                if (cWaveNext >= cv) {
                    if (cWaveNext > cv) {
                        ...
                        t = (node->input[2] + node->input[3]) * node->input[4]
                            * log(1 / (1 - ((cWaveNext - cv) / (node->input[1] - vC))));
                    }
...
int
dsd_555_astbl_reset(struct node_description* node) {
...
int
dsd_555_astbl_init(struct node_description* node) {
...
/************************************************************************/
int
dsd_squarew555_step(struct node_description* node) {
...
int
dsd_squarew555_reset(struct node_description* node) {
    struct dsd_squarew555_context* context = (struct dsd_squarew555_context*)node->context;
...
int
dsd_squarew555_init(struct node_description* node) {
...
/************************************************************************/
int
dsd_squarew566_step(struct node_description* node) {
...
int
dsd_squarew566_reset(struct node_description* node) {
    struct dsd_566_context* context = (struct dsd_566_context*)node->context;
    double start;
...
int
dsd_squarew566_init(struct node_description* node) {
...
/************************************************************************/
int
dsd_trianglew566_step(struct node_description* node) {
    struct dsd_566_context* context = (struct dsd_566_context*)node->context;
    double newphase;
...
int
dsd_trianglew566_reset(struct node_description* node) {
    struct dsd_566_context* context = (struct dsd_566_context*)node->context;
    double start;
...
int
dsd_trianglew566_init(struct node_description* node) {
