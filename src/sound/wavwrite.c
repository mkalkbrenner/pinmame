...
void*
wav_open(const char* filename, int sample_rate, int channels) {
    struct wav_data* wav;
    UINT32 bps, temp32;
    UINT16 align, temp16;
...
void
wav_add_data_16(void* wavptr, INT16* data, int samples) {
    struct wav_data* wav = wavptr;
...
void
wav_add_data_32(void* wavptr, INT32* data, int samples, int shift) {
    struct wav_data* wav = wavptr;
    INT16* temp;
    int i;
...
void
wav_add_data_16lr(void* wavptr, INT16* left, INT16* right, int samples) {
    struct wav_data* wav = wavptr;
    INT16* temp;
    int i;
...
void
wav_add_data_32lr(void* wavptr, INT32* left, INT32* right, int samples, int shift) {
    struct wav_data* wav = wavptr;
    INT16* temp;
    int i;
