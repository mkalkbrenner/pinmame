...
static void
calculate_filter1_coefficients(double fc, double type, double* a1, double* b0, double* b1) {
...
int
dst_filter1_step(struct node_description* node) {
...
int
dst_filter1_reset(struct node_description* node) {
    node->output = 0;
    return 0;
}

int
dst_filter1_init(struct node_description* node) {
    struct dss_filter1_context* context;
...
static void
calculate_filter2_coefficients(double fc, double d, double type, double* a1, double* a2, double* b0, double* b1,
                               double* b2) {
...
int
dst_filter2_step(struct node_description* node) {
    ...
    node->output = -context->a1 * context->y1 - context->a2 * context->y2 + context->b0 * gain * node->input[1]
                   + context->b1 * context->x1 + context->b2 * context->x2;
...
int
dst_filter2_reset(struct node_description* node) {
    node->output = 0;
    return 0;
}

int
dst_filter2_init(struct node_description* node) {
    struct dss_filter2_context* context;
    ...
    calculate_filter2_coefficients(node->input[2], node->input[3], node->input[4], &context->a1, &context->a2,
...
/************************************************************************/
int
dst_rcfilter_step(struct node_description* node) {
    /************************************************************************/
...
int
dst_rcfilter_reset(struct node_description* node) {
    node->output = 0;
    return 0;
}

int
dst_rcfilter_init(struct node_description* node) {
...
int
dst_rcdisc_step(struct node_description* node) {
...
int
dst_rcdisc_reset(struct node_description* node) {
    struct dss_rcdisc_context* context;
    context = (struct dss_rcdisc_context*)node->context;
...
int
dst_rcdisc_init(struct node_description* node) {
    /* Allocate memory for the context array and the node execution order array */
...
int
dst_rcdisc2_step(struct node_description* node) {
    double diff;
    struct dss_rcdisc_context* context;
    context = (struct dss_rcdisc_context*)node->context;
...
int
dst_rcdisc2_reset(struct node_description* node) {
    struct dss_rcdisc_context* context;
    context = (struct dss_rcdisc_context*)node->context;
...
int
dst_rcdisc2_init(struct node_description* node) {
    /* Allocate memory for the context array and the node execution order array */
    if ((node->context = malloc(sizeof(struct dss_rcdisc_context))) == NULL) {
...
int
dst_rcfilterN_init(struct node_description* node) {
...
int
dst_rcdiscN_init(struct node_description* node) {
    double f = 1.0 / ((2. * M_PI) * node->input[2] * node->input[3]);
...
int
dst_rcdiscN_step(struct node_description* node) {
    struct dss_filter1_context* context;
    double gain = 1.0;
    context = (struct dss_filter1_context*)node->context;
...
int
dst_rcdisc2N_step(struct node_description* node) {
...
int
dst_rcdisc2N_reset(struct node_description* node) {
    node->output = 0;
    return 0;
}

int
dst_rcdisc2N_init(struct node_description* node) {
    struct dss_rcdisc2_context* context;
    double f1, f2;
