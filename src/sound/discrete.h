...
#define DISCRETE_SOUND_END                                                                                             \
    { NODE_00, DSS_NULL, 0, {NODE_NC}, {0}, NULL, "End Marker" }                                                       \
    }                                                                                                                  \
    ;

#define DISCRETE_CONSTANT(NODE, CONST) {NODE, DSS_CONSTANT, 1, {NODE_NC}, {CONST}, NULL, "Constant"},
#define DISCRETE_ADJUSTMENT(NODE, ENAB, MIN, MAX, DEFAULT, LOGLIN, NAME)                                               \
    {NODE, DSS_ADJUSTMENT, 5, {ENAB, NODE_NC, NODE_NC, NODE_NC, NODE_NC}, {ENAB, MIN, MAX, DEFAULT, LOGLIN}, NULL,     \
     NAME},
#define DISCRETE_INPUT(NODE, ADDR, MASK, INIT0)                                                                        \
    {NODE, DSS_INPUT, 6, {NODE_NC, NODE_NC, NODE_NC, NODE_NC, NODE_NC, NODE_NC}, {INIT0, ADDR, MASK, 1, 0, INIT0},     \
     NULL, "Input"},
#define DISCRETE_INPUTX(NODE, ADDR, MASK, GAIN, OFFSET, INIT0)                                                         \
    {NODE,                                                                                                             \
     DSS_INPUT,                                                                                                        \
     6,                                                                                                                \
     {NODE_NC, NODE_NC, NODE_NC, NODE_NC, NODE_NC, NODE_NC},                                                           \
     {INIT0, ADDR, MASK, GAIN, OFFSET, INIT0},                                                                         \
     NULL,                                                                                                             \
     "InputX"},
#define DISCRETE_INPUT_PULSE(NODE, ADDR, MASK, INIT0)                                                                  \
    {                                                                                                                  \
        NODE,                                                                                                          \
        DSS_INPUT_PULSE,                                                                                               \
        6,                                                                                                             \
        {NODE_NC, NODE_NC, NODE_NC, NODE_NC, NODE_NC, NODE_NC},                                                        \
        {INIT0, ADDR, MASK, 1, 0, INIT0},                                                                              \
        NULL,                                                                                                          \
        "Input Pulse"},

#define DISCRETE_SQUAREWAVE(NODE, ENAB, FREQ, AMPL, DUTY, BIAS, PHASE)                                                 \
    {NODE, DSS_SQUAREWAVE, 6, {ENAB, FREQ, AMPL, DUTY, BIAS, NODE_NC}, {ENAB, FREQ, AMPL, DUTY, BIAS, PHASE},          \
     NULL, "Square Wave"},
#define DISCRETE_SQUAREWFIX(NODE, ENAB, FREQ, AMPL, DUTY, BIAS, PHASE)                                                 \
    {NODE, DSS_SQUAREWFIX,     6, {ENAB, FREQ, AMPL, DUTY, BIAS, NODE_NC}, {ENAB, FREQ, AMPL, DUTY, BIAS, PHASE},      \
     NULL, "Square Wave Fixed"},
#define DISCRETE_SQUAREWAVE2(NODE, ENAB, AMPL, T_OFF, T_ON, BIAS, TSHIFT)                                              \
    {NODE, DSS_SQUAREWAVE2, 6, {ENAB, AMPL, T_OFF, T_ON, BIAS, NODE_NC}, {ENAB, AMPL, T_OFF, T_ON, BIAS, TSHIFT},      \
     NULL, "Square Wave 2"},
#define DISCRETE_SINEWAVE(NODE, ENAB, FREQ, AMPL, BIAS, PHASE)                                                         \
    {NODE, DSS_SINEWAVE, 5, {ENAB, FREQ, AMPL, BIAS, NODE_NC}, {ENAB, FREQ, AMPL, BIAS, PHASE}, NULL, "Sine Wave"},
#define DISCRETE_NOISE(NODE, ENAB, FREQ, AMPL, BIAS)                                                                   \
    {NODE, DSS_NOISE, 4, {ENAB, FREQ, AMPL, BIAS}, {ENAB, FREQ, AMPL, BIAS}, NULL, "Noise Source"},
#define DISCRETE_TRIANGLEWAVE(NODE, ENAB, FREQ, AMPL, BIAS, PHASE)                                                     \
    {NODE, DSS_TRIANGLEWAVE, 5, {ENAB, FREQ, AMPL, BIAS, NODE_NC}, {ENAB, FREQ, AMPL, BIAS, PHASE},                    \
     NULL, "Triangle Wave"},
#define DISCRETE_SAWTOOTHWAVE(NODE, ENAB, FREQ, AMPL, BIAS, GRAD, PHASE)                                               \
    {NODE, DSS_SAWTOOTHWAVE, 6, {ENAB, FREQ, AMPL, BIAS, NODE_NC, NODE_NC}, {ENAB, FREQ, AMPL, BIAS, GRAD, PHASE},     \
     NULL, "Saw Tooth Wave"},
#define DISCRETE_LFSR_NOISE(NODE, ENAB, RESET, FREQ, AMPL, FEED, BIAS, LFSRTB)                                         \
    {NODE,   DSS_LFSR_NOISE,     6, {ENAB, RESET, FREQ, AMPL, FEED, BIAS}, {ENAB, RESET, FREQ, AMPL, FEED, BIAS},      \
     LFSRTB, "LFSR Noise Source"},
#define DISCRETE_ADSR_ENV(NODE, ENAB, TRIGGER, GAIN, ADSRTB)                                                           \
    {NODE, DSS_ADSR, 3, {ENAB, TRIGGER, GAIN}, {ENAB, TRIGGER, GAIN}, ADSRTB, "ADSR Env Generator"},

#define DISCRETE_RCFILTER(NODE, ENAB, INP0, RVAL, CVAL)                                                                \
    {NODE, DST_RCFILTER, 4, {ENAB, INP0, NODE_NC, NODE_NC}, {ENAB, INP0, RVAL, CVAL}, NULL, "RC Filter"},
#define DISCRETE_RCDISC(NODE, ENAB, INP0, RVAL, CVAL)                                                                  \
    {NODE, DST_RCDISC, 4, {ENAB, INP0, NODE_NC, NODE_NC}, {ENAB, INP0, RVAL, CVAL}, NULL, "RC Discharge"},
#define DISCRETE_RCDISC2(NODE, SWITCH, INP0, RVAL0, INP1, RVAL1, CVAL)                                                 \
    {NODE,                                                                                                             \
     DST_RCDISC2,                                                                                                      \
     6,                                                                                                                \
     {SWITCH, INP0, NODE_NC, INP1, NODE_NC, NODE_NC},                                                                  \
     {SWITCH, INP0, RVAL0, INP1, RVAL1, CVAL},                                                                         \
     NULL,                                                                                                             \
     "RC Discharge 2"},
#define DISCRETE_RCFILTERN(NODE, ENAB, INP0, RVAL, CVAL)                                                               \
    {NODE, DST_RCFILTERN, 4, {ENAB, INP0, NODE_NC, NODE_NC}, {ENAB, INP0, RVAL, CVAL}, NULL, "RC Filter (New Type)"},
#define DISCRETE_RCDISCN(NODE, ENAB, INP0, RVAL, CVAL)                                                                 \
    {NODE, DST_RCDISCN, 4, {ENAB, INP0, NODE_NC, NODE_NC}, {ENAB, INP0, RVAL, CVAL}, NULL, "RC Discharge (New Type)"},
#define DISCRETE_RCDISC2N(NODE, SWITCH, INP0, RVAL0, INP1, RVAL1, CVAL)                                                \
    {NODE,                                                                                                             \
     DST_RCDISC2N,                                                                                                     \
     6,                                                                                                                \
     {SWITCH, INP0, NODE_NC, INP1, NODE_NC, NODE_NC},                                                                  \
     {SWITCH, INP0, RVAL0, INP1, RVAL1, CVAL},                                                                         \
     NULL,                                                                                                             \
     "RC Discharge 2 (New Type)"},
#define DISCRETE_FILTER1(NODE, ENAB, INP0, FREQ, TYPE)                                                                 \
    {NODE, DST_FILTER1, 4, {ENAB, INP0, NODE_NC, NODE_NC}, {ENAB, INP0, FREQ, TYPE}, NULL, "1st Order Filter"},
#define DISCRETE_FILTER2(NODE, ENAB, INP0, FREQ, DAMP, TYPE)                                                           \
    {NODE, DST_FILTER2,       5, {ENAB, INP0, NODE_NC, NODE_NC, NODE_NC}, {ENAB, INP0, FREQ, DAMP, TYPE},              \
     NULL, "2nd Order Filter"},

#define DISCRETE_RAMP(NODE, ENAB, RAMP, GRAD, START, END, CLAMP)                                                       \
    {NODE, DST_RAMP,      6, {ENAB, RAMP, GRAD, START, END, CLAMP}, {ENAB, RAMP, GRAD, START, END, CLAMP},             \
     NULL, "Ramp Up/Down"},
#define DISCRETE_ONOFF(NODE, ENAB, INP0)                                                                               \
    {NODE, DST_GAIN, 4, {ENAB, INP0, NODE_NC, NODE_NC}, {ENAB, 0, 1, 0}, NULL, "OnOff Switch"},
#define DISCRETE_INVERT(NODE, INP0)                                                                                    \
    {NODE, DST_GAIN, 4, {NODE_NC, INP0, NODE_NC, NODE_NC}, {1, 0, -1, 0}, NULL, "Inverter"},
#define DISCRETE_GAIN(NODE, INP0, GAIN)                                                                                \
    {NODE, DST_GAIN, 4, {NODE_NC, INP0, NODE_NC, NODE_NC}, {1, INP0, GAIN, 0}, NULL, "Gain"},
#define DISCRETE_MULTIPLY(NODE, ENAB, INP0, INP1)                                                                      \
    {NODE, DST_GAIN, 4, {ENAB, INP0, INP1, NODE_NC}, {ENAB, INP0, INP1, 0}, NULL, "Multiplier"},
#define DISCRETE_MULTADD(NODE, ENAB, INP0, INP1, INP2)                                                                 \
    {NODE, DST_GAIN, 4, {ENAB, INP0, INP1, INP2}, {ENAB, INP0, INP1, INP2}, NULL, "Multiply/Add"},
#define DISCRETE_TRANSFORM2(NODE, ENAB, INP0, INP1, FUNCT)                                                             \
    {NODE, DST_TRANSFORM, 3, {ENAB, INP0, INP1}, {ENAB, INP0, INP1}, FUNCT, "Transform 2 Nodes"},
#define DISCRETE_TRANSFORM3(NODE, ENAB, INP0, INP1, INP2, FUNCT)                                                       \
    {NODE, DST_TRANSFORM, 4, {ENAB, INP0, INP1, INP2}, {ENAB, INP0, INP1, INP2}, FUNCT, "Transform 3 Nodes"},
#define DISCRETE_TRANSFORM4(NODE, ENAB, INP0, INP1, INP2, INP3, FUNCT)                                                 \
    {NODE,  DST_TRANSFORM,      5, {ENAB, INP0, INP1, INP2, INP3}, {ENAB, INP0, INP1, INP2, INP3},                     \
     FUNCT, "Transform 4 Nodes"},
#define DISCRETE_TRANSFORM5(NODE, ENAB, INP0, INP1, INP2, INP3, INP4, FUNCT)                                           \
    {NODE,  DST_TRANSFORM,      6, {ENAB, INP0, INP1, INP2, INP3, INP4}, {ENAB, INP0, INP1, INP2, INP3, INP4},         \
     FUNCT, "Transform 5 Nodes"},
#define DISCRETE_DIVIDE(NODE, ENAB, INP0, INP1)                                                                        \
    {NODE, DST_DIVIDE, 3, {ENAB, INP0, INP1}, {ENAB, INP0, INP1}, NULL, "Divider"},
#define DISCRETE_CLAMP(NODE, ENAB, INP0, MIN, MAX, CLAMP)                                                              \
    {NODE, DST_CLAMP, 5, {ENAB, INP0, MIN, MAX, CLAMP}, {ENAB, INP0, MIN, MAX, CLAMP}, NULL, "Signal Clamp"},
#define DISCRETE_SWITCH(NODE, ENAB, SWITCH, INP0, INP1)                                                                \
    {NODE, DST_SWITCH, 4, {ENAB, SWITCH, INP0, INP1}, {ENAB, SWITCH, INP0, INP1}, NULL, "2 Pole Switch"},
#define DISCRETE_ADDER2(NODE, ENAB, INP0, INP1)                                                                        \
    {NODE, DST_ADDER, 3, {ENAB, INP0, INP1}, {ENAB, INP0, INP1}, NULL, "Adder 2 Node"},
#define DISCRETE_ADDER3(NODE, ENAB, INP0, INP1, INP2)                                                                  \
    {NODE, DST_ADDER, 4, {ENAB, INP0, INP1, INP2}, {ENAB, INP0, INP1, INP2}, NULL, "Adder 3 Node"},
#define DISCRETE_ADDER4(NODE, ENAB, INP0, INP1, INP2, INP3)                                                            \
    {NODE, DST_ADDER, 5, {ENAB, INP0, INP1, INP2, INP3}, {ENAB, INP0, INP1, INP2, INP3}, NULL, "Adder 4 Node"},
#define DISCRETE_ONESHOTR(NODE, ENAB, TRIG, AMPL, WIDTH)                                                               \
    {NODE, DST_ONESHOT,         5, {ENAB, TRIG, NODE_NC, AMPL, WIDTH}, {ENAB, TRIG, 1, AMPL, WIDTH},                   \
     NULL, "One Shot Resetable"},
#define DISCRETE_ONESHOT(NODE, ENAB, TRIG, RESET, AMPL, WIDTH)                                                         \
    {NODE, DST_ONESHOT, 5, {ENAB, TRIG, RESET, AMPL, WIDTH}, {ENAB, TRIG, RESET, AMPL, WIDTH}, NULL, "One Shot"},
#define DISCRETE_LADDER(NODE, ENAB, INP0, SELECT, GAIN, OFFSET, LADDER)                                                \
    {NODE,   DST_LADDER,       5, {ENAB, INP0, SELECT, GAIN, OFFSET}, {ENAB, INP0, SELECT, GAIN, OFFSET},              \
     LADDER, "Resistor Ladder"},
#define DISCRETE_SAMPLHOLD(NODE, ENAB, INP0, CLOCK, CLKTYPE)                                                           \
    {NODE, DST_SAMPHOLD, 4, {ENAB, INP0, CLOCK, NODE_NC}, {ENAB, INP0, CLOCK, CLKTYPE}, NULL, "Sample & Hold"},

#define DISCRETE_LOGIC_INVERT(NODE, ENAB, INP0)                                                                        \
    {NODE, DST_LOGIC_INV, 2, {ENAB, INP0}, {ENAB, INP0}, NULL, "Logic Invertor"},
#define DISCRETE_LOGIC_AND(NODE, ENAB, INP0, INP1)                                                                     \
    {NODE, DST_LOGIC_AND,     5, {ENAB, INP0, INP1, NODE_NC, NODE_NC}, {ENAB, INP0, INP1, 1.0, 1.0},                   \
     NULL, "Logic AND (2inp)"},
#define DISCRETE_LOGIC_AND3(NODE, ENAB, INP0, INP1, INP2)                                                              \
    {NODE, DST_LOGIC_AND,     5, {ENAB, INP0, INP1, INP2, NODE_NC}, {ENAB, INP0, INP1, INP2, 1.0},                     \
     NULL, "Logic AND (3inp)"},
#define DISCRETE_LOGIC_AND4(NODE, ENAB, INP0, INP1, INP2, INP3)                                                        \
    {NODE, DST_LOGIC_AND, 5, {ENAB, INP0, INP1, INP2, INP3}, {ENAB, INP0, INP1, INP2, INP3}, NULL, "Logic AND (4inp)"},
#define DISCRETE_LOGIC_NAND(NODE, ENAB, INP0, INP1)                                                                    \
    {NODE, DST_LOGIC_NAND,     5, {ENAB, INP0, INP1, NODE_NC, NODE_NC}, {ENAB, INP0, INP1, 1.0, 1.0},                  \
     NULL, "Logic NAND (2inp)"},
#define DISCRETE_LOGIC_NAND3(NODE, ENAB, INP0, INP1, INP2)                                                             \
    {NODE, DST_LOGIC_NAND,     5, {ENAB, INP0, INP1, INP2, NODE_NC}, {ENAB, INP0, INP1, INP2, 1.0},                    \
     NULL, "Logic NAND (3inp)"},
#define DISCRETE_LOGIC_NAND4(NODE, ENAB, INP0, INP1, INP2, INP3)                                                       \
    {NODE, DST_LOGIC_NAND,     5, {ENAB, INP0, INP1, INP2, INP3}, {ENAB, INP0, INP1, INP2, INP3},                      \
     NULL, "Logic NAND (4inp)"},
#define DISCRETE_LOGIC_OR(NODE, ENAB, INP0, INP1)                                                                      \
    {NODE, DST_LOGIC_OR,     5, {ENAB, INP0, INP1, NODE_NC, NODE_NC}, {ENAB, INP0, INP1, 0.0, 0.0},                    \
     NULL, "Logic OR (2inp)"},
#define DISCRETE_LOGIC_OR3(NODE, ENAB, INP0, INP1, INP2)                                                               \
    {NODE, DST_LOGIC_OR, 5, {ENAB, INP0, INP1, INP2, NODE_NC}, {ENAB, INP0, INP1, INP2, 0.0}, NULL, "Logic OR (3inp)"},
#define DISCRETE_LOGIC_OR4(NODE, ENAB, INP0, INP1, INP2, INP3)                                                         \
    {NODE, DST_LOGIC_OR, 5, {ENAB, INP0, INP1, INP2, INP3}, {ENAB, INP0, INP1, INP2, INP3}, NULL, "Logic OR (4inp)"},
#define DISCRETE_LOGIC_NOR(NODE, ENAB, INP0, INP1)                                                                     \
    {NODE, DST_LOGIC_NOR,     5, {ENAB, INP0, INP1, NODE_NC, NODE_NC}, {ENAB, INP0, INP1, 0.0, 0.0},                   \
     NULL, "Logic NOR (2inp)"},
#define DISCRETE_LOGIC_NOR3(NODE, ENAB, INP0, INP1, INP2)                                                              \
    {NODE, DST_LOGIC_NOR,     5, {ENAB, INP0, INP1, INP2, NODE_NC}, {ENAB, INP0, INP1, INP2, 0.0},                     \
     NULL, "Logic NOR (3inp)"},
#define DISCRETE_LOGIC_NOR4(NODE, ENAB, INP0, INP1, INP2, INP3)                                                        \
    {NODE, DST_LOGIC_NOR, 5, {ENAB, INP0, INP1, INP2, INP3}, {ENAB, INP0, INP1, INP2, INP3}, NULL, "Logic NOR (4inp)"},
#define DISCRETE_LOGIC_XOR(NODE, ENAB, INP0, INP1)                                                                     \
    {NODE, DST_LOGIC_XOR, 3, {ENAB, INP0, INP1}, {ENAB, INP0, INP1}, NULL, "Logic XOR (2inp)"},
#define DISCRETE_LOGIC_NXOR(NODE, ENAB, INP0, INP1)                                                                    \
    {NODE, DST_LOGIC_NXOR, 3, {ENAB, INP0, INP1}, {ENAB, INP0, INP1}, NULL, "Logic NXOR (2inp)"},

#define DISCRETE_555_ASTABLE(NODE, RESET, AMPL, R1, R2, C, CTRLV, TYPE)                                                \
    {NODE, DSD_555_ASTBL, 6, {RESET, AMPL, R1, R2, C, CTRLV}, {RESET, AMPL, R1, R2, C, CTRLV}, TYPE, "555 Astable"},
#define DISCRETE_SQUAREW555(NODE, RESET, AMPL, R1, R2, C, BIAS)                                                        \
    {NODE, DSD_SQUAREW555, 6, {RESET, AMPL, R1, R2, C, BIAS}, {RESET, AMPL, R1, R2, C, BIAS}, NULL, "Square Wave 555"},
#define DISCRETE_SQUAREW566(NODE, ENAB, AMPL, V_IN, R, C, BIAS, SETUP)                                                 \
    {NODE,  DSD_SQUAREW566,    6, {ENAB, AMPL, V_IN, R, C, BIAS}, {ENAB, AMPL, V_IN, R, C, BIAS},                      \
     SETUP, " Square Wave 566"},
#define DISCRETE_TRIANGLEW566(NODE, ENAB, AMPL, V_IN, R, C, BIAS, SETUP)                                               \
    {NODE,  DSD_TRIANGLEW566,    6, {ENAB, AMPL, V_IN, R, C, BIAS}, {ENAB, AMPL, V_IN, R, C, BIAS},                    \
     SETUP, " Triangle Wave 566"},

#define DISCRETE_OUTPUT(OPNODE, VOL)                                                                                   \
    {NODE_OP, DSO_OUTPUT, 3, {OPNODE, OPNODE, NODE_NC}, {0, 0, VOL}, NULL, "Output Node"},
#define DISCRETE_OUTPUT_STEREO(OPNODEL, OPNODER, VOL)                                                                  \
    {NODE_OP, DSO_OUTPUT, 3, {OPNODEL, OPNODER, NODE_NC}, {0, 0, VOL}, NULL, "Stereo Output Node"},
