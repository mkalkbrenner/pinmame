...
int config_write_ports(config_file* file, const struct InputPort* input_ports_default,
                       const struct InputPort* input_ports);

/* writes default inputports out of a configuration file */
int config_write_default_ports(config_file* cfg, const struct ipd* input_ports_default_backup,
