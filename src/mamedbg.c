...
enum { MODE_HEX_UINT8, MODE_HEX_UINT16, MODE_HEX_UINT32, MODE_HEX_COUNT };

enum { MODE_CHR_HEX, MODE_CHR_XLATE, MODE_CHR_PLAIN, MODE_CHR_COUNT };
...
static UINT8 cur_col[E_COUNT] = {
    COLOR_TITLE,    COLOR_FRAME,    COLOR_REGS,  COLOR_DASM, COLOR_MEM1,   COLOR_MEM2,    COLOR_CMDS, COLOR_BRK_EXEC,
    COLOR_BRK_DATA, COLOR_BRK_REGS, COLOR_ERROR, COLOR_HELP, COLOR_PROMPT, COLOR_CHANGES, COLOR_PC,   COLOR_CURSOR,
};
...
static char trans_table[256] = {
    ...
    'X', 'Y', 'Z', '[', 92,  ']', '^', '_', '`', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm',
...
static int win_create(int n, UINT8 prio, int x, int y, int w, int h, UINT8 co_text, UINT8 co_frame, UINT8 chr,
                      UINT32 attributes);
...
int
stringcasecmp(const char* s1, const char* s2) {
...
static void
toggle_cursor(struct mame_bitmap* bitmap, struct GfxElement* font) {
    int sx, sy, x, y;
...
void
dbg_put_screen_char(int ch, int attr, int x, int y) {
    struct mame_bitmap* bitmap = Machine->debug_bitmap;
    struct GfxElement* font = Machine->debugger_font;

    drawgfx(bitmap, font, ch, attr, 0, 0, x * font->width, y * font->height, 0, TRANSPARENCY_NONE, 0);
    debugger_bitmap_changed = 1;
}

static void
set_screen_curpos(int x, int y) {
    cursor_x = x;
    cursor_y = y;
}

static void
get_screen_size(unsigned* width, unsigned* height) {
...
readkey(void) {
    ...
    do {
        ...
        k = KEYCODE_NONE;
        if (keyboard_pressed_memory_repeat(KEYCODE_A, dbg_key_repeat))
            k = KEYCODE_A;
        if (keyboard_pressed_memory_repeat(KEYCODE_B, dbg_key_repeat))
            k = KEYCODE_B;
        if (keyboard_pressed_memory_repeat(KEYCODE_C, dbg_key_repeat))
            k = KEYCODE_C;
        if (keyboard_pressed_memory_repeat(KEYCODE_D, dbg_key_repeat))
            k = KEYCODE_D;
        if (keyboard_pressed_memory_repeat(KEYCODE_E, dbg_key_repeat))
            k = KEYCODE_E;
        if (keyboard_pressed_memory_repeat(KEYCODE_F, dbg_key_repeat))
            k = KEYCODE_F;
        if (keyboard_pressed_memory_repeat(KEYCODE_G, dbg_key_repeat))
            k = KEYCODE_G;
        if (keyboard_pressed_memory_repeat(KEYCODE_H, dbg_key_repeat))
            k = KEYCODE_H;
        if (keyboard_pressed_memory_repeat(KEYCODE_I, dbg_key_repeat))
            k = KEYCODE_I;
        if (keyboard_pressed_memory_repeat(KEYCODE_J, dbg_key_repeat))
            k = KEYCODE_J;
        if (keyboard_pressed_memory_repeat(KEYCODE_K, dbg_key_repeat))
            k = KEYCODE_K;
        if (keyboard_pressed_memory_repeat(KEYCODE_L, dbg_key_repeat))
            k = KEYCODE_L;
        if (keyboard_pressed_memory_repeat(KEYCODE_M, dbg_key_repeat))
            k = KEYCODE_M;
        if (keyboard_pressed_memory_repeat(KEYCODE_N, dbg_key_repeat))
            k = KEYCODE_N;
        if (keyboard_pressed_memory_repeat(KEYCODE_O, dbg_key_repeat))
            k = KEYCODE_O;
        if (keyboard_pressed_memory_repeat(KEYCODE_P, dbg_key_repeat))
            k = KEYCODE_P;
        if (keyboard_pressed_memory_repeat(KEYCODE_Q, dbg_key_repeat))
            k = KEYCODE_Q;
        if (keyboard_pressed_memory_repeat(KEYCODE_R, dbg_key_repeat))
            k = KEYCODE_R;
        if (keyboard_pressed_memory_repeat(KEYCODE_S, dbg_key_repeat))
            k = KEYCODE_S;
        if (keyboard_pressed_memory_repeat(KEYCODE_T, dbg_key_repeat))
            k = KEYCODE_T;
        if (keyboard_pressed_memory_repeat(KEYCODE_U, dbg_key_repeat))
            k = KEYCODE_U;
        if (keyboard_pressed_memory_repeat(KEYCODE_V, dbg_key_repeat))
            k = KEYCODE_V;
        if (keyboard_pressed_memory_repeat(KEYCODE_W, dbg_key_repeat))
            k = KEYCODE_W;
        if (keyboard_pressed_memory_repeat(KEYCODE_X, dbg_key_repeat))
            k = KEYCODE_X;
        if (keyboard_pressed_memory_repeat(KEYCODE_Y, dbg_key_repeat))
            k = KEYCODE_Y;
        if (keyboard_pressed_memory_repeat(KEYCODE_Z, dbg_key_repeat))
            k = KEYCODE_Z;
        if (keyboard_pressed_memory_repeat(KEYCODE_0, dbg_key_repeat))
            k = KEYCODE_0;
        if (keyboard_pressed_memory_repeat(KEYCODE_1, dbg_key_repeat))
            k = KEYCODE_1;
        if (keyboard_pressed_memory_repeat(KEYCODE_2, dbg_key_repeat))
            k = KEYCODE_2;
        if (keyboard_pressed_memory_repeat(KEYCODE_3, dbg_key_repeat))
            k = KEYCODE_3;
        if (keyboard_pressed_memory_repeat(KEYCODE_4, dbg_key_repeat))
            k = KEYCODE_4;
        if (keyboard_pressed_memory_repeat(KEYCODE_5, dbg_key_repeat))
            k = KEYCODE_5;
        if (keyboard_pressed_memory_repeat(KEYCODE_6, dbg_key_repeat))
            k = KEYCODE_6;
        if (keyboard_pressed_memory_repeat(KEYCODE_7, dbg_key_repeat))
            k = KEYCODE_7;
        if (keyboard_pressed_memory_repeat(KEYCODE_8, dbg_key_repeat))
            k = KEYCODE_8;
        if (keyboard_pressed_memory_repeat(KEYCODE_9, dbg_key_repeat))
            k = KEYCODE_9;
        if (keyboard_pressed_memory_repeat(KEYCODE_0_PAD, dbg_key_repeat))
            k = KEYCODE_0_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_1_PAD, dbg_key_repeat))
            k = KEYCODE_1_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_2_PAD, dbg_key_repeat))
            k = KEYCODE_2_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_3_PAD, dbg_key_repeat))
            k = KEYCODE_3_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_4_PAD, dbg_key_repeat))
            k = KEYCODE_4_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_5_PAD, dbg_key_repeat))
            k = KEYCODE_5_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_6_PAD, dbg_key_repeat))
            k = KEYCODE_6_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_7_PAD, dbg_key_repeat))
            k = KEYCODE_7_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_8_PAD, dbg_key_repeat))
            k = KEYCODE_8_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_9_PAD, dbg_key_repeat))
            k = KEYCODE_9_PAD;
        if (keyboard_pressed_memory(KEYCODE_F1))
            k = KEYCODE_F1;
        if (keyboard_pressed_memory(KEYCODE_F2))
            k = KEYCODE_F2;
        if (keyboard_pressed_memory(KEYCODE_F3))
            k = KEYCODE_F3;
        if (keyboard_pressed_memory(KEYCODE_F4))
            k = KEYCODE_F4;
        /*		if (keyboard_pressed_memory(KEYCODE_F5)) k = KEYCODE_F5; */
        if (keyboard_pressed_memory(KEYCODE_F6))
            k = KEYCODE_F6;
        if (keyboard_pressed_memory(KEYCODE_F7))
            k = KEYCODE_F7;
        if (keyboard_pressed_memory(KEYCODE_F8))
            k = KEYCODE_F8;
        if (keyboard_pressed_memory(KEYCODE_F9))
            k = KEYCODE_F9;
        if (keyboard_pressed_memory(KEYCODE_F10))
            k = KEYCODE_F10;
        if (keyboard_pressed_memory(KEYCODE_F11))
            k = KEYCODE_F11;
        if (keyboard_pressed_memory(KEYCODE_F12))
            k = KEYCODE_F12;
        if (keyboard_pressed_memory(KEYCODE_ESC))
            k = KEYCODE_ESC;
        /*		if (keyboard_pressed_memory_repeat(KEYCODE_TILDE,dbg_key_repeat)) k = KEYCODE_TILDE; */
        if (keyboard_pressed_memory_repeat(KEYCODE_MINUS, dbg_key_repeat))
            k = KEYCODE_MINUS;
        if (keyboard_pressed_memory_repeat(KEYCODE_EQUALS, dbg_key_repeat))
            k = KEYCODE_EQUALS;
        if (keyboard_pressed_memory_repeat(KEYCODE_BACKSPACE, dbg_key_repeat))
            k = KEYCODE_BACKSPACE;
        if (keyboard_pressed_memory_repeat(KEYCODE_TAB, dbg_key_repeat))
            k = KEYCODE_TAB;
        if (keyboard_pressed_memory_repeat(KEYCODE_OPENBRACE, dbg_key_repeat))
            k = KEYCODE_OPENBRACE;
        if (keyboard_pressed_memory_repeat(KEYCODE_CLOSEBRACE, dbg_key_repeat))
            k = KEYCODE_CLOSEBRACE;
        if (keyboard_pressed_memory_repeat(KEYCODE_ENTER, dbg_key_repeat))
            k = KEYCODE_ENTER;
        if (keyboard_pressed_memory_repeat(KEYCODE_COLON, dbg_key_repeat))
            k = KEYCODE_COLON;
        if (keyboard_pressed_memory_repeat(KEYCODE_QUOTE, dbg_key_repeat))
            k = KEYCODE_QUOTE;
        if (keyboard_pressed_memory_repeat(KEYCODE_BACKSLASH, dbg_key_repeat))
            k = KEYCODE_BACKSLASH;
        if (keyboard_pressed_memory_repeat(KEYCODE_BACKSLASH2, dbg_key_repeat))
            k = KEYCODE_BACKSLASH2;
        if (keyboard_pressed_memory_repeat(KEYCODE_COMMA, dbg_key_repeat))
            k = KEYCODE_COMMA;
        if (keyboard_pressed_memory_repeat(KEYCODE_STOP, dbg_key_repeat))
            k = KEYCODE_STOP;
        if (keyboard_pressed_memory_repeat(KEYCODE_SLASH, dbg_key_repeat))
            k = KEYCODE_SLASH;
        if (keyboard_pressed_memory_repeat(KEYCODE_SPACE, dbg_key_repeat))
            k = KEYCODE_SPACE;
        if (keyboard_pressed_memory_repeat(KEYCODE_INSERT, dbg_key_repeat))
            k = KEYCODE_INSERT;
        if (keyboard_pressed_memory_repeat(KEYCODE_DEL, dbg_key_repeat))
            k = KEYCODE_DEL;
        if (keyboard_pressed_memory_repeat(KEYCODE_HOME, dbg_key_repeat))
            k = KEYCODE_HOME;
        if (keyboard_pressed_memory_repeat(KEYCODE_END, dbg_key_repeat))
            k = KEYCODE_END;
        if (keyboard_pressed_memory_repeat(KEYCODE_PGUP, dbg_key_repeat))
            k = KEYCODE_PGUP;
        if (keyboard_pressed_memory_repeat(KEYCODE_PGDN, dbg_key_repeat))
            k = KEYCODE_PGDN;
        if (keyboard_pressed_memory_repeat(KEYCODE_LEFT, dbg_key_repeat))
            k = KEYCODE_LEFT;
        if (keyboard_pressed_memory_repeat(KEYCODE_RIGHT, dbg_key_repeat))
            k = KEYCODE_RIGHT;
        if (keyboard_pressed_memory_repeat(KEYCODE_UP, dbg_key_repeat))
            k = KEYCODE_UP;
        if (keyboard_pressed_memory_repeat(KEYCODE_DOWN, dbg_key_repeat))
            k = KEYCODE_DOWN;
        if (keyboard_pressed_memory_repeat(KEYCODE_SLASH_PAD, dbg_key_repeat))
            k = KEYCODE_SLASH_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_ASTERISK, dbg_key_repeat))
            k = KEYCODE_ASTERISK;
        if (keyboard_pressed_memory_repeat(KEYCODE_MINUS_PAD, dbg_key_repeat))
            k = KEYCODE_MINUS_PAD;
        if (keyboard_pressed_memory_repeat(KEYCODE_PLUS_PAD, dbg_key_repeat))
            k = KEYCODE_PLUS_PAD;
        ...
        shift_pressed =
            (keyboard_pressed_memory_repeat(KEYCODE_LSHIFT, 0) || keyboard_pressed_memory_repeat(KEYCODE_RSHIFT, 0));
#endif
        if (k == KEYCODE_NONE)
            debugger_idle = 1;
...
static s_command commands[] = {
    {(1 << EDIT_CMDS), "A", 0, CODE_NONE, "[<update>]",
     "Animate (trace) and update display once per frame [or every <update> opcodes only]", cmd_animate},
    {(1 << EDIT_CMDS), "D", 0, CODE_NONE, "<1|2> <address>", "Display memory <1|2> starting at <address>",
     cmd_display_memory},
    {(1 << EDIT_CMDS), "E", 0, CODE_NONE, "<1|2> [<address>]", "Edit memory window <1|2> [at <address>]",
     cmd_edit_memory},
    {(1 << EDIT_CMDS), "M", 0, CODE_NONE, "<1|2> [BYTE|WORD|DWORD]",
     "Change memory window mode to default [to BYTE|WORD|DWORD (or 0|1|2)]", cmd_set_memory_mode},
    ...
    {(1 << EDIT_CMDS), "R", 0, CODE_NONE, "<register> <value>",
     "Replace <register> with <value> (<value> may also be a <register>)", cmd_replace_register},
    {(1 << EDIT_CMDS), "BP", "BPX", CODE_NONE, "<address> [<times>]",
     "Break on execution of <address> [after ignoring it <times>]", cmd_brk_exec_set},
    {(1 << EDIT_CMDS), "BC", 0, CODE_NONE, "", "Clear execution breakpoint", cmd_brk_exec_clear},
    {(1 << EDIT_CMDS), "RP", 0, CODE_NONE, "<register> [<value> [<mask>]]",
     "Break if <register> changes [to <value> [compare after applying <mask>]]", cmd_brk_regs_set},
    {(1 << EDIT_CMDS), "RC", 0, CODE_NONE, "", "Clear register watchpoint", cmd_brk_regs_clear},
    {(1 << EDIT_CMDS), "WP", "BPW", CODE_NONE, "<address> [<value>]", "Break if data at <address> changes [to <value>]",
     cmd_brk_data_set},
    {(1 << EDIT_CMDS), "WC", 0, CODE_NONE, "", "Clear data watchpoint", cmd_brk_data_clear},
#if defined(PINMAME) && defined(DBG_BPR)
    {(1 << EDIT_CMDS), "BPR", 0, CODE_NONE, "<start> [<end>]",
     "Break if data between <start> and <end> is read or written", bpr_set},
#endif /* DBG_BPR */
    {(1 << EDIT_CMDS), "HERE", 0, CODE_NONE, "", "Run to cursor", cmd_here},
    {(1 << EDIT_CMDS), "DASM", 0, CODE_NONE, "<filename> <start> <end> [<boolean>]",
     "Disassemble to <filename> from address <start> to <end>\n"
     "Opcode dump on by default [OFF|NO|0 without]",
     cmd_dasm_to_file},
    {(1 << EDIT_CMDS), "DUMP", 0, CODE_NONE,
     ...
     cmd_dump_to_file},
    {(1 << EDIT_CMDS), "TRACE", 0, CODE_NONE, "{<filename> [<reg1> [<reg2>...]]}|OFF",
     "Trace to <filename> [dumping <reg1> [<reg2>...]] | OFF to stop tracing.", cmd_trace_to_file},
#ifdef PINMAME
    /* CODELIST */
    {(1 << EDIT_CMDS), "CODELIST", 0, CODE_NONE, "[filename]|OFF",
     "Collect code addresses during execution and condense them to blocks.\nCode blocks data is written to <filename> "
     "when switched off",
     cmd_codelist_to_file},
#endif /* PINMAME */
    {(1 << EDIT_CMDS), "SAVE", 0, CODE_NONE, "<filename> <start> <end> [OPCODES|DATA]",
...
#endif
    {(1 << EDIT_CMDS), "IGNORE", 0, CODE_NONE, "<cpunum>", "Ignore CPU #<cpunum> while debugging or tracing",
     cmd_set_ignore},
    {(1 << EDIT_CMDS), "OBSERVE", 0, CODE_NONE, "<cpunum>", "Observe CPU #<cpunum> while debugging or tracing",
     cmd_set_observe},
    {(1 << EDIT_CMDS), "REPEAT", 0, CODE_NONE, "rate",
     "Set keyboard initial repeat rate (rate/frame will increase to 1/frame)", cmd_set_key_repeat},
    {(1 << EDIT_CMDS), "CASE", 0, CODE_NONE, "DEFAULT|LOWER|UPPER (also 0|1|2)", "Set disassembly case style.",
     cmd_set_dasm_case},
    {(1 << EDIT_CMDS), "OPCODES", 0, CODE_NONE, "<boolean>", "Display opcodes in disassembly window",
     cmd_set_dasm_opcodes},
    {(1 << EDIT_CMDS), "RELATIVE", 0, CODE_NONE, "<boolean>", "Display relative jump addresses in disassembly window",
     cmd_set_dasm_relative_jumps},
    {(1 << EDIT_CMDS), "SQUEEZE", 0, CODE_NONE, "<boolean>", "Allow squeezed memory display", cmd_set_mem_squeezed},
    {(1 << EDIT_CMDS), "COLOR", 0, CODE_NONE, "<element> <foreground> [<background>]",
     "Set <element> color to <foreground> on BLACK [or <background>].\nFor a list of <elements> and <colors> see "
     "mamedbg.cfg",
     cmd_set_element_color},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_UP, "", "Move cursor up in disassembly window", cmd_dasm_up},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_DOWN, "", "Move cursor down in disassembly window",
     cmd_dasm_down},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_PGUP, "", "Move cursor up one page in disassembly window",
     cmd_dasm_page_up},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_PGDN, "", "Move cursor down one page in disassembly window",
     cmd_dasm_page_down},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_HOME, "", "Move cursor to first page in disassembly window",
     cmd_dasm_home},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_END, "", "Move cursor to last page in disassembly window",
     cmd_dasm_end},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_LEFT, "", "Back to the previous point in 'follow history'",
     cmd_dasm_hist_back},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_RIGHT, "",
     "Follow the current instruction's code or data reference", cmd_dasm_hist_follow},
    ...
    {(1 << EDIT_MEM1) | (1 << EDIT_MEM2), 0, 0, KEYCODE_H, "", "Toggle between hex, ASCII and full character set mode",
     NULL},
    {(1 << EDIT_MEM1) | (1 << EDIT_MEM2), 0, 0, KEYCODE_P, "",
     "Toggle memory display between DATA and PROGRAM memory (Harvard-architecture CPUs)", NULL},
    {(1 << EDIT_MEM1) | (1 << EDIT_MEM2), 0, 0, KEYCODE_I, "",
     "Toggle memory display between CPU internal and normal memory", NULL},
    {(1 << EDIT_MEM1) | (1 << EDIT_MEM2), 0, 0, KEYCODE_M, "",
     "Switch memory display mode between bytes, words and dwords", NULL},
    {(1 << EDIT_MEM1) | (1 << EDIT_MEM2), 0, 0, KEYCODE_S, "", "Search memory for a sequence of bytes",
     cmd_search_memory},
    {ALL, 0, 0, KEYCODE_F1, "", "Help - maybe you realized this ;)", cmd_help},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_F2, "", "Toggle breakpoint at current cursor position",
     cmd_brk_exec_toggle},
    {(1 << EDIT_CMDS) | (1 << EDIT_DASM), 0, 0, KEYCODE_F4, "", "Run to cursor", cmd_run_to_cursor},
    {(1 << EDIT_MEM1) | (1 << EDIT_MEM2), 0, 0, KEYCODE_F4, "", "Set data watchpoint to current memory location",
     cmd_brk_data_toggle},
...
#ifdef PINMAME
    {ALL, 0, 0, KEYCODE_ENTER, "", "\r[SHIFT+ENTER]\tLike F10, but also skips loops, function calls, etc.",
     cmd_jumpover},
#endif
...
INLINE unsigned
order(unsigned offset, unsigned size) {
    switch (size) {
        case 1:
            return offset;
            break;
        case 2:
            switch (ENDIAN) {
                case CPU_IS_LE:
                    return UINT16_XOR_LE(offset);
                case CPU_IS_BE:
                    return UINT16_XOR_BE(offset);
            }
            break;
        case 4:
            switch (ENDIAN) {
                case CPU_IS_LE:
                    return UINT32_XOR_LE(offset);
                case CPU_IS_BE:
                    return UINT32_XOR_BE(offset);
            }
            break;
    }
    return offset;
...
const char*
set_ea_info(int what, unsigned value, int size, int access) {
    ...
    switch (access) {
        ...
        case EA_ABS_PC: /* Absolute program counter change */
            ...
            if (size == EA_INT8 || size == EA_UINT8)
                width = 2;
            else if (size == EA_INT16 || size == EA_UINT16)
                width = 4;
            else if (size == EA_INT32 || size == EA_UINT32)
                width = 8;
            else
                width = (ABITS + 3) / 4;
            break;
 ...
 **************************************************************************/
INLINE int
my_stricmp(const char* dst, const char* src) {
    while (*src && *dst) {
 ...
 **************************************************************************/
static unsigned
get_boolean(char** parg, int* size) {
    char* p = *parg;
    unsigned result = 0;
    int length = 0;
    ...
    if (toupper(p[0]) == 'O') {
        if (toupper(p[1]) == 'N' && !isalnum(p[2])) {
            ...
            length = 2;
            *parg += length;
        } else if (toupper(p[1]) == 'F' && toupper(p[2]) == 'F' && !isalnum(p[3])) {
            result = 0;
            length = 3;
            *parg += length;
        }
    } else if (toupper(p[0]) == 'N') {
 ...
 **************************************************************************/
static unsigned
get_option_or_value(char** parg, int* size, const char* opt_list) {
    char* p = *parg;
    const char* opt;
...
static const char*
get_file_name(char** parg, int* size) {
...
get_ea_info(unsigned pc) {
    ...
    if (DBGDASM.dst_ea_value != INVALID && DBGDASM.src_ea_value != INVALID)
        sprintf(buffer, "%s\t%s%0*X %s%0*X", name_rdmem(rshift(pc)), access[DBGDASM.src_ea_access], wsrc,
                DBGDASM.src_ea_value, access[DBGDASM.dst_ea_access], wdst, DBGDASM.dst_ea_value);
    else if (DBGDASM.dst_ea_value != INVALID)
        sprintf(buffer, "%s\t%s%0*X", name_rdmem(rshift(pc)), access[DBGDASM.dst_ea_access], wdst,
                DBGDASM.dst_ea_value);
    else if (DBGDASM.src_ea_value != INVALID)
        sprintf(buffer, "%s\t%s%0*X", name_rdmem(rshift(pc)), access[DBGDASM.src_ea_access], wsrc,
                DBGDASM.src_ea_value);
    else
 ...
 **************************************************************************/
static unsigned
get_register_id(char** parg, int* size) {
    int i;
 ...
 **************************************************************************/
static unsigned
get_register_or_value(char** parg, int* size) {
    int regnum, l;
 ...
 **************************************************************************/
static void
trace_init(const char* filename, UINT8* regs) {
    char name[100];
...
trace_output(void) {
    ...
    if (trace_on && TRACE.file) {
...
#endif
        {
            ...
            fflush(TRACE.file);
            memmove(&TRACE.last_pc[0], &TRACE.last_pc[1], (MAX_LOOPS - 1) * sizeof(TRACE.last_pc[0]));
 ...
 **************************************************************************/
void
bpr_memref(UINT32 adr, int length) {
...
bpr_check(void) {
    ...
    if (DBG.bprstart == INVALID)
        return 0;
    while (ii < DBG.bprnext) {
        if ((DBG.bprdata[ii].adr + DBG.bprdata[ii].length - 1 >= DBG.bprstart) && (DBG.bprdata[ii].adr <= DBG.bprend)) {
        ...
        if (DBG.brk_regs_newval != INVALID) {
            if (DBG.brk_regs_newval == (data & DBG.brk_regs_mask)) {
                if (DBG.brk_regs_mask != 0xffffffff)
                    sprintf(dbg_info, "Hit register %s & $%X watchpoint value $%X", get_register_name(DBG.brk_regs),
                            DBG.brk_regs_mask, DBG.brk_regs_newval);
                else
                    sprintf(dbg_info, "Hit register %s watchpoint value $%X", get_register_name(DBG.brk_regs),
                            DBG.brk_regs_newval);
                dbg_info_once = dbg_info;
                return 1;
            }
 ...
 **************************************************************************/
static const char*
name_rom(const char* type, int regnum, unsigned* base, unsigned start) {
...
/* Won't work since the MemoryWrite doesn't support ->base anymore */
                ...
                else if ((FPTR)mr->handler == (FPTR)MRA_ROM) {
                    name = name_rom("ROM", REGION_CPU1 + active_cpu, &base, mr->start);
                    sprintf(dst, "%s+%04X", name, lshift(base));
                } else if ((FPTR)mr->handler == (FPTR)MRA_BANK1 || (FPTR)mr->handler == (FPTR)MRA_BANK2
                           || (FPTR)mr->handler == (FPTR)MRA_BANK3 || (FPTR)mr->handler == (FPTR)MRA_BANK4
                           || (FPTR)mr->handler == (FPTR)MRA_BANK5 || (FPTR)mr->handler == (FPTR)MRA_BANK6
                           || (FPTR)mr->handler == (FPTR)MRA_BANK7 || (FPTR)mr->handler == (FPTR)MRA_BANK8
                           || (FPTR)mr->handler == (FPTR)MRA_BANK9 || (FPTR)mr->handler == (FPTR)MRA_BANK10
                           || (FPTR)mr->handler == (FPTR)MRA_BANK11 || (FPTR)mr->handler == (FPTR)MRA_BANK12
                           || (FPTR)mr->handler == (FPTR)MRA_BANK13 || (FPTR)mr->handler == (FPTR)MRA_BANK14
                           || (FPTR)mr->handler == (FPTR)MRA_BANK15 || (FPTR)mr->handler == (FPTR)MRA_BANK16)
                    sprintf(dst, "BANK%d+%04X", 1 + (int)(MRA_BANK1) - (int)(mr->handler), lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)MRA_NOP)
                    sprintf(dst, "NOP%d+%04X", nop_cnt, lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_0_r)
                    sprintf(dst, "input_port_0+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_1_r)
                    sprintf(dst, "input_port_1+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_2_r)
                    sprintf(dst, "input_port_2+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_3_r)
                ...
                else if ((FPTR)mr->handler == (FPTR)input_port_5_r)
                    sprintf(dst, "input_port_5+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_6_r)
                    sprintf(dst, "input_port_6+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_7_r)
                    sprintf(dst, "input_port_7+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_8_r)
                ...
                else if ((FPTR)mr->handler == (FPTR)input_port_10_r)
                    sprintf(dst, "input_port_10+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_11_r)
                    sprintf(dst, "input_port_11+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_12_r)
                    sprintf(dst, "input_port_12+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_13_r)
                    sprintf(dst, "input_port_13+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_14_r)
                    sprintf(dst, "input_port_14+%04X", lshift(offset));
                else if ((FPTR)mr->handler == (FPTR)input_port_15_r)
...
/* Won't work since the MemoryRead doesn't support ->description anymore */
                ...
                else if ((FPTR)mw->handler == (FPTR)MWA_ROM) {
                    name = name_rom("ROM", REGION_CPU1 + active_cpu, &base, mw->start);
                    sprintf(dst, "%s+%04X", name, lshift(base));
                } else if ((FPTR)mw->handler == (FPTR)MWA_RAMROM) {
                    name = name_rom("RAMROM", REGION_CPU1 + active_cpu, &base, mw->start);
                    sprintf(dst, "%s+%04X", name, lshift(base));
                } else if ((FPTR)mw->handler == (FPTR)MWA_BANK1 || (FPTR)mw->handler == (FPTR)MWA_BANK2
                           || (FPTR)mw->handler == (FPTR)MWA_BANK3 || (FPTR)mw->handler == (FPTR)MWA_BANK4
                           || (FPTR)mw->handler == (FPTR)MWA_BANK5 || (FPTR)mw->handler == (FPTR)MWA_BANK6
                           || (FPTR)mw->handler == (FPTR)MWA_BANK7 || (FPTR)mw->handler == (FPTR)MWA_BANK8
                           || (FPTR)mw->handler == (FPTR)MWA_BANK9 || (FPTR)mw->handler == (FPTR)MWA_BANK10
                           || (FPTR)mw->handler == (FPTR)MWA_BANK11 || (FPTR)mw->handler == (FPTR)MWA_BANK12
                           || (FPTR)mw->handler == (FPTR)MWA_BANK13 || (FPTR)mw->handler == (FPTR)MWA_BANK14
                           || (FPTR)mw->handler == (FPTR)MWA_BANK15 || (FPTR)mw->handler == (FPTR)MWA_BANK16)
                    sprintf(dst, "BANK%d+%04X", 1 + (int)(MWA_BANK1) - (int)(mw->handler), lshift(base - mw->start));
                else if ((FPTR)mw->handler == (FPTR)MWA_NOP)
                    sprintf(dst, "NOP%d+%04X", nop_cnt, lshift(base - mw->start));
            }
            if ((FPTR)mw->handler == (FPTR)MRA_RAM)
                ram_cnt++;
            else if ((FPTR)mw->handler == (FPTR)MRA_NOP)
                nop_cnt++;
        }
        mw++;
    }
 ...
 **************************************************************************/
static int
win_create(int n, UINT8 prio, int x, int y, int w, int h, UINT8 co_text, UINT8 co_frame, UINT8 chr, UINT32 attributes) {
    struct sWindow win;
...
win_msgbox(UINT8 color, const char* title, const char* fmt, ...) {
    UINT32 win = WIN_MSGBOX;
    va_list arg;
    int i;

    win_create(win, 0, 4, 6, 60, 3, color, cur_col[E_FRAME], ' ',
 ...
 **************************************************************************/
INLINE void
dbg_set_rect(struct rectangle* r, int x, int y, int w, int h) {
    r->min_x = x;
    r->max_x = x + w - 1;
    r->min_y = y;
    r->max_y = y + h - 1;
...
#define CMDS_H win_layout[4 * 4 + 3]
        ...
        if (regs.max_x + 1 < w)
            flags |= BORDER_RIGHT;
        win_create(WIN_REGS(i), 1, regs.min_x, regs.min_y, regs.max_x + 1 - regs.min_x, regs.max_y + 1 - regs.min_y,
                   cur_col[E_REGS], cur_col[E_FRAME], ' ', flags);

        flags = BORDER_TOP | BORDER_RIGHT;
        win_create(WIN_DASM(i), 1, dasm.min_x, dasm.min_y, dasm.max_x + 1 - dasm.min_x, dasm.max_y + 1 - dasm.min_y,
                   cur_col[E_DASM], cur_col[E_FRAME], ' ', flags);

        flags = BORDER_TOP;
        if (mem1.max_x + 1 < w)
            flags |= BORDER_RIGHT;
        win_create(WIN_MEM1(i), 1, mem1.min_x, mem1.min_y, mem1.max_x + 1 - mem1.min_x, mem1.max_y + 1 - mem1.min_y,
                   cur_col[E_MEM1], cur_col[E_FRAME], ' ', flags);

        flags = BORDER_TOP;
        if (mem2.max_x + 1 < w)
            flags |= BORDER_RIGHT;
        win_create(WIN_MEM2(i), 1, mem2.min_x, mem2.min_y, mem2.max_x + 1 - mem2.min_x, mem2.max_y + 1 - mem2.min_y,
                   cur_col[E_MEM2], cur_col[E_FRAME], ' ', flags);

        flags = BORDER_TOP;
        win_create(WIN_CMDS(i), 1, cmds.min_x, cmds.min_y, cmds.max_x + 1 - cmds.min_x, cmds.max_y + 1 - cmds.min_y,
 ...
 **************************************************************************/
static unsigned
dasm_line(unsigned pc, int times) {
    static char buffer[127 + 1];
        ...
        if (l + 2 < w) {
            ...
            if (l + 2 < w) {
                ...
                if (y < h) {
                    ...
                    else if (strlen(activecpu_flags()) + 2 < w)
                        win_printf(win, "F:%s\n", flags);
                    else
                        win_printf(win, "%s\n", flags);
                }
        ...
        for (y = 0; y < h; y++) {
            ...
            if (dbg_dasm_opcodes) {
                ...
                switch (ALIGN) {
                    case 1:
                        for (x = 0; x < INSTL; x++) {
                            if (p < n) {
                                l += win_printf(win, "%02X ", RDMEM(order(p, 1)));
                                p++;
                            } else
                                l += win_printf(win, "   ");
                        }
                    ...
                    case 2:
                        for (x = 0; x < INSTL; x += 2) {
                            if (p < n) {
                                l += win_printf(win, "%02X%02X ", RDMEM(order(p + 0, 2)), RDMEM(order(p + 1, 2)));
                                p += 2;
                            } else
                                l += win_printf(win, "     ");
                        }
                    ...
                    case 4:
                        for (x = 0; x < INSTL; x += 4) {
                            if (p < n) {
                                l += win_printf(win, "%02X%02X%02X%02X ", RDMEM(order(p + 0, 4)),
                                                RDMEM(order(p + 1, 4)), RDMEM(order(p + 2, 4)), RDMEM(order(p + 3, 4)));
                                p += 4;
                            } else
                                l += win_printf(win, "         ");
                        }
            ...
            switch (dbg_dasm_case) {
                case 0:
                    ...
                    break;
                case 1:
                    win_printf(win, "%-*.*s", w - l, w - l, lower(dasm));
                    break;
                case 2:
                    win_printf(win, "%-*.*s", w - l, w - l, upper(dasm));
                    break;
            }
        }
 ...
 **************************************************************************/
static void
dump_mem_hex(int which, unsigned len_addr, unsigned len_data) {
    ...
    for (offs = 0, column = 0; offs < DBGMEM[which].size; offs++, old++, val++) {
        ...
        if (column == 0) {
            ...
            win_printf(win, "%*s%0*X:%*s", spc_left, "", len_addr, lshift((DBGMEM[which].base + offs) & AMASK),
                       spc_addr, "");
        }
        ...
        else if (DBGMEM[which].pgm_memory_base)
        ...
        if (activecpu_get_sp() == DBGMEM[which].address)
            color =
                cur_col[COLOR_PROMPT]; // was [COLOR_PROMPT*16]; there's only 0-15; ToDo: mistake or "special feature"?
#endif
        ...
        if (++column < DBGMEM[which].bytes) {
            ...
            else if (spc_data && (column * 2 % len_data) == 0)
                win_putc(win, ' ');
        } else {
            win_putc(win, '\n');
            column = 0;
 ...
 **************************************************************************/
static void
dump_mem(int which, int set_title) {
    ...
    switch (DBGMEM[which].mode) {
        case MODE_HEX_UINT8:
            dump_mem_hex(which, len_addr, 2);
            break;
        case MODE_HEX_UINT16:
            dump_mem_hex(which, len_addr, 4);
            break;
        case MODE_HEX_UINT32:
            dump_mem_hex(which, len_addr, 8);
            break;
    }
}
...
edit_regs(void) {
    ...
    if (regs->base > pedit[regs->idx].y) {
        ...
        dump_regs();
    } else if (pedit[regs->idx].y >= regs->base + win_get_h(win) - regs->top) {
        regs->base = pedit[regs->idx].y - win_get_h(win) + regs->top + 1;
        dump_regs();
    }
    win_set_curpos(win, pedit[regs->idx].x + pedit[regs->idx].n + regs->nibble,
                   pedit[regs->idx].y - regs->base + regs->top);
    ...
    if (strlen(k) == 1) {
        ...
        switch (k[0]) {
            ...
            case 'F':
                ...
                activecpu_set_reg(regs->id[regs->idx], (activecpu_get_reg(regs->id[regs->idx]) & mask) | val);
                dump_regs();
...
edit_mem(int which) {
    ...
    switch (DBGMEM[which].mode) {
        case MODE_HEX_UINT8:
            ...
            break;
        case MODE_HEX_UINT16:
            DBGMEM[which].address =
                (DBGMEM[which].base + (DBGMEM[which].offset & ~1) + pedit[DBGMEM[which].offset].n) & AMASK;
            break;
        case MODE_HEX_UINT32:
            DBGMEM[which].address =
                (DBGMEM[which].base + (DBGMEM[which].offset & ~3) + pedit[DBGMEM[which].offset].n) & AMASK;
            break;
    }
    if (!DBGMEM[which].internal)
    ...
    if (strlen(k) == 1) {
        ...
        switch (k[0]) {
            ...
            case 'F':
                ...
                } else if (DBGMEM[which].pgm_memory_base == 0)
    ...
    if (strlen(cmd)) {
        ...
        for (i = 0; commands[i].name; i++) {
            ...
            if (strncmp(cmd, commands[i].name, l) == 0 && !isalnum(cmd[l])) {
                win_set_title(WIN_CMDS(active_cpu), "Command: %s %s%s", commands[i].name, commands[i].args, hist_info);
                return i;
            }
            if (commands[i].alias) {
                l = strlen(cmd);
                ...
                if (strncmp(cmd, commands[i].alias, l) == 0 && !isalnum(cmd[l])) {
                    win_set_title(WIN_CMDS(active_cpu), "Command: %s %s (aka %s)%s", commands[i].alias,
                                  commands[i].args, commands[i].name, hist_info);
                    return i;
                }
            }
        }
...
edit_cmds_parse(char* cmdline) {
    ...
    for (i = 0; commands[i].valid; i++) {
        ...
        if (!strncmp(cmdline, commands[i].name, l) && !isalnum(cmdline[l])) {
            while (cmdline[l] && isspace(cmdline[l]))
                l++;
 ...
 **************************************************************************/
static void
edit_cmds_append(const char* src) {
...
cmd_help(void) {
    ...
    if (!help) {
        win_msgbox(cur_col[E_ERROR], "Memory problem!", "Couldn't allocate help text buffer");
        return;
    }
    dst = help;
    ...
    switch (DBG.window) {
        case EDIT_CMDS:
            ...
            if (cmd == INVALID) {
                ...
                if (commands[cmd].alias)
                    dst +=
                        sprintf(dst, "%s %s (aka %s)", commands[cmd].name, commands[cmd].args, commands[cmd].alias) + 1;
                else
        ...
        case EDIT_REGS:
            ...
            dst +=
                sprintf(dst, "%s [%s] Version %s", activecpu_name(), activecpu_core_family(), activecpu_core_version())
                + 1;
            ...
            dst +=
                sprintf(dst, "Internal read  : %s", cputype_get_interface(cputype)->internal_read ? "yes" : "no") + 1;
            dst +=
                sprintf(dst, "Internal write : %s", cputype_get_interface(cputype)->internal_write ? "yes" : "no") + 1;
            dst +=
                sprintf(dst, "Program / Data : %s", cputype_get_interface(cputype)->pgm_memory_base ? "yes" : "no") + 1;
    ...
    *dst++ = '\0';
    ...
    get_screen_size(&w, &h);
    win_create(win, 0, 2, 1, w - 2 - 4, h - 2 - 3, cur_col[E_HELP], cur_col[E_FRAME], ' ',
               BORDER_TOP | BORDER_LEFT | BORDER_RIGHT | BORDER_BOTTOM | SHADOW);
    win_set_title(win, title);
    win_show(win);
    h = win_get_h(win);
...
cmd_set_element_color(void) {
    ...
    if (length) {
        ...
        if (length) {
            ...
            if (!length)
                bg = 0; /* BLACK is default background */
        } else {
...
cmd_dasm_to_file(void) {
    ...
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "DASM arguments", "Filename missing");
        edit_cmds_reset();
        return;
    }
    start = get_register_or_value(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "DASM arguments", "Start address missing");
        edit_cmds_reset();
        return;
    }
    end = get_register_or_value(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "DASM arguments", "End address missing");
        edit_cmds_reset();
        return;
    }
    opcodes = get_boolean(&cmd, &length);
    if (length == 4)
        opcodes = 1; /* default to display opcodes */

    file = fopen(filename, "w");
    if (!file) {
        win_msgbox(cur_col[E_ERROR], "DASM to file", "Could not create %s", filename);
        edit_cmds_reset();
        return;
    }
        ...
        if (opcodes) {
            switch (ALIGN) {
                ...
                case 2: /* dump words */
                    for (i = 0; i < INSTL; i += 2) {
                        if (i < s)
                            fprintf(file, "%02X%02X ", RDMEM(order(p + i + 0, 2)), RDMEM(order(p + i + 1, 2)));
                        else
                            fprintf(file, "     ");
                    }
                    break;
                case 4: /* dump dwords */
                    for (i = 0; i < INSTL; i += 4) {
                        if (i < s)
                            fprintf(file, "%02X%02X%02X%02X ", RDMEM(order(p + i + 0, 4)), RDMEM(order(p + i + 1, 4)),
...
cmd_dump_to_file(void) {
    ...
    filename = get_file_name(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "DUMP arguments", "<filename> missing");
        edit_cmds_reset();
        return;
    }
    start = get_register_or_value(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "DUMP arguments", "<start> address missing");
        edit_cmds_reset();
        return;
    }
    start = rshift(start);
    ...
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "DUMP arguments", "<end> address missing");
        edit_cmds_reset();
        return;
    }
    end = rshift(end);
    ...
    file = fopen(filename, "w");
    if (!file) {
        win_msgbox(cur_col[E_ERROR], "DUMP to file", "Could not create %s", filename);
        edit_cmds_reset();
        return;
    }
...
cmd_save_to_file(void) {
    ...
    filename = get_file_name(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "SAVE arguments", "<filename> missing");
        edit_cmds_reset();
        return;
    }
    start = get_register_or_value(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "SAVE arguments", "<start> address missing");
        edit_cmds_reset();
        return;
    }
    end = get_register_or_value(&cmd, &length);
    if (!length) {
        win_msgbox(cur_col[E_ERROR], "SAVE arguments", "<end> address missing");
        edit_cmds_reset();
        return;
    }
    ...
    if (!length)
        save_what = 0; /* default to OP_ROM */

    file = fopen(filename, "wb");
    if (!file) {
        win_msgbox(cur_col[E_ERROR], "SAVE to file", "Could not create %s", filename);
        edit_cmds_reset();
        return;
    }
...
cmd_edit_memory(void) {
    ...
    if (length) {
        ...
        switch (which) {
            case 0:
                DBG.window = EDIT_MEM1;
                break;
            case 1:
                DBG.window = EDIT_MEM2;
                break;
        }
    }
    edit_cmds_reset();
...
cmd_search_memory(void) {
    ...
    get_screen_size(&w, &h);
    win_create(win, 1, 2, 2, w - 4, 2, cur_col[E_PROMPT], cur_col[E_FRAME], ' ',
    ...
    if (i == KEYCODE_ENTER && search_count > 0) {
        ...
        {
            if ((addr & (AMASK >> 8)) == 0) {
                win_set_title(win, "[%3.0f%%] %s/%s", 100.0 * addr / (AMASK + 1), kilobyte(addr), kilobyte(AMASK + 1));
            }
            for (i = 0; i < search_count; i++)
...
cmd_set_ignore(void) {
    ...
    if (cpunum < total_cpu) {
        ...
        win_msgbox(cur_col[E_ERROR], "Ignore CPU", "The selected CPU# is too high.\nOnly %d CPUs (0..%d) are used",
...
cmd_set_observe(void) {
    ...
    if (cpunum < total_cpu) {
        ...
        win_msgbox(cur_col[E_ERROR], "Observe CPU", "The selected CPU# is too high.\nOnly %d CPUs (0..%d) are used",
                   total_cpu, total_cpu - 1);
    }
    ...
    if (regnum > 0) {
        ...
        if (length) {
            ...
            for (DBGREGS.idx = 0; DBGREGS.idx < DBGREGS.count; DBGREGS.idx++)
                if (DBGREGS.id[DBGREGS.idx] == regnum)
                    break;
 ...
 **************************************************************************/
static void
cmd_set_dasm_relative_jumps(void) {
    char* cmd = CMD;
    ...
    if (DBGDASM.pc_top > 0) {
        ...
        if (dasm_pc_tmp > DBGDASM.pc_top) {
            ...
            if (i < h) {
                ...
                win_msgbox(cur_col[E_ERROR], "DBGDASM page up", "Increase cpu_intf[].max_inst_len? Line = %d\n", i);
            } else {
 ...
 **************************************************************************/
static void
cmd_brk_exec_toggle(void) {
    if (DBG.brk_exec == INVALID) {
        DBG.brk_exec = DBGDASM.pc_cur;
        DBG.brk_exec_times = 0;
        DBG.brk_exec_reset = 0;
        dbg_update = 1;
    } else if (DBG.brk_exec == DBGDASM.pc_cur) {
        DBG.brk_exec = INVALID;
        DBG.brk_exec_times = 0;
        DBG.brk_exec_reset = 0;
        dbg_update = 1;
    } else {
        win_msgbox(cur_col[E_PROMPT], "Breakpoint", "Cleared execution break point at $%X", DBG.brk_exec);
        DBG.brk_exec = INVALID;
    }
}
    ...
    if (address != INVALID) {
        if (DBG.hist_cnt < MAX_HIST) {
            ...
            if (access == EA_ABS_PC || access == EA_REL_PC) {
                ...
                DBGDASM.pc_end = dump_dasm(DBGDASM.pc_top);
                DBG.hist_cnt++;
            } else if (access == EA_MEM_RD || access == EA_MEM_WR || access == EA_MEM_RDWR || access == EA_ZPG_RD
                       || access == EA_ZPG_WR || access == EA_ZPG_RDWR) {
...
cmd_brk_data_toggle(void) {
    ...
    if (DBG.brk_data == INVALID) {
        ...
        DBG.brk_data_oldval = data;
        DBG.brk_data_newval = INVALID;
    } else if (DBG.brk_data == DBGMEM[which].address) {
        DBG.brk_data = INVALID;
        DBG.brk_data_oldval = INVALID;
        DBG.brk_data_newval = INVALID;
    } else {
        win_msgbox(cur_col[E_PROMPT], "Data watchpoint", "Cleared data watch point at $%X", DBG.brk_data);
        DBG.brk_data = INVALID;
    }
    dbg_update = 1;
    edit_cmds_reset();
 ...
 **************************************************************************/
static void
cmd_set_dasm_case(void) {
    char* cmd = CMD;

    if (toupper(cmd[0]) == 'D')
        dbg_dasm_case = 0;
    else if (toupper(cmd[0]) == 'L')
        dbg_dasm_case = 1;
    else if (toupper(cmd[0]) == 'U')
        dbg_dasm_case = 2;
    else
...
mame_debug_init(void) {
    ...
    for (active_cpu = 0; active_cpu < total_cpu; active_cpu++) {
        ...
        switch (cpunum_align_unit(active_cpu)) {
            case 1:
                DBGMEM[0].mode = DBGMEM[1].mode = MODE_HEX_UINT8;
                break;
            case 2:
                DBGMEM[0].mode = DBGMEM[1].mode = MODE_HEX_UINT16;
                break;
            case 4:
                DBGMEM[0].mode = DBGMEM[1].mode = MODE_HEX_UINT32;
                break;
        }
    }
...
MAME_Debug(void) {
...
#if defined(PINMAME) && defined(DBG_BPR)
    if ((first_time || hit_brk_exec() || hit_brk_data() || hit_brk_regs() || bpr_check() || debug_key_pressed)
        && !dbg_active)
#else  /* DBG_BPR */
    ...
    if (DBGMEM[0].changed) {
        DBGMEM[0].changed = 0;
        memcpy(DBGMEM[0].backup, DBGMEM[0].newval, DBGMEM[0].size);
    }
    if (DBGMEM[1].changed) {
        DBGMEM[1].changed = 0;
        memcpy(DBGMEM[1].backup, DBGMEM[1].newval, DBGMEM[0].size);
    }
    if (DBGREGS.changed) {
        DBGREGS.changed = 0;
        memcpy(DBGREGS.backup, DBGREGS.newval, DBGREGS.count * sizeof(UINT32));
    }
}
 ...
 **************************************************************************/
static void
codelist_init(const char* given_filename) {
