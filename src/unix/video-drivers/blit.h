...
#else /* not indirect */
#define COPY_LINE2(SRC, END, DST) memcpy(DST, SRC, ((END) - (SRC)) * DEST_PIXEL_SIZE);
#endif /* indirect */
...
#define COPY_LINE_FOR_Y(YV, YMAX, SRC, END, DST)                                                                       \
    {                                                                                                                  \
        ...
        while (reps-- > 0) {                                                                                           \
            memcpy((DST) + (reps * (CORRECTED_DEST_WIDTH)), doublebuffer_buffer,                                       \
...
#define COPY_LINE_FOR_Y(YV, YMAX, SRC, END, DST)                                                                       \
    {                                                                                                                  \
        int reps = REPS_FOR_Y(1, YV, YMAX);                                                                            \
        while (reps-- > 0)                                                                                             \
            COPY_LINE2(SRC, END, (DST) + (reps * (CORRECTED_DEST_WIDTH)));                                             \
    }
#endif
...
#define COPY_LINE_FOR_Y(YV, YMAX, SRC, END, DST)                                                                       \
    {                                                                                                                  \
        ...
        while (reps-- > 1)                                                                                             \
            memcpy((DST) + (reps * (CORRECTED_DEST_WIDTH)), DST, ((END) - (SRC)) * DEST_PIXEL_SIZE * SCALE_X(1));      \
    }
#endif
