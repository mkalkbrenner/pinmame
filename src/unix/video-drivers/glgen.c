...
GLdouble CompareVec(GLdouble i, GLdouble j, GLdouble k, GLdouble x, GLdouble y, GLdouble z);
void TranslatePointInPlane(GLdouble vx_p1, GLdouble vy_p1, GLdouble vz_p1, GLdouble vx_nw, GLdouble vy_nw,
                           GLdouble vz_nw, GLdouble vx_nh, GLdouble vy_nh, GLdouble vz_nh, GLdouble x_off,
                           GLdouble y_off, GLdouble* vx_p, GLdouble* vy_p, GLdouble* vz_p);
void ScaleThisVec(GLdouble i, GLdouble j, GLdouble k, GLdouble* x, GLdouble* y, GLdouble* z);
void AddToThisVec(GLdouble i, GLdouble j, GLdouble k, GLdouble* x, GLdouble* y, GLdouble* z);
GLdouble LengthOfVec(GLdouble x, GLdouble y, GLdouble z);
void NormThisVec(GLdouble* x, GLdouble* y, GLdouble* z);
void DeltaVec(GLdouble x1, GLdouble y1, GLdouble z1, GLdouble x2, GLdouble y2, GLdouble z2, GLdouble* dx, GLdouble* dy,
              GLdouble* dz);
void CrossVec(GLdouble a1, GLdouble a2, GLdouble a3, GLdouble b1, GLdouble b2, GLdouble b3, GLdouble* c1, GLdouble* c2,
              GLdouble* c3);
void CopyVec(GLdouble* ax, GLdouble* ay, GLdouble* az,               /* dest   */
             const GLdouble bx, const GLdouble by, const GLdouble bz /* source */
);
void SwapVec(GLdouble* ax, GLdouble* ay, GLdouble* az, GLdouble* bx, GLdouble* by, GLdouble* bz);
void CalcFlatTexPoint(int x, int y, GLdouble texwpervw, GLdouble texhpervh, GLdouble* px, GLdouble* py);
void CalcCabPointbyWorldpoint(GLdouble vx_gscr, GLdouble vy_gscr, GLdouble* vx_p, GLdouble* vy_p, GLdouble* vz_p);
void CalcCabPointbyViewpoint(GLdouble vx_gscr_view, GLdouble vy_gscr_view, GLdouble* vx_p, GLdouble* vy_p,
                             GLdouble* vz_p);

void SetupFrustum(void);
void SetupOrtho(void);

void WAvg(GLdouble perc, GLdouble x1, GLdouble y1, GLdouble z1, GLdouble x2, GLdouble y2, GLdouble z2, GLdouble* ax,
 ...
 *	bottom < top
 */
GLdouble vx_cscr_p1, vy_cscr_p1, vz_cscr_p1, vx_cscr_p2, vy_cscr_p2, vz_cscr_p2, vx_cscr_p3, vy_cscr_p3, vz_cscr_p3,
...
int
gl_stream_alphablending(int alpha) {
    if (gl_is_initialized == 0)
        return alpha;
...
void
gl_update_16_to_16bpp(struct mame_bitmap* bitmap) {
    if (current_palette->lookup) {
        if (!blit_notified)
            printf("GLINFO: 16bpp color palette lookup bitblit\n");
...
#undef DEST_PIXEL
        ...
        if (!blit_notified)
            printf("GLINFO: 16bpp swapping ... !! JAU \n");
#define SRC_PIXEL  unsigned short
#define DEST_PIXEL unsigned short
#define DEST       texgrid->texture
#define DEST_WIDTH memory_x_len
...
void
gl_update_32_to_32bpp(struct mame_bitmap* bitmap) {
    if (current_palette->lookup) {
        if (!blit_notified)
            printf("GLINFO: 32bpp palette lookup bitblit\n");
...
#undef DEST_PIXEL
        ...
        if (!blit_notified)
            printf("GLINFO: 32bpp swapping ... !! JAU \n");
#define SRC_PIXEL  unsigned int
#define DEST_PIXEL unsigned int
#define DEST       texgrid->texture
#define DEST_WIDTH memory_x_len
...
InitVScreen(int depth) {
    ...
    printf("\tvendor: %s,\n\trenderer %s,\n\tversion %s\n", disp__glGetString(GL_VENDOR),
           disp__glGetString(GL_RENDERER), glVersion);
    ...
    DeltaVec(vx_cscr_p1, vy_cscr_p1, vz_cscr_p1, vx_cscr_p2, vy_cscr_p2, vz_cscr_p2, &vx_cscr_dw, &vy_cscr_dw,
             &vz_cscr_dw);
    DeltaVec(vx_cscr_p1, vy_cscr_p1, vz_cscr_p1, vx_cscr_p4, vy_cscr_p4, vz_cscr_p4, &vx_cscr_dh, &vy_cscr_dh,
             &vz_cscr_dh);
    ...
    CopyVec(&vx_scr_nx, &vy_scr_nx, &vz_scr_nx, vx_cscr_dw, vy_cscr_dw, vz_cscr_dw);
    NormThisVec(&vx_scr_nx, &vy_scr_nx, &vz_scr_nx);

    CopyVec(&vx_scr_ny, &vy_scr_ny, &vz_scr_ny, vx_cscr_dh, vy_cscr_dh, vz_cscr_dh);
    NormThisVec(&vx_scr_ny, &vy_scr_ny, &vz_scr_ny);

    CrossVec(vx_cscr_dw, vy_cscr_dw, vz_cscr_dw, vx_cscr_dh, vy_cscr_dh, vz_cscr_dh, &vx_scr_nz, &vy_scr_nz,
             &vz_scr_nz);
   ...
   * assertions ...
   */
    CopyVec(&t1x, &t1y, &t1z, vx_scr_nx, vy_scr_nx, vz_scr_nx);
    ScaleThisVec(s__cscr_w, s__cscr_w, s__cscr_w, &t1x, &t1y, &t1z);
    ...
    CopyVec(&t1x, &t1y, &t1z, vx_scr_ny, vy_scr_ny, vz_scr_ny);
    ScaleThisVec(s__cscr_h, s__cscr_h, s__cscr_h, &t1x, &t1y, &t1z);
   ...
   */
    ...
    */
    TranslatePointInPlane(vx_cscr_p1, vy_cscr_p1, vz_cscr_p1, vx_scr_nx, vy_scr_nx, vz_scr_nx, vx_scr_ny, vy_scr_ny,
                          vz_scr_ny, s__gscr_offx, s__gscr_offy, &vx_gscr_p1, &vy_gscr_p1, &vz_gscr_p1);

    TranslatePointInPlane(vx_gscr_p1, vy_gscr_p1, vz_gscr_p1, vx_scr_nx, vy_scr_nx, vz_scr_nx, vx_scr_ny, vy_scr_ny,
                          vz_scr_ny, s__gscr_w, 0.0, &vx_gscr_p2, &vy_gscr_p2, &vz_gscr_p2);

    TranslatePointInPlane(vx_gscr_p2, vy_gscr_p2, vz_gscr_p2, vx_scr_nx, vy_scr_nx, vz_scr_nx, vx_scr_ny, vy_scr_ny,
                          vz_scr_ny, 0.0, s__gscr_h, &vx_gscr_p3, &vy_gscr_p3, &vz_gscr_p3);

    TranslatePointInPlane(vx_gscr_p3, vy_gscr_p3, vz_gscr_p3, vx_scr_nx, vy_scr_nx, vz_scr_nx, vx_scr_ny, vy_scr_ny,
                          vz_scr_ny, -s__gscr_w, 0.0, &vx_gscr_p4, &vy_gscr_p4, &vz_gscr_p4);

    TranslatePointInPlane(vx_gscr_p1, vy_gscr_p1, vz_gscr_p1, vx_scr_nx, vy_scr_nx, vz_scr_nx, vx_scr_ny, vy_scr_ny,
                          vz_scr_ny, 0.0, s__gscr_h, &vx_gscr_p4b, &vy_gscr_p4b, &vz_gscr_p4b);

    t1 = CompareVec(vx_gscr_p4, vy_gscr_p4, vz_gscr_p4, vx_gscr_p4b, vy_gscr_p4b, vz_gscr_p4b);

    DeltaVec(vx_gscr_p1, vy_gscr_p1, vz_gscr_p1, vx_gscr_p2, vy_gscr_p2, vz_gscr_p2, &vx_gscr_dw, &vy_gscr_dw,
             &vz_gscr_dw);
    DeltaVec(vx_gscr_p1, vy_gscr_p1, vz_gscr_p1, vx_gscr_p4, vy_gscr_p4, vz_gscr_p4, &vx_gscr_dh, &vy_gscr_dh,
             &vz_gscr_dh);
    ...
    switch (display_palette_info.depth) {
        case 8: /* ... */
            if (!useColorIndex) {
                printf("GLERROR: color blitter mode not supported for 8bpp color map's, use 15bpp, 16bpp or 32bpp "
                       "instead !\n");
                exit(1);
            } else {
    ...
    printf("GLINFO: Offering colors=%d, depth=%d, rgb 0x%X, 0x%X, 0x%X (true color mode)\n",
           display_palette_info.writable_colors, display_palette_info.depth, display_palette_info.red_mask,
           display_palette_info.green_mask, display_palette_info.blue_mask);
...
sysdep_display_alloc_palette(int writable_colors) {
    ...
    if (totalcolors > 256) {
        if (useColorIndex) {
            printf("GLERROR: OpenGL color index mode not supported for colors == %d / only for depth == 8 (<= 256 "
                   "colors) !\n",
                   totalcolors);
            exit(1); /* JAU */
        }
   ...
   */
    ...
    if (useColorIndex) {
        switch (bytes_per_pixel) {
            case 1:
                ...
                break;
            case 2:
                gl_ctable_type = GL_UNSIGNED_SHORT;
                break;
            default:
        ...
        if (useGLEXT78) {
            ...
            ctable = (GLubyte*)calloc(ctable_size * (alphablending ? 4 : 3), 1);

            disp__glColorTableEXT(GL_TEXTURE_2D, gl_ctable_format, ctable_size, gl_ctable_format, gl_ctable_type,
                                  ctable); /* JAU COLOR */
    ...
    fprintf(stderr,
            "GLINFO: totalcolors = %d / colortable size= %d,\n\tdepth = %d "
            "alphablending=%d,\n\tuse_mod_ctable=%d\n\tuseColorIndex=%d\n",
            totalcolors, ctable_size, Machine->color_depth, alphablending, use_mod_ctable, useColorIndex);
 ...
 */
void
InitTextures(struct mame_bitmap* bitmap) {
    int e_x, e_y, s, i = 0;
    ...
    do {
        disp__glTexImage2D(GL_PROXY_TEXTURE_2D, 0, gl_internal_format, text_width, text_height, 0, gl_bitmap_format,
                           gl_bitmap_type, 0);

        CHECK_GL_ERROR();

        disp__glGetTexLevelParameteriv(GL_PROXY_TEXTURE_2D, 0, GL_TEXTURE_INTERNAL_FORMAT, &format);

#ifndef NOTEXIDXSIZE
        disp__glGetTexLevelParameteriv(GL_PROXY_TEXTURE_2D, 0, GL_TEXTURE_INDEX_SIZE_EXT, &tidxsize);
#else
        tidxsize = -1;
#endif
        CHECK_GL_ERROR();

        if (format == gl_internal_format && force_text_width_height > 0
            && (force_text_width_height < text_width || force_text_width_height < text_height)) {
            format = 0;
        }

        if (format != gl_internal_format) {
            fprintf(stderr, "GLINFO: Needed texture [%dx%d] too big (format=0x%X,idxsize=%d), trying ", text_height,
                    text_width, format, tidxsize);
   ...
   */
    if (useColorBlitter) {
        colorBlittedMemory = malloc((text_width + 2 * BITMAP_SAFETY) * texnumx * (text_height + 2 * BITMAP_SAFETY)
                                    * texnumy * bytes_per_pixel);
    ...
    for (y = 0; y < texnumy; y++) {
        for (x = 0; x < texnumx; x++) {
            ...
            if (x == texnumx - 1 && visual_width % text_width)
                tsq->xcov = (GLdouble)(visual_width % text_width) / (GLdouble)text_width;
            else
                tsq->xcov = 1.0;

            if (y == texnumy - 1 && visual_height % text_height)
                tsq->ycov = (GLdouble)(visual_height % text_height) / (GLdouble)text_height;
            else
                tsq->ycov = 1.0;
            ...
            CalcCabPointbyViewpoint(x * (GLdouble)text_width, y * (GLdouble)text_height, &(tsq->x1), &(tsq->y1),
                                    &(tsq->z1));

            CalcCabPointbyViewpoint(x * (GLdouble)text_width + tsq->xcov * (GLdouble)text_width,
                                    y * (GLdouble)text_height, &(tsq->x2), &(tsq->y2), &(tsq->z2));

            CalcCabPointbyViewpoint(x * (GLdouble)text_width + tsq->xcov * (GLdouble)text_width,
                                    y * (GLdouble)text_height + tsq->ycov * (GLdouble)text_height, &(tsq->x3),
                                    &(tsq->y3), &(tsq->z3));

            CalcCabPointbyViewpoint(x * (GLdouble)text_width,
                                    y * (GLdouble)text_height + tsq->ycov * (GLdouble)text_height, &(tsq->x4),
                                    &(tsq->y4), &(tsq->z4));

            /* calculate the pixel store data,
         to use the machine-bitmap for our texture 
      */
            memory_x_start_offset = visual.min_x * bytes_per_pixel + x * text_width * bytes_per_pixel;

            tsq->texture = line_1 + y * text_height * raw_line_len + memory_x_start_offset;

#ifndef NDEBUG
            if (x == 0 && y == 0) {
                fprintf(stderr, "Machine bitmap: w=%d, h=%d, d=%d,\n\trowpixels=%d, rowbytes=%d\n",
                        Machine->scrbitmap->width, Machine->scrbitmap->height, Machine->scrbitmap->depth,
                        Machine->scrbitmap->rowpixels, Machine->scrbitmap->rowbytes);

                fprintf(stderr, "bitmap: w=%d, h=%d, d=%d,\n\trowpixels=%d, rowbytes=%d\n", bitmap->width,
                        bitmap->height, bitmap->depth, bitmap->rowpixels, bitmap->rowbytes);
                ...
                fprintf(stderr, "game (w=%d / h=%d)\n",
                        Machine->drv->default_visible_area.max_x - Machine->drv->default_visible_area.min_x + 1,
                        Machine->drv->default_visible_area.max_y - Machine->drv->default_visible_area.min_y + 1);

                fprintf(stderr, "texture-usage x=%f%% y=%f%%\n", texwpervw, texhpervh);

                fprintf(stderr, "row_len=%d, x_ofs=%d, bytes_per_pixel=%d\n", (int)memory_x_len,
                        (int)memory_x_start_offset, (int)bytes_per_pixel);
            ...
            if (use_dirty) {
                ...
                tsq->isDirty = GL_TRUE;
                tsq->dirtyWidth = text_width;
                tsq->dirtyHeight = text_height;
            }
            ...
            if (err == GL_INVALID_ENUM) {
                ...
                fprintf(stderr,
                        "GLERROR glBindTexture (glGenText) := GL_INVALID_OPERATION, texnum x=%d, y=%d, texture=%d\n", x,
                        y, tsq->texobj);
            }
#endif
            ...
            if (useColorIndex) {
                if (useGLEXT78) {
                    disp__glColorTableEXT(GL_TEXTURE_2D, gl_ctable_format, ctable_size, gl_ctable_format,
            ...
            disp__glTexImage2D(GL_TEXTURE_2D, 0, gl_internal_format, text_width, text_height, 0, gl_bitmap_format,
                               gl_bitmap_type, tsq->texture);
 ...
 */
GLdouble
CompareVec(GLdouble i, GLdouble j, GLdouble k, GLdouble x, GLdouble y, GLdouble z) {
    GLdouble dx = x - i;
    GLdouble dy = y - j;
    GLdouble dz = z - k;
...
void
AddToThisVec(GLdouble i, GLdouble j, GLdouble k, GLdouble* x, GLdouble* y, GLdouble* z) {
    *x += i;
    *y += j;
    *z += k;
}
 ...
 */
void
TranslatePointInPlane(GLdouble vx_p1, GLdouble vy_p1, GLdouble vz_p1, GLdouble vx_nw, GLdouble vy_nw, GLdouble vz_nw,
                      GLdouble vx_nh, GLdouble vy_nh, GLdouble vz_nh, GLdouble x_off, GLdouble y_off, GLdouble* vx_p,
                      GLdouble* vy_p, GLdouble* vz_p) {
    GLdouble tx, ty, tz;

    CopyVec(vx_p, vy_p, vz_p, vx_p1, vy_p1, vz_p1);

    CopyVec(&tx, &ty, &tz, vx_nw, vy_nw, vz_nw);

    ScaleThisVec(x_off, x_off, x_off, &tx, &ty, &tz);

    AddToThisVec(tx, ty, tz, vx_p, vy_p, vz_p);

    CopyVec(&tx, &ty, &tz, vx_nh, vy_nh, vz_nh);

    ScaleThisVec(y_off, y_off, y_off, &tx, &ty, &tz);

    AddToThisVec(tx, ty, tz, vx_p, vy_p, vz_p);
}

void
ScaleThisVec(GLdouble i, GLdouble j, GLdouble k, GLdouble* x, GLdouble* y, GLdouble* z) {
    *x *= i;
    *y *= j;
    *z *= k;
}
...
void
DeltaVec(GLdouble x1, GLdouble y1, GLdouble z1, GLdouble x2, GLdouble y2, GLdouble z2, GLdouble* dx, GLdouble* dy,
         GLdouble* dz) {
    *dx = x2 - x1;
    *dy = y2 - y1;
    *dz = z2 - z1;
...
void
CrossVec(GLdouble a1, GLdouble a2, GLdouble a3, GLdouble b1, GLdouble b2, GLdouble b3, GLdouble* c1, GLdouble* c2,
         GLdouble* c3) {
    *c1 = a2 * b3 - a3 * b2;
    *c2 = a3 * b1 - a1 * b3;
    *c3 = a1 * b2 - a1 * b1;
...
void
CopyVec(GLdouble* ax, GLdouble* ay, GLdouble* az,               /* dest   */
        const GLdouble bx, const GLdouble by, const GLdouble bz /* source */
) {
    *ax = bx;
    *ay = by;
...
void
SwapVec(GLdouble* ax, GLdouble* ay, GLdouble* az, GLdouble* bx, GLdouble* by, GLdouble* bz) {
    GLdouble t;
 ...
 */
void
CalcFlatTexPoint(int x, int y, GLdouble texwpervw, GLdouble texhpervh, GLdouble* px, GLdouble* py) {
 ...
 */
void
CalcCabPointbyWorldpoint(GLdouble vx_gscr, GLdouble vy_gscr, GLdouble* vx_p, GLdouble* vy_p, GLdouble* vz_p) {
    /**
    * v__p  = v__gscr_p1  + vx_gscr * v__scr_nx + vy_gscr * v__scr_ny ;
    */

    TranslatePointInPlane(vx_gscr_p1, vy_gscr_p1, vz_gscr_p1, vx_scr_nx, vy_scr_nx, vz_scr_nx, vx_scr_ny, vy_scr_ny,
                          vz_scr_ny, vx_gscr, vy_gscr, vx_p, vy_p, vz_p);
}
 ...
 */
void
CalcCabPointbyViewpoint(GLdouble vx_gscr_view, GLdouble vy_gscr_view, GLdouble* vx_p, GLdouble* vy_p, GLdouble* vz_p) {
...
SetWindowRatio() {
   ...
   */
    ...
    fprintf(stderr, "GLINFO: SetWindowRatio: win (%dx%d), visual (%dx%d)\n", winwidth, winheight,
            visual_orientated_width, visual_orientated_height);
...
void
xgl_fixaspectratio(int* w, int* h) {
...
void
xgl_resize(int w, int h, int now) {
    winheight = h;
    winwidth = w;
    ...
    if (glContext != NULL) {
        ...
        if (cabview)
            ...
            disp__glViewport((int)(vscrndx + 0.5), (int)(vscrndy + 0.5), (int)(vscrnwidth + 0.5),
                             (int)(vscrnheight + 0.5));
...
void
WAvg(GLdouble perc, GLdouble x1, GLdouble y1, GLdouble z1, GLdouble x2, GLdouble y2, GLdouble z2, GLdouble* ax,
     GLdouble* ay, GLdouble* az) {
...
void
gl_mark_dirty(int x, int y, int x2, int y2) {
...
drawGameAxis() {
    ...
    CopyVec(&tx, &ty, &tz, vx_scr_nx, vy_scr_nx, vz_scr_nx);
    ...
    CopyVec(&tx, &ty, &tz, vx_scr_ny, vy_scr_ny, vz_scr_ny);
    ScaleThisVec(5.0, 5.0, 5.0, &tx, &ty, &tz);
    disp__glVertex3d(tx, ty, tz);
    ...
    CopyVec(&tx, &ty, &tz, vx_scr_nz, vy_scr_nz, vz_scr_nz);
    ScaleThisVec(5.0, 5.0, 5.0, &tx, &ty, &tz);
    disp__glVertex3d(tx, ty, tz);
    ...
    for (y = 0; y < texnumy; y++) {
        for (x = 0; x < texnumx; x++) {
            ...
            if (updateTexture && square->isDirty) {
                disp__glTexSubImage2D(GL_TEXTURE_2D, 0, square->dirtyXoff, square->dirtyYoff, square->dirtyWidth,
                                      square->dirtyHeight, gl_bitmap_format, gl_bitmap_type, square->texture);
...
void
UpdateCabDisplay(struct mame_bitmap* bitmap) {
    int glerrid;
    int shadeModel;
...
*/
        ...
        switch (pan->type) {
            ...
            case pan_moveto:
                ...
                WAvg(perc, lpan->lx, lpan->ly, lpan->lz, pan->lx, pan->ly, pan->lz, &camx, &camy, &camz);
                WAvg(perc, lpan->px, lpan->py, lpan->pz, pan->px, pan->py, pan->pz, &dirx, &diry, &dirz);
                WAvg(perc, lpan->nx, lpan->ny, lpan->nz, pan->nx, pan->ny, pan->nz, &normx, &normy, &normz);
                break;
            default:
                break;
        }
 ...
 */
void
UpdateGLDisplayBegin(struct mame_bitmap* bitmap) {
    if (!texture_init)
        InitTextures(bitmap);
 ...
 */
void
UpdateGLDisplayEnd(struct mame_bitmap* bitmap) {
    if (vecgame) {
        vector_clear_list();
...
struct mame_bitmap*
osd_override_snapshot(struct mame_bitmap* bitmap, struct rectangle* bounds) {
    do_snapshot = 1;
    return NULL;
}
