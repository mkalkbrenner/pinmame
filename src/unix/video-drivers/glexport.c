...
gl_png_write_bitmap(void* fp) {
    ...
    disp__glReadPixels(0, 0, p.width, p.height, GL_RGB, GL_UNSIGNED_BYTE, ip);
...
ppm_save_snapshot(void* fp) {
    ...
    disp__glReadPixels(0, 0, width, height, GL_RGB, GL_UNSIGNED_BYTE, pixels);
