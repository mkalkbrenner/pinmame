...
Register scr224x288[] = {{0x3c2, 0x00, 0xe7}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x37}, {0x3d4, 0x02, 0x38},
                         {0x3d4, 0x03, 0x82}, {0x3d4, 0x04, 0x49}, {0x3d4, 0x05, 0x9a}, {0x3d4, 0x06, 0x54},
                         {0x3d4, 0x07, 0xf0}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x61}, {0x3d4, 0x10, 0x40},
                         {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0x3f}, {0x3d4, 0x13, 0x1c}, {0x3d4, 0x14, 0x40},
                         {0x3d4, 0x15, 0x40}, {0x3d4, 0x16, 0x4a}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x0e}};

Register scr224x288scanlines[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x37}, {0x3d4, 0x02, 0x38},
                                  {0x3d4, 0x03, 0x82}, {0x3d4, 0x04, 0x4a}, {0x3d4, 0x05, 0x9a}, {0x3d4, 0x06, 0x43},
                                  {0x3d4, 0x07, 0x1f}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x60}, {0x3d4, 0x10, 0x2a},
                                  {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0x1f}, {0x3d4, 0x13, 0x1c}, {0x3d4, 0x14, 0x40},
                                  {0x3d4, 0x15, 0x27}, {0x3d4, 0x16, 0x3a}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                                  {0x3c4, 0x04, 0x0e}};
...
Register scr240x256[] = {{0x3c2, 0x00, 0xe7}, {0x3D4, 0x00, 0x67}, {0x3d4, 0x01, 0x3b}, {0x3d4, 0x02, 0x40},
                         {0x3D4, 0x03, 0x42}, {0x3d4, 0x04, 0x4e}, {0x3d4, 0x05, 0x9a}, {0x3D4, 0x06, 0x23},
                         {0x3d4, 0x07, 0xb2}, {0x3d4, 0x08, 0x00}, {0x3D4, 0x09, 0x61}, {0x3d4, 0x10, 0x0a},
                         {0x3d4, 0x11, 0xac}, {0x3D4, 0x12, 0xff}, {0x3d4, 0x13, 0x1e}, {0x3d4, 0x14, 0x40},
                         {0x3d4, 0x15, 0x07}, {0x3D4, 0x16, 0x11}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x0e}};
...
/* Vertical Refresh Rate ~60Hz */
/* Mode Type - Linear */
Register scr256x240[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x55}, {0x3d4, 0x01, 0x3f}, {0x3d4, 0x02, 0x80},
                         {0x3d4, 0x03, 0x90}, {0x3d4, 0x04, 0x49}, {0x3d4, 0x05, 0x80}, {0x3D4, 0x06, 0x43},
                         {0x3d4, 0x07, 0xb2}, {0x3d4, 0x08, 0x00}, {0x3D4, 0x09, 0x61}, {0x3d4, 0x10, 0x04},
                         {0x3d4, 0x11, 0xac}, {0x3D4, 0x12, 0xdf}, {0x3d4, 0x13, 0x20}, {0x3d4, 0x14, 0x40},
                         {0x3d4, 0x15, 0x07}, {0x3D4, 0x16, 0x11}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x0e}};
...
/* Mode Type - Linear */
Register scr256x256[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x55}, {0x3d4, 0x01, 0x3f}, {0x3d4, 0x02, 0x40},
                         {0x3d4, 0x03, 0x90}, {0x3d4, 0x04, 0x49}, {0x3d4, 0x05, 0x80}, {0x3D4, 0x06, 0x60},
                         {0x3d4, 0x07, 0xb2}, {0x3d4, 0x08, 0x00}, {0x3D4, 0x09, 0x61}, {0x3d4, 0x10, 0x28},
                         {0x3d4, 0x11, 0xac}, {0x3D4, 0x12, 0xff}, {0x3d4, 0x13, 0x20}, {0x3d4, 0x14, 0x40},
                         {0x3d4, 0x15, 0x07}, {0x3D4, 0x16, 0x11}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x0e}};
...
Register scr256x256ver[] = {{0x3c2, 0x00, 0xe7}, {0x3D4, 0x00, 0x6c}, {0x3d4, 0x01, 0x3f}, {0x3d4, 0x02, 0x40},
                            {0x3D4, 0x03, 0x42}, {0x3d4, 0x04, 0x51}, {0x3d4, 0x05, 0x9a}, {0x3D4, 0x06, 0x23},
                            {0x3d4, 0x07, 0xb2}, {0x3d4, 0x08, 0x00}, {0x3D4, 0x09, 0x61}, {0x3d4, 0x10, 0x0a},
                            {0x3d4, 0x11, 0xac}, {0x3D4, 0x12, 0xff}, {0x3d4, 0x13, 0x20}, {0x3d4, 0x14, 0x40},
                            {0x3d4, 0x15, 0x07}, {0x3D4, 0x16, 0x11}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                            {0x3c4, 0x04, 0x0e}};
...
/* Vertical Refresh Rate ~60Hz */
/* Mode Type - Linear */
Register scr288x224[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x47}, {0x3d4, 0x02, 0x49},
                         {0x3d4, 0x03, 0x90}, {0x3d4, 0x04, 0x50}, {0x3d4, 0x05, 0x80}, {0x3d4, 0x06, 0x0c},
                         {0x3d4, 0x07, 0x3e}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x41}, {0x3d4, 0x10, 0xd8},
                         {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0xbf}, {0x3d4, 0x13, 0x24}, {0x3d4, 0x14, 0x40},
                         {0x3d4, 0x15, 0xc2}, {0x3d4, 0x16, 0xf4}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x0e}};
...
Register scr240x320[] = {{0x3c2, 0x00, 0xe7}, {0x3d4, 0x00, 0x5a}, {0x3d4, 0x01, 0x3b}, {0x3d4, 0x02, 0x3c},
                         {0x3d4, 0x03, 0x96}, {0x3d4, 0x04, 0x47}, {0x3d4, 0x05, 0x14}, {0x3d4, 0x06, 0x8c},
                         {0x3d4, 0x07, 0xf0}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x61}, {0x3d4, 0x10, 0x80},
                         {0x3d4, 0x11, 0x92}, {0x3d4, 0x12, 0x7f}, {0x3d4, 0x13, 0x1e}, {0x3d4, 0x14, 0x00},
                         {0x3d4, 0x15, 0x80}, {0x3d4, 0x16, 0x84}, {0x3d4, 0x17, 0xe3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x06}};
...
/* Vertical Refresh Rate ~60Hz */
/* Mode Type - Planar */
Register scr320x240[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x4f}, {0x3d4, 0x02, 0x50},
                         {0x3d4, 0x03, 0x82}, {0x3d4, 0x04, 0x54}, {0x3d4, 0x05, 0x80}, {0x3d4, 0x06, 0x0c},
                         {0x3d4, 0x07, 0x3e}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x41}, {0x3d4, 0x10, 0xe9},
                         {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0xdf}, {0x3d4, 0x13, 0x28}, {0x3d4, 0x14, 0x00},
                         {0x3d4, 0x15, 0xe7}, {0x3d4, 0x16, 0x06}, {0x3d4, 0x17, 0xe3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x06}};
...
/* Vertical Refresh Rate ~60Hz */
/* Mode Type - Planar */
Register scr336x240[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x53}, {0x3d4, 0x02, 0x56},
                         {0x3d4, 0x03, 0x80}, {0x3d4, 0x04, 0x57}, {0x3d4, 0x05, 0x9b}, {0x3d4, 0x06, 0x0c},
                         {0x3d4, 0x07, 0x3e}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x41}, {0x3d4, 0x10, 0xe5},
                         {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0xdf}, {0x3d4, 0x13, 0x2a}, {0x3d4, 0x14, 0x00},
                         {0x3d4, 0x15, 0xe8}, {0x3d4, 0x16, 0x02}, {0x3d4, 0x17, 0xe3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x06}};
...
Register scr384x224[] = {{0x3c2, 0x00, 0xe7}, {0x3d4, 0x00, 0x6c}, {0x3d4, 0x01, 0x5f}, {0x3d4, 0x02, 0x61},
                         {0x3d4, 0x03, 0x8b}, {0x3d4, 0x04, 0x62}, {0x3d4, 0x05, 0x86}, {0x3d4, 0x06, 0x0c},
                         {0x3d4, 0x07, 0x3e}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x41}, {0x3d4, 0x10, 0xd8},
                         {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0xbf}, {0x3d4, 0x13, 0x30}, {0x3d4, 0x14, 0x00},
                         {0x3d4, 0x15, 0xc2}, {0x3d4, 0x16, 0xf4}, {0x3d4, 0x17, 0xe3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x06}};
...
/* Vertical Refresh Rate ~60Hz */
/* Mode Type - Planar */
Register scr384x240[] = {{0x3c2, 0x00, 0xe7}, {0x3d4, 0x00, 0x6c}, {0x3d4, 0x01, 0x5f}, {0x3d4, 0x02, 0x61},
                         {0x3d4, 0x03, 0x8b}, {0x3d4, 0x04, 0x62}, {0x3d4, 0x05, 0x86}, {0x3d4, 0x06, 0x0c},
                         {0x3d4, 0x07, 0x3e}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x41}, {0x3d4, 0x10, 0xe9},
                         {0x3d4, 0x11, 0xac}, {0x3d4, 0x12, 0xdf}, {0x3d4, 0x13, 0x30}, {0x3d4, 0x14, 0x00},
                         {0x3d4, 0x15, 0xe8}, {0x3d4, 0x16, 0x04}, {0x3d4, 0x17, 0xe3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x06}};
...
/* Vertical Refresh Rate ~57Hz */
/* Mode Type - Planar */
Register scr384x256[] = {{0x3c2, 0x00, 0xe7}, {0x3d4, 0x00, 0x6c}, {0x3d4, 0x01, 0x5f}, {0x3d4, 0x02, 0x61},
                         {0x3d4, 0x03, 0x8b}, {0x3d4, 0x04, 0x62}, {0x3d4, 0x05, 0x86}, {0x3D4, 0x06, 0x23},
                         {0x3d4, 0x07, 0x36}, {0x3d4, 0x08, 0x00}, {0x3D4, 0x09, 0x61}, {0x3d4, 0x10, 0xff},
                         {0x3d4, 0x11, 0xac}, {0x3D4, 0x12, 0xff}, {0x3d4, 0x13, 0x30}, {0x3d4, 0x14, 0x00},
                         {0x3d4, 0x15, 0x07}, {0x3D4, 0x16, 0x11}, {0x3d4, 0x17, 0xe3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x06}};
...
/* Mode Type - Linear */
Register scr320x204[] = {
    {0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x4f}, {0x3d4, 0x02, 0x50}, {0x3d4, 0x03, 0x82},
    {0x3d4, 0x04, 0x54}, {0x3d4, 0x05, 0x80}, {0x3d4, 0x06, 0xbf}, {0x3d4, 0x07, 0x1f}, {0x3d4, 0x08, 0x00},
    {0x3d4, 0x09, 0x41}, {0x3d4, 0x10, 0x9c}, {0x3d4, 0x11, 0x8e}, {0x3d4, 0x12, 0x97}, {0x3d4, 0x13, 0x28},
    {0x3d4, 0x14, 0x40}, {0x3d4, 0x15, 0x96}, {0x3d4, 0x16, 0xb9}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
    {0x3c4, 0x04, 0x0e},
};

/* 200x320 - vertical mode */
/* Mode Type - Linear */
Register scr200x320[] = {{0x3c2, 0x00, 0xe3}, {0x3d4, 0x00, 0x5f}, {0x3d4, 0x01, 0x31}, {0x3d4, 0x02, 0x38},
                         {0x3d4, 0x03, 0x82}, {0x3d4, 0x04, 0x4a}, {0x3d4, 0x05, 0x9a}, {0x3d4, 0x06, 0x4e},
                         {0x3d4, 0x07, 0x1f}, {0x3d4, 0x08, 0x00}, {0x3d4, 0x09, 0x40}, {0x3d4, 0x10, 0x40},
                         {0x3d4, 0x11, 0x90}, {0x3d4, 0x12, 0x3f}, {0x3d4, 0x13, 0x19}, {0x3d4, 0x14, 0x40},
                         {0x3d4, 0x15, 0x80}, {0x3d4, 0x16, 0x40}, {0x3d4, 0x17, 0xa3}, {0x3c4, 0x01, 0x01},
                         {0x3c4, 0x04, 0x0e}};

Register*
make_scanline_mode(Register* inreg, int entries) {
...
center_mode(Register* pReg) {
    ...
    vert_display = (pReg[V_END_INDEX].value | ((pReg[OVERFLOW_INDEX].value & 0x02) << 7)
                    | ((pReg[OVERFLOW_INDEX].value & 0x40) << 3))
                   + 1;
