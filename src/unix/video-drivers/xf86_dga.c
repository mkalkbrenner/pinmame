...
int
xf86_dga_create_display(int depth) {
    return (*p_xf86_dga_create_display)(depth);
}

void
xf86_dga_close_display(void) {
    (*p_xf86_dga_close_display)();
}

int
xf86_dga_modify_pen(int pen, unsigned char red, unsigned char green, unsigned char blue) {
    return (*p_xf86_dga_modify_pen)(pen, red, green, blue);
}

void
xf86_dga_update_display(struct mame_bitmap* bitmap) {
    (*p_xf86_dga_update_display)(bitmap);
}

int
xf86_dga_alloc_palette(int writable_colors) {
    return (*p_xf86_dga_alloc_palette)(writable_colors);
}

int
xf86_dga_16bpp_capable(void) {
