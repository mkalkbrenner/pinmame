...
#define JOY_BUTTON_CODE(joy, button)     (joy * JOY_LIST_TOTAL_ENTRIES + JOY_LIST_AXIS_ENTRIES + button)

#define MOUSE_BUTTON_CODE(mouse, button) (JOY_LIST_LEN + mouse * MOUSE_LIST_TOTAL_ENTRIES + button)

#define JOY_AXIS_CODE(joy, axis, dir)    (joy * JOY_LIST_TOTAL_ENTRIES + JOY_DIRS * axis + dir)

/* mouse doesn't support axis this way */

#define JOY_GET_JOY(code)                (code / JOY_LIST_TOTAL_ENTRIES)

#define MOUSE_GET_MOUSE(code)            ((code - JOY_LIST_LEN) / MOUSE_LIST_TOTAL_ENTRIES)

#define JOY_IS_AXIS(code)                ((code < JOY_LIST_LEN) && ((code % JOY_LIST_TOTAL_ENTRIES) < JOY_LIST_AXIS_ENTRIES))
...
#define MOUSE_IS_BUTTON(code)  (code >= JOY_LIST_LEN)

#define JOY_GET_AXIS(code)     ((code % JOY_LIST_TOTAL_ENTRIES) / JOY_DIRS)

/* mouse doesn't support axis this way */

#define JOY_GET_DIR(code)      ((code % JOY_LIST_TOTAL_ENTRIES) % JOY_DIRS)

/* mouse doesn't support axis this way */

#define JOY_GET_BUTTON(code)   ((code % JOY_LIST_TOTAL_ENTRIES) - JOY_LIST_AXIS_ENTRIES)

#define MOUSE_GET_BUTTON(code) ((code - JOY_LIST_LEN) % MOUSE_LIST_TOTAL_ENTRIES)
