...
#define SYSDEP_MIXER_NAMES                                                                                             \
    { "Volume", "PCM 1", "PCM 2", "Synth", "CD", "Line 1", "Line 2", "Line 3", "Bass", "Treble" }
...
struct sysdep_mixer_struct* sysdep_mixer_create(const char* plugin, const char* device, int flags);
void sysdep_mixer_destroy(struct sysdep_mixer_struct* dsp);

int sysdep_mixer_channel_available(struct sysdep_mixer_struct* mixer, int channel);

int sysdep_mixer_set(struct sysdep_mixer_struct* mixer, int channel, int left, int right);
int sysdep_mixer_get(struct sysdep_mixer_struct* mixer, int channel, int* left, int* right);
