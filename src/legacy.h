...
enum {
    ...
    ver_567_KEYCODE_8,
    ver_567_KEYCODE_9,
    ver_567_KEYCODE_0_PAD,
    ver_567_KEYCODE_1_PAD,
    ver_567_KEYCODE_2_PAD,
    ver_567_KEYCODE_3_PAD,
    ver_567_KEYCODE_4_PAD,
    ver_567_KEYCODE_5_PAD,
    ver_567_KEYCODE_6_PAD,
    ver_567_KEYCODE_7_PAD,
    ver_567_KEYCODE_8_PAD,
    ver_567_KEYCODE_9_PAD,
    ver_567_KEYCODE_F1,
    ver_567_KEYCODE_F2,
    ver_567_KEYCODE_F3,
    ver_567_KEYCODE_F4,
    ...
    ver_567_KEYCODE_F12,
    ver_567_KEYCODE_ESC,
    ver_567_KEYCODE_TILDE,
    ver_567_KEYCODE_MINUS,
    ver_567_KEYCODE_EQUALS,
    ver_567_KEYCODE_BACKSPACE,
    ver_567_KEYCODE_TAB,
    ver_567_KEYCODE_OPENBRACE,
    ver_567_KEYCODE_CLOSEBRACE,
    ver_567_KEYCODE_ENTER,
    ver_567_KEYCODE_COLON,
    ver_567_KEYCODE_QUOTE,
    ver_567_KEYCODE_BACKSLASH,
    ver_567_KEYCODE_BACKSLASH2,
    ver_567_KEYCODE_COMMA,
    ver_567_KEYCODE_STOP,
    ver_567_KEYCODE_SLASH,
    ver_567_KEYCODE_SPACE,
    ver_567_KEYCODE_INSERT,
    ver_567_KEYCODE_DEL,
    ver_567_KEYCODE_HOME,
    ver_567_KEYCODE_END,
    ver_567_KEYCODE_PGUP,
    ver_567_KEYCODE_PGDN,
    ver_567_KEYCODE_LEFT,
    ver_567_KEYCODE_RIGHT,
    ver_567_KEYCODE_UP,
    ver_567_KEYCODE_DOWN,
    ver_567_KEYCODE_SLASH_PAD,
    ver_567_KEYCODE_ASTERISK,
    ver_567_KEYCODE_MINUS_PAD,
    ver_567_KEYCODE_PLUS_PAD,
    ver_567_KEYCODE_DEL_PAD,
    ver_567_KEYCODE_ENTER_PAD,
    ver_567_KEYCODE_PRTSCR,
    ver_567_KEYCODE_PAUSE,
    ver_567_KEYCODE_LSHIFT,
    ver_567_KEYCODE_RSHIFT,
    ver_567_KEYCODE_LCONTROL,
    ver_567_KEYCODE_RCONTROL,
    ver_567_KEYCODE_LALT,
    ver_567_KEYCODE_RALT,
    ver_567_KEYCODE_SCRLOCK,
    ver_567_KEYCODE_NUMLOCK,
    ver_567_KEYCODE_CAPSLOCK,
...
enum {
    ...
    ver_567_JOYCODE_1_LEFT,
    ver_567_JOYCODE_1_RIGHT,
    ver_567_JOYCODE_1_UP,
    ver_567_JOYCODE_1_DOWN,
    ver_567_JOYCODE_1_BUTTON1,
    ver_567_JOYCODE_1_BUTTON2,
    ver_567_JOYCODE_1_BUTTON3,
    ver_567_JOYCODE_1_BUTTON4,
    ver_567_JOYCODE_1_BUTTON5,
    ver_567_JOYCODE_1_BUTTON6,
    ver_567_JOYCODE_2_LEFT,
    ver_567_JOYCODE_2_RIGHT,
    ver_567_JOYCODE_2_UP,
    ver_567_JOYCODE_2_DOWN,
    ver_567_JOYCODE_2_BUTTON1,
    ver_567_JOYCODE_2_BUTTON2,
    ver_567_JOYCODE_2_BUTTON3,
    ver_567_JOYCODE_2_BUTTON4,
    ver_567_JOYCODE_2_BUTTON5,
    ver_567_JOYCODE_2_BUTTON6,
    ver_567_JOYCODE_3_LEFT,
    ver_567_JOYCODE_3_RIGHT,
    ver_567_JOYCODE_3_UP,
    ver_567_JOYCODE_3_DOWN,
    ver_567_JOYCODE_3_BUTTON1,
    ver_567_JOYCODE_3_BUTTON2,
    ver_567_JOYCODE_3_BUTTON3,
    ver_567_JOYCODE_3_BUTTON4,
    ver_567_JOYCODE_3_BUTTON5,
    ver_567_JOYCODE_3_BUTTON6,
    ver_567_JOYCODE_4_LEFT,
    ver_567_JOYCODE_4_RIGHT,
    ver_567_JOYCODE_4_UP,
    ver_567_JOYCODE_4_DOWN,
    ver_567_JOYCODE_4_BUTTON1,
    ver_567_JOYCODE_4_BUTTON2,
    ver_567_JOYCODE_4_BUTTON3,
    ver_567_JOYCODE_4_BUTTON4,
    ver_567_JOYCODE_4_BUTTON5,
    ver_567_JOYCODE_4_BUTTON6,
...
static struct ver_table ver_567_table_keyboard[] = {{0, CODE_NONE},
...
static struct ver_table ver_567_table_joystick[] = {{0, CODE_NONE},
...
static int
code_table_ver_567_keyboard(int v) {
...
static int
code_table_ver_567_joystick(int v) {
...
static int
seq_partial_is_special_code(InputCode code) {
    if (code < __code_max)
        return 0;
    if (code == CODE_NOT)
        return 0;
...
static int
seq_partial_read(mame_file* f, InputSeq* seq, unsigned* pos, unsigned len, int (*code_table)(int)) {
    UINT16 w;
    unsigned j = 0;
    int code;
...
static int
seq_read_ver_5(mame_file* f, InputSeq* seq) {
    unsigned pos = 0;
    seq_set_0(seq);
...
static int
seq_read_ver_6(mame_file* f, InputSeq* seq) {
    unsigned pos = 0;
    seq_set_0(seq);
...
static int
seq_read_ver_7(mame_file* f, InputSeq* seq) {
    unsigned pos = 0;
    seq_set_0(seq);
...
static int
input_port_read_ver_5(mame_file* f, struct InputPort* in) {
    UINT32 i;
    UINT16 w;
    if (readint(f, &i) != 0)
        return -1;
...
static int
input_port_read_ver_6(mame_file* f, struct InputPort* in) {
    UINT32 i;
    UINT16 w;
    if (readint(f, &i) != 0)
        return -1;
...
static int
input_port_read_ver_7(mame_file* f, struct InputPort* in) {
    UINT32 i;
    UINT16 w;
    if (readint(f, &i) != 0)
        return -1;
