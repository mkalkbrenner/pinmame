...
enum { CT_NONE = 0, CT_BUTTON, CT_COMBOBOX, CT_SLIDER };
...
void DataMapAdd(DWORD dwCtrlId, int dmType, int cType, void* var, int encoded_type, void* encoded_var, int min, int max,
                void (*func)(HWND hWnd));
