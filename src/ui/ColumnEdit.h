...
INT_PTR InternalColumnDialogProc(HWND hDlg, UINT Msg, WPARAM wParam, LPARAM lParam, int nColumnMax, int* shown,
                                 int* order, const char** names, void (*pfnGetRealColumnOrder)(int*),
