...
BOOL
TestBit(LPBITS lpBits, UINT nBit) {
    UINT offset;
    UCHAR mask;
...
/* Set the 'nBit'th bit */
void
SetBit(LPBITS lpBits, UINT nBit) {
    UINT offset;
    UCHAR mask;
...
void
ClearBit(LPBITS lpBits, UINT nBit) {
    UINT offset;
    UCHAR mask;
...
void
SetAllBits(LPBITS lpBits, BOOL bSet) {
 ...
 */
int
FindBit(LPBITS lpBits, int nStartPos, BOOL bSet) {
    UINT end;
    UINT i;
    BOOL res;
