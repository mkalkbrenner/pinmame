...
BOOL
PropSheetFilter_Vector(const struct InternalMachineDriver* drv, const struct GameDriver* gamedrv) {
...
static DWORD dwHelpIDs[] = {
    ...
    IDC_A2D, HIDC_A2D, IDC_ANTIALIAS, HIDC_ANTIALIAS, IDC_ARTRES, HIDC_ARTRES, IDC_ARTWORK, HIDC_ARTWORK,
    IDC_ARTWORK_CROP, HIDC_ARTWORK_CROP, IDC_ASPECTRATIOD, HIDC_ASPECTRATIOD, IDC_ASPECTRATION, HIDC_ASPECTRATION,
    IDC_AUTOFRAMESKIP, HIDC_AUTOFRAMESKIP, IDC_BACKDROPS, HIDC_BACKDROPS, IDC_BEAM, HIDC_BEAM, IDC_BEZELS, HIDC_BEZELS,
    IDC_BRIGHTNESS, HIDC_BRIGHTNESS, IDC_BRIGHTCORRECT, HIDC_BRIGHTCORRECT, IDC_BROADCAST, HIDC_BROADCAST,
    IDC_RANDOM_BG, HIDC_RANDOM_BG, IDC_CHEAT, HIDC_CHEAT, IDC_DDRAW, HIDC_DDRAW, IDC_DEFAULT_INPUT, HIDC_DEFAULT_INPUT,
    IDC_EFFECT, HIDC_EFFECT, IDC_FILTER_CLONES, HIDC_FILTER_CLONES, IDC_FILTER_EDIT, HIDC_FILTER_EDIT,
    IDC_FILTER_NONWORKING, HIDC_FILTER_NONWORKING, IDC_FILTER_ORIGINALS, HIDC_FILTER_ORIGINALS, IDC_FILTER_RASTER,
    HIDC_FILTER_RASTER, IDC_FILTER_UNAVAILABLE, HIDC_FILTER_UNAVAILABLE, IDC_FILTER_VECTOR, HIDC_FILTER_VECTOR,
    IDC_FILTER_WORKING, HIDC_FILTER_WORKING, IDC_FLICKER, HIDC_FLICKER, IDC_FLIPX, HIDC_FLIPX, IDC_FLIPY, HIDC_FLIPY,
    IDC_FRAMESKIP, HIDC_FRAMESKIP, IDC_GAMMA, HIDC_GAMMA, IDC_HISTORY, HIDC_HISTORY, IDC_HWSTRETCH, HIDC_HWSTRETCH,
    IDC_INTENSITY, HIDC_INTENSITY, IDC_JOYSTICK, HIDC_JOYSTICK, IDC_KEEPASPECT, HIDC_KEEPASPECT, IDC_LANGUAGECHECK,
    HIDC_LANGUAGECHECK, IDC_LANGUAGEEDIT, HIDC_LANGUAGEEDIT, IDC_LEDS, HIDC_LEDS, IDC_LOG, HIDC_LOG, IDC_SLEEP,
    HIDC_SLEEP, IDC_MATCHREFRESH, HIDC_MATCHREFRESH, IDC_MAXIMIZE, HIDC_MAXIMIZE, IDC_OVERLAYS, HIDC_OVERLAYS,
    IDC_PROP_RESET, HIDC_PROP_RESET, IDC_REFRESH, HIDC_REFRESH, IDC_RESDEPTH, HIDC_RESDEPTH, IDC_RESET_DEFAULT,
    HIDC_RESET_DEFAULT, IDC_RESET_FILTERS, HIDC_RESET_FILTERS, IDC_RESET_GAMES, HIDC_RESET_GAMES, IDC_RESET_UI,
    HIDC_RESET_UI, IDC_ROTATE, HIDC_ROTATE, IDC_SAMPLERATE, HIDC_SAMPLERATE, IDC_SAMPLES, HIDC_SAMPLES, IDC_SCANLINES,
    HIDC_SCANLINES, IDC_SIZES, HIDC_SIZES, IDC_START_GAME_CHECK, HIDC_START_GAME_CHECK, IDC_SWITCHBPP, HIDC_SWITCHBPP,
    IDC_SWITCHRES, HIDC_SWITCHRES, IDC_SYNCREFRESH, HIDC_SYNCREFRESH, IDC_THROTTLE, HIDC_THROTTLE, IDC_TRANSLUCENCY,
    HIDC_TRANSLUCENCY, IDC_TRIPLE_BUFFER, HIDC_TRIPLE_BUFFER, IDC_USE_DEFAULT, HIDC_USE_DEFAULT,
    //IDC_USE_FILTER,         HIDC_USE_FILTER,
    IDC_USE_MOUSE, HIDC_USE_MOUSE, IDC_USE_SOUND, HIDC_USE_SOUND, IDC_VOLUME, HIDC_VOLUME, IDC_WAITVSYNC,
    HIDC_WAITVSYNC, IDC_WINDOWED, HIDC_WINDOWED, IDC_PAUSEBRIGHT, HIDC_PAUSEBRIGHT, IDC_LIGHTGUN, HIDC_LIGHTGUN,
    IDC_STEADYKEY, HIDC_STEADYKEY, IDC_OLD_TIMING, HIDC_OLD_TIMING, IDC_JOY_GUI, HIDC_JOY_GUI, IDC_RANDOM_BG,
    HIDC_RANDOM_BG, IDC_SKIP_DISCLAIMER, HIDC_SKIP_DISCLAIMER, IDC_SKIP_GAME_INFO, HIDC_SKIP_GAME_INFO,
    IDC_HIGH_PRIORITY, HIDC_HIGH_PRIORITY, IDC_D3D, HIDC_D3D, IDC_D3D_FILTER, HIDC_D3D_FILTER, IDC_D3D_EFFECT,
    HIDC_D3D_EFFECT, IDC_D3D_TEXTURE_MANAGEMENT, HIDC_D3D_TEXTURE_MANAGEMENT, IDC_AUDIO_LATENCY, HIDC_AUDIO_LATENCY,
    IDC_D3D_PRESCALE, HIDC_D3D_PRESCALE, IDC_D3D_SCANLINES_ENABLE, HIDC_D3D_SCANLINES, IDC_D3D_SCANLINES,
    HIDC_D3D_SCANLINES, IDC_D3D_FEEDBACK_ENABLE, HIDC_D3D_FEEDBACK, IDC_D3D_FEEDBACK, HIDC_D3D_FEEDBACK, IDC_ZOOM,
    HIDC_ZOOM, IDC_BIOS, HIDC_BIOS, IDC_CLEAN_STRETCH, HIDC_CLEAN_STRETCH, IDC_D3D_ROTATE_EFFECTS,
    HIDC_D3D_ROTATE_EFFECTS, IDC_CYCLE_SCREENSHOT, HIDC_CYCLE_SCREENSHOT, IDC_STRETCH_SCREENSHOT_LARGER,
    HIDC_STRETCH_SCREENSHOT_LARGER, 0, 0};

static struct ComboBoxEffect {
    const char* m_pText;
    const char* m_pData;
} g_ComboBoxEffect[] = {{"None", "none"},
                        {"25% scanlines", "scan25"},
                        {"50% scanlines", "scan50"},
                        {"75% scanlines", "scan75"},
...
static void CLIB_DECL
DetailsPrintf(const char* fmt, ...) {
    // throw it away
}
#endif

static PROPSHEETPAGE*
CreatePropSheetPages(HINSTANCE hInst, BOOL bOnlyDefault, const struct GameDriver* gamedrv, UINT* pnMaxPropSheets) {
...
void
InitDefaultPropertyPage(HINSTANCE hInst, HWND hWnd) {
...
void
InitPropertyPage(HINSTANCE hInst, HWND hWnd, int game_num, HICON hIcon) {
    InitPropertyPageToPage(hInst, hWnd, game_num, hIcon, PROPERTIES_PAGE);
}

void
InitPropertyPageToPage(HINSTANCE hInst, HWND hWnd, int game_num, HICON hIcon, int start_page) {
    PROPSHEETHEADER pshead;
    PROPSHEETPAGE* pspage;
...
GameInfoCPU(UINT nIndex) {
    ...
    while (i < MAX_CPU && drv.cpu[i].cpu_type) {
        if (drv.cpu[i].cpu_clock >= 1000000000)
            sprintf(&buf[strlen(buf)], "%s %3.09lf GHz", cputype_name(drv.cpu[i].cpu_type),
                    drv.cpu[i].cpu_clock / 1000000000.);
        else if (drv.cpu[i].cpu_clock >= 1000000)
            sprintf(&buf[strlen(buf)], "%s %3.06lf MHz", cputype_name(drv.cpu[i].cpu_type),
                    drv.cpu[i].cpu_clock / 1000000.);
        else
            sprintf(&buf[strlen(buf)], "%s %3.03lf kHz", cputype_name(drv.cpu[i].cpu_type),
    ...
    while (i < MAX_SOUND && drv.sound[i].sound_type) {
        ...
        if (sound_clock(&drv.sound[i])) {
            if (sound_clock(&drv.sound[i]) >= 1000000)
                sprintf(&buf[strlen(buf)], " %3.06lf MHz", sound_clock(&drv.sound[i]) / 1000000.);
            else
                sprintf(&buf[strlen(buf)], " %3.03lf kHz", sound_clock(&drv.sound[i]) / 1000.);
        }
...
GameInfoScreen(UINT nIndex) {
    ...
    if (drv.video_attributes & VIDEO_TYPE_VECTOR)
        ...
        if (drivers[nIndex]->flags & ORIENTATION_SWAP_XY)
            sprintf(buf, "%d x %d (vert) %5.2f Hz", drv.default_visible_area.max_y - drv.default_visible_area.min_y + 1,
                    drv.default_visible_area.max_x - drv.default_visible_area.min_x + 1, drv.frames_per_second);
        else
            sprintf(buf, "%d x %d (horz) %5.2f Hz", drv.default_visible_area.max_x - drv.default_visible_area.min_x + 1,
                    drv.default_visible_area.max_y - drv.default_visible_area.min_y + 1, drv.frames_per_second);
    }
    return buf;
}
...
const char*
GameInfoStatus(int driver_index) {
...
static char*
GameInfoManufactured(UINT nIndex) {
...
static char*
GameInfoCloneOf(UINT nIndex) {
    static char buf[1024];

    buf[0] = '\0';

    if (DriverIsClone(nIndex)) {
        sprintf(buf, "%s - \"%s\"", ConvertAmpersandString(ModifyThe(drivers[nIndex]->clone_of->description)),
...
static const char*
GameInfoSource(UINT nIndex) {
    return GetDriverFilename(nIndex);
}

/* Handle the information property page */
INT_PTR CALLBACK
GamePropertiesDialogProc(HWND hDlg, UINT Msg, WPARAM wParam, LPARAM lParam) {
    switch (Msg) {
        case WM_INITDIALOG:
            if (g_hIcon)
...
#ifndef PINMAME_NO_UNUSED // currently unused function (GCC 3.4)
static BOOL
ReadSkipCtrl(HWND hWnd, UINT nCtrlID, int* value) {
    HWND hCtrl;
    char buf[100];
    int nValue = *value;
...
INT_PTR CALLBACK
GameOptionsProc(HWND hDlg, UINT Msg, WPARAM wParam, LPARAM lParam) {
    switch (Msg) {
        case WM_INITDIALOG:
...
static void
PropToOptions(HWND hWnd, options_type* o) {
    HWND hCtrl;
    HWND hCtrl2;
    int nIndex;
...
static void
OptionsToProp(HWND hWnd, options_type* o) {
    HWND hCtrl;
    HWND hCtrl2;
    char buf[100];
    int h = 0;
    ...
    if (!_stricmp(o->resolution, "auto")) {
        w = h = 0;
    } else if (sscanf(o->resolution, "%dx%dx%d", &w, &h, &d) < 2) {
        w = h = d = 0;
    }
...
static void
SetPropEnabledControls(HWND hWnd) {
    HWND hCtrl;
    int nIndex;
    int sound;
    BOOL ddraw = FALSE;
    ...
    EnableWindow(GetDlgItem(hWnd, IDC_ASPECTRATIOTEXT),
                 ddraw && DirectDraw_HasHWStretch() && Button_GetCheck(GetDlgItem(hWnd, IDC_HWSTRETCH)));
    EnableWindow(GetDlgItem(hWnd, IDC_ASPECTRATION),
                 ddraw && DirectDraw_HasHWStretch() && Button_GetCheck(GetDlgItem(hWnd, IDC_HWSTRETCH)));
    EnableWindow(GetDlgItem(hWnd, IDC_ASPECTRATIOD),
                 ddraw && DirectDraw_HasHWStretch() && Button_GetCheck(GetDlgItem(hWnd, IDC_HWSTRETCH)));
...
static void
AssignSampleRate(HWND hWnd) {
    switch (g_nSampleRateIndex) {
        case 0:
            pGameOpts->samplerate = 11025;
            break;
        case 1:
            pGameOpts->samplerate = 22050;
            break;
        case 2:
            pGameOpts->samplerate = 48000;
            break;
        default:
            pGameOpts->samplerate = 48000;
            break;
...
AssignRotate(HWND hWnd) {
    ...
    switch (g_nRotateIndex) {
        ...
        case 2:
            ...
            break;
        case 3:
            pGameOpts->norotate = 1;
            break;
        case 4:
            pGameOpts->auto_ror = 1;
            break;
        case 5:
            pGameOpts->auto_rol = 1;
            break;
        default:
            break;
    }
...
ResetDataMap(void) {
    ...
    switch (pGameOpts->samplerate) {
        case 11025:
            g_nSampleRateIndex = 0;
            break;
        case 22050:
            g_nSampleRateIndex = 1;
            break;
        default:
        case 48000:
            g_nSampleRateIndex = 2;
            break;
    }
...
BuildDataMap(void) {
    ...
    /* video */
    DataMapAdd(IDC_AUTOFRAMESKIP, DM_BOOL, CT_BUTTON, &pGameOpts->autoframeskip, DM_BOOL, &pGameOpts->autoframeskip, 0,
               0, 0);
    ...
    DataMapAdd(IDC_TRIPLE_BUFFER, DM_BOOL, CT_BUTTON, &pGameOpts->use_triplebuf, DM_BOOL, &pGameOpts->use_triplebuf, 0,
               0, 0);
    ...
    DataMapAdd(IDC_HWSTRETCH, DM_BOOL, CT_BUTTON, &pGameOpts->ddraw_stretch, DM_BOOL, &pGameOpts->ddraw_stretch, 0, 0,
               0);
    ...
    DataMapAdd(IDC_MATCHREFRESH, DM_BOOL, CT_BUTTON, &pGameOpts->matchrefresh, DM_BOOL, &pGameOpts->matchrefresh, 0, 0,
               0);
    ...
    DataMapAdd(IDC_BRIGHTNESS, DM_INT, CT_SLIDER, &g_nBrightnessIndex, DM_DOUBLE, &pGameOpts->gfx_brightness, 0, 0,
               AssignBrightness);
    ...
    DataMapAdd(IDC_CLEAN_STRETCH, DM_INT, CT_COMBOBOX, &pGameOpts->clean_stretch, DM_INT, &pGameOpts->clean_stretch, 0,
               0, 0);
    ...
    DataMapAdd(IDC_D3D_TEXTURE_MANAGEMENT, DM_BOOL, CT_BUTTON, &pGameOpts->d3d_texture_management, DM_BOOL,
               &pGameOpts->d3d_texture_management, 0, 0, 0);
    DataMapAdd(IDC_D3D_EFFECT, DM_INT, CT_COMBOBOX, &pGameOpts->d3d_effect, DM_INT, &pGameOpts->d3d_effect, 0, 0, 0);
    DataMapAdd(IDC_D3D_PRESCALE, DM_INT, CT_COMBOBOX, &pGameOpts->d3d_prescale, DM_INT, &pGameOpts->d3d_prescale, 0, 0,
               0);
    DataMapAdd(IDC_D3D_ROTATE_EFFECTS, DM_BOOL, CT_BUTTON, &pGameOpts->d3d_rotate_effects, DM_BOOL,
               &pGameOpts->d3d_rotate_effects, 0, 0, 0);
    DataMapAdd(IDC_D3D_SCANLINES_ENABLE, DM_BOOL, CT_BUTTON, &pGameOpts->d3d_scanlines_enable, DM_BOOL,
               &pGameOpts->d3d_scanlines_enable, 0, 0, 0);
    DataMapAdd(IDC_D3D_SCANLINES, DM_INT, CT_SLIDER, &pGameOpts->d3d_scanlines, DM_INT, &pGameOpts->d3d_scanlines, 0, 0,
               0);
    DataMapAdd(IDC_D3D_FEEDBACK_ENABLE, DM_BOOL, CT_BUTTON, &pGameOpts->d3d_feedback_enable, DM_BOOL,
               &pGameOpts->d3d_feedback_enable, 0, 0, 0);
    DataMapAdd(IDC_D3D_FEEDBACK, DM_INT, CT_SLIDER, &pGameOpts->d3d_feedback, DM_INT, &pGameOpts->d3d_feedback, 0, 0,
               0);
    ...
    /* core video */
    DataMapAdd(IDC_BRIGHTCORRECT, DM_INT, CT_SLIDER, &g_nBrightCorrectIndex, DM_DOUBLE, &pGameOpts->f_bright_correct, 0,
               0, AssignBrightCorrect);
    DataMapAdd(IDC_BRIGHTCORRECTDISP, DM_NONE, CT_NONE, NULL, DM_DOUBLE, &pGameOpts->f_bright_correct, 0, 0, 0);
    DataMapAdd(IDC_PAUSEBRIGHT, DM_INT, CT_SLIDER, &g_nPauseBrightIndex, DM_DOUBLE, &pGameOpts->f_pause_bright, 0, 0,
               AssignPauseBright);
    ...
    DataMapAdd(IDC_TRANSLUCENCY, DM_BOOL, CT_BUTTON, &pGameOpts->translucency, DM_BOOL, &pGameOpts->translucency, 0, 0,
               0);
    ...
    DataMapAdd(IDC_INTENSITY, DM_INT, CT_SLIDER, &g_nIntensityIndex, DM_DOUBLE, &pGameOpts->f_intensity, 0, 0,
               AssignIntensity);
    DataMapAdd(IDC_INTENSITYDISP, DM_NONE, CT_NONE, NULL, DM_DOUBLE, &pGameOpts->f_intensity, 0, 0, 0);

    /* sound */
    DataMapAdd(IDC_SAMPLERATE, DM_INT, CT_COMBOBOX, &g_nSampleRateIndex, DM_INT, &pGameOpts->samplerate, 0, 0,
               AssignSampleRate);
    ...
    DataMapAdd(IDC_AUDIO_LATENCY, DM_INT, CT_SLIDER, &pGameOpts->audio_latency, DM_INT, &pGameOpts->audio_latency, 0, 0,
               0);
    ...
    DataMapAdd(IDC_ARTWORK_CROP, DM_BOOL, CT_BUTTON, &pGameOpts->artwork_crop, DM_BOOL, &pGameOpts->artwork_crop, 0, 0,
               0);
    ...
    DataMapAdd(IDC_DMD_ANTIALIAS, DM_INT, CT_SLIDER, &pGameOpts->dmd_antialias, DM_INT, &pGameOpts->dmd_antialias, 0, 0,
               0);
...
#ifdef RED_TEST
BOOL
IsControlDefaultValue(HWND hDlg, HWND hwnd_ctrl) {
    ...
    switch (control_id) {
        ...
        case IDC_SIZES: {
            ...
            if (strcmp(pGameOpts->resolution, "auto") == 0 && strcmp(default_options->resolution, "auto") == 0)
                return TRUE;
        ...
        case IDC_ROTATE: {
            ...
            return pGameOpts->ror == default_options->ror && pGameOpts->rol == default_options->rol;
        }
    }
...
static void
SetStereoEnabled(HWND hWnd, int nIndex) {
    BOOL enabled = FALSE;
    HWND hCtrl;
    struct InternalMachineDriver drv;
...
static void
SetYM3812Enabled(HWND hWnd, int nIndex) {
    int i;
    BOOL enabled;
    HWND hCtrl;
    struct InternalMachineDriver drv;
...
static void
SetSamplesEnabled(HWND hWnd, int nIndex, BOOL bSoundEnabled) {
    ...
    if (hCtrl) {
        for (i = 0; i < MAX_SOUND; i++) {
            if (nIndex == -1 || drv.sound[i].sound_type == SOUND_SAMPLES
#if HAS_VLM5030
...
static void
InitializeMisc(HWND hDlg) {
    Button_Enable(GetDlgItem(hDlg, IDC_JOYSTICK), DIJoystick.Available());

    SendMessage(GetDlgItem(hDlg, IDC_GAMMA), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 30)); /* [0.50, 2.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_BRIGHTCORRECT), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 30)); /* [0.50, 2.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_PAUSEBRIGHT), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 30)); /* [0.50, 2.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_BRIGHTNESS), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 38)); /* [0.10, 2.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_INTENSITY), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 50)); /* [0.50, 3.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_A2D), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 20)); /* [0.00, 1.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_FLICKER), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 100)); /* [0.0, 100.0] in 1.0 increments */

    SendMessage(GetDlgItem(hDlg, IDC_BEAM), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 300)); /* [1.00, 16.00] in .05 increments */

    SendMessage(GetDlgItem(hDlg, IDC_VOLUME), TBM_SETRANGE, (WPARAM)FALSE, (LPARAM)MAKELONG(0, 32)); /* [-32, 0] */
    SendMessage(GetDlgItem(hDlg, IDC_AUDIO_LATENCY), TBM_SETRANGE, (WPARAM)FALSE, (LPARAM)MAKELONG(1, 4));   // [1, 4]
    SendMessage(GetDlgItem(hDlg, IDC_D3D_SCANLINES), TBM_SETRANGE, (WPARAM)FALSE, (LPARAM)MAKELONG(0, 100)); // [0, 100]
    SendMessage(GetDlgItem(hDlg, IDC_D3D_FEEDBACK), TBM_SETRANGE, (WPARAM)FALSE, (LPARAM)MAKELONG(0, 100));  // [0, 100]
    SendMessage(GetDlgItem(hDlg, IDC_ZOOM), TBM_SETRANGE, (WPARAM)FALSE, (LPARAM)MAKELONG(1, 8));            // [1, 8]
#ifdef PINMAME
    SendMessage(GetDlgItem(hDlg, IDC_DMD_RED), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 255)); /* [0.0, 255.0] in 1.0 increments */
    SendMessage(GetDlgItem(hDlg, IDC_DMD_GREEN), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 255)); /* [0.0, 255.0] in 1.0 increments */
    SendMessage(GetDlgItem(hDlg, IDC_DMD_BLUE), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 255)); /* [0.0, 255.0] in 1.0 increments */
    SendMessage(GetDlgItem(hDlg, IDC_DMD_PERC0), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 100)); /* [0.0, 100.0] in 1.0 increments */
    SendMessage(GetDlgItem(hDlg, IDC_DMD_PERC33), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 100)); /* [0.0, 100.0] in 1.0 increments */
    SendMessage(GetDlgItem(hDlg, IDC_DMD_PERC66), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 100)); /* [0.0, 100.0] in 1.0 increments */
    SendMessage(GetDlgItem(hDlg, IDC_DMD_ANTIALIAS), TBM_SETRANGE, (WPARAM)FALSE,
                (LPARAM)MAKELONG(0, 100)); /* [0.0, 100.0] in 1.0 increments */
#endif                                     /* PINMAME */
}

static void
OptOnHScroll(HWND hwnd, HWND hwndCtl, UINT code, int pos) {
    if (hwndCtl == GetDlgItem(hwnd, IDC_FLICKER)) {
        FlickerSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_GAMMA)) {
        GammaSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_BRIGHTCORRECT)) {
        BrightCorrectSelectionChange(hwnd);
    }
    if (hwndCtl == GetDlgItem(hwnd, IDC_PAUSEBRIGHT)) {
        PauseBrightSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_BRIGHTNESS)) {
        BrightnessSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_BEAM)) {
        BeamSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_FLICKER)) {
        FlickerSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_VOLUME)) {
        VolumeSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_INTENSITY)) {
        IntensitySelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_A2D)) {
        A2DSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_AUDIO_LATENCY)) {
        AudioLatencySelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_D3D_SCANLINES)) {
        D3DScanlinesSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_D3D_FEEDBACK)) {
        D3DFeedbackSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_ZOOM)) {
        ZoomSelectionChange(hwnd);
    }
#ifdef PINMAME
    else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_RED)) {
        DMDREDSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_GREEN)) {
        DMDGREENSelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_BLUE)) {
        DMDBLUESelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_PERC0)) {
        DMDPERC0SelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_PERC33)) {
        DMDPERC33SelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_PERC66)) {
        DMDPERC66SelectionChange(hwnd);
    } else if (hwndCtl == GetDlgItem(hwnd, IDC_DMD_ANTIALIAS)) {
...
static void
FlickerSelectionChange(HWND hwnd) {
    char buf[100];
    UINT nValue;
    double dFlicker;
...
static void
GammaSelectionChange(HWND hwnd) {
    char buf[100];
    UINT nValue;
    double dGamma;
...
static void
BrightCorrectSelectionChange(HWND hwnd) {
    char buf[100];
    UINT nValue;
    double dValue;
...
static void
PauseBrightSelectionChange(HWND hwnd) {
    char buf[100];
    UINT nValue;
    double dValue;
...
static void
BrightnessSelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
    double dBrightness;
...
static void
IntensitySelectionChange(HWND hwnd) {
    char buf[100];
    UINT nValue;
    double dIntensity;
...
static void
ResDepthSelectionChange(HWND hWnd, HWND hWndCtrl) {
    int nCurSelection;
...
static void
RefreshSelectionChange(HWND hWnd, HWND hWndCtrl) {
    int nCurSelection;
...
static void
VolumeSelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
AudioLatencySelectionChange(HWND hwnd) {
    char buffer[100];
    int value;
...
static void
D3DScanlinesSelectionChange(HWND hwnd) {
    char buffer[100];
    int value;
...
static void
D3DFeedbackSelectionChange(HWND hwnd) {
    char buffer[100];
    int value;
...
static void
DMDREDSelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
DMDGREENSelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
DMDBLUESelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
DMDPERC0SelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
DMDPERC33SelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
DMDPERC66SelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
DMDANTIALIASSelectionChange(HWND hwnd) {
    char buf[100];
    int nValue;
...
static void
UpdateDisplayModeUI(HWND hwnd, DWORD dwDepth, DWORD dwRefresh) {
    int i;
    char buf[100];
    ...
    for (i = 0; i < pDisplayModes->m_nNumModes; i++) {
        if ((pDisplayModes->m_Modes[i].m_dwBPP == dwDepth || dwDepth == 0)
            ...
            sprintf(buf, "%li x %li", pDisplayModes->m_Modes[i].m_dwWidth, pDisplayModes->m_Modes[i].m_dwHeight);

            if (ComboBox_FindString(hCtrl, 0, buf) == CB_ERR) {
                idx = ComboBox_AddString(hCtrl, buf);
                nCount++;

                if (w == pDisplayModes->m_Modes[i].m_dwWidth && h == pDisplayModes->m_Modes[i].m_dwHeight)
                    nSelection = nCount;
            }
        }
    }
...
static void
InitializeDisplayModeUI(HWND hwnd) {
    UpdateDisplayModeUI(hwnd, 0, 0);
}

/* Initialize the sound options */
static void
InitializeSoundUI(HWND hwnd) {
    HWND hCtrl;
    int idx;
    int result;
...
static void
InitializeSkippingUI(HWND hwnd) {
...
static void
InitializeResDepthUI(HWND hwnd) {
    ...
    if (hCtrl) {
        ...
        for (i = 0; i < pDisplayModes->m_nNumModes; i++) {
            if (pDisplayModes->m_Modes[i].m_dwBPP == 16 || pDisplayModes->m_Modes[i].m_dwBPP == 24
...
static void
InitializeDefaultInputUI(HWND hwnd) {
...
static void
InitializeD3DFilterUI(HWND hwnd) {
...
static void
InitializeD3DEffectUI(HWND hwnd) {
...
static void
InitializeD3DPrescaleUI(HWND hwnd) {
...
static void
InitializeCleanStretchUI(HWND hwnd) {
