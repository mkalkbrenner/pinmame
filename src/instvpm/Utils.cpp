...
void
DisplayCOMError(IUnknown* pUnknown, REFIID riid) {
    if (!pUnknown)
        return;
...
LONG
RegDeleteKeyEx(HKEY hKey, LPCTSTR lpszSubKey) {
    LONG lResult;
