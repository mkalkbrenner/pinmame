...
static const PinmameKeyboardInfo _keyboardInfo[] = {{"A", A, KEYCODE_A},
                                                    {"B", B, KEYCODE_B},
                                                    {"C", C, KEYCODE_C},
                                                    {"D", D, KEYCODE_D},
                                                    {"E", E, KEYCODE_E},
...
char*
ComposePath(const char* const path, const char* const file) {
...
int
GetGameNumFromString(const char* const name) {
    int gameNum = 0;
...
int
GetDisplayCount(const struct core_dispLayout* p_layout, int* const p_index) {
...
extern "C" const struct KeyboardInfo*
...
extern "C" int
osd_is_key_pressed(const int keycode) {
...
extern "C" int
osd_readkey_unicode(const int flush) {
    return 0;
}
...
extern "C" int
osd_start_audio_stream(const int stereo) {
...
extern "C" int
osd_update_audio_stream(INT16* p_buffer) {
...
extern "C" void
osd_set_mastervolume(int attenuation) {}
...
extern "C" void
libpinmame_update_display(const int index, const struct core_dispLayout* p_layout, void* p_data) {
...
extern "C" void
libpinmame_forward_console_data(void* p_data, int size) {
...
extern "C" void
OnSolenoid(const int solenoid, const int isActive) {
...
extern "C" void
libpinmame_update_mech(const int mechNo, mech_tMechData* p_mechData) {
...
LIBPINMAME_API PINMAME_STATUS
PinmameGetGame(const char* const p_name, PinmameGameCallback callback) {
...
LIBPINMAME_API PINMAME_STATUS
PinmameGetGames(PinmameGameCallback callback) {
    if (_p_Config == nullptr) {
        return CONFIG_NOT_SET;
    }
...
LIBPINMAME_API void
PinmameSetConfig(const PinmameConfig* const p_config) {
    if (_p_Config == nullptr) {
...
LIBPINMAME_API void
PinmameSetHandleKeyboard(const int handleKeyboard) {
...
LIBPINMAME_API void
PinmameSetHandleMechanics(const int handleMechanics) {
...
LIBPINMAME_API PINMAME_STATUS
PinmameRun(const char* const p_name) {
    if (_p_Config == nullptr) {
        return CONFIG_NOT_SET;
    }
...
LIBPINMAME_API PINMAME_HARDWARE_GEN
PinmameGetHardwareGen() {
...
LIBPINMAME_API int
PinmameGetSwitch(const int swNo) {
...
LIBPINMAME_API void
PinmameSetSwitch(const int swNo, const int state) {
    if (_isRunning) {
...
LIBPINMAME_API void
PinmameSetSwitches(const int* const p_states, const int numSwitches) {
    if (_isRunning) {
...
LIBPINMAME_API int
PinmameGetChangedLamps(int* const p_changedStates) {
    if (!_isRunning) {
        return -1;
    }
...
LIBPINMAME_API int
PinmameGetChangedGIs(int* const p_changedStates) {
    if (!_isRunning) {
        return -1;
    }
...
LIBPINMAME_API PINMAME_STATUS
PinmameSetMech(const int mechNo, const PinmameMechConfig* const p_mechConfig) {
    if (!_isRunning) {
        return EMULATOR_NOT_RUNNING;
    }
