...
typedef enum : int { AUDIO_FORMAT_INT16 = 0, AUDIO_FORMAT_FLOAT = 1 } PINMAME_AUDIO_FORMAT;
...
typedef void(CALLBACK* PinmameOnDisplayAvailableCallback)(int index, int displayCount,
                                                          PinmameDisplayLayout* p_displayLayout);
typedef void(CALLBACK* PinmameOnDisplayUpdatedCallback)(int index, void* p_displayData,
                                                        PinmameDisplayLayout* p_displayLayout);
