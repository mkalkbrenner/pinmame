...
#if M68K_LOG_ENABLE
#include <stdio.h>
extern FILE* M68K_LOG_FILEHANDLE extern char* m68ki_cpu_names[];
...
m68ki_read_imm_16(void) {
    ...
    m68ki_check_address_error(REG_PC, MODE_READ,
                              FLAG_S | FUNCTION_CODE_USER_PROGRAM); /* auto-disable (see m68kcpu.h) */
 ...
 */
INLINE uint
m68ki_read_8_fc(uint address, uint fc) {
    m68ki_set_fc(fc); /* auto-disable (see m68kcpu.h) */
    return m68k_read_memory_8(ADDRESS_68K(address));
}

INLINE uint
m68ki_read_16_fc(uint address, uint fc) {
    m68ki_set_fc(fc);                                  /* auto-disable (see m68kcpu.h) */
...
INLINE uint
m68ki_read_32_fc(uint address, uint fc) {
    m68ki_set_fc(fc);                                  /* auto-disable (see m68kcpu.h) */
    m68ki_check_address_error(address, MODE_READ, fc); /* auto-disable (see m68kcpu.h) */
...
INLINE void
m68ki_write_8_fc(uint address, uint fc, uint value) {
    m68ki_set_fc(fc); /* auto-disable (see m68kcpu.h) */
    m68k_write_memory_8(ADDRESS_68K(address), value);
}

INLINE void
m68ki_write_16_fc(uint address, uint fc, uint value) {
    m68ki_set_fc(fc);                                   /* auto-disable (see m68kcpu.h) */
...
INLINE void
m68ki_write_32_fc(uint address, uint fc, uint value) {
    m68ki_set_fc(fc);                                   /* auto-disable (see m68kcpu.h) */
    m68ki_check_address_error(address, MODE_WRITE, fc); /* auto-disable (see m68kcpu.h) */
...
#if M68K_SIMULATE_PD_WRITES
INLINE void
m68ki_write_32_pd_fc(uint address, uint fc, uint value) {
    m68ki_set_fc(fc);                                   /* auto-disable (see m68kcpu.h) */
    m68ki_check_address_error(address, MODE_WRITE, fc); /* auto-disable (see m68kcpu.h) */
...
INLINE void
m68ki_push_16(uint value) {
    REG_SP = MASK_OUT_ABOVE_32(REG_SP - 2);
    m68ki_write_16(REG_SP, value);
}

INLINE void
m68ki_push_32(uint value) {
 ...
 */
INLINE void
m68ki_fake_push_16(void) {
    REG_SP = MASK_OUT_ABOVE_32(REG_SP - 2);
}

INLINE void
m68ki_fake_push_32(void) {
    REG_SP = MASK_OUT_ABOVE_32(REG_SP - 4);
}

INLINE void
m68ki_fake_pull_16(void) {
    REG_SP = MASK_OUT_ABOVE_32(REG_SP + 2);
}

INLINE void
m68ki_fake_pull_32(void) {
    REG_SP = MASK_OUT_ABOVE_32(REG_SP + 4);
}
 ...
 */
INLINE void
m68ki_jump(uint new_pc) {
    REG_PC = new_pc;
    m68ki_pc_changed(REG_PC);
}

INLINE void
m68ki_jump_vector(uint vector) {
 ...
 */
INLINE void
m68ki_branch_8(uint offset) {
    REG_PC += MAKE_INT_8(offset);
}

INLINE void
m68ki_branch_16(uint offset) {
...
INLINE void
m68ki_set_sm_flag_nosp(uint value) {
    /* Set the S and M flags */
    FLAG_S = value & SFLAG_SET;
    FLAG_M = value & MFLAG_SET;
}
 ...
 */
INLINE void
m68ki_set_sr_noint_nosp(uint value) {
    /* Mask out the "unimplemented" bits */
    value &= CPU_SR_MASK;
...
INLINE void
m68ki_stack_frame_3word(uint pc, uint sr) {
    m68ki_push_32(pc);
    m68ki_push_16(sr);
}
 ...
 */
INLINE void
m68ki_stack_frame_0000(uint pc, uint sr, uint vector) {
 ...
 */
INLINE void
m68ki_stack_frame_0001(uint pc, uint sr, uint vector) {
 ...
 */
INLINE void
m68ki_stack_frame_0010(uint sr, uint vector) {
 ...
 */
INLINE void
m68ki_stack_frame_buserr(uint sr) {
    m68ki_push_32(REG_PC);
    m68ki_push_16(sr);
 ...
 */
static void
m68ki_stack_frame_1000(uint pc, uint sr, uint vector) {
    /* VERSION
	 * NUMBER
 ...
 */
static void
m68ki_stack_frame_1010(uint sr, uint vector, uint pc) {
    /* INTERNAL REGISTER */
    m68ki_push_16(0);
 ...
 */
static void
m68ki_stack_frame_1011(uint sr, uint vector, uint pc) {
 ...
 */
INLINE void
m68ki_exception_trap(uint vector) {
...
INLINE void
m68ki_exception_trapN(uint vector) {
    uint sr = m68ki_init_exception();
    m68ki_stack_frame_0000(REG_PC, sr, vector);
    m68ki_jump_vector(vector);
...
INLINE void
m68ki_exception_privilege_violation(void) {
    uint sr = m68ki_init_exception();
...
INLINE void
m68ki_exception_1010(void) {
    uint sr;
#if M68K_LOG_1010_1111 == OPT_ON
    M68K_DO_LOG_EMU((M68K_LOG_FILEHANDLE "%s at %08x: called 1010 instruction %04x (%s)\n", m68ki_cpu_names[CPU_TYPE],
                     ADDRESS_68K(REG_PPC), REG_IR, m68ki_disassemble_quick(ADDRESS_68K(REG_PPC))));
#endif
...
INLINE void
m68ki_exception_format_error(void) {
    uint sr = m68ki_init_exception();
...
INLINE void
m68ki_exception_address_error(void) {
    uint sr = m68ki_init_exception();
...
static void
m68ki_exception_interrupt(uint int_level) {
    uint vector;
    uint sr;
    uint new_pc;
