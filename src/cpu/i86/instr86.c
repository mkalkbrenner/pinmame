...
static void
PREFIX86(_interrupt)(unsigned int_num) {
...
#ifndef I186
static void
PREFIX86(_rotate_shift_Byte)(unsigned ModRM, unsigned count) {
...
static void
PREFIX86(_rotate_shift_Word)(unsigned ModRM, unsigned count) {
...
#ifndef I186
static void
PREFIX86(_add_br8)(void) /* Opcode 0x00 */
{
    DEF_br8(dst, src);
...
static void
PREFIX86(_add_wr16)(void) /* Opcode 0x01 */
{
    DEF_wr16(dst, src);
...
static void
PREFIX86(_add_r8b)(void) /* Opcode 0x02 */
{
    DEF_r8b(dst, src);
...
static void
PREFIX86(_add_r16w)(void) /* Opcode 0x03 */
{
    DEF_r16w(dst, src);
...
static void
PREFIX86(_add_ald8)(void) /* Opcode 0x04 */
{
    DEF_ald8(dst, src);
...
static void
PREFIX86(_add_axd16)(void) /* Opcode 0x05 */
{
    DEF_axd16(dst, src);
...
static void
PREFIX86(_push_es)(void) /* Opcode 0x06 */
{
...
static void
PREFIX86(_pop_es)(void) /* Opcode 0x07 */
{
    POP(I.sregs[ES]);
...
static void
PREFIX86(_or_br8)(void) /* Opcode 0x08 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_mr8;
    ORB(dst, src);
...
static void
PREFIX86(_or_wr16)(void) /* Opcode 0x09 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_mr16;
    ORW(dst, src);
...
static void
PREFIX86(_or_r8b)(void) /* Opcode 0x0a */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    ORB(dst, src);
...
static void
PREFIX86(_or_r16w)(void) /* Opcode 0x0b */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    ORW(dst, src);
...
static void
PREFIX86(_or_ald8)(void) /* Opcode 0x0c */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    ORB(dst, src);
...
static void
PREFIX86(_or_axd16)(void) /* Opcode 0x0d */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    ORW(dst, src);
...
static void
PREFIX86(_push_cs)(void) /* Opcode 0x0e */
{
    ICOUNT -= cycles.push_seg;
    PUSH(I.sregs[CS]);
}
...
static void
PREFIX86(_adc_br8)(void) /* Opcode 0x10 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_mr8;
    src += CF;
...
static void
PREFIX86(_adc_wr16)(void) /* Opcode 0x11 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_mr16;
    src += CF;
...
static void
PREFIX86(_adc_r8b)(void) /* Opcode 0x12 */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    src += CF;
...
static void
PREFIX86(_adc_r16w)(void) /* Opcode 0x13 */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    src += CF;
...
static void
PREFIX86(_adc_ald8)(void) /* Opcode 0x14 */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    src += CF;
...
static void
PREFIX86(_adc_axd16)(void) /* Opcode 0x15 */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    src += CF;
...
static void
PREFIX86(_push_ss)(void) /* Opcode 0x16 */
{
    PUSH(I.sregs[SS]);
    ICOUNT -= cycles.push_seg;
}
...
static void
PREFIX86(_pop_ss)(void) /* Opcode 0x17 */
{
#ifdef I286
    UINT16 tmp;
    POP(tmp);
...
static void
PREFIX86(_sbb_br8)(void) /* Opcode 0x18 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_mr8;
    src += CF;
...
static void
PREFIX86(_sbb_wr16)(void) /* Opcode 0x19 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_mr16;
    src += CF;
...
static void
PREFIX86(_sbb_r8b)(void) /* Opcode 0x1a */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    src += CF;
...
static void
PREFIX86(_sbb_r16w)(void) /* Opcode 0x1b */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    src += CF;
...
static void
PREFIX86(_sbb_ald8)(void) /* Opcode 0x1c */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    src += CF;
...
static void
PREFIX86(_sbb_axd16)(void) /* Opcode 0x1d */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    src += CF;
...
static void
PREFIX86(_push_ds)(void) /* Opcode 0x1e */
{
    PUSH(I.sregs[DS]);
    ICOUNT -= cycles.push_seg;
}
...
static void
PREFIX86(_pop_ds)(void) /* Opcode 0x1f */
{
#ifdef I286
    UINT16 tmp;
    POP(tmp);
...
static void
PREFIX86(_and_br8)(void) /* Opcode 0x20 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_mr8;
    ANDB(dst, src);
...
static void
PREFIX86(_and_wr16)(void) /* Opcode 0x21 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_mr16;
    ANDW(dst, src);
...
static void
PREFIX86(_and_r8b)(void) /* Opcode 0x22 */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    ANDB(dst, src);
...
static void
PREFIX86(_and_r16w)(void) /* Opcode 0x23 */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    ANDW(dst, src);
...
static void
PREFIX86(_and_ald8)(void) /* Opcode 0x24 */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    ANDB(dst, src);
...
static void
PREFIX86(_and_axd16)(void) /* Opcode 0x25 */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    ANDW(dst, src);
...
static void
PREFIX86(_daa)(void) /* Opcode 0x27 */
{
...
static void
PREFIX86(_sub_br8)(void) /* Opcode 0x28 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_mr8;
    SUBB(dst, src);
...
static void
PREFIX86(_sub_wr16)(void) /* Opcode 0x29 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_mr16;
    SUBW(dst, src);
...
static void
PREFIX86(_sub_r8b)(void) /* Opcode 0x2a */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    SUBB(dst, src);
...
static void
PREFIX86(_sub_r16w)(void) /* Opcode 0x2b */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    SUBW(dst, src);
...
static void
PREFIX86(_sub_ald8)(void) /* Opcode 0x2c */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    SUBB(dst, src);
...
static void
PREFIX86(_sub_axd16)(void) /* Opcode 0x2d */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    SUBW(dst, src);
...
static void
PREFIX86(_das)(void) /* Opcode 0x2f */
{
...
static void
PREFIX86(_xor_br8)(void) /* Opcode 0x30 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_mr8;
    XORB(dst, src);
...
static void
PREFIX86(_xor_wr16)(void) /* Opcode 0x31 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_mr16;
    XORW(dst, src);
...
static void
PREFIX86(_xor_r8b)(void) /* Opcode 0x32 */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    XORB(dst, src);
...
static void
PREFIX86(_xor_r16w)(void) /* Opcode 0x33 */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    XORW(dst, src);
...
static void
PREFIX86(_xor_ald8)(void) /* Opcode 0x34 */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    XORB(dst, src);
...
static void
PREFIX86(_xor_axd16)(void) /* Opcode 0x35 */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    XORW(dst, src);
...
static void
PREFIX86(_aaa)(void) /* Opcode 0x37 */
{
    UINT8 ALcarry = 1;
    if (I.regs.b[AL] > 0xf9)
        ALcarry = 2;
...
static void
PREFIX86(_cmp_br8)(void) /* Opcode 0x38 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    SUBB(dst, src);
...
static void
PREFIX86(_cmp_wr16)(void) /* Opcode 0x39 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    SUBW(dst, src);
...
static void
PREFIX86(_cmp_r8b)(void) /* Opcode 0x3a */
{
    DEF_r8b(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    SUBB(dst, src);
...
static void
PREFIX86(_cmp_r16w)(void) /* Opcode 0x3b */
{
    DEF_r16w(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    SUBW(dst, src);
...
static void
PREFIX86(_cmp_ald8)(void) /* Opcode 0x3c */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    SUBB(dst, src);
...
static void
PREFIX86(_cmp_axd16)(void) /* Opcode 0x3d */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    SUBW(dst, src);
...
static void
PREFIX86(_aas)(void) /* Opcode 0x3f */
{
...
static void
PREFIX86(_inc_ax)(void) /* Opcode 0x40 */
{
    IncWordReg(AX);
}

static void
PREFIX86(_inc_cx)(void) /* Opcode 0x41 */
{
    IncWordReg(CX);
}

static void
PREFIX86(_inc_dx)(void) /* Opcode 0x42 */
{
    IncWordReg(DX);
}

static void
PREFIX(_inc_bx)(void) /* Opcode 0x43 */
{
    IncWordReg(BX);
}

static void
PREFIX86(_inc_sp)(void) /* Opcode 0x44 */
{
    IncWordReg(SP);
}

static void
PREFIX86(_inc_bp)(void) /* Opcode 0x45 */
{
    IncWordReg(BP);
}

static void
PREFIX86(_inc_si)(void) /* Opcode 0x46 */
{
    IncWordReg(SI);
}

static void
PREFIX86(_inc_di)(void) /* Opcode 0x47 */
{
    IncWordReg(DI);
}
...
static void
PREFIX86(_dec_ax)(void) /* Opcode 0x48 */
{
    DecWordReg(AX);
}

static void
PREFIX86(_dec_cx)(void) /* Opcode 0x49 */
{
    DecWordReg(CX);
}

static void
PREFIX86(_dec_dx)(void) /* Opcode 0x4a */
{
    DecWordReg(DX);
}

static void
PREFIX86(_dec_bx)(void) /* Opcode 0x4b */
{
    DecWordReg(BX);
}

static void
PREFIX86(_dec_sp)(void) /* Opcode 0x4c */
{
    DecWordReg(SP);
}

static void
PREFIX86(_dec_bp)(void) /* Opcode 0x4d */
{
    DecWordReg(BP);
}

static void
PREFIX86(_dec_si)(void) /* Opcode 0x4e */
{
    DecWordReg(SI);
}

static void
PREFIX86(_dec_di)(void) /* Opcode 0x4f */
{
    DecWordReg(DI);
}

static void
PREFIX86(_push_ax)(void) /* Opcode 0x50 */
{
...
static void
PREFIX86(_push_cx)(void) /* Opcode 0x51 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[CX]);
}
...
static void
PREFIX86(_push_dx)(void) /* Opcode 0x52 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[DX]);
}
...
static void
PREFIX86(_push_bx)(void) /* Opcode 0x53 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[BX]);
}
...
static void
PREFIX86(_push_sp)(void) /* Opcode 0x54 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[SP]);
}
...
static void
PREFIX86(_push_bp)(void) /* Opcode 0x55 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[BP]);
}
...
static void
PREFIX86(_push_si)(void) /* Opcode 0x56 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[SI]);
}
...
static void
PREFIX86(_push_di)(void) /* Opcode 0x57 */
{
    ICOUNT -= cycles.push_r16;
    PUSH(I.regs.w[DI]);
}
...
static void
PREFIX86(_pop_ax)(void) /* Opcode 0x58 */
{
...
static void
PREFIX86(_pop_cx)(void) /* Opcode 0x59 */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[CX]);
}
...
static void
PREFIX86(_pop_dx)(void) /* Opcode 0x5a */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[DX]);
}
...
static void
PREFIX86(_pop_bx)(void) /* Opcode 0x5b */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[BX]);
}
...
static void
PREFIX86(_pop_sp)(void) /* Opcode 0x5c */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[SP]);
}
...
static void
PREFIX86(_pop_bp)(void) /* Opcode 0x5d */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[BP]);
}
...
static void
PREFIX86(_pop_si)(void) /* Opcode 0x5e */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[SI]);
}
...
static void
PREFIX86(_pop_di)(void) /* Opcode 0x5f */
{
    ICOUNT -= cycles.pop_r16;
    POP(I.regs.w[DI]);
}
...
static void
PREFIX86(_jno)(void) /* Opcode 0x71 */
{
    int tmp = (int)((INT8)FETCH);
    if (!OF) {
        I.pc += tmp;
...
static void
PREFIX86(_jnb)(void) /* Opcode 0x73 */
{
    int tmp = (int)((INT8)FETCH);
    if (!CF) {
        I.pc += tmp;
...
static void
PREFIX86(_jnz)(void) /* Opcode 0x75 */
{
    int tmp = (int)((INT8)FETCH);
    if (!ZF) {
        I.pc += tmp;
...
static void
PREFIX86(_jbe)(void) /* Opcode 0x76 */
{
    int tmp = (int)((INT8)FETCH);
    if (CF || ZF) {
        I.pc += tmp;
...
static void
PREFIX86(_jnbe)(void) /* Opcode 0x77 */
{
    int tmp = (int)((INT8)FETCH);
    if (!(CF || ZF)) {
        I.pc += tmp;
...
static void
PREFIX86(_jns)(void) /* Opcode 0x79 */
{
    int tmp = (int)((INT8)FETCH);
    if (!SF) {
        I.pc += tmp;
...
static void
PREFIX86(_jnp)(void) /* Opcode 0x7b */
{
    int tmp = (int)((INT8)FETCH);
    if (!PF) {
        I.pc += tmp;
...
static void
PREFIX86(_jnl)(void) /* Opcode 0x7d */
{
    int tmp = (int)((INT8)FETCH);
    if (SF == OF) {
        I.pc += tmp;
...
static void
PREFIX86(_jle)(void) /* Opcode 0x7e */
{
    int tmp = (int)((INT8)FETCH);
    if (ZF || (SF != OF)) {
        I.pc += tmp;
...
static void
PREFIX86(_jnle)(void) /* Opcode 0x7f */
{
    int tmp = (int)((INT8)FETCH);
    if ((SF == OF) && !ZF) {
        I.pc += tmp;
...
static void
PREFIX86(_80pre)(void) /* Opcode 0x80 */
{
...
static void
PREFIX86(_81pre)(void) /* Opcode 0x81 */
{
...
static void
PREFIX86(_82pre)(void) /* Opcode 0x82 */
{
    unsigned ModRM = FETCH;
    unsigned dst = GetRMByte(ModRM);
    unsigned src = FETCH;
...
static void
PREFIX86(_83pre)(void) /* Opcode 0x83 */
{
    unsigned ModRM = FETCH;
    unsigned dst = GetRMWord(ModRM);
...
static void
PREFIX86(_test_br8)(void) /* Opcode 0x84 */
{
    DEF_br8(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr8 : cycles.alu_rm8;
    ANDB(dst, src);
...
static void
PREFIX86(_test_wr16)(void) /* Opcode 0x85 */
{
    DEF_wr16(dst, src);
    ICOUNT -= (ModRM >= 0xc0) ? cycles.alu_rr16 : cycles.alu_rm16;
    ANDW(dst, src);
...
static void
PREFIX86(_xchg_br8)(void) /* Opcode 0x86 */
{
    DEF_br8(dst, src);
...
static void
PREFIX86(_xchg_wr16)(void) /* Opcode 0x87 */
{
    DEF_wr16(dst, src);
...
static void
PREFIX86(_mov_br8)(void) /* Opcode 0x88 */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_mov_wr16)(void) /* Opcode 0x89 */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_mov_r8b)(void) /* Opcode 0x8a */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_mov_r16w)(void) /* Opcode 0x8b */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_mov_wsreg)(void) /* Opcode 0x8c */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_lea)(void) /* Opcode 0x8d */
{
    unsigned ModRM = FETCH;
    ICOUNT -= cycles.lea;
    (void)(*GetEA[ModRM])();
...
static void
PREFIX86(_mov_sregw)(void) /* Opcode 0x8e */
{
    unsigned ModRM = FETCH;
    WORD src = GetRMWord(ModRM);
...
static void
PREFIX86(_popw)(void) /* Opcode 0x8f */
{
    unsigned ModRM = FETCH;
    WORD tmp;
    POP(tmp);
...
static void
PREFIX86(_nop)(void) /* Opcode 0x90 */
{
...
static void
PREFIX86(_xchg_axcx)(void) /* Opcode 0x91 */
{
    XchgAXReg(CX);
}

static void
PREFIX86(_xchg_axdx)(void) /* Opcode 0x92 */
{
    XchgAXReg(DX);
}

static void
PREFIX86(_xchg_axbx)(void) /* Opcode 0x93 */
{
    XchgAXReg(BX);
}

static void
PREFIX86(_xchg_axsp)(void) /* Opcode 0x94 */
{
    XchgAXReg(SP);
}

static void
PREFIX86(_xchg_axbp)(void) /* Opcode 0x95 */
{
    XchgAXReg(BP);
}

static void
PREFIX86(_xchg_axsi)(void) /* Opcode 0x96 */
{
    XchgAXReg(SI);
}

static void
PREFIX86(_xchg_axdi)(void) /* Opcode 0x97 */
{
    XchgAXReg(DI);
}

static void
PREFIX86(_cbw)(void) /* Opcode 0x98 */
{
    ICOUNT -= cycles.cbw;
...
static void
PREFIX86(_cwd)(void) /* Opcode 0x99 */
{
    ICOUNT -= cycles.cwd;
...
static void
PREFIX86(_wait)(void) /* Opcode 0x9b */
{
    /*if (I.test_state)
	{
		ICOUNT = 0;
...
static void
PREFIX86(_pushf)(void) /* Opcode 0x9c */
{
    unsigned tmp;
    ICOUNT -= cycles.pushf;
...
static void
PREFIX86(_popf)(void) /* Opcode 0x9d */
{
    unsigned tmp;
    POP(tmp);
    ICOUNT -= cycles.popf;
...
static void
PREFIX86(_sahf)(void) /* Opcode 0x9e */
{
...
static void
PREFIX86(_lahf)(void) /* Opcode 0x9f */
{
...
static void
PREFIX86(_mov_aldisp)(void) /* Opcode 0xa0 */
{
    unsigned addr;
...
static void
PREFIX86(_mov_axdisp)(void) /* Opcode 0xa1 */
{
    unsigned addr;
...
static void
PREFIX86(_mov_dispal)(void) /* Opcode 0xa2 */
{
    unsigned addr;
...
static void
PREFIX86(_mov_dispax)(void) /* Opcode 0xa3 */
{
    unsigned addr;
...
static void
PREFIX86(_movsb)(void) /* Opcode 0xa4 */
{
...
static void
PREFIX86(_movsw)(void) /* Opcode 0xa5 */
{
...
static void
PREFIX86(_cmpsb)(void) /* Opcode 0xa6 */
{
...
static void
PREFIX86(_cmpsw)(void) /* Opcode 0xa7 */
{
...
static void
PREFIX86(_test_ald8)(void) /* Opcode 0xa8 */
{
    DEF_ald8(dst, src);
    ICOUNT -= cycles.alu_ri8;
    ANDB(dst, src);
...
static void
PREFIX86(_test_axd16)(void) /* Opcode 0xa9 */
{
    DEF_axd16(dst, src);
    ICOUNT -= cycles.alu_ri16;
    ANDW(dst, src);
...
static void
PREFIX86(_stosb)(void) /* Opcode 0xaa */
{
    PutMemB(ES, I.regs.w[DI], I.regs.b[AL]);
    I.regs.w[DI] += I.DirVal;
    ICOUNT -= cycles.stos8;
...
static void
PREFIX86(_stosw)(void) /* Opcode 0xab */
{
    PutMemW(ES, I.regs.w[DI], I.regs.w[AX]);
    I.regs.w[DI] += 2 * I.DirVal;
...
static void
PREFIX86(_lodsb)(void) /* Opcode 0xac */
{
    I.regs.b[AL] = GetMemB(DS, I.regs.w[SI]);
    I.regs.w[SI] += I.DirVal;
    ICOUNT -= cycles.lods8;
...
static void
PREFIX86(_lodsw)(void) /* Opcode 0xad */
{
    I.regs.w[AX] = GetMemW(DS, I.regs.w[SI]);
    I.regs.w[SI] += 2 * I.DirVal;
...
static void
PREFIX86(_scasb)(void) /* Opcode 0xae */
{
...
static void
PREFIX86(_scasw)(void) /* Opcode 0xaf */
{
...
static void
PREFIX86(_mov_ald8)(void) /* Opcode 0xb0 */
{
    I.regs.b[AL] = FETCH;
...
static void
PREFIX86(_mov_cld8)(void) /* Opcode 0xb1 */
{
    I.regs.b[CL] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_dld8)(void) /* Opcode 0xb2 */
{
    I.regs.b[DL] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_bld8)(void) /* Opcode 0xb3 */
{
    I.regs.b[BL] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_ahd8)(void) /* Opcode 0xb4 */
{
    I.regs.b[AH] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_chd8)(void) /* Opcode 0xb5 */
{
    I.regs.b[CH] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_dhd8)(void) /* Opcode 0xb6 */
{
    I.regs.b[DH] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_bhd8)(void) /* Opcode 0xb7 */
{
    I.regs.b[BH] = FETCH;
    ICOUNT -= cycles.mov_ri8;
}
...
static void
PREFIX86(_mov_axd16)(void) /* Opcode 0xb8 */
{
    I.regs.b[AL] = FETCH;
    I.regs.b[AH] = FETCH;
...
static void
PREFIX86(_mov_cxd16)(void) /* Opcode 0xb9 */
{
    I.regs.b[CL] = FETCH;
    I.regs.b[CH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_mov_dxd16)(void) /* Opcode 0xba */
{
    I.regs.b[DL] = FETCH;
    I.regs.b[DH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_mov_bxd16)(void) /* Opcode 0xbb */
{
    I.regs.b[BL] = FETCH;
    I.regs.b[BH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_mov_spd16)(void) /* Opcode 0xbc */
{
    I.regs.b[SPL] = FETCH;
    I.regs.b[SPH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_mov_bpd16)(void) /* Opcode 0xbd */
{
    I.regs.b[BPL] = FETCH;
    I.regs.b[BPH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_mov_sid16)(void) /* Opcode 0xbe */
{
    I.regs.b[SIL] = FETCH;
    I.regs.b[SIH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_mov_did16)(void) /* Opcode 0xbf */
{
    I.regs.b[DIL] = FETCH;
    I.regs.b[DIH] = FETCH;
    ICOUNT -= cycles.mov_ri16;
...
static void
PREFIX86(_ret_d16)(void) /* Opcode 0xc2 */
{
...
static void
PREFIX86(_ret)(void) /* Opcode 0xc3 */
{
    POP(I.pc);
    I.pc = (I.pc + I.base[CS]) & AMASK;
...
static void
PREFIX86(_les_dw)(void) /* Opcode 0xc4 */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_lds_dw)(void) /* Opcode 0xc5 */
{
    unsigned ModRM = FETCH;
    WORD tmp = GetRMWord(ModRM);
...
static void
PREFIX86(_mov_bd8)(void) /* Opcode 0xc6 */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_mov_wd16)(void) /* Opcode 0xc7 */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_retf_d16)(void) /* Opcode 0xca */
{
    unsigned count = FETCH;
    count += FETCH << 8;
...
static void
PREFIX86(_retf)(void) /* Opcode 0xcb */
{
#ifdef I286
    {
        int tmp, tmp2;
...
static void
PREFIX86(_int3)(void) /* Opcode 0xcc */
{
    ICOUNT -= cycles.int3;
    PREFIX(_interrupt)(3);
}
...
static void
PREFIX86(_int)(void) /* Opcode 0xcd */
{
...
static void
PREFIX86(_into)(void) /* Opcode 0xce */
{
    if (OF) {
...
static void
PREFIX86(_iret)(void) /* Opcode 0xcf */
{
    ICOUNT -= cycles.iret;
#ifdef I286
    {
...
static void
PREFIX86(_rotshft_b)(void) /* Opcode 0xd0 */
{
    PREFIX(_rotate_shift_Byte)(FETCHOP, 1);
}

static void
PREFIX86(_rotshft_w)(void) /* Opcode 0xd1 */
{
    PREFIX(_rotate_shift_Word)(FETCHOP, 1);
}

static void
PREFIX86(_rotshft_bcl)(void) /* Opcode 0xd2 */
{
    PREFIX(_rotate_shift_Byte)(FETCHOP, I.regs.b[CL]);
}

static void
PREFIX86(_rotshft_wcl)(void) /* Opcode 0xd3 */
{
...
static void
PREFIX86(_aam)(void) /* Opcode 0xd4 */
{
    unsigned mult = FETCH;
...
static void
PREFIX86(_aad)(void) /* Opcode 0xd5 */
{
    unsigned mult = FETCH;
...
static void
PREFIX86(_xlat)(void) /* Opcode 0xd7 */
{
...
static void
PREFIX86(_escape)(void) /* Opcodes 0xd8, 0xd9, 0xda, 0xdb, 0xdc, 0xdd, 0xde and 0xdf */
{
    unsigned ModRM = FETCH;
    ICOUNT -= cycles.nop;
    GetRMByte(ModRM);
...
static void
PREFIX86(_loopne)(void) /* Opcode 0xe0 */
{
...
static void
PREFIX86(_loope)(void) /* Opcode 0xe1 */
{
    int disp = (int)((INT8)FETCH);
    unsigned tmp = I.regs.w[CX] - 1;
...
static void
PREFIX86(_loop)(void) /* Opcode 0xe2 */
{
    int disp = (int)((INT8)FETCH);
    unsigned tmp = I.regs.w[CX] - 1;
...
static void
PREFIX86(_jcxz)(void) /* Opcode 0xe3 */
{
    int disp = (int)((INT8)FETCH);
...
static void
PREFIX86(_inal)(void) /* Opcode 0xe4 */
{
    unsigned port = FETCH;
...
static void
PREFIX86(_inax)(void) /* Opcode 0xe5 */
{
    unsigned port = FETCH;
...
static void
PREFIX86(_outal)(void) /* Opcode 0xe6 */
{
    unsigned port = FETCH;
...
static void
PREFIX86(_outax)(void) /* Opcode 0xe7 */
{
    unsigned port = FETCH;
...
static void
PREFIX86(_call_d16)(void) /* Opcode 0xe8 */
{
    WORD ip, tmp;
...
static void
PREFIX86(_jmp_d16)(void) /* Opcode 0xe9 */
{
    WORD ip, tmp;
...
static void
PREFIX86(_jmp_far)(void) /* Opcode 0xea */
{
    unsigned tmp, tmp1;
...
static void
PREFIX86(_jmp_d8)(void) /* Opcode 0xeb */
{
    int tmp = (int)((INT8)FETCH);
    I.pc += tmp;
    /* ASG - can probably assume this is safe
...
static void
PREFIX86(_inaldx)(void) /* Opcode 0xec */
{
...
static void
PREFIX86(_inaxdx)(void) /* Opcode 0xed */
{
...
static void
PREFIX86(_outdxal)(void) /* Opcode 0xee */
{
...
static void
PREFIX86(_outdxax)(void) /* Opcode 0xef */
{
    unsigned port = I.regs.w[DX];
...
static void
PREFIX86(_lock)(void) /* Opcode 0xf0 */
{
    ICOUNT -= cycles.nop;
...
static void
PREFIX(_repne)(void) /* Opcode 0xf2 */
{
    PREFIX(rep)(0);
}

static void
PREFIX(_repe)(void) /* Opcode 0xf3 */
{
    PREFIX(rep)(1);
}
...
#ifndef I186
static void
PREFIX86(_hlt)(void) /* Opcode 0xf4 */
{
    I.pc--;
    ICOUNT = 0;
}
...
static void
PREFIX86(_cmc)(void) /* Opcode 0xf5 */
{
...
static void
PREFIX86(_clc)(void) /* Opcode 0xf8 */
{
    ICOUNT -= cycles.flag_ops;
    I.CarryVal = 0;
}
...
static void
PREFIX86(_stc)(void) /* Opcode 0xf9 */
{
    ICOUNT -= cycles.flag_ops;
    I.CarryVal = 1;
}
...
static void
PREFIX86(_cli)(void) /* Opcode 0xfa */
{
    ICOUNT -= cycles.flag_ops;
    SetIF(0);
}
...
static void
PREFIX86(_sti)(void) /* Opcode 0xfb */
{
    ICOUNT -= cycles.flag_ops;
    SetIF(1);
    PREFIX(_instruction)[FETCHOP](); /* no interrupt before next instruction */
...
static void
PREFIX86(_cld)(void) /* Opcode 0xfc */
{
    ICOUNT -= cycles.flag_ops;
    SetDF(0);
}
...
static void
PREFIX86(_std)(void) /* Opcode 0xfd */
{
    ICOUNT -= cycles.flag_ops;
    SetDF(1);
}
...
static void
PREFIX86(_fepre)(void) /* Opcode 0xfe */
{
    unsigned ModRM = FETCH;
...
static void
PREFIX86(_ffpre)(void) /* Opcode 0xff */
{
    unsigned ModRM = FETCHOP;
    unsigned tmp;
    unsigned tmp1;
