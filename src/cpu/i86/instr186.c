...
static void
PREFIX186(_pusha)(void) /* Opcode 0x60 */
{
...
static void
PREFIX186(_popa)(void) /* Opcode 0x61 */
{
    unsigned tmp;
...
static void
PREFIX186(_bound)(void) /* Opcode 0x62 */
{
...
static void
PREFIX186(_push_d16)(void) /* Opcode 0x68 */
{
    unsigned tmp = FETCH;
...
static void
PREFIX186(_imul_d16)(void) /* Opcode 0x69 */
{
    DEF_r16w(dst, src);
    unsigned src2 = FETCH;
    src += (FETCH << 8);
...
static void
PREFIX186(_push_d8)(void) /* Opcode 0x6a */
{
...
static void
PREFIX186(_imul_d8)(void) /* Opcode 0x6b */
{
    DEF_r16w(dst, src);
...
static void
PREFIX186(_insb)(void) /* Opcode 0x6c */
{
    ICOUNT -= cycles.ins8;
...
static void
PREFIX186(_insw)(void) /* Opcode 0x6d */
{
    ICOUNT -= cycles.ins16;
...
static void
PREFIX186(_outsb)(void) /* Opcode 0x6e */
{
    ICOUNT -= cycles.outs8;
...
static void
PREFIX186(_outsw)(void) /* Opcode 0x6f */
{
...
static void
PREFIX186(_rotshft_bd8)(void) /* Opcode 0xc0 */
{
...
static void
PREFIX186(_rotshft_wd8)(void) /* Opcode 0xc1 */
{
    unsigned ModRM = FETCH;
    unsigned count = FETCH;
...
static void
PREFIX186(_enter)(void) /* Opcode 0xc8 */
{
    unsigned nb = FETCH;
    unsigned i, level;
    ...
    nb += FETCH << 8;
    level = FETCH;
    ICOUNT -= (level == 0)   ? cycles.enter0
              : (level == 1) ? cycles.enter1
                             : cycles.enter_base + level * cycles.enter_count;
    PUSH(I.regs.w[BP]);
...
static void
PREFIX186(_leave)(void) /* Opcode 0xc9 */
{
    ICOUNT -= cycles.leave;
