...
static const char* token[] = {
    "a",    "ab",  "c",    "cb",   "s",    "sb",   "soc",  "socb", "szc",  "szcb", "mov",  "movb", "coc",  "czc",
    "xor",  "mpy", "div",  "xop",  "b",    "bl",   "blwp", "clr",  "seto", "inv",  "neg",  "abs",  "swpb", "inc",
    "inct", "dec", "dect", "x",    "ldcr", "stcr", "sbo",  "sbz",  "tb",   "jeq",  "jgt",  "jh",   "jhe",  "jl",
    "jle",  "jlt", "jmp",  "jnc",  "jne",  "jno",  "joc",  "jop",  "sla",  "sra",  "src",  "srl",  "ai",   "andi",
    "ci",   "li",  "ori",  "lwpi", "limi", "stst", "stwp", "rtwp", "idle", "rset", "ckof", "ckon", "lrex", "ill"};
