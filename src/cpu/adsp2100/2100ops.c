...
#define CALC_NZ(r)                                                                                                     \
    ...
    CALC_N(r);                                                                                                         \
    CALC_Z(r)
#define CALC_NZV(s, d, r)                                                                                              \
    CLR_FLAGS;                                                                                                         \
    CALC_N(r);                                                                                                         \
    CALC_Z(r);                                                                                                         \
    CALC_V(s, d, r)
#define CALC_NZVC(s, d, r)                                                                                             \
    CLR_FLAGS;                                                                                                         \
    CALC_N(r);                                                                                                         \
    CALC_Z(r);                                                                                                         \
    CALC_V(s, d, r);                                                                                                   \
    CALC_C(r)
#define CALC_NZVC_SUB(s, d, r)                                                                                         \
    CLR_FLAGS;                                                                                                         \
    CALC_N(r);                                                                                                         \
    CALC_Z(r);                                                                                                         \
    CALC_V(s, d, r);                                                                                                   \
...
/* ADSP-218x constants */
static const INT32 constants[] = {0x0001, 0xfffe, 0x0002, 0xfffd, 0x0004, 0xfffb, 0x0008, 0xfff7,
...
static void
wr_ax0(INT32 val) {
    adsp2100.core.ax0.s = val;
}

static void
wr_ax1(INT32 val) {
    adsp2100.core.ax1.s = val;
}

static void
wr_mx0(INT32 val) {
    adsp2100.core.mx0.s = val;
}

static void
wr_mx1(INT32 val) {
    adsp2100.core.mx1.s = val;
}

static void
wr_ay0(INT32 val) {
    adsp2100.core.ay0.s = val;
}

static void
wr_ay1(INT32 val) {
    adsp2100.core.ay1.s = val;
}

static void
wr_my0(INT32 val) {
    adsp2100.core.my0.s = val;
}

static void
wr_my1(INT32 val) {
    adsp2100.core.my1.s = val;
}

static void
wr_si(INT32 val) {
    adsp2100.core.si.s = val;
}

static void
wr_se(INT32 val) {
    adsp2100.core.se.s = (INT8)val;
}

static void
wr_ar(INT32 val) {
    adsp2100.core.ar.s = val;
}

static void
wr_mr0(INT32 val) {
    adsp2100.core.mr.mrx.mr0.s = val;
}

static void
wr_mr1(INT32 val) {
    adsp2100.core.mr.mrx.mr1.s = val;
    adsp2100.core.mr.mrx.mr2.s = (INT16)val >> 15;
}

static void
wr_mr2(INT32 val) {
    adsp2100.core.mr.mrx.mr2.s = (INT8)val;
}

static void
wr_sr0(INT32 val) {
    adsp2100.core.sr.srx.sr0.s = val;
}

static void
wr_sr1(INT32 val) {
    adsp2100.core.sr.srx.sr1.s = val;
}
...
static void
wr_m0(INT32 val) {
    adsp2100.m[0] = (INT32)(val << 18) >> 18;
}

static void
wr_m1(INT32 val) {
    adsp2100.m[1] = (INT32)(val << 18) >> 18;
}

static void
wr_m2(INT32 val) {
    adsp2100.m[2] = (INT32)(val << 18) >> 18;
}

static void
wr_m3(INT32 val) {
    adsp2100.m[3] = (INT32)(val << 18) >> 18;
}

static void
wr_m4(INT32 val) {
    adsp2100.m[4] = (INT32)(val << 18) >> 18;
}

static void
wr_m5(INT32 val) {
    adsp2100.m[5] = (INT32)(val << 18) >> 18;
}

static void
wr_m6(INT32 val) {
    adsp2100.m[6] = (INT32)(val << 18) >> 18;
}

static void
wr_m7(INT32 val) {
    adsp2100.m[7] = (INT32)(val << 18) >> 18;
}
...
static void
wr_sb(INT32 val) {
    adsp2100.core.sb.s = (INT32)(val << 27) >> 27;
}
...
wr_ifc(INT32 val) {
    adsp2100.ifc = val;
    if (val & 0x002)
        adsp2100.irq_latch[ADSP2101_IRQ0] = 0;
    if (val & 0x004)
        adsp2100.irq_latch[ADSP2101_IRQ1] = 0;
    if (val & 0x008)
        adsp2100.irq_latch[ADSP2101_SPORT0_RX] = 0;
    if (val & 0x010)
        adsp2100.irq_latch[ADSP2101_SPORT0_TX] = 0;
    if (val & 0x020)
        adsp2100.irq_latch[ADSP2101_IRQ2] = 0;
    if (val & 0x080)
        adsp2100.irq_latch[ADSP2101_IRQ0] = 1;
    if (val & 0x100)
        adsp2100.irq_latch[ADSP2101_IRQ1] = 1;
    if (val & 0x200)
        adsp2100.irq_latch[ADSP2101_SPORT0_RX] = 1;
    if (val & 0x400)
        adsp2100.irq_latch[ADSP2101_SPORT0_TX] = 1;
    if (val & 0x800)
        adsp2100.irq_latch[ADSP2101_IRQ2] = 1;
    check_irqs();
}

static void
wr_tx0(INT32 val) {
    if (sport_tx_callback)
        (*sport_tx_callback)(0, val);
}

static void
wr_tx1(INT32 val) {
    if (sport_tx_callback)
        (*sport_tx_callback)(1, val);
}
...
static void
wr_topstack(INT32 val) {
    pc_stack_push_val(val & 0x3fff);
}

#define WRITE_REG(grp, reg, val) ((*wr_reg[grp][reg])(val))

static void (*wr_reg[4][16])(INT32) = {{wr_ax0, wr_ax1, wr_mx0, wr_mx1, wr_ay0, wr_ay1, wr_my0, wr_my1, wr_si, wr_se,
                                        wr_ar, wr_mr0, wr_mr1, wr_mr2, wr_sr0, wr_sr1},
                                       {wr_i0, wr_i1, wr_i2, wr_i3, wr_m0, wr_m1, wr_m2, wr_m3, wr_l0, wr_l1, wr_l2,
                                        wr_l3, wr_inval, wr_inval, wr_inval, wr_inval},
                                       {wr_i4, wr_i5, wr_i6, wr_i7, wr_m4, wr_m5, wr_m6, wr_m7, wr_l4, wr_l5, wr_l6,
                                        wr_l7, wr_inval, wr_inval, wr_inval, wr_inval},
...
static INT32
rd_ax0(void) {
    return adsp2100.core.ax0.s;
}

static INT32
rd_ax1(void) {
    return adsp2100.core.ax1.s;
}

static INT32
rd_mx0(void) {
    return adsp2100.core.mx0.s;
}

static INT32
rd_mx1(void) {
    return adsp2100.core.mx1.s;
}

static INT32
rd_ay0(void) {
    return adsp2100.core.ay0.s;
}

static INT32
rd_ay1(void) {
    return adsp2100.core.ay1.s;
}

static INT32
rd_my0(void) {
    return adsp2100.core.my0.s;
}

static INT32
rd_my1(void) {
    return adsp2100.core.my1.s;
}

static INT32
rd_si(void) {
    return adsp2100.core.si.s;
}

static INT32
rd_se(void) {
    return adsp2100.core.se.s;
}

static INT32
rd_ar(void) {
    return adsp2100.core.ar.s;
}

static INT32
rd_mr0(void) {
    return adsp2100.core.mr.mrx.mr0.s;
}

static INT32
rd_mr1(void) {
    return adsp2100.core.mr.mrx.mr1.s;
}

static INT32
rd_mr2(void) {
    return adsp2100.core.mr.mrx.mr2.s;
}

static INT32
rd_sr0(void) {
    return adsp2100.core.sr.srx.sr0.s;
}

static INT32
rd_sr1(void) {
    return adsp2100.core.sr.srx.sr1.s;
}
...
static INT32
rd_rx0(void) {
    if (sport_rx_callback)
        return (*sport_rx_callback)(0);
    else
        return 0;
}
...
static INT32 (*rd_reg[4][16])(void) = {{rd_ax0, rd_ax1, rd_mx0, rd_mx1, rd_ay0, rd_ay1, rd_my0, rd_my1, rd_si, rd_se,
                                        rd_ar, rd_mr0, rd_mr1, rd_mr2, rd_sr0, rd_sr1},
                                       {rd_i0, rd_i1, rd_i2, rd_i3, rd_m0, rd_m1, rd_m2, rd_m3, rd_l0, rd_l1, rd_l2,
                                        rd_l3, rd_inval, rd_inval, rd_inval, rd_inval},
                                       {rd_i4, rd_i5, rd_i6, rd_i7, rd_m4, rd_m5, rd_m6, rd_m7, rd_l4, rd_l5, rd_l6,
                                        rd_l7, rd_inval, rd_inval, rd_inval, rd_inval},
                                       {rd_astat, rd_mstat, rd_sstat, rd_imask, rd_icntl, rd_cntr, rd_sb, rd_px, rd_rx0,
                                        rd_inval, rd_rx1, rd_inval, rd_inval, rd_inval, rd_inval, rd_stacktop}};
...
INLINE void
modify_address(UINT32 ireg, UINT32 mreg) {
...
INLINE void
data_write_dag1(UINT32 op, INT32 val) {
    UINT32 ireg = (op >> 2) & 3;
    UINT32 mreg = op & 3;
    UINT32 base = adsp2100.base[ireg];
    UINT32 i = adsp2100.i[ireg];
...
INLINE void
data_write_dag2(UINT32 op, INT32 val) {
...
INLINE void
pgm_write_dag2(UINT32 op, INT32 val) {
    UINT32 ireg = 4 + ((op >> 2) & 3);
    UINT32 mreg = 4 + (op & 3);
    UINT32 base = adsp2100.base[ireg];
    UINT32 i = adsp2100.i[ireg];
...
static const void* alu_xregs[8] = {&adsp2100.core.ax0,        &adsp2100.core.ax1,        &adsp2100.core.ar,
                                   &adsp2100.core.mr.mrx.mr0, &adsp2100.core.mr.mrx.mr1, &adsp2100.core.mr.mrx.mr2,
                                   &adsp2100.core.sr.srx.sr0, &adsp2100.core.sr.srx.sr1};

static const void* alu_yregs[4] = {&adsp2100.core.ay0, &adsp2100.core.ay1, &adsp2100.core.af, &adsp2100.core.zero};
...
static const void* mac_xregs[8] = {&adsp2100.core.mx0,        &adsp2100.core.mx1,        &adsp2100.core.ar,
                                   &adsp2100.core.mr.mrx.mr0, &adsp2100.core.mr.mrx.mr1, &adsp2100.core.mr.mrx.mr2,
                                   &adsp2100.core.sr.srx.sr0, &adsp2100.core.sr.srx.sr1};

static const void* mac_yregs[4] = {&adsp2100.core.my0, &adsp2100.core.my1, &adsp2100.core.mf, &adsp2100.core.zero};
...
static const void* shift_xregs[8] = {&adsp2100.core.si,         &adsp2100.core.si,         &adsp2100.core.ar,
                                     &adsp2100.core.mr.mrx.mr0, &adsp2100.core.mr.mrx.mr1, &adsp2100.core.mr.mrx.mr2,
                                     &adsp2100.core.sr.srx.sr0, &adsp2100.core.sr.srx.sr1};
...
alu_op_ar(int op) {
    ...
    /* saturate */
    if ((adsp2100.mstat & MSTAT_SATURATE) && GET_V)
        res = GET_C ? -32768 : 32767;
