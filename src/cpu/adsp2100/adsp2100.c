...
INLINE UINT32
RWORD_DATA(UINT32 addr) {
    addr <<= 1;
    return ADSP2100_RDMEM_WORD(ADSP2100_DATA_OFFSET + addr);
}

INLINE void
WWORD_DATA(UINT32 addr, UINT32 data) {
    addr <<= 1;
...
INLINE UINT32
RWORD_PGM(UINT32 addr) {
#ifdef PINMAME
    if (!WPC_gWPC95 && (addr == 0x3000))
        return dcs_latch_r(0, 0xffff) << 8;
#endif /* PINMAME */
    addr <<= 2;
...
INLINE void
WWORD_PGM(UINT32 addr, UINT32 data) {
#ifdef PINMAME
    if (!WPC_gWPC95 && (addr == 0x3000))
        dcs_latch_w(0, (data >> 8), 0xffff);
#endif /* PINMAME */
    addr <<= 2;
...
INLINE int
adsp2100_generate_irq(int which) {
    /* skip if masked */
    ...
    if (adsp2100.icntl & 0x10)
        adsp2100.imask &= ~((2 << which) - 1);
    else
        adsp2100.imask &= ~0xf;
...
INLINE int
adsp2101_generate_irq(int which, int indx) {
    /* skip if masked */
...
void
adsp2100_set_irq_line(int irqline, int state) {
...
void
adsp2100_set_irq_callback(int (*callback)(int irqline)) {
    ...
    resume_from_speedup:
        ...
        switch ((op >> 16) & 0xff) {
            ...
            case 0x05:
                ...
                if (GET_MV) {
                    if (adsp2100.core.mr.mrx.mr2.u & 0x80)
                        adsp2100.core.mr.mrx.mr2.u = 0xffff, adsp2100.core.mr.mrx.mr1.u = 0x8000,
                        adsp2100.core.mr.mrx.mr0.u = 0x0000;
                    else
                        adsp2100.core.mr.mrx.mr2.u = 0x0000, adsp2100.core.mr.mrx.mr1.u = 0x7fff,
                        adsp2100.core.mr.mrx.mr0.u = 0xffff;
                }
                break;
            case 0x06:
            ...
            case 0x0c:
                ...
                if (chip_type >= CHIP_TYPE_ADSP2101) {
                    if (op & 0x000008)
                        temp = (temp & ~MSTAT_GOMODE) | ((op << 5) & MSTAT_GOMODE);
                    if (op & 0x002000)
                        temp = (temp & ~MSTAT_INTEGER) | ((op >> 8) & MSTAT_INTEGER);
                    if (op & 0x008000)
                        temp = (temp & ~MSTAT_TIMER) | ((op >> 9) & MSTAT_TIMER);
                }
                if (op & 0x000020)
                    temp = (temp & ~MSTAT_BANK) | ((op >> 4) & MSTAT_BANK);
                if (op & 0x000080)
                    temp = (temp & ~MSTAT_REVERSE) | ((op >> 5) & MSTAT_REVERSE);
                if (op & 0x000200)
                    temp = (temp & ~MSTAT_STICKYV) | ((op >> 6) & MSTAT_STICKYV);
                if (op & 0x000800)
                    temp = (temp & ~MSTAT_SATURATE) | ((op >> 7) & MSTAT_SATURATE);
                set_mstat(temp);
                break;
            case 0x0d:
            ...
            case 0x37:
				 ...
				 */
                if (op == 0x378000) {
                    static unsigned char signature[] = {0xe1, 0x8f, 0x37, 0x00, 0x02, 0x90,
                                                        0x37, 0x00, 0xe3, 0x9f, 0x37, 0x00};
                    if (memcmp(&OP_ROM[ADSP2100_PGM_OFFSET + ((adsp2100.pc) << 2)], signature, sizeof(signature))
                        == 0) {
...
adsp2100_get_reg(int regnum) {
    switch (regnum) {
        ...
        case ADSP2100_AX0:
            return adsp2100.core.ax0.u;
        case ADSP2100_AX1:
            return adsp2100.core.ax1.u;
        case ADSP2100_AY0:
            return adsp2100.core.ay0.u;
        case ADSP2100_AY1:
            return adsp2100.core.ay1.u;
        case ADSP2100_AR:
            return adsp2100.core.ar.u;
        case ADSP2100_AF:
            return adsp2100.core.af.u;

        case ADSP2100_MX0:
            return adsp2100.core.mx0.u;
        case ADSP2100_MX1:
            return adsp2100.core.mx1.u;
        case ADSP2100_MY0:
            return adsp2100.core.my0.u;
        case ADSP2100_MY1:
            return adsp2100.core.my1.u;
        case ADSP2100_MR0:
            return adsp2100.core.mr.mrx.mr0.u;
        case ADSP2100_MR1:
            return adsp2100.core.mr.mrx.mr1.u;
        case ADSP2100_MR2:
            return adsp2100.core.mr.mrx.mr2.u;
        case ADSP2100_MF:
            return adsp2100.core.mf.u;

        case ADSP2100_SI:
            return adsp2100.core.si.u;
        case ADSP2100_SE:
            return adsp2100.core.se.u;
        case ADSP2100_SB:
            return adsp2100.core.sb.u;
        case ADSP2100_SR0:
            return adsp2100.core.sr.srx.sr0.u;
        case ADSP2100_SR1:
            return adsp2100.core.sr.srx.sr1.u;

        case ADSP2100_AX0_SEC:
            return adsp2100.alt.ax0.u;
        case ADSP2100_AX1_SEC:
            return adsp2100.alt.ax1.u;
        case ADSP2100_AY0_SEC:
            return adsp2100.alt.ay0.u;
        case ADSP2100_AY1_SEC:
            return adsp2100.alt.ay1.u;
        case ADSP2100_AR_SEC:
            return adsp2100.alt.ar.u;
        case ADSP2100_AF_SEC:
            return adsp2100.alt.af.u;

        case ADSP2100_MX0_SEC:
            return adsp2100.alt.mx0.u;
        case ADSP2100_MX1_SEC:
            return adsp2100.alt.mx1.u;
        case ADSP2100_MY0_SEC:
            return adsp2100.alt.my0.u;
        case ADSP2100_MY1_SEC:
            return adsp2100.alt.my1.u;
        case ADSP2100_MR0_SEC:
            return adsp2100.alt.mr.mrx.mr0.u;
        case ADSP2100_MR1_SEC:
            return adsp2100.alt.mr.mrx.mr1.u;
        case ADSP2100_MR2_SEC:
            return adsp2100.alt.mr.mrx.mr2.u;
        case ADSP2100_MF_SEC:
            return adsp2100.alt.mf.u;

        case ADSP2100_SI_SEC:
            return adsp2100.alt.si.u;
        case ADSP2100_SE_SEC:
            return adsp2100.alt.se.u;
        case ADSP2100_SB_SEC:
            return adsp2100.alt.sb.u;
        case ADSP2100_SR0_SEC:
            return adsp2100.alt.sr.srx.sr0.u;
        case ADSP2100_SR1_SEC:
            return adsp2100.alt.sr.srx.sr1.u;
...
void
adsp2100_set_reg(int regnum, unsigned val) {
    switch (regnum) {
        case REG_PC:
        case ADSP2100_PC:
            adsp2100.pc = val;
        ...
        case ADSP2100_AX0_SEC:
            adsp2100.alt.ax0.s = val;
            break;
        case ADSP2100_AX1_SEC:
            adsp2100.alt.ax1.s = val;
            break;
        case ADSP2100_AY0_SEC:
            adsp2100.alt.ay0.s = val;
            break;
        case ADSP2100_AY1_SEC:
            adsp2100.alt.ay1.s = val;
            break;
        case ADSP2100_AR_SEC:
            adsp2100.alt.ar.s = val;
            break;
        case ADSP2100_AF_SEC:
            adsp2100.alt.af.u = val;
            break;

        case ADSP2100_MX0_SEC:
            adsp2100.alt.mx0.s = val;
            break;
        case ADSP2100_MX1_SEC:
            adsp2100.alt.mx1.s = val;
            break;
        case ADSP2100_MY0_SEC:
            adsp2100.alt.my0.s = val;
            break;
        case ADSP2100_MY1_SEC:
            adsp2100.alt.my1.s = val;
            break;
        case ADSP2100_MR0_SEC:
            adsp2100.alt.mr.mrx.mr0.s = val;
            break;
        case ADSP2100_MR1_SEC:
            adsp2100.alt.mr.mrx.mr1.s = val;
            adsp2100.alt.mr.mrx.mr2.s = (INT16)val >> 15;
            break;
        case ADSP2100_MR2_SEC:
            adsp2100.alt.mr.mrx.mr2.s = (INT8)val;
            break;
        case ADSP2100_MF_SEC:
            adsp2100.alt.mf.u = val;
            break;

        case ADSP2100_SI_SEC:
            adsp2100.alt.si.s = val;
            break;
        case ADSP2100_SE_SEC:
            adsp2100.alt.se.s = (INT8)val;
            break;
        case ADSP2100_SB_SEC:
            adsp2100.alt.sb.s = (INT32)(val << 27) >> 27;
            break;
        case ADSP2100_SR0_SEC:
            adsp2100.alt.sr.srx.sr0.s = val;
            break;
        case ADSP2100_SR1_SEC:
            adsp2100.alt.sr.srx.sr1.s = val;
            break;
...
static UINT8 adsp2100_reg_layout[] = {
    ADSP2100_PC,     ADSP2100_AX0, ADSP2100_MX0, -1, ADSP2100_CNTR,   ADSP2100_AX1, ADSP2100_MX1, -1,
    ADSP2100_MSTAT,  ADSP2100_AY0, ADSP2100_MY0, -1, ADSP2100_SSTAT,  ADSP2100_AY1, ADSP2100_MY1, -1,
    ADSP2100_PX,     ADSP2100_AR,  ADSP2100_MR0, -1, ADSP2100_PCSP,   ADSP2100_AF,  ADSP2100_MR1, -1,
    ADSP2100_CNTRSP, ADSP2100_SI,  ADSP2100_MR2, -1, ADSP2100_STATSP, ADSP2100_SE,  ADSP2100_MF,  -1,
    ADSP2100_LOOPSP, ADSP2100_SB,  100,          -1, ADSP2100_IMASK,  ADSP2100_SR0, 100,          -1,
    ADSP2100_ICNTL,  ADSP2100_SR1, 100,          -1, ADSP2100_I0,     ADSP2100_L0,  ADSP2100_M0,  -1,
    ADSP2100_I1,     ADSP2100_L1,  ADSP2100_M1,  -1, ADSP2100_I2,     ADSP2100_L2,  ADSP2100_M2,  -1,
    ADSP2100_I3,     ADSP2100_L3,  ADSP2100_M3,  -1, ADSP2100_I4,     ADSP2100_L4,  ADSP2100_M4,  -1,
    ADSP2100_I5,     ADSP2100_L5,  ADSP2100_M5,  -1, ADSP2100_I6,     ADSP2100_L6,  ADSP2100_M6,  -1,
...
const char*
adsp2100_info(void* context, int regnum) {
    ...
    switch (regnum) {
        case CPU_INFO_REG + ADSP2100_PC:
            sprintf(buffer[which], "PC:  %04X", r->pc);
            break;

        case CPU_INFO_REG + ADSP2100_AX0:
            sprintf(buffer[which], "AX0: %04X", adsp2100.core.ax0.u);
            break;
        case CPU_INFO_REG + ADSP2100_AX1:
            sprintf(buffer[which], "AX1: %04X", adsp2100.core.ax1.u);
            break;
        case CPU_INFO_REG + ADSP2100_AY0:
            sprintf(buffer[which], "AY0: %04X", adsp2100.core.ay0.u);
            break;
        case CPU_INFO_REG + ADSP2100_AY1:
            sprintf(buffer[which], "AY1: %04X", adsp2100.core.ay1.u);
            break;
        case CPU_INFO_REG + ADSP2100_AR:
            sprintf(buffer[which], "AR:  %04X", adsp2100.core.ar.u);
            break;
        case CPU_INFO_REG + ADSP2100_AF:
            sprintf(buffer[which], "AF:  %04X", adsp2100.core.af.u);
            break;

        case CPU_INFO_REG + ADSP2100_MX0:
            sprintf(buffer[which], "MX0: %04X", adsp2100.core.mx0.u);
            break;
        case CPU_INFO_REG + ADSP2100_MX1:
            sprintf(buffer[which], "MX1: %04X", adsp2100.core.mx1.u);
            break;
        case CPU_INFO_REG + ADSP2100_MY0:
            sprintf(buffer[which], "MY0: %04X", adsp2100.core.my0.u);
            break;
        case CPU_INFO_REG + ADSP2100_MY1:
            sprintf(buffer[which], "MY1: %04X", adsp2100.core.my1.u);
            break;
        case CPU_INFO_REG + ADSP2100_MR0:
            sprintf(buffer[which], "MR0: %04X", adsp2100.core.mr.mrx.mr0.u);
            break;
        case CPU_INFO_REG + ADSP2100_MR1:
            sprintf(buffer[which], "MR1: %04X", adsp2100.core.mr.mrx.mr1.u);
            break;
        case CPU_INFO_REG + ADSP2100_MR2:
            sprintf(buffer[which], "MR2: %02X", adsp2100.core.mr.mrx.mr2.u & 0x00ff);
            break;
        case CPU_INFO_REG + ADSP2100_MF:
            sprintf(buffer[which], "MF:  %04X", adsp2100.core.mf.u);
            break;

        case CPU_INFO_REG + ADSP2100_SI:
            sprintf(buffer[which], "SI:  %04X", adsp2100.core.si.u);
            break;
        case CPU_INFO_REG + ADSP2100_SE:
            sprintf(buffer[which], "SE:  %02X  ", adsp2100.core.se.u & 0x00ff);
            break;
        case CPU_INFO_REG + ADSP2100_SB:
            sprintf(buffer[which], "SB:  %02X  ", adsp2100.core.sb.u & 0x001f);
            break;
        case CPU_INFO_REG + ADSP2100_SR0:
            sprintf(buffer[which], "SR0: %04X", adsp2100.core.sr.srx.sr0.u);
            break;
        case CPU_INFO_REG + ADSP2100_SR1:
            sprintf(buffer[which], "SR1: %04X", adsp2100.core.sr.srx.sr1.u);
            break;

        case CPU_INFO_REG + ADSP2100_AX0_SEC:
            sprintf(buffer[which], "AX0_SEC: %04X", adsp2100.alt.ax0.u);
            break;
        case CPU_INFO_REG + ADSP2100_AX1_SEC:
            sprintf(buffer[which], "AX1_SEC: %04X", adsp2100.alt.ax1.u);
            break;
        case CPU_INFO_REG + ADSP2100_AY0_SEC:
            sprintf(buffer[which], "AY0_SEC: %04X", adsp2100.alt.ay0.u);
            break;
        case CPU_INFO_REG + ADSP2100_AY1_SEC:
            sprintf(buffer[which], "AY1_SEC: %04X", adsp2100.alt.ay1.u);
            break;
        case CPU_INFO_REG + ADSP2100_AR_SEC:
            sprintf(buffer[which], "AR_SEC:  %04X", adsp2100.alt.ar.u);
            break;
        case CPU_INFO_REG + ADSP2100_AF_SEC:
            sprintf(buffer[which], "AF_SEC:  %04X", adsp2100.alt.af.u);
            break;

        case CPU_INFO_REG + ADSP2100_MX0_SEC:
            sprintf(buffer[which], "MX0_SEC: %04X", adsp2100.alt.mx0.u);
            break;
        case CPU_INFO_REG + ADSP2100_MX1_SEC:
            sprintf(buffer[which], "MX1_SEC: %04X", adsp2100.alt.mx1.u);
            break;
        case CPU_INFO_REG + ADSP2100_MY0_SEC:
            sprintf(buffer[which], "MY0_SEC: %04X", adsp2100.alt.my0.u);
            break;
        case CPU_INFO_REG + ADSP2100_MY1_SEC:
            sprintf(buffer[which], "MY1_SEC: %04X", adsp2100.alt.my1.u);
            break;
        case CPU_INFO_REG + ADSP2100_MR0_SEC:
            sprintf(buffer[which], "MR0_SEC: %04X", adsp2100.alt.mr.mrx.mr0.u);
            break;
        case CPU_INFO_REG + ADSP2100_MR1_SEC:
            sprintf(buffer[which], "MR1_SEC: %04X", adsp2100.alt.mr.mrx.mr1.u);
            break;
        case CPU_INFO_REG + ADSP2100_MR2_SEC:
            sprintf(buffer[which], "MR2_SEC: %02X", adsp2100.alt.mr.mrx.mr2.u & 0x00ff);
            break;
        case CPU_INFO_REG + ADSP2100_MF_SEC:
            sprintf(buffer[which], "MF_SEC:  %04X", adsp2100.alt.mf.u);
            break;

        case CPU_INFO_REG + ADSP2100_SI_SEC:
            sprintf(buffer[which], "SI_SEC:  %04X", adsp2100.alt.si.u);
            break;
        case CPU_INFO_REG + ADSP2100_SE_SEC:
            sprintf(buffer[which], "SE_SEC:  %02X  ", adsp2100.alt.se.u & 0x00ff);
            break;
        case CPU_INFO_REG + ADSP2100_SB_SEC:
            sprintf(buffer[which], "SB_SEC:  %02X  ", adsp2100.alt.sb.u & 0x001f);
            break;
        case CPU_INFO_REG + ADSP2100_SR0_SEC:
            sprintf(buffer[which], "SR0_SEC: %04X", adsp2100.alt.sr.srx.sr0.u);
            break;
        case CPU_INFO_REG + ADSP2100_SR1_SEC:
            sprintf(buffer[which], "SR1_SEC: %04X", adsp2100.alt.sr.srx.sr1.u);
            break;

        case CPU_INFO_REG + ADSP2100_I0:
            sprintf(buffer[which], "I0:  %04X", adsp2100.i[0]);
            break;
        case CPU_INFO_REG + ADSP2100_I1:
            sprintf(buffer[which], "I1:  %04X", adsp2100.i[1]);
            break;
        case CPU_INFO_REG + ADSP2100_I2:
            sprintf(buffer[which], "I2:  %04X", adsp2100.i[2]);
            break;
        case CPU_INFO_REG + ADSP2100_I3:
            sprintf(buffer[which], "I3:  %04X", adsp2100.i[3]);
            break;
        case CPU_INFO_REG + ADSP2100_I4:
            sprintf(buffer[which], "I4:  %04X", adsp2100.i[4]);
            break;
        case CPU_INFO_REG + ADSP2100_I5:
            sprintf(buffer[which], "I5:  %04X", adsp2100.i[5]);
            break;
        case CPU_INFO_REG + ADSP2100_I6:
            sprintf(buffer[which], "I6:  %04X", adsp2100.i[6]);
            break;
        case CPU_INFO_REG + ADSP2100_I7:
            sprintf(buffer[which], "I7:  %04X", adsp2100.i[7]);
            break;

        case CPU_INFO_REG + ADSP2100_L0:
            sprintf(buffer[which], "L0:  %04X", adsp2100.l[0]);
            break;
        case CPU_INFO_REG + ADSP2100_L1:
            sprintf(buffer[which], "L1:  %04X", adsp2100.l[1]);
            break;
        case CPU_INFO_REG + ADSP2100_L2:
            sprintf(buffer[which], "L2:  %04X", adsp2100.l[2]);
            break;
        case CPU_INFO_REG + ADSP2100_L3:
            sprintf(buffer[which], "L3:  %04X", adsp2100.l[3]);
            break;
        case CPU_INFO_REG + ADSP2100_L4:
            sprintf(buffer[which], "L4:  %04X", adsp2100.l[4]);
            break;
        case CPU_INFO_REG + ADSP2100_L5:
            sprintf(buffer[which], "L5:  %04X", adsp2100.l[5]);
            break;
        case CPU_INFO_REG + ADSP2100_L6:
            sprintf(buffer[which], "L6:  %04X", adsp2100.l[6]);
            break;
        case CPU_INFO_REG + ADSP2100_L7:
            sprintf(buffer[which], "L7:  %04X", adsp2100.l[7]);
            break;

        case CPU_INFO_REG + ADSP2100_M0:
            sprintf(buffer[which], "M0:  %04X", adsp2100.m[0]);
            break;
        case CPU_INFO_REG + ADSP2100_M1:
            sprintf(buffer[which], "M1:  %04X", adsp2100.m[1]);
            break;
        case CPU_INFO_REG + ADSP2100_M2:
            sprintf(buffer[which], "M2:  %04X", adsp2100.m[2]);
            break;
        case CPU_INFO_REG + ADSP2100_M3:
            sprintf(buffer[which], "M3:  %04X", adsp2100.m[3]);
            break;
        case CPU_INFO_REG + ADSP2100_M4:
            sprintf(buffer[which], "M4:  %04X", adsp2100.m[4]);
            break;
        case CPU_INFO_REG + ADSP2100_M5:
            sprintf(buffer[which], "M5:  %04X", adsp2100.m[5]);
            break;
        case CPU_INFO_REG + ADSP2100_M6:
            sprintf(buffer[which], "M6:  %04X", adsp2100.m[6]);
            break;
        case CPU_INFO_REG + ADSP2100_M7:
            sprintf(buffer[which], "M7:  %04X", adsp2100.m[7]);
            break;

        case CPU_INFO_REG + ADSP2100_PX:
            sprintf(buffer[which], "PX:  %02X  ", adsp2100.px);
            break;
        case CPU_INFO_REG + ADSP2100_CNTR:
            sprintf(buffer[which], "CNTR:%04X", adsp2100.cntr);
            break;
        case CPU_INFO_REG + ADSP2100_ASTAT:
            sprintf(buffer[which], "ASTA:%02X  ", adsp2100.astat);
            break;
        case CPU_INFO_REG + ADSP2100_SSTAT:
            sprintf(buffer[which], "SSTA:%02X  ", adsp2100.sstat);
            break;
        case CPU_INFO_REG + ADSP2100_MSTAT:
            sprintf(buffer[which], "MSTA:%02X  ", adsp2100.mstat);
            break;

        case CPU_INFO_REG + ADSP2100_PCSP:
            sprintf(buffer[which], "PCSP:%02X  ", adsp2100.pc_sp);
            break;
        case CPU_INFO_REG + ADSP2100_CNTRSP:
            sprintf(buffer[which], "CTSP:%01X   ", adsp2100.cntr_sp);
            break;
        case CPU_INFO_REG + ADSP2100_STATSP:
            sprintf(buffer[which], "STSP:%01X   ", adsp2100.stat_sp);
            break;
        case CPU_INFO_REG + ADSP2100_LOOPSP:
            sprintf(buffer[which], "LPSP:%01X   ", adsp2100.loop_sp);
            break;

        case CPU_INFO_REG + ADSP2100_IMASK:
            sprintf(buffer[which], "IMSK:%02X  ", adsp2100.imask);
            break;
        case CPU_INFO_REG + ADSP2100_ICNTL:
            sprintf(buffer[which], "ICTL:%02X  ", adsp2100.icntl);
            break;
        case CPU_INFO_REG + ADSP2100_IRQSTATE0:
            sprintf(buffer[which], "IRQ0:%X   ", adsp2100.irq_state[0]);
            break;
        case CPU_INFO_REG + ADSP2100_IRQSTATE1:
            sprintf(buffer[which], "IRQ1:%X   ", adsp2100.irq_state[1]);
            break;
        case CPU_INFO_REG + ADSP2100_IRQSTATE2:
            sprintf(buffer[which], "IRQ2:%X   ", adsp2100.irq_state[2]);
            break;
        case CPU_INFO_REG + ADSP2100_IRQSTATE3:
            sprintf(buffer[which], "IRQ3:%X   ", adsp2100.irq_state[3]);
            break;

        case CPU_INFO_REG + ADSP2100_FLAGIN:
            sprintf(buffer[which], "FI:  %X   ", adsp2100.flagin);
            break;
        case CPU_INFO_REG + ADSP2100_FLAGOUT:
            sprintf(buffer[which], "FO:  %X   ", adsp2100.flagout);
            break;
        case CPU_INFO_REG + ADSP2100_FL0:
            sprintf(buffer[which], "FL0: %X   ", adsp2100.fl0);
            break;
        case CPU_INFO_REG + ADSP2100_FL1:
            sprintf(buffer[which], "FL1: %X   ", adsp2100.fl1);
            break;
        case CPU_INFO_REG + ADSP2100_FL2:
            sprintf(buffer[which], "FL2: %X   ", adsp2100.fl2);
            break;

        case CPU_INFO_FLAGS:
            sprintf(buffer[which], "%c%c%c%c%c%c%c%c", (r->astat & 0x80) ? 'X' : '.', (r->astat & 0x40) ? 'M' : '.',
                    (r->astat & 0x20) ? 'Q' : '.', (r->astat & 0x10) ? 'S' : '.', (r->astat & 0x08) ? 'C' : '.',
                    (r->astat & 0x04) ? 'V' : '.', (r->astat & 0x02) ? 'N' : '.', (r->astat & 0x01) ? 'Z' : '.');
            break;
        case CPU_INFO_NAME:
            return "ADSP2100";
        ...
        case CPU_INFO_REG_LAYOUT:
            return (const char*)adsp2100_reg_layout;
        case CPU_INFO_WIN_LAYOUT:
            return (const char*)adsp2100_win_layout;
...
unsigned
adsp2100_dasm(char* buffer, unsigned pc) {
#ifdef MAME_DEBUG
...
int
adsp2101_execute(int cycles) {
    return adsp2100_execute(cycles);
}

unsigned
adsp2101_get_context(void* dst) {
    return adsp2100_get_context(dst);
}

void
adsp2101_set_context(void* src) {
    set_core_2101();
    adsp2100_set_context(src);
}

unsigned
adsp2101_get_reg(int regnum) {
    return adsp2100_get_reg(regnum);
}

void
adsp2101_set_reg(int regnum, unsigned val) {
    adsp2100_set_reg(regnum, val);
}

void
adsp2101_set_irq_line(int irqline, int state) {
    adsp2100_set_irq_line(irqline, state);
}

void
adsp2101_set_irq_callback(int (*callback)(int irqline)) {
    adsp2100_set_irq_callback(callback);
}

const char*
adsp2101_info(void* context, int regnum) {
    switch (regnum) {
        case CPU_INFO_NAME:
            return "ADSP2101";
        case CPU_INFO_VERSION:
            return "1.0";
        case CPU_INFO_REG_LAYOUT:
            return (const char*)adsp2101_reg_layout;
        case CPU_INFO_WIN_LAYOUT:
            return (const char*)adsp2101_win_layout;
    }
    return adsp2100_info(context, regnum);
}

unsigned
adsp2101_dasm(char* buffer, unsigned pc) {
#ifdef MAME_DEBUG
    extern unsigned dasm2100(char*, unsigned);
    return dasm2100(buffer, pc);
#else
...
void
adsp2101_set_rx_callback(RX_CALLBACK cb) {
    sport_rx_callback = cb;
}

void
adsp2101_set_tx_callback(TX_CALLBACK cb) {
...
int
adsp2105_execute(int cycles) {
    return adsp2100_execute(cycles);
}

unsigned
adsp2105_get_context(void* dst) {
    return adsp2100_get_context(dst);
}

void
adsp2105_set_context(void* src) {
    set_core_2105();
    adsp2100_set_context(src);
}

unsigned
adsp2105_get_reg(int regnum) {
    return adsp2100_get_reg(regnum);
}

void
adsp2105_set_reg(int regnum, unsigned val) {
    adsp2100_set_reg(regnum, val);
}

void
adsp2105_set_irq_line(int irqline, int state) {
    adsp2100_set_irq_line(irqline, state);
}

void
adsp2105_set_irq_callback(int (*callback)(int irqline)) {
    adsp2100_set_irq_callback(callback);
}

const char*
adsp2105_info(void* context, int regnum) {
    switch (regnum) {
        case CPU_INFO_NAME:
            return "ADSP2105";
        case CPU_INFO_VERSION:
            return "1.0";
        case CPU_INFO_REG_LAYOUT:
            return (const char*)adsp2105_reg_layout;
        case CPU_INFO_WIN_LAYOUT:
            return (const char*)adsp2105_win_layout;
    }
    return adsp2100_info(context, regnum);
}

unsigned
adsp2105_dasm(char* buffer, unsigned pc) {
#ifdef MAME_DEBUG
    extern unsigned dasm2100(char*, unsigned);
    return dasm2100(buffer, pc);
#else
...
void
adsp2105_set_rx_callback(RX_CALLBACK cb) {
    sport_rx_callback = cb;
}

void
adsp2105_set_tx_callback(TX_CALLBACK cb) {
    sport_tx_callback = cb;
}

void
adsp2105_load_boot_data(data8_t* srcdata, data32_t* dstdata) {
...
int
adsp2115_execute(int cycles) {
    return adsp2100_execute(cycles);
}

unsigned
adsp2115_get_context(void* dst) {
    return adsp2100_get_context(dst);
}

void
adsp2115_set_context(void* src) {
    set_core_2115();
    adsp2100_set_context(src);
}

unsigned
adsp2115_get_reg(int regnum) {
    return adsp2100_get_reg(regnum);
}

void
adsp2115_set_reg(int regnum, unsigned val) {
    adsp2100_set_reg(regnum, val);
}

void
adsp2115_set_irq_line(int irqline, int state) {
    adsp2100_set_irq_line(irqline, state);
}

void
adsp2115_set_irq_callback(int (*callback)(int irqline)) {
    adsp2100_set_irq_callback(callback);
}

const char*
adsp2115_info(void* context, int regnum) {
    switch (regnum) {
        case CPU_INFO_NAME:
            return "ADSP2115";
        case CPU_INFO_VERSION:
            return "1.0";
        case CPU_INFO_REG_LAYOUT:
            return (const char*)adsp2115_reg_layout;
        case CPU_INFO_WIN_LAYOUT:
            return (const char*)adsp2115_win_layout;
    }
    return adsp2100_info(context, regnum);
}

unsigned
adsp2115_dasm(char* buffer, unsigned pc) {
#ifdef MAME_DEBUG
    extern unsigned dasm2100(char*, unsigned);
    return dasm2100(buffer, pc);
#else
...
void
adsp2115_set_rx_callback(RX_CALLBACK cb) {
    sport_rx_callback = cb;
}

void
adsp2115_set_tx_callback(TX_CALLBACK cb) {
    sport_tx_callback = cb;
}

void
adsp2115_load_boot_data(data8_t* srcdata, data32_t* dstdata) {
    /* see how many words we need to copy */
#ifdef LSB_FIRST
    UINT32 size = 8 * (srcdata[3] + 1), i;
#else
