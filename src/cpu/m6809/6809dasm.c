...
static opcodeinfo pg2opcodes[NUMPG2OPS] = {
    {33, 3, "LBRN", LREL, EA_INT16, EA_REL_PC, 5},  {34, 3, "LBHI", LREL, EA_INT16, EA_REL_PC, 5},
    {35, 3, "LBLS", LREL, EA_INT16, EA_REL_PC, 5},  {36, 3, "LBCC", LREL, EA_INT16, EA_REL_PC, 5},
    {37, 3, "LBCS", LREL, EA_INT16, EA_REL_PC, 5},  {38, 3, "LBNE", LREL, EA_INT16, EA_REL_PC, 5},
    {39, 3, "LBEQ", LREL, EA_INT16, EA_REL_PC, 5},  {40, 3, "LBVC", LREL, EA_INT16, EA_REL_PC, 5},
    {41, 3, "LBVS", LREL, EA_INT16, EA_REL_PC, 5},  {42, 3, "LBPL", LREL, EA_INT16, EA_REL_PC, 5},
    {43, 3, "LBMI", LREL, EA_INT16, EA_REL_PC, 5},  {44, 3, "LBGE", LREL, EA_INT16, EA_REL_PC, 5},
    {45, 3, "LBLT", LREL, EA_INT16, EA_REL_PC, 5},  {46, 3, "LBGT", LREL, EA_INT16, EA_REL_PC, 5},
    {47, 3, "LBLE", LREL, EA_INT16, EA_REL_PC, 5},  {63, 2, "SWI2", INH, 0, 0, 20},
    {131, 3, "CMPD", IMM, EA_UINT16, EA_VALUE, 5},  {140, 3, "CMPY", IMM, EA_UINT16, EA_VALUE, 5},
    {142, 3, "LDY", IMM, EA_UINT16, EA_VALUE, 4},   {147, 2, "CMPD", DIR, EA_UINT16, EA_ZPG_RD, 7},
    {156, 2, "CMPY", DIR, EA_UINT16, EA_ZPG_RD, 7}, {158, 2, "LDY", DIR, EA_UINT16, EA_ZPG_RD, 6},
    {159, 2, "STY", DIR, EA_UINT16, EA_ZPG_RD, 6},  {163, 2, "CMPD", IND, EA_UINT16, EA_MEM_RD, 7},
    {172, 2, "CMPY", IND, EA_UINT16, EA_MEM_RD, 7}, {174, 2, "LDY", IND, EA_UINT16, EA_MEM_RD, 6},
    {175, 2, "STY", IND, EA_UINT16, EA_MEM_RD, 6},  {179, 3, "CMPD", EXT, EA_UINT16, EA_MEM_RD, 8},
    {188, 3, "CMPY", EXT, EA_UINT16, EA_MEM_RD, 8}, {190, 3, "LDY", EXT, EA_UINT16, EA_MEM_RD, 7},
    {191, 3, "STY", EXT, EA_UINT16, EA_MEM_RD, 7},  {206, 3, "LDS", IMM, EA_UINT16, EA_VALUE, 4},
    {222, 2, "LDS", DIR, EA_UINT16, EA_ZPG_RD, 6},  {223, 2, "STS", DIR, EA_UINT16, EA_ZPG_WR, 6},
    {238, 2, "LDS", IND, EA_UINT16, EA_MEM_RD, 6},  {239, 2, "STS", IND, EA_UINT16, EA_MEM_WR, 6},
    {254, 3, "LDS", EXT, EA_UINT16, EA_MEM_RD, 7},  {255, 3, "STS", EXT, EA_UINT16, EA_MEM_WR, 7},
};
...
static const UINT8 regid_6809[5] = {M6809_X, M6809_Y, M6809_U, M6809_S, M6809_PC};

static const char* regs_6809[5] = {"X", "Y", "U", "S", "PC"};

static const char* teregs[16] = {"D", "X", "Y",  "U",  "S",   "PC",  "inv", "inv",
                                 "A", "B", "CC", "DP", "inv", "inv", "inv", "inv"};

static char*
hexstring(int address) {
...
unsigned
Dasm6809(char* buffer, unsigned pc) {
            ...
            if (pb2 == 0x88 || pb2 == 0x8c) { /* 8-bit offset */
                ...
                switch (pb & 0x8f) {
                    ...
                    case 0x86:
                        ...
                        break;
                    case 0x8b:
                        ea = (activecpu_get_reg(regid_6809[reg]) + (activecpu_get_reg(M6809_A) << 8)
                              + activecpu_get_reg(M6809_B))
                             & 0xffff;
