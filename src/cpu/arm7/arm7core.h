...
static const int sRegisterTable[ARM7_NUM_MODES][18] = {
    {
        /* mode 0 - USR */
        eR0, eR1, eR2, eR3, eR4, eR5, eR6, eR7, eR8_User, eR9_User, eR10_User, eR11_User, eR12_User, eR13_User,
        eR14_User, eR15, eCPSR, eNoSPSR //No SPSR in this mode
    },
    {/* mode 1 - FIQ */
     eR0, eR1, eR2, eR3, eR4, eR5, eR6, eR7, eR8_FIQ, eR9_FIQ, eR10_FIQ, eR11_FIQ, eR12_FIQ, eR13_FIQ, eR14_FIQ, eR15,
     eCPSR, eSPSR_FIQ},
    {/* mode 2 - IRQ */
     eR0, eR1, eR2, eR3, eR4, eR5, eR6, eR7, eR8_User, eR9_User, eR10_User, eR11_User, eR12_User, eR13_IRQ, eR14_IRQ,
     eR15, eCPSR, eSPSR_IRQ},
    {/* mode 3 - SVC */
     eR0, eR1, eR2, eR3, eR4, eR5, eR6, eR7, eR8_User, eR9_User, eR10_User, eR11_User, eR12_User, eR13_SVC, eR14_SVC,
     eR15, eCPSR, eSPSR_SVC},
    {0},
    {0},
    {0}, //values for modes 4,5,6 are not valid
    {    /* mode 7 - ABT */
     eR0, eR1, eR2, eR3, eR4, eR5, eR6, eR7, eR8_User, eR9_User, eR10_User, eR11_User, eR12_User, eR13_ABT, eR14_ABT,
     eR15, eCPSR, eSPSR_ABT},
    {0},
    {0},
    {0}, //values for modes 8,9,a are not valid!
    {    /* mode B - UND */
     eR0, eR1, eR2, eR3, eR4, eR5, eR6, eR7, eR8_User, eR9_User, eR10_User, eR11_User, eR12_User, eR13_UND, eR14_UND,
...
enum {
    ...
    COND_NE,     /* ~Z           not equal               */
    COND_CS,
    COND_HS = 2, /*  C           unsigned higher or same */
    COND_CC,
    COND_LO = 3, /* ~C           unsigned lower          */
    COND_MI,     /*  N           negative                */
...
EXTERN WRITE32_HANDLER(
    (*arm7_coproc_rt_w_callback)); //holder for the co processor Register Transfer Write Callback Callback func.
