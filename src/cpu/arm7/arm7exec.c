...
#ifdef ARM9
void
arm7_cpu_device::arm9ops_undef(uint32_t insn) {
    // unsupported instruction
    LOG(("ARM7: Instruction %08X unsupported\n", insn));
}

void
arm7_cpu_device::arm9ops_1(uint32_t insn) {
...
void
arm7_cpu_device::arm9ops_57(uint32_t insn) {
    /* Cache Preload (PLD) */
...
void
arm7_cpu_device::arm9ops_89(uint32_t insn) {
...
void
arm7_cpu_device::arm9ops_ab(uint32_t insn) {
    // BLX
...
void
arm7_cpu_device::arm9ops_c(uint32_t insn) {
...
void
arm7_cpu_device::arm9ops_e(uint32_t insn) {
            ...
            case 1:
                ...
                if ((insn & 0x0ffffff0) == 0x012fff10) //bits 27-4 == 000100101111111111110001
                {
                    ...
                    /* Data Processing OR PSR Transfer */
                    {
                        ...
                        if (((insn & 0x0100000) == 0)
                            && ((insn & 0x01800000) == 0x01000000)) //( S bit must be clear, and bit 24,23 = 10 )
                        {
