...
static const struct {
    ...
    {"BR", Low},   {"BQ", Low},   {"BZ", Low},   {"BDF", Low},  {"B1", Low},   {"B2", Low},
    {"B3", Low},   {"B4", Low},   {"SKP", Low},  {"BNQ", Low},  {"BNZ", Low},  {"BNF", Low},
    ...
    {"IRX", Imp},  {"OUT", Imp3}, {0},           {0},           {0},           {0},
    {0},           {0},           {0},           {"INP", Imp3}, {0},           {0},
    {0},           {0},           {0},           {0},

    {"RET", Imp},  {"DIS", Imp},  {"LDXA", Imp}, {"STXD", Imp}, {"ADC", Imp},  {"SDB", Imp},
    {"SHRC", Imp}, {"SMB", Imp},  {"SAV", Imp},  {"MARK", Imp}, {"REQ", Imp},  {"SEQ", Imp},
    ...
    {"LBR", Abs},  {"LBQ", Abs},  {"LBZ", Abs},  {"LBDF", Abs}, {"NOP", Imp},  {"LSNQ", Imp},
    {"LSNZ", Imp}, {"LSNF", Imp}, {"LSKP", Imp}, {"LBNQ", Abs}, {"LBNZ", Abs}, {"LBNF", Abs},
    ...
    {"LDX", Imp},  {"OR", Imp},   {"AND", Imp},  {"XOR", Imp},  {"ADD", Imp},  {"SD", Imp},
    {"SHR", Imp},  {"SM", Imp},   {"LDI", Imm},  {"ORI", Imm},  {"ANI", Imm},  {"XRI", Imm},
    {"ADI", Imm},  {"SDI", Imm},  {"SHL", Imp},  {"SMI", Imm},

};

unsigned
cdp1802_dasm(char* dst, unsigned oldpc) {
    int pc;
    int oper;
    UINT16 absolut;
    oldpc &= 0xffff;
