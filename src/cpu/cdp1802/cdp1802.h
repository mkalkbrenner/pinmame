...
enum { CDP1802_INPUT_LINE_INT = 0, CDP1802_INPUT_LINE_DMAIN, CDP1802_INPUT_LINE_DMAOUT };

enum { EF1 = 0x01, EF2 = 0x02, EF3 = 0x04, EF4 = 0x08 };

enum _cdp1802_control_mode { CDP1802_MODE_LOAD = 0, CDP1802_MODE_RESET, CDP1802_MODE_PAUSE, CDP1802_MODE_RUN };
