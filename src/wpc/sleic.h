...
#define SLEIC_COMPORTS                                                                                                 \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BIT(0x0001, "Key 1", KEYCODE_1) COREPORT_BIT(0x0002, "Key 2", KEYCODE_2)                              \
            COREPORT_BIT(0x0004, "Key 3", KEYCODE_3) COREPORT_BIT(0x0008, "Key 4", KEYCODE_4)                          \
                COREPORT_BIT(0x0010, "Key 5", KEYCODE_5) COREPORT_BIT(0x0020, "Key 6", KEYCODE_6) COREPORT_BIT(        \
                    0x0040, "Key 7", KEYCODE_7) COREPORT_BIT(0x0080, "Key 8", KEYCODE_8) PORT_START /* 1 */            \
                    COREPORT_DIPNAME(0x0001, 0x0000, "S1") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0001, "1")   \
                        COREPORT_DIPNAME(0x0002, 0x0000, "S2") COREPORT_DIPSET(0x0000, "0")                            \
                            COREPORT_DIPSET(0x0002, "1") COREPORT_DIPNAME(0x0004, 0x0000, "S3")                        \
                                COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0004, "1")                              \
                                    COREPORT_DIPNAME(0x0008, 0x0000, "S4") COREPORT_DIPSET(0x0000, "0")                \
                                        COREPORT_DIPSET(0x0008, "1") COREPORT_DIPNAME(0x0010, 0x0000, "S5")            \
                                            COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0010, "1")                  \
                                                COREPORT_DIPNAME(0x0020, 0x0000, "S6") COREPORT_DIPSET(0x0000, "0")    \
