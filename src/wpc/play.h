...
#define PLAYMATIC_COMPORTS                                                                                             \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0008, IPT_START1, IP_KEY_DEFAULT) COREPORT_BIT(0x0001, "Coin 1", KEYCODE_3)                  \
            COREPORT_BIT(0x0002, "Coin 2", KEYCODE_4) COREPORT_BIT(0x0004, "Coin 3", KEYCODE_5)                        \
                COREPORT_BIT(0x0040, "Ball Tilt", KEYCODE_INSERT) COREPORT_BIT(0x0020, "Diagnostics", KEYCODE_7)       \
                    COREPORT_BIT(0x0080, "Reset", KEYCODE_8) /* Switch Column 0 */                                     \
        COREPORT_BIT(0x0100, DEF_STR(Unknown), KEYCODE_0)

/*-- Inports for Spain '82 --*/
#define PLAYMATIC2_COMPORTS                                                                                            \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0080, IPT_START1, IP_KEY_DEFAULT) COREPORT_BIT(0x0001, "Coin 1", KEYCODE_3)                  \
            COREPORT_BIT(0x0002, "Coin 2", KEYCODE_4) COREPORT_BIT(0x0004, "Coin 3", KEYCODE_5)                        \
                COREPORT_BIT(0x0010, "Ball Tilt", KEYCODE_INSERT) /* Switch Column 0 */                                \
        COREPORT_BIT(0x8000, "Diagnostics", KEYCODE_7) COREPORT_BIT(0x0100, "Reset", KEYCODE_0)

/*-- Inports for series III games --*/
#define PLAYMATIC3_COMPORTS                                                                                            \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0040, IPT_START1, IP_KEY_DEFAULT) COREPORT_BIT(0x0001, "Coin 1", KEYCODE_3)                  \
            COREPORT_BIT(0x0002, "Coin 2", KEYCODE_4) COREPORT_BIT(0x0004, "Coin 3", KEYCODE_5)                        \
                COREPORT_BIT(0x1010, "Tilt / Diagnostics", KEYCODE_7) COREPORT_BIT(0x0020, "Advance Digit", KEYCODE_2) \
                    COREPORT_BIT(0x0080, "Advance Step", KEYCODE_8) /* Switch Column 0 */                              \
...
#define PLAYMATIC4_COMPORTS                                                                                            \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0040, IPT_START1, IP_KEY_DEFAULT) COREPORT_BIT(0x0001, "Coin 1", KEYCODE_3)                  \
            COREPORT_BIT(0x0002, "Coin 2", KEYCODE_4) COREPORT_BIT(0x0004, "Coin 3", KEYCODE_5)                        \
                COREPORT_BIT(0x0808, "Tilt / Diagnostics", KEYCODE_7) COREPORT_BIT(0x0080, "Advance Digit", KEYCODE_2) \
                    COREPORT_BITTOG(0x0010, "Advance Step / Coin door", KEYCODE_8) /* Switch Column 0 */               \
        COREPORT_BIT(0x0100, "Reset", KEYCODE_0)
...
#define PLAYMATIC1_INPUT_PORTS_START(name, balls)                                                                      \
    ...
    PORT_START /* 0 */ /* Switch Column 5 */                                                                           \
        COREPORT_BIT(0x2000, "Coin 1", KEYCODE_3) COREPORT_BIT(0x4000, "Coin 2", KEYCODE_4)                            \
            COREPORT_BIT(0x8000, "Coin 3", KEYCODE_5) /* Switch Column 7 */                                            \
        COREPORT_BIT(0x0001, "Test", KEYCODE_7) COREPORT_BIT(0x0002, "Reset", KEYCODE_6) COREPORT_BIT(                 \
            0x0004, "(Re)set HSTD", KEYCODE_END) COREPORT_BIT(0x0008, "Set Replay #1", KEYCODE_8)                      \
            COREPORT_BIT(0x0010, "Set Replay #2", KEYCODE_9) COREPORT_BIT(0x0020, "Set Replay #3",                     \
                                                                          KEYCODE_0) PORT_START /* 1 */                \
                COREPORT_DIPNAME(0x0001, 0x0000, "HSTD award") COREPORT_DIPSET(0x0000, "3 games") COREPORT_DIPSET(     \
                    0x0001, "1 game") COREPORT_DIPNAME(0x0002, 0x0000, "Balls per game") COREPORT_DIPSET(0x0000, "3")  \
                    COREPORT_DIPSET(0x0002, "5") COREPORT_DIPNAME(0x0004, 0x0000, "Special award")                     \
                        COREPORT_DIPSET(0x0000, "Replay") COREPORT_DIPSET(0x0004, "Extra ball") PORT_START /* 2 */     \
                            COREPORT_DIPNAME(0x00ff, 0x0002, "Credits for small coin") COREPORT_DIPSET(0x0001, "1/2")  \
                                COREPORT_DIPSET(0x0002, "1") COREPORT_DIPSET(0x0004, "3/2")                            \
                                    COREPORT_DIPSET(0x0008, "2") COREPORT_DIPSET(0x0010, "3")                          \
                                        COREPORT_DIPSET(0x0020, "4") COREPORT_DIPSET(0x0040, "5")                      \
                                            COREPORT_DIPSET(0x0080, "6")                                               \
                                                COREPORT_DIPNAME(0xff00, 0x0400, "Credits for big coin")               \
                                                    COREPORT_DIPSET(0x0100, "3") COREPORT_DIPSET(0x0200, "4")          \
                                                        COREPORT_DIPSET(0x0400, "5") COREPORT_DIPSET(0x0800, "6")      \
                                                            COREPORT_DIPSET(0x1000, "7") COREPORT_DIPSET(0x2000, "8")  \
