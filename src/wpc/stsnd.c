...
static INT16 s100Waveb1[] = {32736,  26136,  19008,  12144,  7392,  3960,  2376,  264,
...
static INT16 s100Waveb5[] = {
    0,      -16000, -18000, -17800, -17400, -17000, -16800, -16400, -16000, -15800, -15400,
    -15000, -14800, -14400, -14000, -13800, -13400, -13000, -7000,  8000,   15000,  18000,
    20000,  20000,  20000,  19000,  19000,  18000,  17000,  16000,  15000,  14500
...
static INT16 freqarb5[] = {500, 400, 300, 200, 200, 300, 9999};
...
static INT16 freqarb6[] = {
    ...
    340, 320, 300, 280, 260, 240, 220, 200, 180, 160, 140, 120, 100, 80, 60, 40, 30, 20, 9999};
...
static int
st100b_sh_start(const struct MachineSound* msound) {
    ...
    mixer_play_sample_16(st100loc.channel + 0, s100Waveb1, sizeof(s100Waveb1), ST100B_FREQ1 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 1, s100Waveb1, sizeof(s100Waveb1), ST100B_FREQ2 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 2, s100Waveb1, sizeof(s100Waveb1), ST100B_FREQ3 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 3, s100Waveb1, sizeof(s100Waveb1), ST100B_FREQ4 * (sizeof(s100Waveb1) / 2),
                         1);

    st100loc.freqb5 = 0;
    mixer_play_sample_16(st100loc.channel + 4, s100Waveb5, sizeof(s100Waveb5),
                         freqarb5[st100loc.freqb5] * sizeof(s100Waveb5), 1);
    st100loc.freqb6 = 0;
    mixer_play_sample_16(st100loc.channel + 5, s100Waveb6, sizeof(s100Waveb6),
                         freqarb6[st100loc.freqb6] * sizeof(s100Waveb6), 1);
...
static int
st100_sh_start(const struct MachineSound* msound) {
    ...
    mixer_play_sample_16(st100loc.channel + 0, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ1 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 1, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ2 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 2, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ3 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 3, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ4 * (sizeof(s100Waveb1) / 2),
                         1);
    ...
    mixer_play_sample_16(st100loc.channel + 6, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ1 * (sizeof(s100Waveb1) / 2),
                         1); // Electronic chimes base frequency
    mixer_play_sample_16(st100loc.channel + 7, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ1 * sizeof(s100Waveb1),
                         1); // Electronic chimes next harmonic
    mixer_play_sample_16(st100loc.channel + 8, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ2 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 9, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ2 * sizeof(s100Waveb1), 1);
    mixer_play_sample_16(st100loc.channel + 10, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ3 * (sizeof(s100Waveb1) / 2),
                         1);
    mixer_play_sample_16(st100loc.channel + 11, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ3 * sizeof(s100Waveb1), 1);
    mixer_play_sample_16(st100loc.channel + 12, s100Waveb1, sizeof(s100Waveb1), ST100_FREQ4 * (sizeof(s100Waveb1) / 2),
                         1);
...
static INT16 sineWaveinp[] = {0x7FFF,  0x7FFF,  0x7FFF,  0x7FFF,  0x7FFF,  0x7FFF,  0x7FFF,  0x7FFF,
                              -0x7FFF, -0x7FFF, -0x7FFF, -0x7FFF, -0x7FFF, -0x7FFF, -0x7FFF, -0x7FFF}; // q2 wave

static INT16 sineWaveinpq1[] = {0x4000,  0x2000,  0x7fff,  0x1000,  0x0000,  0x0000,  0x0000,  0x0000,
                                -0x4000, -0x2000, -0x7fff, -0x1000, -0x0000, -0x0000, -0x0000, -0x0000}; // q1 wave

static INT16 volume300[] = {0, 0, 0, 0, 0, 10, 20, 20, 30, 30, 40, 40, 60, 60, 80, 90, 100, 100};

static INT16 sineWaveext
    [16][32000]; // wave triggered by external clock, very rough approximation for noise generator (related to exidy?)
...
static void
nextvol(int param) {
    if ((st300loc.volnr > 0) && (st300loc.volnr <= 16))
        st300loc.volnr++;
...
playsam2(int param) {
    ...
    if ((st300loc.cr2 & 0x80) && (st300loc.timlat2 > 0) && (st300loc.reset == 0)) { // output is enabled...
        mixer_play_sample_16(st300loc.channel, sineWaveinp, sizeof(sineWaveinp),
                             (int)(st300loc.tfre2 * sizeof(sineWaveinp) / 2 / 1.137), 1);
...
playsam1(int param) {
    ...
    if ((st300loc.cr1 & 0x80) && (st300loc.timlat1 > 0) && (st300loc.reset == 0)) { // output is enabled...
        mixer_play_sample_16(st300loc.channel + 1, sineWaveinpq1, sizeof(sineWaveinpq1),
                             (int)(st300loc.tfre1 * sizeof(sineWaveinpq1) / 2 / 1.137), 1);
        logerror("*** playsam Q1 start %04d ***\n", st300loc.tfre1);
    }
}

static void
playsamext(int param) {
    ...
    if (st300loc.noise) { // output is enabled...
        ...
        mixer_play_sample_16(st300loc.channel + 2, sineWaveext[st300loc.extfreq - 1],
                             sizeof(sineWaveext[st300loc.extfreq - 1]), 48000, 1);
...
static int
st300_sh_start(const struct MachineSound* msound) {
...
static struct { struct sndbrdData brdData; } sts_locals;
    ...
    if (!st300loc.voiceSw) {
        ...
        if (data & 0x80) { // VSU-1000 control write
            ...
            logerror("st300_CTRL_W Voicespeed data %02x speed %02x vol %02x \n", data,
                     /*data & 0x07*/ S14001_CLOCK / clock_divisor / 8, ((data >> 3) & 0xf));
...
static void
sts_init(struct sndbrdData* brdData) {
...
/ exported interfaces
/--------------------*/
const struct sndbrdIntf st100Intf = {"ST100",    sts_init, NULL,       NULL, sts_data_w,
                                     sts_data_w, NULL,     sts_ctrl_w, NULL, SNDBRD_NODATASYNC | SNDBRD_NOCTRLSYNC};

const struct sndbrdIntf st300Intf = {
    "ST300",      sts_init, NULL,         st300_switch_w, st300_man_w,
    st300_data_w, NULL,     st300_ctrl_w, NULL,           SNDBRD_NODATASYNC | SNDBRD_NOCTRLSYNC};

const struct sndbrdIntf astroIntf = {"ASTRO",      sts_init, NULL,         NULL, st300_data_w,
                                     st300_data_w, NULL,     st300_ctrl_w, NULL, SNDBRD_NODATASYNC | SNDBRD_NOCTRLSYNC};
