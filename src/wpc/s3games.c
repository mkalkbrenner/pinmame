...
/----------------------------*/
    INITGAMEFULL(httip, GEN_S3C, s4_disp, SNDBRD_NONE, 0, 0, 31, 13, 35, 0, 0, 0)
        S4_ROMSTART(httip, l1, "gamerom.716", CRC(b1d4fd9b) SHA1(e55ecf1328a55979c4cf8f3fb4e6761747e0abc4),
                    "white1.716", CRC(9bbbf14f) SHA1(b0542ffdd683fa0ea4a9819576f3789cd5a4b2eb), "white2.716",
                    CRC(4d4010dd) SHA1(11221124fef3b7bf82d353d65ce851495f6946a7)) S4_ROMEND
...
/-------------------------------------*/
    INITGAMEFULL(wldcp, GEN_S3, s4_disp, SNDBRD_S3WCS, 0, 0, 38, 37, 0, 0, 0,
                 0) S4_ROMSTART(wldcp, l1, "gamerom.716", CRC(c8071956) SHA1(0452aaf2ec1bcc5717fe52a6c541d79402bebb17),
        ...
        S67S_SOUNDROMS8("481_s0_world_cup.716",
                        CRC(cf012812) SHA1(26074f6a44075a94e6f91de1dbf92f8ec3ff8ca4)) // same as 481-50-world_cup.716
    S4_ROMEND
...
/-------------------------------------*/
    INITGAMEFULL(cntct, GEN_S3, s4_disp, SNDBRD_S3S, 0, 0, 33, 34, 35, 0, 0,
                 0) S4_ROMSTART(cntct, l1, "gamerom.716", CRC(35359b60) SHA1(ab4c3328d93bdb4c952090b327c91b0ded36152c),
                                "white1.716", CRC(9bbbf14f) SHA1(b0542ffdd683fa0ea4a9819576f3789cd5a4b2eb),
                                "white2.716", CRC(4d4010dd) SHA1(11221124fef3b7bf82d353d65ce851495f6946a7))
        S67S_SOUNDROMS8("482_s0_contact.716", CRC(d3c713da) SHA1(1fc4a8fadf472e9a04b3a86f60a9d625d07764e1)) S4_ROMEND
...
/-------------------------------------*/
    INITGAMEFULL(disco, GEN_S3, s4_disp, SNDBRD_S3DFS, 0, 0, 33, 17, 23, 21, 0,
                 0) S4_ROMSTART(disco, l1, "gamerom.716", CRC(831d8adb) SHA1(99a9c3d5c8cbcdf3bb9c210ad9d05c34905b272e),
                                "white1.716", CRC(9bbbf14f) SHA1(b0542ffdd683fa0ea4a9819576f3789cd5a4b2eb),
                                "white2.716", CRC(4d4010dd) SHA1(11221124fef3b7bf82d353d65ce851495f6946a7))
        S67S_SOUNDROMS8(
            "483_s0_disco_fever.716",
            CRC(d1cb5047) SHA1(
                7f36296975df19feecc6456ffb91f4a23bcad037)) // also a PROM version exists, but its the same as this one
    S4_ROMEND
