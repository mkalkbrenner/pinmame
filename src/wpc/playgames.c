...
#define INITGAME1(name, disptype, balls)                                                                               \
    PLAYMATIC1_INPUT_PORTS_START(name, balls)                                                                          \
    PLAYMATIC_INPUT_PORTS_END static core_tGameData name##GameData = {                                                 \
        GEN_PLAYMATIC, disptype, {FLIP_SW(FLIP_L), 0, -1, 0, SNDBRD_PLAY1}};                                           \
    static void init_##name(void) { core_gameData = &name##GameData; }

#define INITGAME2(name, disptype, balls, sb)                                                                           \
    PLAYMATIC_INPUT_PORTS_START(name, balls)                                                                           \
    PLAYMATIC_INPUT_PORTS_END static core_tGameData name##GameData = {                                                 \
        GEN_PLAYMATIC, disptype, {FLIP_SW(FLIP_L), 0, 0, 0, sb}};                                                      \
    static void init_##name(void) { core_gameData = &name##GameData; }

#define INITGAME4(name, disptype, balls)                                                                               \
    PLAYMATIC4_INPUT_PORTS_START(name, balls)                                                                          \
    PLAYMATIC_INPUT_PORTS_END static core_tGameData name##GameData = {                                                 \
        GEN_PLAYMATIC, disptype, {FLIP_SW(FLIP_L), 0, 0, 0, SNDBRD_PLAY4}};                                            \
    static void init_##name(void) { core_gameData = &name##GameData; }

#define INITGAME4FM(name, disptype, balls)                                                                             \
    PLAYMATIC4_INPUT_PORTS_START(name, balls)                                                                          \
    PLAYMATIC_INPUT_PORTS_END static core_tGameData name##GameData = {                                                 \
        GEN_PLAYMATIC, disptype, {FLIP_SW(FLIP_L), 0, 0, 0, SNDBRD_PLAY4, 0, 1}};                                      \
    static void init_##name(void) { core_gameData = &name##GameData; }

#define INITGAME5(name, disptype, balls)                                                                               \
    PLAYMATIC4_INPUT_PORTS_START(name, balls)                                                                          \
    PLAYMATIC_INPUT_PORTS_END static core_tGameData name##GameData = {                                                 \
        GEN_PLAYMATIC, disptype, {FLIP_SW(FLIP_L), 0, 0, 0, SNDBRD_ZSU}};                                              \
    static void init_##name(void) { core_gameData = &name##GameData; }

core_tLCDLayout play_dispOld[] = {{0, 0, 0, 2, CORE_SEG7},    {0, 4, 2, 1, CORE_SEG8D},   {0, 6, 3, 3, CORE_SEG7},
                                  {3, 0, 6, 2, CORE_SEG7},    {3, 4, 8, 1, CORE_SEG8D},   {3, 6, 9, 1, CORE_SEG7},
                                  {3, 8, 4, 2, CORE_SEG7},    {6, 0, 10, 2, CORE_SEG7},   {6, 4, 12, 1, CORE_SEG8D},
                                  {6, 6, 13, 1, CORE_SEG7},   {6, 8, 4, 2, CORE_SEG7},    {9, 0, 14, 2, CORE_SEG7},
                                  {9, 4, 16, 1, CORE_SEG8D},  {9, 6, 17, 1, CORE_SEG7},   {9, 8, 4, 2, CORE_SEG7},
                                  {6, 25, 18, 2, CORE_SEG7S}, {4, 24, 20, 3, CORE_SEG7S}, {0}};

core_tLCDLayout play_disp6[] = {{0, 0, 37, 1, CORE_SEG7}, {0, 2, 32, 5, CORE_SEG7}, {3, 0, 29, 1, CORE_SEG7},
                                {3, 2, 24, 5, CORE_SEG7}, {6, 0, 21, 1, CORE_SEG7}, {6, 2, 16, 5, CORE_SEG7},
                                {9, 0, 13, 1, CORE_SEG7}, {9, 2, 8, 5, CORE_SEG7},  {12, 0, 5, 1, CORE_SEG7},
                                {12, 2, 0, 2, CORE_SEG7}, {12, 8, 3, 2, CORE_SEG7}, {0}};

core_tLCDLayout play_disp7[] = {{0, 0, 37, 1, CORE_SEG7},  {0, 2, 32, 5, CORE_SEG7},  {0, 12, 52, 1, CORE_SEG7},
                                ...
                                {3, 10, 5, 1, CORE_SEG7},  {3, 12, 0, 1, CORE_SEG7},  {3, 16, 2, 1, CORE_SEG7},
                                {3, 20, 4, 1, CORE_SEG7},  {3, 22, 48, 1, CORE_SEG7}, {0}};

core_tLCDLayout play_disp7a[] = {{0, 0, 37, 1, CORE_SEG7},
                                 {0, 2, 32, 5, CORE_SEG7},
                                 {0, 12, 52, 1, CORE_SEG7},
                                 {6, 0, 29, 1, CORE_SEG7},
                                 {6, 2, 24, 5, CORE_SEG7},
...
PLAYMATIC_ROMSTART884(chance, "chance_a.bin", CRC(3cd9d5a6) SHA1(c1d9488495a67198f7f60f70a889a9a3062c71d7),
                      "chance_b.bin", CRC(a281b0f1) SHA1(1d2d26ce5f50294d5a95f688c82c3bdcec75de95), "chance_c.bin",
                      CRC(369afee3) SHA1(7fa46c7f255a5ef21b0d1cc018056bc4889d68b8))
PLAYMATIC_ROMEND
...
PLAYMATIC_ROMSTART8888(antar, "antar08.bin", CRC(f6207f77) SHA1(f68ce967c6189457bd0ce8638e9c477f16e65763),
                       "antar09.bin", CRC(2c954f1a) SHA1(fa83a5f1c269ea28d4eeff181f493cbb4dc9bc47), "antar10.bin",
                       CRC(a6ce5667) SHA1(85ecd4fce94dc419e4c210262f867310b0889cd3), "antar11.bin",
                       CRC(6474b17f) SHA1(e4325ceff820393b06eb2e8e4a85412b0d01a385))
PLAYMATIC_ROMEND
...
PLAYMATIC_ROMSTART8888(antar2, "antar08.bin", CRC(f6207f77) SHA1(f68ce967c6189457bd0ce8638e9c477f16e65763),
                       "antar09.bin", CRC(2c954f1a) SHA1(fa83a5f1c269ea28d4eeff181f493cbb4dc9bc47), "antar10a.bin",
                       CRC(520eb401) SHA1(1d5e3f829a7e7f38c7c519c488e6b7e1a4d34321), "antar11a.bin",
                       CRC(17ad38bf) SHA1(e2c9472ed8fbe9d5965a5c79515a1b7ea9edaa79))
PLAYMATIC_ROMEND
...
PLAYMATIC_ROMSTART8888(evlfight, "evfg08.bin", CRC(2cc2e79a) SHA1(17440512c419b3bb2012539666a5f052f3cd8c1d),
                       "evfg09.bin", CRC(5232dc4c) SHA1(6f95a578e9f09688e6ce8b0a622bcee887936c82), "evfg10.bin",
                       CRC(de2f754d) SHA1(0287a9975095bcbf03ddb2b374ff25c080c8020f), "evfg11.bin",
                       CRC(5eb8ac02) SHA1(31c80e74a4272becf7014aa96eaf7de555e26cd6))
PLAYMATIC_ROMEND
...
PLAYMATIC_ROMSTART8888(attack, "attack8.bin", CRC(a5204b58) SHA1(afb4b81720f8d56e88f47fc842b23313824a1085),
                       "attack9.bin", CRC(bbd086b4) SHA1(6fc94b94beea482d8c8f5b3c69d3f218e2b2dfc4), "attack10.bin",
                       CRC(764925e4) SHA1(2f207ef87786d27d0d856c5816a570a59d89b718), "attack11.bin",
                       CRC(972157b4) SHA1(23c90f23a34b34acfe445496a133b6022a749ccc))
PLAYMATIC_ROMEND
...
PLAYMATIC_ROMSTART8888(blkfever, "blackf8.bin", CRC(916b8ed8) SHA1(ddc7e09b68e3e1a033af5dc5ec32ab5b0922a833),
                       "blackf9.bin", CRC(ecb72fdc) SHA1(d3598031b7170fab39727b3402b7053d4f9e1ca7), "blackf10.bin",
                       CRC(b3fae788) SHA1(e14e09cc7da1098abf2f60f26a8ec507e123ff7c), "blackf11.bin",
                       CRC(5a97c1b4) SHA1(b9d7eb0dd55ef6d959c0fab48f710e4b1c8d8003))
PLAYMATIC_ROMEND
...
/ ??/81 Zira
/-------------------------------------------------------------------*/
PLAYMATIC_INPUT_PORTS_START(zira, 1)
PLAYMATIC_INPUT_PORTS_END
...
PLAYMATIC_ROMSTART00(zira, "zira_u8.bin", CRC(53f8bf17) SHA1(5eb74f27bc65374a85dd44bbc8f6142488c226a2), "zira_u9.bin",
                     CRC(d50a2419) SHA1(81b157f579a433389506817b1b6e02afaa2cf0d5))
...
PLAYMATIC_ROMSTART000(cerberus, "cerb8.cpu", CRC(021d0452) SHA1(496010e6892311b1cabcdac62296cd6aa0782c5d), "cerb9.cpu",
                      CRC(0fd41156) SHA1(95d1bf42c82f480825e3d907ae3c87b5f994fd2a), "cerb10.cpu",
                      CRC(785602e0) SHA1(f38df3156cd14ab21752dbc849c654802079eb33))
...
PLAYMATIC_ROMSTART000(madrace, "madrace.2a0", CRC(ab487c79) SHA1(a5df29b2af4c9d94d8bf54c5c91d1e9b5ca4d065),
                      "madrace.2b0", CRC(dcb54b39) SHA1(8e2ca7180f5ea3a28feb34b01f3387b523dbfa3b), "madrace.2c0",
                      CRC(b24ea245) SHA1(3f868ccbc4bfb77c40c4cc05dcd8eeca85ecd76f))
PLAYMATIC_SOUNDROM6416("madrace1.snd", CRC(49e956a5) SHA1(8790cc27a0fda7b8e07bee65109874140b4018a2), "madrace2.snd",
                       CRC(c19283d3) SHA1(42f9770c46030ef20a80cc94fdbe6548772aa525))
PLAYMATIC_ROMEND
...
/ 04/84 Meg-Aaton
/-------------------------------------------------------------------*/
PLAYMATIC3_INPUT_PORTS_START(megaaton, 3)
PLAYMATIC_INPUT_PORTS_END
...
PLAYMATIC_SOUNDROM6432("smogot.bin", CRC(fefc3ab2) SHA1(e748d9b443a69fcdd587f22c87d41818b6c0e436), "smegat.bin",
                       CRC(910ab7fe) SHA1(0ddfd15c9c25f43b8fcfc4e11bc8ea180f6bd761))
PLAYMATIC_ROMEND
...
PLAYMATIC_SOUNDROM6416("ufoxu3.rom", CRC(6ebd8ee1) SHA1(83522b76a755556fd38d7b292273b4c68bfc0ddf), "ufoxu4.rom",
                       CRC(aa54ede6) SHA1(7dd7e2852d42aa0f971936dbb84c7708727ce0e7))
PLAYMATIC_ROMEND
...
PLAYMATIC_SOUNDROM6416("sound1.su3", CRC(8ad1a804) SHA1(6177619f09af4302ffddd8c0c1b374dab7f47e91), "sound2.su4",
                       CRC(355dc9ad) SHA1(eac8bc27157afd908f9bc5b5a7c40be5b9427269))
PLAYMATIC_ROMEND
...
PLAYMATIC_SOUNDROM6416("starfu3.rom", CRC(5d602d80) SHA1(19d21adbcbd0067c051f3033468eda8c5af57be1), "starfu4.rom",
                       CRC(9af8be9a) SHA1(da6db3716db73baf8e1493aba91d4d85c5d613b4))
PLAYMATIC_ROMEND
...
PLAYMATIC_SOUNDROM6416("trsndu3.rom", CRC(05975c29) SHA1(e54d3a5613c3e39fc0338a53dbadc2e91c09ffe3), "trsndu4.rom",
                       CRC(bda2a735) SHA1(134b5abb813ed8bf2eeac0861b4c88c7176582d8))
PLAYMATIC_ROMEND
...
PLAYMATIC_SOUNDROM6416("fdsndu3.rom", CRC(aa9c52a8) SHA1(97d5d63b14d10c70a5eb80c08ccf5a1f3df7596d), "fdsndu4.rom",
                       CRC(0a7dc1d2) SHA1(32c7be5e9fbe4fa9ca661af7b7b5ea13ef250ce6))
PLAYMATIC_ROMEND
...
PLAYMATIC_SOUNDROM256x4("sonido1.bin", CRC(3294611d) SHA1(5f790b41bcb6d87418c80e61ac8ae69c57864b1d), "sonido2.bin",
                        CRC(c2efc826) SHA1(44ee144b902627745853011968e0d654b35b3b08), "sonido3.bin",
                        CRC(13d50f39) SHA1(70624de2dd8412c83866183a83f16cc5b8bdccb8), "sonido4.bin",
                        CRC(b53f73ed) SHA1(bb928cfee418e8d9698d7bee78a32426f793c6e9)) PLAYMATIC_ROMEND
...
/-------------------------------------------------------------------*/
    INITGAME5(sklflite, play_disp7a, 1)
        PLAYMATIC_ROMSTART64_2(sklflite, "skflcpu1.rom", CRC(8f833b55) SHA1(1729203582c22b51d1cc401aa8f270aa5cdadabe),
            ...
            PLAYMATIC_SOUNDROM256("skflsnd.rom",
                                  CRC(926a1da9) SHA1(16c762fbfe6a55597f26ff55d380192bb8647ee0)) PLAYMATIC_ROMEND
...
INPUT_PORTS_START(msdisco)
CORE_PORTS SIM_PORTS(1) PORT_START COREPORT_BIT(0x0001, "Key 1", KEYCODE_1) COREPORT_BIT(0x0002, "Key 2", KEYCODE_2)
    COREPORT_BIT(0x0004, "Key 3", KEYCODE_3) COREPORT_BIT(0x0008, "Key 4", KEYCODE_4)
        COREPORT_BIT(0x0010, "Key 5", KEYCODE_5) COREPORT_BIT(0x0020, "Key 6", KEYCODE_6)
            COREPORT_BIT(0x0040, "Key 7", KEYCODE_7) COREPORT_BIT(0x0080, "Key 8", KEYCODE_8) PORT_START
    COREPORT_DIPNAME(0x0001, 0x0000, "EF1") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0001, "1")
        COREPORT_DIPNAME(0x0002, 0x0000, "EF2") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0002, "1")
            COREPORT_DIPNAME(0x0004, 0x0000, "EF3") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0004, "1")
                COREPORT_DIPNAME(0x0008, 0x0000, "EF4") COREPORT_DIPSET(0x0000, "0")
                    COREPORT_DIPSET(0x0008, "1") INPUT_PORTS_END
...
PLAYMATIC_ROMSTART8888(storm, "a-1.bin", CRC(12e37664) SHA1(d7095975cd9d4445fd1f4cd711992c7367deae89), "b-1.bin",
                       CRC(3ac3cea3) SHA1(c6197911d25661cb647ea606eee5f3f1bd9b4ba2), "c-1.bin",
                       CRC(8bedf1ea) SHA1(7633ebf8a65e3fc7afa21d50aaa441f87a86efd3), "d-1.bin",
                       CRC(f717ef3e) SHA1(cd5126360471c06539e445fecbf2f0ddeb1b156c))
PLAYMATIC_ROMEND
...
/-------------------------------------------------------------------*/
core_tLCDLayout dispFM[] = {{0, 0, 37, 1, CORE_SEG7},  {0, 2, 32, 5, CORE_SEG7},  {0, 12, 52, 1, CORE_SEG7},
                            ...
                            {10, 0, 5, 1, CORE_SEG7},  {10, 2, 0, 1, CORE_SEG7},  {10, 5, 1, 1, CORE_SEG7},
                            {10, 8, 2, 1, CORE_SEG7},  {10, 11, 3, 2, CORE_SEG7}, {0}};
...
PLAYMATIC_SOUNDROM6416("mfm-1a0.u3", CRC(456fd555) SHA1(e91d6df15fdfc330ee9edb691ff925ad24afea35), "mfm-1b0.u4",
                       CRC(90256257) SHA1(c7f2554e500c4e512999b4edc54c86f3335a2b30))
PLAYMATIC_ROMEND
...
/-------------------------------------------------------------------*/
core_tLCDLayout dispSM[] = {{0, 0, 37, 1, CORE_SEG7},  {0, 2, 32, 5, CORE_SEG7},  {0, 12, 52, 1, CORE_SEG7},
