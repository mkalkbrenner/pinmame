...
GTS80_INPUT_PORTS_START(gts80, 1)
GTS80_INPUT_PORTS_END GTS80VID_INPUT_PORTS_START(gts80vid, 1) GTS80_INPUT_PORTS_END

    /* 4 x 6 BCD + Ball,Credit */
    static core_tLCDLayout dispNumeric1[] = {{0, 0, 2, 6, CORE_SEG9},
                                             {0, 16, 9, 6, CORE_SEG9},
                                             {4, 0, 22, 6, CORE_SEG9},
                                             {4, 16, 29, 6, CORE_SEG9},
                                             DISP_SEG_CREDIT(40, 41, CORE_SEG7S),
                                             DISP_SEG_BALLS(42, 43, CORE_SEG7S),
                                             {0}};
/* 5 x 6 BCD + Ball, Credit */
static core_tLCDLayout dispNumeric2[] = {{0, 0, 2, 6, CORE_SEG9},
                                         {0, 16, 9, 6, CORE_SEG9},
                                         {4, 0, 22, 6, CORE_SEG9},
                                         {4, 16, 29, 6, CORE_SEG9},
                                         DISP_SEG_CREDIT(40, 41, CORE_SEG7S),
...
static core_tLCDLayout dispNumeric3[] = {{0, 0, 2, 7, CORE_SEG98F},
                                         {0, 16, 9, 7, CORE_SEG98F},
                                         {4, 0, 22, 7, CORE_SEG98F},
                                         {4, 16, 29, 7, CORE_SEG98F},
                                         DISP_SEG_CREDIT(40, 41, CORE_SEG7S),
                                         DISP_SEG_BALLS(42, 43, CORE_SEG7S),
                                         {0}};
/* 4 x 7 BCD + 1 x 6 BCD + Ball, Credit */
static core_tLCDLayout dispNumeric4[] = {{0, 0, 2, 7, CORE_SEG98F},
                                         {0, 16, 9, 7, CORE_SEG98F},
                                         {4, 0, 22, 7, CORE_SEG98F},
                                         {4, 16, 29, 7, CORE_SEG98F},
                                         DISP_SEG_CREDIT(40, 41, CORE_SEG7S),
...
static core_tLCDLayout dispAlpha[] = {{0, 0, 0, 20, CORE_SEG16}, {2, 0, 20, 20, CORE_SEG16}, {0}};
...
INIT_S80(gts80, dispNumeric1, SNDBRD_GTS80SS)
GTS80_ROMEND GAMEX(1981, gts80, 0, gts80ss, gts80, gts80, ROT0, "Gottlieb", "System 80 with speech board", NOT_A_DRIVER)
...
/-------------------------------------------------------------------*/
    INIT_S80(spidermn, dispNumeric1, SNDBRD_GTS80S)
        GTS80_2_ROMSTART("653-1.cpu", CRC(674ddc58) SHA1(c9be45391b8dd58a0836801807d593d4c7da9904), "653-2.cpu",
                         CRC(ff1ddfd7) SHA1(dd7b98e491045916153b760f36432506277a4093))
            GTS80S1K_ROMSTART("653.snd", CRC(f5650c46) SHA1(2d0e50fa2f4b3d633daeaa7454630e3444453cb2), "6530sy80.bin",
                              CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c)) GTS80_ROMEND
...
/-------------------------------------------------------------------*/
    INIT_S80(panthera, dispNumeric1, SNDBRD_GTS80S)
        GTS80_1_ROMSTART("652.cpu", CRC(5386e5fb) SHA1(822f47951b702f9c6a1ce674baaab0a596f34413))
            GTS80S1K_ROMSTART("652.snd", CRC(4d0cf2c0) SHA1(0da5d118ffd19b1e78dfaaee3e31c43750d45c8d), "6530sy80.bin",
                              CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c)) GTS80_ROMEND
...
/-------------------------------------------------------------------*/
    INIT_S80(circus, dispNumeric1, SNDBRD_GTS80S)
        GTS80_2_ROMSTART("654-1.cpu", CRC(0eeb2731) SHA1(087cd6400bf0775bda0264422b3f790a77852bc4), "654-2.cpu",
                         CRC(01e23569) SHA1(47088421254e487aa1d1e87ea911dc1634e7d9ad))
            GTS80S1K_ROMSTART("654.snd", CRC(75c3ad67) SHA1(4f59c451b8659d964d5242728814c2d97f68445b), "6530sy80.bin",
                              CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c)) GTS80_ROMEND
...
/-------------------------------------------------------------------*/
    INIT_S80(cntforce, dispNumeric1, SNDBRD_GTS80S)
        GTS80_2_ROMSTART("656-1.cpu", CRC(42baf51d) SHA1(6c7947df6e4d7ed2fd48410705018bde91db3356), "656-2.cpu",
                         CRC(0e185c30) SHA1(01d9fb5d335c24bed9f747d6e23f57adb6ef09a5))
            GTS80S1K_ROMSTART("656.snd", CRC(0be2cbe9) SHA1(306a3e7d93733562360285de35b331b5daae7250), "6530sy80.bin",
                              CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c)) GTS80_ROMEND
...
/-------------------------------------------------------------------*/
    INIT_S80(starrace, dispNumeric1, SNDBRD_GTS80S)
        GTS80_2_ROMSTART("657-1.cpu", CRC(27081372) SHA1(2d9cd81ffa44c389c4895043fa1e93b899544158), "657-2.cpu",
                         CRC(c56e31c8) SHA1(1e129fb6309e015a16f2bdb1e389cbc85d1919a7))
            GTS80S1K_ROMSTART("657.snd", CRC(3a1d3995) SHA1(6f0bdb34c4fa11d5f8ecbb98ae55bafeb5d62c9e), "6530sy80.bin",
                              CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c)) GTS80_ROMEND
...
/-------------------------------------------------------------------*/
    INIT_S80(jamesb, dispNumeric2, SNDBRD_GTS80S)
        GTS80_1_ROMSTART("658-1.cpu", CRC(b841ad7a) SHA1(3396e82351c975781cac9112bfa341a3b799f296))
            GTS80S1K_ROMSTART("658.snd", CRC(962c03df) SHA1(e8ff5d502a038531a921380b75c27ef79b6feac8), "6530sy80.bin",
                              CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c)) GTS80_ROMEND
...
/ Time Line
/-------------------------------------------------------------------*/
    static core_tLCDLayout dispTimeline[] = {DISP_SEG_IMPORT(dispNumeric1), {6, 12, 50, 2, CORE_SEG9}, {0}};
...
GTS80S1K_ROMSTART("659.snd", CRC(28185568) SHA1(2fd26e7e0a8f050d67159f17634df2b1fc47cbd3), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
#define input_ports_timeline input_ports_gts80
CORE_CLONEDEFNV(timeline, gts80s, "Time Line", 1980, "Gottlieb", gl_mGTS80S, 0)

static core_tLCDLayout dispTimeline7[] = {DISP_SEG_IMPORT(dispNumeric3), {6, 13, 50, 2, CORE_SEG9}, {0}};
...
GTS80S1K_ROMSTART("661.snd", CRC(650158a7) SHA1(c7a9d521d1e7de1e00e7abc3a97aaaee04f8052e), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
static core_tLCDLayout dispPinkPanther[] = {
    DISP_SEG_IMPORT(dispNumeric1), {6, 8, 50, 2, CORE_SEG9}, {6, 16, 54, 2, CORE_SEG9}, {0}};
...
GTS80S1K_ROMSTART("664.snd", CRC(18f4abfd) SHA1(9e85eb7e9b1e2fe71be828ff1b5752424ed42588), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
static core_tLCDLayout dispPinkPanther7[] = {
    DISP_SEG_IMPORT(dispNumeric3), {6, 10, 50, 2, CORE_SEG9}, {6, 16, 54, 2, CORE_SEG9}, {0}};
...
GTS80_1_ROMSTART("664-1.cpu", CRC(a0d3e69a) SHA1(590e68dc28067e61832927cd4b3eefcc066f0a92))
GTS80S1K_ROMSTART("664_flipprojets.snd", CRC(48aeb325) SHA1(49dae08c635f191841188565bd89f07c4ad44c08), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("666-s1.snd", CRC(d33dc8a5) SHA1(8d071c392996a74c3cdc2cf5ea3be3c86553ce89), "666-s2.snd",
                   CRC(e5616f3e) SHA1(a6b5ebd0b456a555db0889cd63ce79aafc64dbe5))
GTS80_ROMEND
...
GTS80_1_ROMSTART("666-1.cpu", CRC(bb7d476a) SHA1(22d5d7f0e52c5180f73a1ca0b3c6bd4b7d0843d6))
GTS80SS22_ROMSTART("f666-s1.snd", CRC(f9f782c5) SHA1(83438fcf3475bc2cb24c828036d94063c263a031), "f666-s2.snd",
                   CRC(7bd64d94) SHA1(a52492820e69f2072fd1dffb5cbb48fb960e19ce))
GTS80_ROMEND
...
CORE_CLONEDEFNV(mars_2, mars, "Mars - God of War (rev. 2 unofficial MOD)", 1981, "Flipprojets", gl_mGTS80SS,
                0) // fixes a potential startup problem
...
GTS80SS22_ROMSTART("667-s1.snd", CRC(ba9d40b7) SHA1(3d6640b259cd8ae87b998cbf1ae2dc13a2913e4f), "667-s2.snd",
                   CRC(b54bd123) SHA1(3522ccdcb28bfacff2287f5537d52f22879249ab))
GTS80_ROMEND
...
GTS80S1K_ROMSTART("667-a-s.snd", CRC(894b4e2e) SHA1(d888f8e00b2b50cef5cc916d46e4c5e6699914a1), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("668-s1.snd", CRC(23d5045d) SHA1(a20bf02ece97e8238d1dbe8d35ca63d82b62431e), "668-s2.snd",
                   CRC(d63da498) SHA1(84dd87783f47fbf64b1830284c168501f9b455e2))
GTS80_ROMEND
...
GTS80S1K_ROMSTART("668-a-s.snd", CRC(5175f307) SHA1(97be8f2bbc393cc45a07fa43daec4bbba2336af8), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("669-s1.snd", CRC(52ec7335) SHA1(2b08dd8a89057c9c8c184d5b723ecad01572129f), "669-s2.snd",
                   CRC(a3317b4b) SHA1(c3b14aa58fd4588c8b8fa3540ea6331a9ee40f1f))
GTS80_ROMEND
...
CORE_CLONEDEFNV(hh_3b, hh, "Haunted House (rev. 3 unofficial MOD, LED+Secret Tunnel)", 1982, "Flipprojets", gl_mGTS80SS,
                0)
...
GTS80SS22_ROMSTART("669-4-s1.snd", NO_DUMP, "669-4-s2.snd", NO_DUMP)
GTS80_ROMEND
#define input_ports_hh_4a input_ports_hh
CORE_CLONEDEFNV(hh_4a, hh, "Haunted House (rev. 4 unofficial Votrax speech MOD, LED)", 1982, "Flipprojets", gl_mGTS80SS,
                0)
...
CORE_CLONEDEFNV(hh_4b, hh, "Haunted House (rev. 4 unofficial Votrax speech MOD, LED+Secret Tunnel)", 1982,
                "Flipprojets", gl_mGTS80SS, 0)
...
GTS80S1K_ROMSTART("671-a-s.snd", CRC(5175f307) SHA1(97be8f2bbc393cc45a07fa43daec4bbba2336af8), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("80tst-s1.snd", CRC(b9dbdd21) SHA1(dfe42c9e6e02f82ffd0cafe164df3211cdc2d966), "80tst-s2.snd",
                   CRC(1a4b1e9d) SHA1(18e7ffbdbdaf83ab1c8daa5fa5201d9f54390758))
GTS80_ROMEND
...
static core_tLCDLayout dispDevilsdare[] = {
    DISP_SEG_IMPORT(dispNumeric3), {6, 1, 50, 6, CORE_SEG9}, {6, 17, 44, 6, CORE_SEG9}, {0}};
...
GTS80SS22_ROMSTART("670-s1.snd", CRC(506bc22a) SHA1(3c69f8d0c38c51796c31fb38c02d00afe8a4b8c5), "670-s2.snd",
                   CRC(f662ee4b) SHA1(0f63e01672b7c07a4913e150f0bbe07ecfc06e7c))
GTS80_ROMEND
...
GTS80S1K_ROMSTART("670-a-s.snd", CRC(f141d535) SHA1(91e4ab9ce63b5ff3e395b6447a104286327b5533), "6530sy80.bin",
                  CRC(c8ba951d) SHA1(e4aa152b36695a0205c19a8914e4d77373f64c6c))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("pv810-s1.snd", CRC(a491664d) SHA1(45031bcbddb75b4f3a5c3b623a0f2723fb95f92f), "pv810-s2.snd",
                   CRC(d8654e6e) SHA1(75d4f1f966ed5a1632536723229166b9cc7d77c7))
VIDEO_ROMSTART("v810-u8.bin", CRC(514aa152) SHA1(f61a98bbc95f202417cf97b35fe9835108200477), "v810-u7.bin",
               CRC(74c6533e) SHA1(8fe373c28dc4089bd9e573c69682113315236c72), "v810-u6.bin",
               CRC(2fd0ee95) SHA1(8374b7729b2de9e73784617ada6f9d895f54cc8d), "v810-u5.bin",
               CRC(2fb15da3) SHA1(ba2927bc88c1ee1b8dd682234b2616d2013c7e7c), "v810-u4.bin",
               CRC(2dfe8492) SHA1(a29604cda968504f95577e36c715ae97034bb5f8), "v810-u3.bin",
               CRC(740e9ec3) SHA1(ba4839680694bf5acff540147af4319c64c313e8), "v810-u2.bin",
               CRC(b793baf9) SHA1(cf1618cd0134529d057bc8245b9b366c3aae2326), "v810-u1.bin",
               CRC(0a283b15) SHA1(4a57ae5be36500c22b55ac17dc71968bd833298b))
GTS80_ROMEND
...
VIDEO_ROMSTART("v810-u8.bin", CRC(514aa152) SHA1(f61a98bbc95f202417cf97b35fe9835108200477), "v810-u7.bin",
               CRC(74c6533e) SHA1(8fe373c28dc4089bd9e573c69682113315236c72), "v810-u6.bin",
               CRC(2fd0ee95) SHA1(8374b7729b2de9e73784617ada6f9d895f54cc8d), "v810-u5.bin",
               CRC(2fb15da3) SHA1(ba2927bc88c1ee1b8dd682234b2616d2013c7e7c), "v810-u4a.bin",
               CRC(3437c697) SHA1(e35822ed04eeb7f8a54a0bfdd2b63d54fa9b2263), "v810-u3a.bin",
               CRC(729819f6) SHA1(6f684d05d1dcdbb975d3b97cfa0b1d657e7a98a5), "v810-u2a.bin",
               CRC(ab6193c2) SHA1(eb898b3a3dfef15f992f7ef6f2d636a3e124ca13), "v810-u1a.bin",
               CRC(7c6410fb) SHA1(6606d853d4955ce18ace71814bd2ae3d25e0c046))
GTS80_ROMEND
...
CORE_CLONEDEFNV(cavemane, caveman, "Caveman (Pinball/Video Combo) (Evolution, unofficial MOD)", 1981, "Flipprojets",
                gl_mGTS80VID, 0)
...
GTS80SS22_ROMSTART("672-s1.snd", CRC(10ba523c) SHA1(4289acd1437d7bf69fb442884a98290dc1b5f493), "672-s2.snd",
                   CRC(5e77117a) SHA1(7836b1ee0b2afe621ae414d5710111b550db0e63))
GTS80_ROMEND
...
GTS80_1_ROMSTART("672-2x.cpu", CRC(8e2f0d39) SHA1(eb0982d2bfa910b3c95d6d55c04dc58395789411))
GTS80SS22_ROMSTART("f672-s1.snd", CRC(57a0ce22) SHA1(cdc167b5eb72e8c3235d3ffd9143faf8e6c0a2ef), "f672-s2.snd",
                   CRC(87a0474f) SHA1(62fe995f3bc7fe23422d75b043d508c2f84f745a))
GTS80_ROMEND
...
/ Spirit (#673)
/-------------------------------------------------------------------*/
static core_tLCDLayout dispSpirit[] = {DISP_SEG_IMPORT(dispNumeric3), {6, 9, 50, 6, CORE_SEG9}, {0}};
...
GTS80SS22_ROMSTART("673-s1.snd", CRC(fd3062ae) SHA1(6eae04ec470afd4363ca448ee106e3e89fbf471e), "673-s2.snd",
                   CRC(7cf923f1) SHA1(2182324c30e8cb22735e59b74d4f6b268d3750e6))
GTS80_ROMEND
...
static core_tLCDLayout dispStriker[] = {/* as displayed on real machine */
                                        {2, 0, 2, 7, CORE_SEG98F},
                                        {6, 0, 9, 7, CORE_SEG98F},
                                        {2, 16, 22, 7, CORE_SEG98F},
                                        {6, 16, 29, 7, CORE_SEG98F},
                                        {0, 2, 40, 2, CORE_SEG7S},
                                        {0, 8, 42, 2, CORE_SEG7S}, /* ball/credit */
                                        {4, 2, 52, 2, CORE_SEG9},
                                        {4, 8, 50, 2, CORE_SEG9},
                                        {4, 18, 48, 2, CORE_SEG9},
                                        {4, 24, 46, 2, CORE_SEG9},
...
GTS80SS22_ROMSTART("675-s1.snd", CRC(cc11c487) SHA1(fe880dd7dc03f368b2c7ea81059c4b176018b86e), "675-s2.snd",
                   CRC(ec30a3d9) SHA1(895be373598786d618bed635fe43daae7245c8ac))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("674-s1.snd", CRC(b75f79d5) SHA1(921774dacccb025c9465ea7e24534aca2d29d6f1), "674-s2.snd",
                   CRC(005d123a) SHA1(ebe258786de09488ec0a104a47e208c66b3613b5))
GTS80_ROMEND
...
static core_tLCDLayout dispKrull[] = {
    DISP_SEG_IMPORT(dispNumeric3), {6, 8, 50, 3, CORE_SEG9}, {6, 16, 53, 3, CORE_SEG9}, {0}};
...
GTS80SS22_ROMSTART("676-s1.snd", CRC(b1989d8f) SHA1(f1a7eac8aa9c7685f4d37f1c73bba27f4fa8b6ae), "676-s2.snd",
                   CRC(05fade11) SHA1(538f6225235b5338504597acdf6bafd1de24284e))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("677-s1.snd", CRC(af7bc8b7) SHA1(33100d63629be7a5b768efd82a1ed1280c845d25), "677-s2.snd",
                   CRC(820aa26f) SHA1(7181ceedcf61204277d7b9fdba621915960999ad))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("680-s1.snd", CRC(fccbbbdd) SHA1(089f2b15ab1cc46550351614e18d8915b3d6a8bf), "680-s2.snd",
                   CRC(d883d63d) SHA1(1777a16bc9df7e5be2643ed18754ba120c7a954b))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("681-s1.snd", CRC(33455bbd) SHA1(04db645060d93d7d9faff56ead9fa29a9c4723ec), "681-s2.snd",
                   CRC(639c93f9) SHA1(1623fea6681a009e7a755357fa85206cf2ce6897))
GTS80_ROMEND
...
/ Goin' Nuts (#682)
/-------------------------------------------------------------------*/
static core_tLCDLayout dispGoinNuts[] = {DISP_SEG_IMPORT(dispNumeric3), {6, 12, 53, 3, CORE_SEG9}, {0}};
...
GTS80SS22_ROMSTART("682-s1.snd", CRC(f00dabf3) SHA1(a6e3078220ab23dc41fd48fd528e679aefec3693), "682-s2.snd",
                   CRC(3be8ac5f) SHA1(0112d3417c0793e672733eff58058d8c9ad10421))
GTS80_ROMEND
...
GTS80SS22_ROMSTART("684-s1.snd", CRC(86d239df) SHA1(f18efdc6b84d18b1cf01e79224284c5180c57d22), "684-s2.snd",
                   CRC(4d8ea26c) SHA1(d76d535bf29297247f1e5abd080a52b7dfc3811b))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(tagteam, "prom2.cpu", CRC(fd1615ce) SHA1(3a6c3525552286b86e5340af2bf196f12adc9b35), "prom1.cpu",
                   CRC(65931038) SHA1(6d2f1a9fb1b3ce4610074fd3f2ac37ad6af70a44))
...
GTS80B_2K_ROMSTART(tagteam2, "prom2a.cpu", CRC(6d56b636) SHA1(8f50f2742be727835e7343307787b4b5daa1623a), "prom1a.cpu",
                   CRC(92766607) SHA1(29744dd3c447cc51fb123750ae1456329122e986))
GTS80S2K_ROMSTART("698-s.snd", CRC(9c8191b7) SHA1(12b017692f078dcdc8e4bbf1ffcea1c5d0293d06))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(tagtemfp, "prom2.cpu", CRC(fd1615ce) SHA1(3a6c3525552286b86e5340af2bf196f12adc9b35), "prom1_fp.cpu",
                   CRC(3f052c44) SHA1(176fbe35a4ad5832b1ba61889a858b8585dc86be))
GTS80S2K_ROMSTART("698-s.snd", CRC(9c8191b7) SHA1(12b017692f078dcdc8e4bbf1ffcea1c5d0293d06))
GTS80_ROMEND
#define input_ports_tagtemfp input_ports_tagteam
CORE_CLONEDEFNV(tagtemfp, tagteam, "Tag-Team Pinball (Free Play)", 1985, "Flipprojets", gl_mGTS80B,
                0) //!! rev.1 actually ??

// #698Y
INITGAME(tagteamg, GEN_GTS80B, FLIP616, dispAlpha, SNDBRD_GTS80SP, GTS80_DISPALPHA, 0)
GTS80B_2K_ROMSTART(tagteamg, "prom2g.cpu", CRC(5e6d2da7) SHA1(9b23d1ac34163edeaceffe806a2a559f3d408b41), "prom1g.cpu",
                   CRC(e206c519) SHA1(0d5b3237807b6f11633ab9be2b0e5b000369a0e8))
GTS80S2K_ROMSTART("698-s.snd", CRC(9c8191b7) SHA1(12b017692f078dcdc8e4bbf1ffcea1c5d0293d06))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(tagtem2f, "prom2a.cpu", CRC(6d56b636) SHA1(8f50f2742be727835e7343307787b4b5daa1623a), "prom1_2f.cpu",
                   CRC(9c2c0058) SHA1(92e28a0e5fb454b046d1cd365e39ebdd6fa6baf1))
GTS80S2K_ROMSTART("698-s.snd", CRC(9c8191b7) SHA1(12b017692f078dcdc8e4bbf1ffcea1c5d0293d06))
GTS80_ROMEND
...
GTS80BSSOUND88("drom1.snd", CRC(03830e81) SHA1(786f85eba5a8f5e9cc659305623e1d178b5410f6), "yrom1.snd",
               CRC(effba2ad) SHA1(2288a4f655376e0aa18f8ecd9a3818ed4d6c6891))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(raven, "prom2.cpu", CRC(481f3fb8) SHA1(22ffa55ed362219ebedbc40edcf866ff152a01b9), "prom1.cpu",
                   CRC(edc88561) SHA1(101878527307c6f04d141dd74e04102c4ea53105))
GTS80BSSOUND88("drom1.snd", CRC(a04bf7d0) SHA1(5be5d445b199e7dc9d42e7ee5e9b31c18dec3881), "yrom1.snd",
               CRC(ee5f868b) SHA1(23ef4112b94109ad4d4a6b9bb5215acec20e5e55))
GTS80_ROMEND
#define input_ports_raven input_ports_gts80
CORE_GAMEDEFNV(raven, "Raven", 1986, "Gottlieb", gl_mGTS80BS1, 0)

GTS80B_2K_ROMSTART(
    ravena, "prom2a.cpu", CRC(a693785e) SHA1(7c8878f1c3c5205b3ae46a78c881bbd2b722838d), "prom1.cpu",
    CRC(edc88561) SHA1(
        101878527307c6f04d141dd74e04102c4ea53105)) // actually this would also be different, but in practice it isn't by accident (as the internal checksum for PROM2 stored in here is the same)
GTS80BSSOUND88("drom1.snd", CRC(a04bf7d0) SHA1(5be5d445b199e7dc9d42e7ee5e9b31c18dec3881), "yrom1.snd",
               CRC(ee5f868b) SHA1(23ef4112b94109ad4d4a6b9bb5215acec20e5e55))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(ravenfp, "prom2.cpu", CRC(481f3fb8) SHA1(22ffa55ed362219ebedbc40edcf866ff152a01b9), "prom1_fp.cpu",
                   CRC(d6e5120b) SHA1(1d00bce8170b5ad4185e6517ba1a0f46c8ae7444))
GTS80BSSOUND88("drom1.snd", CRC(a04bf7d0) SHA1(5be5d445b199e7dc9d42e7ee5e9b31c18dec3881), "yrom1.snd",
               CRC(ee5f868b) SHA1(23ef4112b94109ad4d4a6b9bb5215acec20e5e55))
GTS80_ROMEND
...
// #702Y
GTS80B_2K_ROMSTART(raveng, "prom2g.cpu", CRC(4ca540a5) SHA1(50bb240465d80b7763574e1261f8d0ddda5ad587), "prom1g.cpu",
                   CRC(3441aeda) SHA1(12dd2faac64170bad5cf5b9247283f64df9e5337))
GTS80BSSOUND88("drom1.snd", CRC(a04bf7d0) SHA1(5be5d445b199e7dc9d42e7ee5e9b31c18dec3881), "yrom1.snd",
               CRC(ee5f868b) SHA1(23ef4112b94109ad4d4a6b9bb5215acec20e5e55))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(
    ravenafp, "prom2a.cpu", CRC(a693785e) SHA1(7c8878f1c3c5205b3ae46a78c881bbd2b722838d), "prom1_fp.cpu",
    CRC(d6e5120b) SHA1(
        1d00bce8170b5ad4185e6517ba1a0f46c8ae7444)) // actually this would also be different, but in practice it isn't by accident (as the internal checksum for PROM2 stored in here is the same)
GTS80BSSOUND88("drom1.snd", CRC(a04bf7d0) SHA1(5be5d445b199e7dc9d42e7ee5e9b31c18dec3881), "yrom1.snd",
               CRC(ee5f868b) SHA1(23ef4112b94109ad4d4a6b9bb5215acec20e5e55))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(rambo, "prom2a.cpu", CRC(a693785e) SHA1(7c8878f1c3c5205b3ae46a78c881bbd2b722838d), "prom1r.cpu",
                   CRC(51629598) SHA1(a5408fad2baec43633f407665f006fae74f3d9aa))
GTS80BSSOUND88("drom1.snd", CRC(a04bf7d0) SHA1(5be5d445b199e7dc9d42e7ee5e9b31c18dec3881), "yrom1.snd",
               CRC(ee5f868b) SHA1(23ef4112b94109ad4d4a6b9bb5215acec20e5e55))
GTS80_ROMEND
...
GTS80BSSOUND888("drom1a.snd", CRC(b8aa8912) SHA1(abff690256c0030807b2d4dfa0516496516384e8), "yrom1a.snd",
                CRC(a62e3b94) SHA1(59636c2ac7ebbd116a0eb39479c97299ba391906), "yrom2a.snd",
                CRC(66645a3f) SHA1(f06261af81e6b1829d639933297d2461a8c993fc))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(hlywoodh, "prom2.cpu", CRC(a465e5f3) SHA1(56afa2f67aebcd17345bba76ecb814653719ee7b), "prom1.cpu",
                   CRC(0493e27a) SHA1(72c603cda3cc43ed0f841a9fcc6f40d020475e74))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(hlywdhfp, "prom2.cpu", CRC(a465e5f3) SHA1(56afa2f67aebcd17345bba76ecb814653719ee7b), "prom1_fp.cpu",
                   CRC(63bc8395) SHA1(b4007b5a6b78e162c9b3e0243f01fa30501323ae))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(hlywodhg, "prom2g.cpu", CRC(bf60b631) SHA1(944089895d4253dd094a8f6b7168f9e62a75568a), "prom1g.cpu",
                   CRC(0f212d15) SHA1(b671b8fbc50f5528f0de061c7695932035266a0e))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(hlywodhf, "prom2f.cpu", CRC(969ca81f) SHA1(2606a0f63434056c5d2b509a885c9919a7a5d70f), "prom1f.cpu",
                   CRC(ddc45d2d) SHA1(8bd50f3e0049fe322f7bc626d39f9787cfea1940))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(bubba, "prom2.cpu", CRC(a465e5f3) SHA1(56afa2f67aebcd17345bba76ecb814653719ee7b), "prom1_b.cpu",
                   CRC(6556d711) SHA1(9d0ccaf05d0aa5a68e5514a2ade7773959868bbb))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
#define input_ports_bubba input_ports_hlywoodh
CORE_CLONEDEFNV(bubba, hlywoodh, "Bubba the Redneck Werewolf (Hollywood Heat unofficial MOD)", 2017, "HauntFreaks",
                gl_mGTS80BS1, 0)

INITGAME(beachbms, GEN_GTS80B, FLIP616, dispAlpha, SNDBRD_GTS80B, GTS80_DISPALPHA, 0)
GTS80B_2K_ROMSTART(beachbms, "prom2.cpu", CRC(a465e5f3) SHA1(56afa2f67aebcd17345bba76ecb814653719ee7b), "prom1_bb.cpu",
                   CRC(a035eb2d) SHA1(0f467b506bd514129e4175af3e35a666e09ec41b))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(tomjerry, "prom2.cpu", CRC(a465e5f3) SHA1(56afa2f67aebcd17345bba76ecb814653719ee7b), "prom1_tj.cpu",
                   CRC(45164b17) SHA1(40cf8bd6725d2e7d5e15cfaf8215e36c0d32183d))
GTS80BSSOUND888("drom1.snd", CRC(a698ec33) SHA1(e7c1d28279ec4f12095c3a106c6cefcc2a84b31e), "yrom1.snd",
                CRC(9232591e) SHA1(72883e0c542c572226c6c654bea14749cc9e351f), "yrom2.snd",
                CRC(51709c2f) SHA1(5834d7b72bd36e30c87377dc7c3ad0cf26ff303a))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(genesis, "prom2.cpu", CRC(ac9f3a0f) SHA1(0e44888dc046121794e824d128628f991245c1cb), "prom1.cpu",
                   CRC(4a2f185c) SHA1(b45982b1ce9777292731ad523516c76cde4ddfa4))
GTS80BSSOUND888("drom1.snd", CRC(758e1743) SHA1(6df3011c044796afcd88e52d1ca69692cb489ff4), "yrom1.snd",
                CRC(4869b0ec) SHA1(b8a56753257205af56e06105515b8a700bb1935b), "yrom2.snd",
                CRC(0528c024) SHA1(d24ff7e088b08c1f35b54be3c806f8a8757d96c7))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(genesifp, "prom2.cpu", CRC(ac9f3a0f) SHA1(0e44888dc046121794e824d128628f991245c1cb), "prom1_fp.cpu",
                   CRC(662722b1) SHA1(1a7cf2f6cf92b5e6a288272ff785f215b241842f))
GTS80BSSOUND888("drom1.snd", CRC(758e1743) SHA1(6df3011c044796afcd88e52d1ca69692cb489ff4), "yrom1.snd",
                CRC(4869b0ec) SHA1(b8a56753257205af56e06105515b8a700bb1935b), "yrom2.snd",
                CRC(0528c024) SHA1(d24ff7e088b08c1f35b54be3c806f8a8757d96c7))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(genesisg, "prom2g.cpu", CRC(e8fc30af) SHA1(2401bff3cf566cae4e6de6167fa004c5fe232928), "prom1g.cpu",
                   CRC(68a27ec1) SHA1(b14a933e6c7e2972faef8dfecebabe3da4021367))
GTS80BSSOUND888("drom1.snd", CRC(758e1743) SHA1(6df3011c044796afcd88e52d1ca69692cb489ff4), "yrom1.snd",
                CRC(4869b0ec) SHA1(b8a56753257205af56e06105515b8a700bb1935b), "yrom2.snd",
                CRC(0528c024) SHA1(d24ff7e088b08c1f35b54be3c806f8a8757d96c7))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(genesisf, "prom2f.cpu", CRC(ea7f824f) SHA1(45f619153e0584cffd33e6e09e6f5a97ab9522b2), "prom1f.cpu",
                   CRC(e7ef875b) SHA1(37ac83d9a75ce604c5a4173ce918beb64f75cd3e))
GTS80BSSOUND888("drom1.snd", CRC(758e1743) SHA1(6df3011c044796afcd88e52d1ca69692cb489ff4), "yrom1.snd",
                CRC(4869b0ec) SHA1(b8a56753257205af56e06105515b8a700bb1935b), "yrom2.snd",
                CRC(0528c024) SHA1(d24ff7e088b08c1f35b54be3c806f8a8757d96c7))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(goldwing, "prom2.cpu", CRC(a5318c20) SHA1(8b4dcf45b13657ff753237a2e7d0352fda7755ef), "prom1.cpu",
                   CRC(bf242185) SHA1(0bf231050aa29f8bba5cb478a815b3d83bad93b3))
GTS80BSSOUND888("drom1.snd", CRC(892dbb21) SHA1(e24611544693e95dd2b9c0f2532c4d1f0b8ac10c), "yrom1.snd",
                CRC(e17e9b1f) SHA1(ada9a6139a13ef31173801d560ec732d5a285140), "yrom2.snd",
                CRC(4e482023) SHA1(62e97d229eb28ff67f0ebc4ee04c1b4918a4affe))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(goldwgfp, "prom2.cpu", CRC(a5318c20) SHA1(8b4dcf45b13657ff753237a2e7d0352fda7755ef), "prom1_fp.cpu",
                   CRC(58f19602) SHA1(b17c7aadcb314e6639446ed08de7666f5ea3dd66))
GTS80BSSOUND888("drom1.snd", CRC(892dbb21) SHA1(e24611544693e95dd2b9c0f2532c4d1f0b8ac10c), "yrom1.snd",
                CRC(e17e9b1f) SHA1(ada9a6139a13ef31173801d560ec732d5a285140), "yrom2.snd",
                CRC(4e482023) SHA1(62e97d229eb28ff67f0ebc4ee04c1b4918a4affe))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(gldwingg, "prom2g.cpu", CRC(f69c963c) SHA1(9e39344ecfcca1115e12c559c66eaa21716c0ce2), "prom1g.cpu",
                   CRC(a9349b2f) SHA1(836c86d8db8be5ac29013bbe4daec8d96d15fba0))
GTS80BSSOUND888("drom1.snd", CRC(892dbb21) SHA1(e24611544693e95dd2b9c0f2532c4d1f0b8ac10c), "yrom1.snd",
                CRC(e17e9b1f) SHA1(ada9a6139a13ef31173801d560ec732d5a285140), "yrom2.snd",
                CRC(4e482023) SHA1(62e97d229eb28ff67f0ebc4ee04c1b4918a4affe))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(gldwingf, "prom2f.cpu", CRC(50337adf) SHA1(dc286d52e6872edd68af442cbd0442babc174b93), "prom1f.cpu",
                   CRC(ec046fc0) SHA1(856f09f420e0f37488b0a896a37fffad62f18d6d))
GTS80BSSOUND888("drom1.snd", CRC(892dbb21) SHA1(e24611544693e95dd2b9c0f2532c4d1f0b8ac10c), "yrom1.snd",
                CRC(e17e9b1f) SHA1(ada9a6139a13ef31173801d560ec732d5a285140), "yrom2.snd",
                CRC(4e482023) SHA1(62e97d229eb28ff67f0ebc4ee04c1b4918a4affe))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(mntecrlo, "prom2.cpu", CRC(6860e315) SHA1(cecb1815334506dfebf29efe3e4e2a838010e8db), "prom1.cpu",
                   CRC(0fbf15a3) SHA1(0155b39c2c38224301857313ab784c1d39f1183b))
GTS80BSSOUND888("drom1.snd", CRC(1a53ac15) SHA1(f2751664a09431e908873580ddf4f44df9b4eda7), "yrom1.snd",
                CRC(6e234c49) SHA1(fdb4126ecdaac378d144e9dd3c29b4e79290da2a), "yrom2.snd",
                CRC(a95d1a6b) SHA1(91946ef7af0e4dd96db6d2d6f4f2e9a3a7279b81))
GTS80_ROMEND
#define input_ports_mntecrlo input_ports_gts80
CORE_GAMEDEFNV(mntecrlo, "Monte Carlo", 1987, "Gottlieb", gl_mGTS80BS1, 0)

GTS80B_2K_ROMSTART(mntecrfp, "prom2.cpu", CRC(6860e315) SHA1(cecb1815334506dfebf29efe3e4e2a838010e8db), "prom1_fp.cpu",
                   CRC(5b703cf8) SHA1(dfb3eb886675989a1bbae7a2581e522869d81392))
GTS80BSSOUND888("drom1.snd", CRC(1a53ac15) SHA1(f2751664a09431e908873580ddf4f44df9b4eda7), "yrom1.snd",
                CRC(6e234c49) SHA1(fdb4126ecdaac378d144e9dd3c29b4e79290da2a), "yrom2.snd",
                CRC(a95d1a6b) SHA1(91946ef7af0e4dd96db6d2d6f4f2e9a3a7279b81))
GTS80_ROMEND
...
// #708Y
GTS80B_2K_ROMSTART(mntecrlg, "prom2g.cpu", CRC(2a5e0c4f) SHA1(b386168bd911b9977104c47da962d0248f22614b), "prom1g.cpu",
                   CRC(25e015f1) SHA1(4b1467438def657eac3b8a858d7b17c102e14f0d))
GTS80BSSOUND888("drom1.snd", CRC(1a53ac15) SHA1(f2751664a09431e908873580ddf4f44df9b4eda7), "yrom1.snd",
                CRC(6e234c49) SHA1(fdb4126ecdaac378d144e9dd3c29b4e79290da2a), "yrom2.snd",
                CRC(a95d1a6b) SHA1(91946ef7af0e4dd96db6d2d6f4f2e9a3a7279b81))
GTS80_ROMEND
...
CORE_CLONEDEFNV(mntcrgmfp, mntecrlo, "Monte Carlo (German Millions option, Free Play)", 2021, "Flipprojets",
                gl_mGTS80BS1, 0)

// #708X
GTS80B_2K_ROMSTART(mntecrlf, "prom2f.cpu", CRC(f6842631) SHA1(7447994d2055c7fa12aaf35e93436ee829f5b7ae), "prom1f.cpu",
                   CRC(33a8dbc9) SHA1(5ef586e2b1ba7f245723584bc14c60c2860d19fc))
GTS80BSSOUND888("drom1.snd", CRC(1a53ac15) SHA1(f2751664a09431e908873580ddf4f44df9b4eda7), "yrom1.snd",
                CRC(6e234c49) SHA1(fdb4126ecdaac378d144e9dd3c29b4e79290da2a), "yrom2.snd",
                CRC(a95d1a6b) SHA1(91946ef7af0e4dd96db6d2d6f4f2e9a3a7279b81))
GTS80_ROMEND
...
CORE_CLONEDEFNV(mntcrfmfp, mntecrlo, "Monte Carlo (French Millions option, Free Play)", 2021, "Flipprojets",
                gl_mGTS80BS1, 0)

GTS80B_2K_ROMSTART(mntecrla, "prom2a.cpu", CRC(5dd75c06) SHA1(911f7e56b7602c9bc9b51dde7719d3e0562f0702), "prom1a.cpu",
                   CRC(de980755) SHA1(0df99526a432e26fb73288b529dc0f4f49623e81))
GTS80BSSOUND888("drom1.snd", CRC(1a53ac15) SHA1(f2751664a09431e908873580ddf4f44df9b4eda7), "yrom1.snd",
                CRC(6e234c49) SHA1(fdb4126ecdaac378d144e9dd3c29b4e79290da2a), "yrom2.snd",
                CRC(a95d1a6b) SHA1(91946ef7af0e4dd96db6d2d6f4f2e9a3a7279b81))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(mntecrl2, "prom2_2.cpu", CRC(8e72a68f) SHA1(8320c44020f7d5f9e887b17556252f1c617235ac), "prom1_2.cpu",
                   CRC(9bd6a010) SHA1(680ce076452ab3fd911fa58fc48c07ea2ec793da))
GTS80BSSOUND888("drom1.snd", CRC(1a53ac15) SHA1(f2751664a09431e908873580ddf4f44df9b4eda7), "yrom1.snd",
                CRC(6e234c49) SHA1(fdb4126ecdaac378d144e9dd3c29b4e79290da2a), "yrom2.snd",
                CRC(a95d1a6b) SHA1(91946ef7af0e4dd96db6d2d6f4f2e9a3a7279b81))
GTS80_ROMEND
...
CORE_CLONEDEFNV(mntcrmfp, mntecrlo, "Monte Carlo (rev. 2 Millions option, Free Play)", 2021, "Flipprojets",
                gl_mGTS80BS1, 0)
...
GTS80B_2K_ROMSTART(sprbreak, "prom2.cpu", CRC(47171062) SHA1(0d2e7777f695ab22170be861019c05ddeade5f85), "prom1.cpu",
                   CRC(53ed608b) SHA1(555a6c02d637ea03e8265bb2b0fba95f2e2584b3))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
#define input_ports_sprbreak input_ports_gts80
CORE_GAMEDEFNV(sprbreak, "Spring Break", 1987, "Gottlieb", gl_mGTS80BS1, 0)

GTS80B_2K_ROMSTART(sprbrkfp, "prom2.cpu", CRC(47171062) SHA1(0d2e7777f695ab22170be861019c05ddeade5f85), "prom1_fp.cpu",
                   CRC(2424a214) SHA1(d4d48082652e99731833fbb57a1c04fea6b564b0))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
...
// #706Y
GTS80B_2K_ROMSTART(sprbrkg, "prom2g.cpu", CRC(fa4b750d) SHA1(89f797f65fc18473419080810bca4590f77e2502), "prom1g.cpu",
                   CRC(2d9c4640) SHA1(3671a962334f5c84ae2635891ee90c62be69da5c))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
...
// #706X
GTS80B_2K_ROMSTART(sprbrkf, "prom2f.cpu", CRC(c0ee0555) SHA1(3d2aef5a8a6452f9f87b4ec2040643dda5843ebd), "prom1f.cpu",
                   CRC(608cf4d5) SHA1(41193eb036da7c7d05f313d1a68723504a7a90f4))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(sprbrka, "prom2a.cpu", CRC(d9d841b4) SHA1(8b9773e5ae9917d27089deca3b8311cb74e7f88e), "prom1a.cpu",
                   CRC(93db71e9) SHA1(59f75c4ef2c36b4f1f94dd365f2df82e7bcf53f8))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(sprbrks, "prom2.rv2", CRC(911cd14f) SHA1(2bc3ff6a3889da69b97f8ec318f93208e3d42cfe), "prom1.rv2",
                   CRC(d67d9d2f) SHA1(ebb82f0a1b7d6a2ec2607d4000e58fb6bfa73fe7))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(sprbrsfp, "prom2.rv2", CRC(911cd14f) SHA1(2bc3ff6a3889da69b97f8ec318f93208e3d42cfe), "prom1_fp.rv2",
                   CRC(dc956db7) SHA1(8bdb357c0a4c78967b4bb053f9d807897a28ad88))
GTS80BSSOUND888("drom1.snd", CRC(97d3f9ba) SHA1(1b34c7e51373c26d29d757c57a2b0333fe38d19e), "yrom1.snd",
                CRC(5ea89df9) SHA1(98ce7661a4d862fd02c77e69b0f6e9372c3ade2b), "yrom2.snd",
                CRC(0fb0128e) SHA1(3bdc5ed11b8e062f71f2a78b955830bd985e80a3))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(arena, "prom2.cpu", CRC(4783b689) SHA1(d10d4cbf8d00c9d0db57cdac32ef96498275eea6), "prom1.cpu",
                   CRC(8c9f8ee9) SHA1(840505d08e387c3f7de105305e183f8ed3a6d5c6))
GTS80BSSOUND888("drom1.snd", CRC(78e6cbf1) SHA1(7b66a0cb211a93cf475172aa0465a952009e1a59), "yrom1.snd",
                CRC(f7a951c2) SHA1(12d7a6119d9033ae02c6312c9af888bfc7c63ad1), "yrom2.snd",
                CRC(cc2aef4e) SHA1(a6e243de99f6a76eb527e879f4441c036dd379b6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(arena_fp, "prom2.cpu", CRC(4783b689) SHA1(d10d4cbf8d00c9d0db57cdac32ef96498275eea6), "prom1_fp.cpu",
                   CRC(33ade406) SHA1(daea04b9ccd95b2e4ee3d45ad8ea6e1851cf8cc6))
GTS80BSSOUND888("drom1.snd", CRC(78e6cbf1) SHA1(7b66a0cb211a93cf475172aa0465a952009e1a59), "yrom1.snd",
                CRC(f7a951c2) SHA1(12d7a6119d9033ae02c6312c9af888bfc7c63ad1), "yrom2.snd",
                CRC(cc2aef4e) SHA1(a6e243de99f6a76eb527e879f4441c036dd379b6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(arenag, "prom2g.cpu", CRC(e170d1cd) SHA1(bd7919eb9e480309f794ac25a371c7b818dcd01b), "prom1g.cpu",
                   CRC(71fd6e48) SHA1(5c87ba79968085d386fd1357c9d8b2b7a745682a))
GTS80BSSOUND888("drom1.snd", CRC(78e6cbf1) SHA1(7b66a0cb211a93cf475172aa0465a952009e1a59), "yrom1.snd",
                CRC(f7a951c2) SHA1(12d7a6119d9033ae02c6312c9af888bfc7c63ad1), "yrom2.snd",
                CRC(cc2aef4e) SHA1(a6e243de99f6a76eb527e879f4441c036dd379b6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(arenaf, "prom2f.cpu", CRC(49b127d8) SHA1(0436f83e969b4bfc7edaf881bf7556a868c88cdc), "prom1f.cpu",
                   CRC(391fb7de) SHA1(ec47a6e057d18a0043afccb694c23d0fa0d42aa0))
GTS80BSSOUND888("drom1.snd", CRC(78e6cbf1) SHA1(7b66a0cb211a93cf475172aa0465a952009e1a59), "yrom1.snd",
                CRC(f7a951c2) SHA1(12d7a6119d9033ae02c6312c9af888bfc7c63ad1), "yrom2.snd",
                CRC(cc2aef4e) SHA1(a6e243de99f6a76eb527e879f4441c036dd379b6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(arenaa, "prom2a.cpu", CRC(13c8813b) SHA1(756e3583fd55b72e0bfb15e9b4a60740b389ca2e), "prom1a.cpu",
                   CRC(253eceb1) SHA1(b46ccec4b3e8fc57fb3295b675b4f27dafc0322e))
GTS80BSSOUND888("drom1.snd", CRC(78e6cbf1) SHA1(7b66a0cb211a93cf475172aa0465a952009e1a59), "yrom1.snd",
                CRC(f7a951c2) SHA1(12d7a6119d9033ae02c6312c9af888bfc7c63ad1), "yrom2.snd",
                CRC(cc2aef4e) SHA1(a6e243de99f6a76eb527e879f4441c036dd379b6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(victory, "prom2.cpu", CRC(6a42eaf4) SHA1(3e28b01473266db463986a4283e1be85f2410fb1), "prom1.cpu",
                   CRC(e724db90) SHA1(10e760e129ce89f11372c6dd3616216d45f2c926))
GTS80BSSOUND3232("drom1.snd", CRC(4ab6dab7) SHA1(7e21e69029e60052112ddd5c7481582ea6684dc1), "yrom1.snd",
                 CRC(921a100e) SHA1(0c3c7eae4ceeb5a1a8150bac52203d3f1e8f917e))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(victryfp, "prom2.cpu", CRC(6a42eaf4) SHA1(3e28b01473266db463986a4283e1be85f2410fb1), "prom1_fp.cpu",
                   CRC(3eba52ec) SHA1(e3cbdd803373e614c5b9bb5e61c9e2dfcf25df6c))
GTS80BSSOUND3232("drom1.snd", CRC(4ab6dab7) SHA1(7e21e69029e60052112ddd5c7481582ea6684dc1), "yrom1.snd",
                 CRC(921a100e) SHA1(0c3c7eae4ceeb5a1a8150bac52203d3f1e8f917e))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(victoryg, "prom2g.cpu", CRC(b191a87a) SHA1(f205ffb41c5ba34e3cefc96ca870a5d08bee8854), "prom1g.cpu",
                   CRC(097b9062) SHA1(e7f05084b36f84b9948702ba297700473386ae6d))
GTS80BSSOUND3232("drom1.snd", CRC(4ab6dab7) SHA1(7e21e69029e60052112ddd5c7481582ea6684dc1), "yrom1.snd",
                 CRC(921a100e) SHA1(0c3c7eae4ceeb5a1a8150bac52203d3f1e8f917e))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(victoryf, "prom2f.cpu", CRC(dffcfa77) SHA1(3efaca85295ca55268b8d7c7cfe8f09f159d5fbd), "prom1f.cpu",
                   CRC(d3a9df20) SHA1(7e0a97a4c1b488af89959cbaa693e23302479d0a))
GTS80BSSOUND3232("drom1.snd", CRC(4ab6dab7) SHA1(7e21e69029e60052112ddd5c7481582ea6684dc1), "yrom1.snd",
                 CRC(921a100e) SHA1(0c3c7eae4ceeb5a1a8150bac52203d3f1e8f917e))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(diamond, "prom2.cpu", CRC(862951dc) SHA1(b15899ecf7ec869e3722cef3f5c16b0dadd2514e), "prom1.cpu",
                   CRC(7a011757) SHA1(cc49ec7451feae035670ea9d70cc8f6b32747c90))
GTS80BSSOUND3232("drom1.snd", CRC(c216d1e4) SHA1(aa38db5ad36d1d1d35e727ab27c1f1c05a9627cd), "yrom1.snd",
                 CRC(0a18d626) SHA1(6b367668be55ca04c69c4c4c5a4a524ae8f790f8))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(diamonfp, "prom2.cpu", CRC(862951dc) SHA1(b15899ecf7ec869e3722cef3f5c16b0dadd2514e), "prom1_fp.cpu",
                   CRC(eef4da86) SHA1(74b274adfddc29fed91d00af52fc4e477b571fe8))
GTS80BSSOUND3232("drom1.snd", CRC(c216d1e4) SHA1(aa38db5ad36d1d1d35e727ab27c1f1c05a9627cd), "yrom1.snd",
                 CRC(0a18d626) SHA1(6b367668be55ca04c69c4c4c5a4a524ae8f790f8))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(diamondg, "prom2g.cpu", CRC(f0ef69f6) SHA1(1f48bb656bb20073e2ff261199cb94919f0bb2ab), "prom1g.cpu",
                   CRC(961cfdf9) SHA1(97135f77705969736f704acdeda6157bb765c73e))
GTS80BSSOUND3232("drom1.snd", CRC(c216d1e4) SHA1(aa38db5ad36d1d1d35e727ab27c1f1c05a9627cd), "yrom1.snd",
                 CRC(0a18d626) SHA1(6b367668be55ca04c69c4c4c5a4a524ae8f790f8))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(diamondf, "prom2f.cpu", CRC(943019a8) SHA1(558c3696339bb6e150b4ddb499bc60897d5954ec), "prom1f.cpu",
                   CRC(479b0267) SHA1(a9586c5b2cc3561ba3409123eca5a73ebabfd823))
GTS80BSSOUND3232("drom1.snd", CRC(c216d1e4) SHA1(aa38db5ad36d1d1d35e727ab27c1f1c05a9627cd), "yrom1.snd",
                 CRC(0a18d626) SHA1(6b367668be55ca04c69c4c4c5a4a524ae8f790f8))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(txsector, "prom2.cpu", CRC(f12514e6) SHA1(80bca17c33df99ed1a7acc21f7f70ea90e7c0463), "prom1.cpu",
                   CRC(e51d39da) SHA1(b6e4d573b62cc441a153cc4d8b647ee46b4dd2a7))
GTS80BSSOUND3232("drom1.snd", CRC(61d66ca1) SHA1(59b1705b13d46b29f45257c566274f3cdce15ec2), "yrom1.snd",
                 CRC(469ef444) SHA1(faa16f34357a53c3fc61b59251fabdc44c605000))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(txsectfp, "prom2.cpu", CRC(f12514e6) SHA1(80bca17c33df99ed1a7acc21f7f70ea90e7c0463), "prom1_fp.cpu",
                   CRC(13283b01) SHA1(e4e0602ead0ec4d4f54a39df3d08b1aaeb92f1ca))
GTS80BSSOUND3232("drom1.snd", CRC(61d66ca1) SHA1(59b1705b13d46b29f45257c566274f3cdce15ec2), "yrom1.snd",
                 CRC(469ef444) SHA1(faa16f34357a53c3fc61b59251fabdc44c605000))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(txsectrg, "prom2g.cpu", CRC(2b17261f) SHA1(a3195190c0d5116b60e487a7b7f3a28c1f110e89), "prom1g.cpu",
                   CRC(83ea2f11) SHA1(ac3570597512c71c099aa15f0750a12a3e206b83))
GTS80BSSOUND3232("drom1.snd", CRC(61d66ca1) SHA1(59b1705b13d46b29f45257c566274f3cdce15ec2), "yrom1.snd",
                 CRC(469ef444) SHA1(faa16f34357a53c3fc61b59251fabdc44c605000))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(txsectrf, "prom2f.cpu", CRC(1bd08247) SHA1(968cc30e5e5c783e73cb3278a58189c4f8b8186f), "prom1f.cpu",
                   CRC(8df27155) SHA1(67aeeab0d50e43674082e1dd99a849db64ba00b2))
GTS80BSSOUND3232("drom1.snd", CRC(61d66ca1) SHA1(59b1705b13d46b29f45257c566274f3cdce15ec2), "yrom1.snd",
                 CRC(469ef444) SHA1(faa16f34357a53c3fc61b59251fabdc44c605000))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(robowars, "prom2.cpu", CRC(893177ed) SHA1(791540a64d498979e5b0c8baf4ceb2fd5ff7f047), "prom1.cpu",
                   CRC(cd1587d8) SHA1(77e8e02dc03d052e9e4ce19c9431439e4211a29f))
GTS80BSSOUND3232("drom1.snd", CRC(ea59b6a1) SHA1(6a4cdd37ba85f94f703afd1c5d3f102f51fedf46), "yrom1.snd",
                 CRC(7ecd8b67) SHA1(c5167b0acc64e535d389ba70be92a65672e119f6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(robowrfp, "prom2.cpu", CRC(893177ed) SHA1(791540a64d498979e5b0c8baf4ceb2fd5ff7f047), "prom1_fp.cpu",
                   CRC(96da77eb) SHA1(402208f5ac52d8f1e7193bf7c86faa106afe3492))
GTS80BSSOUND3232("drom1.snd", CRC(ea59b6a1) SHA1(6a4cdd37ba85f94f703afd1c5d3f102f51fedf46), "yrom1.snd",
                 CRC(7ecd8b67) SHA1(c5167b0acc64e535d389ba70be92a65672e119f6))
GTS80_ROMEND
...
GTS80B_2K_ROMSTART(robowarf, "prom2f.cpu", CRC(1afa0e69) SHA1(178813494b877ac9ca36863661596b4df04df1bb), "prom1f.cpu",
                   CRC(263cb8f9) SHA1(ba27ca0618b9ed68c258a654bdd00a24f8413239))
GTS80BSSOUND3232("drom1.snd", CRC(ea59b6a1) SHA1(6a4cdd37ba85f94f703afd1c5d3f102f51fedf46), "yrom1.snd",
                 CRC(7ecd8b67) SHA1(c5167b0acc64e535d389ba70be92a65672e119f6))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(excaliba, "prom2.cpu", CRC(082d64ab) SHA1(0eae3b549839fc281d2487d483d0b4e723ebdc48), "prom1.cpu",
                   CRC(e8902c16) SHA1(c3e4ece6be7027a4deef052ba4be752070e9b542))
GTS80BSSOUND3232("drom1.snd", CRC(a4368cd0) SHA1(c48513e56899938dc83a3545d8ee9def3dc1491f), "yrom1.snd",
                 CRC(9f194744) SHA1(dbd73b546071c3d4f0dcfe21e3e646da716c5b71))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(excalbfp, "prom2.cpu", CRC(082d64ab) SHA1(0eae3b549839fc281d2487d483d0b4e723ebdc48), "prom1_fp.cpu",
                   CRC(86cf464b) SHA1(c857187e6f3dd1f5b5013c95d3ded8a9a5a2e485))
GTS80BSSOUND3232("drom1.snd", CRC(a4368cd0) SHA1(c48513e56899938dc83a3545d8ee9def3dc1491f), "yrom1.snd",
                 CRC(9f194744) SHA1(dbd73b546071c3d4f0dcfe21e3e646da716c5b71))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(excalibg, "prom2g.cpu", CRC(49079396) SHA1(92361a87464e39afeb74fe531b7d4356323405b8), "prom1g.cpu",
                   CRC(504fad7a) SHA1(6648778d537161e9bdcf2955209e1525e90a3617))
GTS80BSSOUND3232("drom1.snd", CRC(a4368cd0) SHA1(c48513e56899938dc83a3545d8ee9def3dc1491f), "yrom1.snd",
                 CRC(9f194744) SHA1(dbd73b546071c3d4f0dcfe21e3e646da716c5b71))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(excalibr, "prom2f.cpu", CRC(499e2e41) SHA1(1e3fcba18882bd7df30a43843916aa5d7968eecc), "prom1f.cpu",
                   CRC(ed1083d7) SHA1(3ff829ecfaba7d20c75268d3ee5224cb3cac3507))
GTS80BSSOUND3232("drom1.snd", CRC(a4368cd0) SHA1(c48513e56899938dc83a3545d8ee9def3dc1491f), "yrom1.snd",
                 CRC(9f194744) SHA1(dbd73b546071c3d4f0dcfe21e3e646da716c5b71))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(badgirls, "prom2.cpu", CRC(583933ec) SHA1(89da6750d779d68db578715b058f9321695b79b0), "prom1.cpu",
                   CRC(956aeae0) SHA1(24d9d514fc83aba1ab310bfe4ed80605df399417))
GTS80BSSOUND3232("drom1.snd", CRC(452dec20) SHA1(a9c41dfb2d83c5671ab96e946f13df774b567976), "yrom1.snd",
                 CRC(ab3b8e2d) SHA1(b57a0b804b42b923bb102d295e3b8a69b1033d27))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(badgrlfp, "prom2.cpu", CRC(583933ec) SHA1(89da6750d779d68db578715b058f9321695b79b0), "prom1_fp.cpu",
                   CRC(05e8259b) SHA1(d1e4e50e44e215dcfa510e4d45d6c39e136452b1))
GTS80BSSOUND3232("drom1.snd", CRC(452dec20) SHA1(a9c41dfb2d83c5671ab96e946f13df774b567976), "yrom1.snd",
                 CRC(ab3b8e2d) SHA1(b57a0b804b42b923bb102d295e3b8a69b1033d27))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(badgirlg, "prom2g.cpu", CRC(55aa30ac) SHA1(9544485ccf52a2ad51a00cce0c12871db099699f), "prom1g.cpu",
                   CRC(f2923255) SHA1(645b62d015e3a4feaf485c600eb345824f551b9e))
GTS80BSSOUND3232("drom1.snd", CRC(452dec20) SHA1(a9c41dfb2d83c5671ab96e946f13df774b567976), "yrom1.snd",
                 CRC(ab3b8e2d) SHA1(b57a0b804b42b923bb102d295e3b8a69b1033d27))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(badgirlf, "prom2f.cpu", CRC(58c35099) SHA1(ff76bd28175ea0f5d0437c16c5ae6886339edfe2), "prom1f.cpu",
                   CRC(9861147a) SHA1(e9d31cd1130bc1785db26c23f52944842fdd4ca0))
GTS80BSSOUND3232("drom1.snd", CRC(452dec20) SHA1(a9c41dfb2d83c5671ab96e946f13df774b567976), "yrom1.snd",
                 CRC(ab3b8e2d) SHA1(b57a0b804b42b923bb102d295e3b8a69b1033d27))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(bighouse, "prom2.cpu", CRC(047c8ef5) SHA1(3afa2a0011b724836b69b2ef386597e0953dfadf), "prom1.cpu",
                   CRC(0ecef900) SHA1(78e4ed6e40fdb45dde2d0f2cf60d4c8a7ea2e39e))
GTS80BSSOUND3232("drom1.snd", CRC(f330fd04) SHA1(1288c47f636d9d5b826a2b870b81788a630e489e), "yrom1.snd",
                 CRC(0b1ba1cb) SHA1(26327689992018837b1c9957c515ab67248623eb))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(bighosfp, "prom2.cpu", CRC(047c8ef5) SHA1(3afa2a0011b724836b69b2ef386597e0953dfadf), "prom1_fp.cpu",
                   CRC(8a8510a2) SHA1(729a7254d00fee7c4aa29684e944df4eab113565))
GTS80BSSOUND3232("drom1.snd", CRC(f330fd04) SHA1(1288c47f636d9d5b826a2b870b81788a630e489e), "yrom1.snd",
                 CRC(0b1ba1cb) SHA1(26327689992018837b1c9957c515ab67248623eb))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(bighousg, "prom2g.cpu", CRC(214f0afb) SHA1(9874773e4ffa2472e78d42dfa9e21a621bf7b49e), "prom1g.cpu",
                   CRC(374f3593) SHA1(e90d867fff28ee86f017b1b638bc26f1bcde6b81))
GTS80BSSOUND3232("drom1.snd", CRC(f330fd04) SHA1(1288c47f636d9d5b826a2b870b81788a630e489e), "yrom1.snd",
                 CRC(0b1ba1cb) SHA1(26327689992018837b1c9957c515ab67248623eb))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(bighousf, "prom2f.cpu", CRC(767efc44) SHA1(6b8f9a580e6a6ad92c9efe9f4345496d5063b7a8), "prom1f.cpu",
                   CRC(b87150bc) SHA1(2ebdf27ede3445ac99068c8cec712c06e57c7ffc))
GTS80BSSOUND3232("drom1.snd", CRC(f330fd04) SHA1(1288c47f636d9d5b826a2b870b81788a630e489e), "yrom1.snd",
                 CRC(0b1ba1cb) SHA1(26327689992018837b1c9957c515ab67248623eb))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(hotshots, "prom2.cpu", CRC(7695c7db) SHA1(90188ff83b888262ba849e5af9d99145c5bc1c30), "prom1.cpu",
                   CRC(122ff4a8) SHA1(195392b9f2050b52392a123831bb7a9428087c1b))
GTS80BSSOUND3232("drom1.snd", CRC(42c3cc3d) SHA1(26ca7f3a71b83df18ac6be1d1eb28da20120285e), "yrom1.snd",
                 CRC(2933a80e) SHA1(5982b9ed361d90f8ea47047fc29770ef142acbec))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(hotshtfp, "prom2.cpu", CRC(7695c7db) SHA1(90188ff83b888262ba849e5af9d99145c5bc1c30), "prom1_fp.cpu",
                   CRC(74c0f7d7) SHA1(7af87d03fb604e7192ff4ee7581c034e8b2556da))
GTS80BSSOUND3232("drom1.snd", CRC(42c3cc3d) SHA1(26ca7f3a71b83df18ac6be1d1eb28da20120285e), "yrom1.snd",
                 CRC(2933a80e) SHA1(5982b9ed361d90f8ea47047fc29770ef142acbec))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(hotshotg, "prom2g.cpu", CRC(7e2f0d59) SHA1(b8a7b9be3e4d705631e017da87b27be53ed23f30), "prom1g.cpu",
                   CRC(e07b46ad) SHA1(c7b48dcfb074f3d0f38a6d49028ba172946467fc))
GTS80BSSOUND3232("drom1.snd", CRC(42c3cc3d) SHA1(26ca7f3a71b83df18ac6be1d1eb28da20120285e), "yrom1.snd",
                 CRC(2933a80e) SHA1(5982b9ed361d90f8ea47047fc29770ef142acbec))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(hotshotf, "prom2f.cpu", CRC(476e260c) SHA1(2b88920c77462d190f9b98aebf8fcb5c9e853ecd), "prom1f.cpu",
                   CRC(8d74aca7) SHA1(c25b015ad8a6fa142c7cb46e2ac0229eb00289cf))
GTS80BSSOUND3232("drom1.snd", CRC(42c3cc3d) SHA1(26ca7f3a71b83df18ac6be1d1eb28da20120285e), "yrom1.snd",
                 CRC(2933a80e) SHA1(5982b9ed361d90f8ea47047fc29770ef142acbec))
GTS80_ROMEND
...
GTS80B_4K_ROMSTART(bonebstr, "prom2.cpu", CRC(681643df) SHA1(76af6951e4403b4951298d35a9058bcebfa6bc43), "prom1.cpu",
                   CRC(052f97be) SHA1(0ee108e79c4196dffedc64d7f7a576e0394427c1))
...
static MACHINE_DRIVER_START(manila) MDRV_IMPORT_FROM(gts80) MDRV_CPU_MODIFY("mcpu")
    MDRV_CPU_MEMORY(manila_readmem, manila_writemem) MDRV_NVRAM_HANDLER(generic_0fill) MDRV_SCREEN_SIZE(320, 200)
        MDRV_VISIBLE_AREA(0, 319, 0, 199) MDRV_IMPORT_FROM(gts80s_b1) MACHINE_DRIVER_END

    /*-------------------------------------------------------------------
/ Top Sound (1988)
/-------------------------------------------------------------------*/
    INITGAME(topsound, GEN_GTS80B, FLIP616, dispAlpha, SNDBRD_GTS80B, GTS80_DISPALPHA, 0) ROM_START(topsound)
        NORMALREGION(0x10000, GTS80_MEMREG_CPU)
    ...
    GTS80BSSOUND888("drom1a.snd", CRC(b8aa8912) SHA1(abff690256c0030807b2d4dfa0516496516384e8), "yrom1a.snd",
                    CRC(a62e3b94) SHA1(59636c2ac7ebbd116a0eb39479c97299ba391906), "yrom2a.snd",
                    CRC(66645a3f) SHA1(f06261af81e6b1829d639933297d2461a8c993fc)) GTS80_ROMEND
...
/ Master (1988)
/-------------------------------------------------------------------*/
    INITGAME(mmmaster, GEN_GTS80B, FLIP616, dispAlpha, SNDBRD_GTS80B, GTS80_DISPALPHA, 0) ROM_START(mmmaster)
        NORMALREGION(0x10000, GTS80_MEMREG_CPU)
    ...
    GTS80BSSOUND888("drom.snd", CRC(758e1743) SHA1(6df3011c044796afcd88e52d1ca69692cb489ff4), // Genesis sound roms
                    "yrom1.snd", CRC(4869b0ec) SHA1(b8a56753257205af56e06105515b8a700bb1935b), "yrom2.snd",
                    CRC(0528c024) SHA1(d24ff7e088b08c1f35b54be3c806f8a8757d96c7)) GTS80_ROMEND
