...
#define S11_COMPORTS                                                                                                   \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        ...
        COREPORT_BIT(0x0100, "Advance", KEYCODE_8) COREPORT_BITTOG(0x0200, "Up/Down", KEYCODE_7)                       \
            COREPORT_BIT(0x0400, "CPU Diagnostic", KEYCODE_9) COREPORT_BIT(0x0800, "Sound Diagnostic", KEYCODE_0)      \
                PORT_START /* 1 */                                                                                     \
                    COREPORT_DIPNAME(0x0001, 0x0000, "Country") COREPORT_DIPSET(0x0001, "Germany")                     \
...
#define DE_COMPORTS                                                                                                    \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0001, IPT_TILT, KEYCODE_INSERT) COREPORT_BIT(0x0002, "Ball Tilt", KEYCODE_2)                 \
            COREPORT_BITDEF(0x0004, IPT_START1, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0008, IPT_COIN1, IP_KEY_DEFAULT)     \
                COREPORT_BITDEF(0x0010, IPT_COIN2, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0020, IPT_COIN3, KEYCODE_3)       \
                    COREPORT_BIT(0x0040, "Slam Tilt", KEYCODE_HOME) /* These are put in switch column 0 */             \
        COREPORT_BIT(0x0100, "Black Button", KEYCODE_8) COREPORT_BITTOG(0x0200, "Green Button", KEYCODE_7)
    ...
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0001, IPT_TILT, KEYCODE_INSERT) COREPORT_BIT(0x0002, "Ball Tilt", KEYCODE_2)                 \
            COREPORT_BITDEF(0x0004, IPT_START1, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0008, IPT_COIN1, IP_KEY_DEFAULT)     \
                COREPORT_BITDEF(0x0010, IPT_COIN2, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0020, IPT_COIN3, KEYCODE_3)       \
                    COREPORT_BIT(0x0040, "Slam Tilt", KEYCODE_HOME) /* These are put in switch column 0 */             \
        COREPORT_BIT(0x0100, "Black Button", KEYCODE_8) COREPORT_BIT(0x0200, "Green Button", KEYCODE_7)
