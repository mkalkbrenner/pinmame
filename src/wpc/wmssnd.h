...
#define WPCS_ROMLOAD8(start, n, chk) ROM_LOAD(n, start, 0x80000, chk)
...
#define DCS_ROMLOADx(start, n, chk) ROM_LOAD(n, start, 0x080000, chk) ROM_RELOAD(start + 0x080000, 0x080000)
#define DCS_ROMLOADm(start, n, chk) ROM_LOAD(n, start, 0x100000, chk)
...
#define DCS_SOUNDROM2m(n2, chk2, n3, chk3)                                                                             \
    DCS_STDREG(0x200000)                                                                                               \
    DCS_ROMLOADm(0x000000, n2, chk2) DCS_ROMLOADm(0x100000, n3, chk3)

#define DCS_SOUNDROM3m(n2, chk2, n3, chk3, n4, chk4)                                                                   \
    DCS_STDREG(0x300000)                                                                                               \
    DCS_ROMLOADm(0x000000, n2, chk2) DCS_ROMLOADm(0x100000, n3, chk3) DCS_ROMLOADm(0x200000, n4, chk4)
...
#define DCS_SOUNDROM4xm(n2, chk2, n3, chk3, n4, chk4, n5, chk5)                                                        \
    DCS_STDREG(0x400000)                                                                                               \
    DCS_ROMLOADx(0x000000, n2, chk2) DCS_ROMLOADm(0x100000, n3, chk3) DCS_ROMLOADm(0x200000, n4, chk4)                 \
        DCS_ROMLOADm(0x300000, n5, chk5)
...
#define DCS_SOUNDROM5xm(n2, chk2, n3, chk3, n4, chk4, n5, chk5, n6, chk6)                                              \
    DCS_STDREG(0x500000)                                                                                               \
    DCS_ROMLOADx(0x000000, n2, chk2) DCS_ROMLOADm(0x100000, n3, chk3) DCS_ROMLOADm(0x200000, n4, chk4)                 \
        DCS_ROMLOADm(0x300000, n5, chk5) DCS_ROMLOADm(0x400000, n6, chk6)

#define DCS_SOUNDROM5x(n2, chk2, n3, chk3, n4, chk4, n5, chk5, n6, chk6)                                               \
    DCS_STDREG(0x500000)                                                                                               \
    DCS_ROMLOADx(0x000000, n2, chk2) DCS_ROMLOADx(0x100000, n3, chk3) DCS_ROMLOADx(0x200000, n4, chk4)                 \
        DCS_ROMLOADx(0x300000, n5, chk5) DCS_ROMLOADx(0x400000, n6, chk6)
...
#define DCS_SOUNDROM6x(n2, chk2, n3, chk3, n4, chk4, n5, chk5, n6, chk6, n7, chk7)                                     \
    DCS_STDREG(0x600000)                                                                                               \
    DCS_ROMLOADx(0x000000, n2, chk2) DCS_ROMLOADx(0x100000, n3, chk3) DCS_ROMLOADx(0x200000, n4, chk4)                 \
        DCS_ROMLOADx(0x300000, n5, chk5) DCS_ROMLOADx(0x400000, n6, chk6) DCS_ROMLOADx(0x500000, n7, chk7)

#define DCS_SOUNDROM6m(n2, chk2, n3, chk3, n4, chk4, n5, chk5, n6, chk6, n7, chk7)                                     \
    DCS_STDREG(0x600000)                                                                                               \
    DCS_ROMLOADm(0x000000, n2, chk2) DCS_ROMLOADm(0x100000, n3, chk3) DCS_ROMLOADm(0x200000, n4, chk4)                 \
        DCS_ROMLOADm(0x300000, n5, chk5) DCS_ROMLOADm(0x400000, n6, chk6) DCS_ROMLOADm(0x500000, n7, chk7)
...
#define DCS_SOUNDROM8x(n2, chk2, n3, chk3, n4, chk4, n5, chk5, n6, chk6, n7, chk7, n8, chk8, n9, chk9)                 \
    ...
    DCS_ROMLOADx(0x000000, n2, chk2) DCS_ROMLOADx(0x100000, n3, chk3) DCS_ROMLOADx(0x200000, n4, chk4)                 \
        DCS_ROMLOADx(0x300000, n5, chk5) DCS_ROMLOADx(0x400000, n6, chk6) DCS_ROMLOADx(0x500000, n7, chk7)             \
            DCS_ROMLOADx(0x600000, n8, chk8) DCS_ROMLOADx(0x700000, n9, chk9)
