...
#define CC_COMPORTS                                                                                                    \
    PORT_START /* 0 */ /* These are put in switch column 9 */                                                          \
        COREPORT_BIT(0x0040, "Start Game", KEYCODE_1) COREPORT_BIT(0x0001, "Coin #1", KEYCODE_3)                       \
            COREPORT_BIT(0x0002, "Coin #2", KEYCODE_4) COREPORT_BIT(0x0004, "Coin #3", KEYCODE_5)                      \
                COREPORT_BIT(0x0008, "Coin #4", KEYCODE_6)                                                             \
                    COREPORT_BITTOG(0x0080, "Coin Door", KEYCODE_7) /* These are put in switch column 0 */             \
        COREPORT_BIT(0x0400, "Buy In", KEYCODE_2) COREPORT_BIT(0x0200, "Tilt", KEYCODE_INSERT)                         \
            COREPORT_BIT(0x0100, "Slam Tilt", KEYCODE_HOME) COREPORT_BIT(0x0800, "Unused #1", KEYCODE_8)               \
                COREPORT_BIT(0x1000, "Unused #2", KEYCODE_9) COREPORT_BIT(0x2000, "Unused #3", KEYCODE_0)              \
                    COREPORT_BIT(0x4000, "Unused #4", KEYCODE_PGUP) COREPORT_BIT(0x8000, "Unused #5", KEYCODE_PGDN)
