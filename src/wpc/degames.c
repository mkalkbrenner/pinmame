...
#define INITGAMES11(name, gen, disptype, flippers, sb, db, gs1)                                                        \
    static core_tGameData name##GameData = {gen, disptype, {flippers, 0, 0, 0, sb, db, gs1}, NULL, {{0}}, {10}};       \
    static void init_##name(void) { core_gameData = &name##GameData; }

DE_INPUT_PORTS_START(des11, 1)
DE_INPUT_PORTS_END DE_INPUT_PORTS_START2(des112, 1) DE_INPUT_PORTS_END
...
#define FLIP6364 FLIP_SWNO(63, 64)
    ...
    static struct core_dispLayout de_dispAlpha1[] = {/* 2 X 7 AlphaNumeric Rows, 2 X 7 Numeric Rows, 1 X 4 Numeric*/
                                                     DISP_SEG_7(0, 0, CORE_SEG16),
                                                     DISP_SEG_7(0, 1, CORE_SEG16),
                                                     DISP_SEG_7(1, 0, CORE_SEG8),
                                                     DISP_SEG_7(1, 1, CORE_SEG8),
                                                     DISP_SEG_CREDIT(20, 28, CORE_SEG7),
                                                     DISP_SEG_BALLS(0, 8, CORE_SEG7),
                                                     {0}};
...
static struct core_dispLayout de_dispAlpha3[] = {/* 2 X 16 AlphaNumeric Rows */
                                                 DISP_SEG_16(0, CORE_SEG16),
                                                 DISP_SEG_16(1, CORE_SEG16),
                                                 {0}};

static struct core_dispLayout de_128x16DMD[] = {/* 128x16 DMD OUTPUT */
                                                {0, 0, 16, 128, CORE_DMD, (genf*)dedmd16_update, NULL},
                                                {0}};
...
static struct core_dispLayout de_192x64DMD[] = {/* 192x64 DMD OUTPUT */
                                                {0, 0, 64, 192, CORE_DMD, (genf*)dedmd64_update, NULL},
                                                {0}};
...
static core_tGameData trekGameData = {GEN_DEDMD16,
                                      de_128x16DMD,
...
DE_ROMSTARTx0(trek_201, "trekcpuu.201", CRC(ea0681fe) SHA1(282c8181e60da6358ef320358575a538aa4abe8c))
    DE_DMD16ROM2("trekdspa.109", CRC(a7e7d44d) SHA1(d26126310b8b316ca161d4202645de8fb6359822))
        DE2S_SOUNDROM022("trek.u7", CRC(f137abbb) SHA1(11731170ed4f04dd8af05d8f79ad727b0e0104d7), "trek.u17",
                         CRC(531545da) SHA1(905f34173db0e04eaf5236191186ea209b8a0a34), "trek.u21",
                         CRC(6107b004) SHA1(1f9bed9b06d5b19fbc0cc0bef2e493eb1a3f1aa4)) DE_ROMEND
        ...
        DE_ROMSTARTx0(trek_11a, "trekcpu.110", CRC(06e0f87b) SHA1(989d70e067cd322351768550549a4e2c8923132c))
            DE_DMD16ROM2("trekadsp.bin", CRC(54681627) SHA1(4251fa0568d2e869b44358471a3d4a4e88443954))
                DE2S_SOUNDROM022("trek.u7", CRC(f137abbb) SHA1(11731170ed4f04dd8af05d8f79ad727b0e0104d7), "trek.u17",
                                 CRC(531545da) SHA1(905f34173db0e04eaf5236191186ea209b8a0a34), "trek.u21",
                                 CRC(6107b004) SHA1(1f9bed9b06d5b19fbc0cc0bef2e493eb1a3f1aa4)) DE_ROMEND
    CORE_CLONEDEF(trek, 11a, 201, "Star Trek 25th Anniversary (1.10, Alpha Display)", 1992, "Data East", de_mDEDMD16S2A,
                  0)
        ...
        DE_ROMSTARTx0(trek_300, "trekcpuu.300", CRC(3859939e) SHA1(a453208a7640a39cb96947e8d3d3b2f71f85e613))
            DE_DMD16ROM2("trekdspa.300", CRC(d312f92e) SHA1(eebcc697b89bbe62b0450fdec6226a8396308f37))
                DE2S_SOUNDROM022("trek.u7", CRC(f137abbb) SHA1(11731170ed4f04dd8af05d8f79ad727b0e0104d7), "trek.u17",
                                 CRC(531545da) SHA1(905f34173db0e04eaf5236191186ea209b8a0a34), "trek.u21",
                                 CRC(6107b004) SHA1(1f9bed9b06d5b19fbc0cc0bef2e493eb1a3f1aa4)) DE_ROMEND
    CORE_CLONEDEF(trek, 300, 201, "Star Trek 25th Anniversary (3.00 unofficial MOD)", 2020, "Data East", de_mDEDMD16S2A,
                  0)
...
DE_ROMSTARTx0(hook_408, "hokcpua.408", CRC(46477fc7) SHA1(ce6228fd9ab4b6c774e128d291f50695746da358))
    DE_DMD16ROM2("hokdspa.401", CRC(59a07eb5) SHA1(d1ca41ce417f1772fe4da1eb37077f924b66ad36))
        DE2S_SOUNDROM022("hooksnd.u7", CRC(642f45b3) SHA1(a4b2084f32e52a596547384906281d04424332fc), "hook-voi.u17",
                         CRC(6ea9fcd2) SHA1(bffc66df542e06dedddaa403b5513446d9d6fc8c), "hook-voi.u21",
                         CRC(b5c275e2) SHA1(ff51c2007132a1310ac53b5ab2a4af7d0ab15948)) DE_ROMEND
        ...
        DE_ROMSTARTx0(hook_500, "hokcpua.500", CRC(93e25b12) SHA1(5ec37ad3358f1f093be771f5978f1ad8a7a7c61a))
            DE_DMD16ROM2("hokdspa.500", CRC(ed6a134b) SHA1(775975b629312f7f1151d878d40723ad4a79928c))
                DE2S_SOUNDROM022("hooksnd.u7", CRC(642f45b3) SHA1(a4b2084f32e52a596547384906281d04424332fc),
                                 ...
                                 "hook-voi.u21", CRC(b5c275e2) SHA1(ff51c2007132a1310ac53b5ab2a4af7d0ab15948)) DE_ROMEND
        ...
        DE_ROMSTARTx0(hook_401p, "hokcpua.401", CRC(20223298) SHA1(a8063765db947b059eadaad6654ed0c5cad9198d))
            DE_DMD16ROM2("hokdspa.401", CRC(59a07eb5) SHA1(d1ca41ce417f1772fe4da1eb37077f924b66ad36))
                DE2S_SOUNDROM022("hooksnd_p.u7", CRC(20091293) SHA1(fdfc4eadef0bf1915c7c72c1fd8dafaa429b3c44),
                                 ...
                                 "hook-voi_p.u21",
                                 CRC(04775416) SHA1(5675aea39b76178ff476b0f627223a1c75a3d6b7)) DE_ROMEND
...
/---------------------------------------------------------------*/
    INITGAMES11(lw3, GEN_DEDMD32, de_128x32DMD, FLIP1516, SNDBRD_DE2S, SNDBRD_DEDMD32, 0)
        DE_ROMSTARTx0(lw3_208, "lw3cpuu.208", CRC(a3041f8a) SHA1(3c5b8525b8e9b924590648429c56aaf97adee460))
            DE_DMD32ROM44("lw3drom1.a26", CRC(44a4cf81) SHA1(c7f3e3d5fbe930650e48423c8ba0ac484ce0640c), "lw3drom0.a26",
                          CRC(22932ed5) SHA1(395aa376cd8562de7956a6e34b8747e7cf81f935))
                DE2S_SOUNDROM022("lw3u7.dat", CRC(ba845ac3) SHA1(bb50413ace1885870cb3817edae478904b0eefb8),
                                 ...
                                 "lw3u21.dat", CRC(82bed051) SHA1(49ddc4190762d9b473fda270e0d6d88a4422d5d7)) DE_ROMEND
#define input_ports_lw3 input_ports_des11
        ...
        DE_ROMSTARTx0(lw3_208p, "lw3cpuu.208", CRC(a3041f8a) SHA1(3c5b8525b8e9b924590648429c56aaf97adee460))
            DE_DMD32ROM44("lw3drom1.a26", CRC(44a4cf81) SHA1(c7f3e3d5fbe930650e48423c8ba0ac484ce0640c), "lw3drom0.a26",
                ...
                DE2S_SOUNDROM022("lw3u7.dat", CRC(ba845ac3) SHA1(bb50413ace1885870cb3817edae478904b0eefb8),
                                 ...
                                 "lw3u21_vm.dat",
                                 CRC(7ec96750) SHA1(13e41833d43396e370b817928618f72f928d9ba0)) DE_ROMEND
    ...
    CORE_CLONEDEF(lw3, 207, 208, "Lethal Weapon 3 (2.07 Canadian)", 1992, "Data East", de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(lw3_205, "lw3gc5.205", CRC(5ad8ff4a) SHA1(6a01a2195543c0c57ce4ce78703c91500835a2da))
            DE_DMD32ROM44("lw3dsp1.205", CRC(9dfeffb4) SHA1(f62f2a884da68b4dbfe7da071058dc8cd1766c36), "lw3dsp0.205",
                          CRC(bd8156f1) SHA1(b18214af1b79cca79bdc634c175c3bf7d0052843))
                DE2S_SOUNDROM022("lw3u7.dat", CRC(ba845ac3) SHA1(bb50413ace1885870cb3817edae478904b0eefb8),
                                 "lw3u17.dat", CRC(e34cf2fc) SHA1(417c83ded6637f891c8bb42b32d6898c90a0e5cf),
                                 "lw3u21.dat", CRC(82bed051) SHA1(49ddc4190762d9b473fda270e0d6d88a4422d5d7)) DE_ROMEND
    CORE_CLONEDEF(lw3, 205, 208, "Lethal Weapon 3 (2.05)", 1992, "Data East", de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(lw3_e204, "lw3cpue.204", CRC(33cb9197) SHA1(c6b25dfd93bb5c425a606ae21f757a87a07dc320))
            DE_DMD32ROM44("lw3dsp1a.202", CRC(4920f84f) SHA1(928e4aefdcf9462201001f4ac03d56a0cda25ec1), "lw3dsp0a.202",
                          CRC(f0ac3da3) SHA1(2e65f31e65302a5d343915488b229769f9784657))
                DE2S_SOUNDROM022("lw3u7.dat", CRC(ba845ac3) SHA1(bb50413ace1885870cb3817edae478904b0eefb8),
                                 "lw3u17.dat", CRC(e34cf2fc) SHA1(417c83ded6637f891c8bb42b32d6898c90a0e5cf),
                                 "lw3u21.dat", CRC(82bed051) SHA1(49ddc4190762d9b473fda270e0d6d88a4422d5d7)) DE_ROMEND
    CORE_CLONEDEF(lw3, e204, 208, "Lethal Weapon 3 (2.04 English)", 1992, "Data East", de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(lw3_203, "lw3cpuu.203", CRC(0cfa38d4) SHA1(11d2e101a574c2dfec49ec701f480173b84c842e))
            DE_DMD32ROM44("lw3dsp1.204", CRC(1ba79363) SHA1(46d489a1190533c73370acd8a48cef60d12f87ce), "lw3dsp0.204",
                          CRC(c74d3cf2) SHA1(076ee9b2e3cad0b8058ac0c70f5ffe7e29f3eff5))
                DE2S_SOUNDROM022("lw3u7.dat", CRC(ba845ac3) SHA1(bb50413ace1885870cb3817edae478904b0eefb8),
                                 "lw3u17.dat", CRC(e34cf2fc) SHA1(417c83ded6637f891c8bb42b32d6898c90a0e5cf),
                                 "lw3u21.dat", CRC(82bed051) SHA1(49ddc4190762d9b473fda270e0d6d88a4422d5d7)) DE_ROMEND
    ...
    CORE_CLONEDEF(lw3, 200, 208, "Lethal Weapon 3 (2.00)", 1992, "Data East", de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(lw3_300, "LW3CPUU.300", CRC(1ebcf869) SHA1(f708635bd3dedca0979a31de4151a2569e040639))
            DE_DMD32ROM44("lw3drom1.300", CRC(38f0ab03) SHA1(6ab549c6388aacedadd5a16e937ec0612475a0ac), "lw3drom0.300",
                          CRC(af9c066b) SHA1(bc3ba45f3031ffec654172f29c8660ac2e606b68))
                DE2S_SOUNDROM022("lw3u7.dat", CRC(ba845ac3) SHA1(bb50413ace1885870cb3817edae478904b0eefb8),
                                 "lw3u17.dat", CRC(e34cf2fc) SHA1(417c83ded6637f891c8bb42b32d6898c90a0e5cf),
                                 "lw3u21.dat", CRC(82bed051) SHA1(49ddc4190762d9b473fda270e0d6d88a4422d5d7)) DE_ROMEND
...
/------------------------------------------------------------*/
    INITGAMES11(aar, GEN_DEDMD32, de_128x32DMD, FLIP1516, SNDBRD_DE2S, SNDBRD_DEDMD32, 0)
        DE_ROMSTARTx0(aar_101, "as512cpu.bin", CRC(03c70e67) SHA1(3093e217943ae80c842a1d893cff5330ac90bc30))
            DE_DMD32ROM44("asdspu12.bin", CRC(5dd81be6) SHA1(20e5ec19550e3795670c5ee4e8e92fae0499fdb8), "asdspu14.bin",
                          CRC(3f2204ca) SHA1(69523d6c5555d391ab24912f4c4c78aa09a400c1))
                DE2S_SOUNDROM144("assndu7.bin", CRC(f0414a0d) SHA1(b1f940be05426a39f4e5ea0802fd03a7ce055ebc),
                                 ...
                                 "assndu21.bin", CRC(7d69e917) SHA1(73e21e65bc194c063933288cb617127b41593466)) DE_ROMEND
        ...
        DE_ROMSTARTx0(mj_130, "MJcpuc5.bin", CRC(311ab1d1) SHA1(062b02aab851f9f2ca64c24b8faa7dd293cacd22))
            DE_DMD32ROM8x("MJdsp0.bin", CRC(1e2f27e8) SHA1(bfc567d6d3a7cecf7623ceb383350c78c14baef3))
                DE2S_SOUNDROM144("MJsndu7.bin", CRC(a32237f5) SHA1(0fc106429af320c4a30a99c67b45f44cb9a45644),
                                 ...
                                 "MJsndu21.bin", CRC(addfe20e) SHA1(3a6862640f81493da1beddca11011090d8b7cab0)) DE_ROMEND
        ...
        DE_ROMSTARTx0(stwr_104, "starcpua.104", CRC(12b87cfa) SHA1(12e0ab52f6784beefce8291d29b8aff01b2f2818))
            DE_DMD32ROM8x("sw4mrom.a15", CRC(00c87952) SHA1(cd2f491f03fcb3e3ceff7ee7f678aa1957a5d14b))
                DE2S_SOUNDROM042("s-wars.u7", CRC(cefa19d5) SHA1(7ddf9cc85ab601514305bc46083a07a3d087b286),
                                 ...
                                 "s-wars.u21", CRC(7b08fdf1) SHA1(489d21a10e97e886f948d81dedd7f8de3acecd2b)) DE_ROMEND
#define input_ports_stwr input_ports_des11
        ...
        DE_ROMSTARTx0(stwr_107s, "starcpua.107", CRC(1a801b7e) SHA1(fef567126dff87a2cb31401b029c3050438072b7))
            DE_DMD32ROM8x("sw4mrom.s15", CRC(158867b9) SHA1(45a0f4d26c21e2259aeb2a726a1eac23744213a2))
                DE2S_SOUNDROM042("s-wars.u7", CRC(cefa19d5) SHA1(7ddf9cc85ab601514305bc46083a07a3d087b286),
                                 "s-wars.u17", CRC(7950a147) SHA1(f5bcd5cf6b35f9e4f14d62b084495c3a743d92a1),
                                 "s-wars.u21", CRC(7b08fdf1) SHA1(489d21a10e97e886f948d81dedd7f8de3acecd2b)) DE_ROMEND
    CORE_CLONEDEF(stwr, 107s, 104, "Star Wars (1.07 20th Anniversary, Spanish)", 2016, "Data East", de_mDEDMD32S2A_hack,
                  0)
    ...
    CORE_CLONEDEF(stwr, 103, 104, "Star Wars (1.03, Display 1.05)", 1992, "Data East", de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(stwr_a14, "starcpua.103", CRC(318085ca) SHA1(7c35bdee52e8093fe05f0624615baabe559a1917))
            DE_DMD32ROM44("swrom1.a14", CRC(4d577828) SHA1(8b1f302621fe2ee13a067b9c97e3dc33f4519cea), "swrom0.a14",
                          CRC(104e5a6b) SHA1(b6a9e32f8aec078665faf2ba9ba4f9f51f68cea8))
                DE2S_SOUNDROM042("s-wars.u7", CRC(cefa19d5) SHA1(7ddf9cc85ab601514305bc46083a07a3d087b286),
                                 "s-wars.u17", CRC(7950a147) SHA1(f5bcd5cf6b35f9e4f14d62b084495c3a743d92a1),
                                 "s-wars.u21", CRC(7b08fdf1) SHA1(489d21a10e97e886f948d81dedd7f8de3acecd2b)) DE_ROMEND
    CORE_CLONEDEF(stwr, a14, 104, "Star Wars (1.03, Display 1.04)", 1992, "Data East", de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(stwr_a046, "starcpua.103", CRC(318085ca) SHA1(7c35bdee52e8093fe05f0624615baabe559a1917))
            DE_DMD32ROM44("swrom1.a046", CRC(5ceac219) SHA1(76b7acf378f83bacf6c4adb020d6e544eacbac7a), "swrom0.a046",
                          CRC(305e45be) SHA1(fbdc90175467a9ee59dc11c5ccbe83130b3644c8))
                DE2S_SOUNDROM042("s-wars.u7", CRC(cefa19d5) SHA1(7ddf9cc85ab601514305bc46083a07a3d087b286),
                                 "s-wars.u17", CRC(7950a147) SHA1(f5bcd5cf6b35f9e4f14d62b084495c3a743d92a1),
                                 "s-wars.u21", CRC(7b08fdf1) SHA1(489d21a10e97e886f948d81dedd7f8de3acecd2b)) DE_ROMEND
    ...
    DE_ROMSTARTx0(stwr_102, "starcpua.102", CRC(8b9d90d6) SHA1(2fb7594e6f4aae1dc3a07192546fabd2901acbed))
        DE_DMD32ROM8x("sw4mrom.a15", CRC(00c87952) SHA1(cd2f491f03fcb3e3ceff7ee7f678aa1957a5d14b))
            DE2S_SOUNDROM042("s-wars.u7", CRC(cefa19d5) SHA1(7ddf9cc85ab601514305bc46083a07a3d087b286), "s-wars.u17",
                             CRC(7950a147) SHA1(f5bcd5cf6b35f9e4f14d62b084495c3a743d92a1), "s-wars.u21",
                             CRC(7b08fdf1) SHA1(489d21a10e97e886f948d81dedd7f8de3acecd2b)) DE_ROMEND
    ...
    INITGAMES11(rab, GEN_DEDMD32, de_128x32DMD, FLIP1516, SNDBRD_DE2S, SNDBRD_DEDMD32, S11_PRINTERLINE)
        DE_ROMSTARTx0(rab_320, "rabcpua.320", CRC(21a2d518) SHA1(42123dca519034ecb740e5cb493b1b0b6b44e3be))
            DE_DMD32ROM8x("rbdspa.300", CRC(a5dc2f72) SHA1(60bbb4914ff56ad48c86c3550e094a3d9d70c700))
                DE2S_SOUNDROM142("rab.u7", CRC(b232e630) SHA1(880fffc395d7c24bdea4e7e8000afba7ea71c094), "rab.u17",
                                 CRC(7f2b53b8) SHA1(fd4f4ed1ed343069ffc534fe4b20026fe7403220), "rab.u21",
                                 CRC(3de1b375) SHA1(a48bb80483ca03cd7c3bf0b5f2930a6ee9cc448d)) DE_ROMEND
#define input_ports_rab input_ports_des11
    CORE_GAMEDEF(rab, 320, "Adventures of Rocky and Bullwinkle and Friends, The (3.20)", 1993, "Data East",
                 de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(rab_130, "rabcpua.130", CRC(f59b1a53) SHA1(046cd0eaee6e646286f3dfa73eeacfd93c2be273))
            DE_DMD32ROM8x("rbdspa.130", CRC(b6e2176e) SHA1(9ccbb30dc0f386fcf5e5255c9f80c720e601565f))
                DE2S_SOUNDROM142("rab.u7", CRC(b232e630) SHA1(880fffc395d7c24bdea4e7e8000afba7ea71c094), "rab.u17",
                                 CRC(7f2b53b8) SHA1(fd4f4ed1ed343069ffc534fe4b20026fe7403220), "rab.u21",
                                 CRC(3de1b375) SHA1(a48bb80483ca03cd7c3bf0b5f2930a6ee9cc448d)) DE_ROMEND
    CORE_CLONEDEF(rab, 130, 320, "Adventures of Rocky and Bullwinkle and Friends, The (1.30)", 1993, "Data East",
                  de_mDEDMD32S2A_hack, 0)
        ...
        DE_ROMSTARTx0(rab_103, "rabcpu.103", CRC(d5fe3184) SHA1(dc1ca938f15240d1c15ee5724d29a3538418f8de))
            DE_DMD32ROM8x("rabdspsp.103", CRC(02624948) SHA1(069ef69d6ce193d73954935b378230c05b83b8fc))
                DE2S_SOUNDROM142("rab.u7", CRC(b232e630) SHA1(880fffc395d7c24bdea4e7e8000afba7ea71c094), "rab.u17",
                                 CRC(7f2b53b8) SHA1(fd4f4ed1ed343069ffc534fe4b20026fe7403220), "rab.u21",
                                 CRC(3de1b375) SHA1(a48bb80483ca03cd7c3bf0b5f2930a6ee9cc448d)) DE_ROMEND
    CORE_CLONEDEF(rab, 103, 320, "Adventures of Rocky and Bullwinkle and Friends, The (1.03 Spanish)", 1993,
                  "Data East", de_mDEDMD32S2A_hack, 0)
    ...
    INITGAMES11(jupk, GEN_DEDMD32, de_128x32DMD, FLIP6364, SNDBRD_DE2S, SNDBRD_DEDMD32, S11_PRINTERLINE)
        DE_ROMSTARTx0(jupk_513, "jpcpua.513", CRC(9f70a937) SHA1(cdea6c6e852982eb5e800db138f7660d51b6fdc8))
            DE_DMD32ROM8x("jpdspa.510", CRC(9ca61e3c) SHA1(38ae472f38e6fc33671e9a276313208e5ccd8640))
                DE2S_SOUNDROM142("jpu7.dat", CRC(f3afcf13) SHA1(64e12f9d42c00ae08a4584b2ebea475566b90c13), "jpu17.dat",
                                 CRC(38135a23) SHA1(7c284c17783269824a3d3e83c4cd8ead27133309), "jpu21.dat",
                                 CRC(6ac1554c) SHA1(9a91ce836c089f96ad9c809bb66fcddda1f3e456)) DE_ROMEND
    ...
    CORE_CLONEDEF(jupk, g51, 513, "Jurassic Park (5.01 German)", 1993, "Data East", de_mDEDMD32S2A, 0)
        ...
        DE_ROMSTARTx0(jupk_305, "jpcpua3.05.bin", CRC(0a9bd439) SHA1(486df3e268c81518ff4d0638517e93b57a8d9d2e))
            DE_DMD32ROM8x(
                ...
                CRC(4c044f05)
                    SHA1(
                        573a188a255ad3b6aa18427fd6b45aeca6f83e04)) // Not dumped on this set, using 4.00 from the 3.07 revision
    DE2S_SOUNDROM142("jpu7.dat", CRC(f3afcf13) SHA1(64e12f9d42c00ae08a4584b2ebea475566b90c13), "jpu17.dat",
                     CRC(38135a23) SHA1(7c284c17783269824a3d3e83c4cd8ead27133309), "jpu21.dat",
                     CRC(6ac1554c) SHA1(9a91ce836c089f96ad9c809bb66fcddda1f3e456)) DE_ROMEND
        ...
        DE_ROMSTARTx0(lah_112, "lahcpua.112", CRC(e7422236) SHA1(c0422fa6d29fe615cb718056bea00eb9a80ce803))
            DE_DMD32ROM8x("lahdispa.106", CRC(ca6cfec5) SHA1(5e2081387d76bed17c14120cd347d6aaf435276b))
                DE2S_SOUNDROM142("lahsnd.u7", CRC(0279c45b) SHA1(14daf6b711d1936352209e90240f51812ebe76e0),
                                 ...
                                 "lahsnd.u21", CRC(4571dc2e) SHA1(a1068cb080c30dbc07d164eddfc5dfd0afd52d3b)) DE_ROMEND
        ...
        DE_ROMSTARTx0(tftc_303, "tftccpua.303", CRC(e9bec98e) SHA1(02643805d596017c88d9a534b94b2075bb2ab101))
            DE_DMD32ROM8x("tftcdspa.301", CRC(3888d06f) SHA1(3d276df436a76c6e9bed6629114204dacd88245b))
                DE2S_SOUNDROM144("sndu7.dat", CRC(7963740e) SHA1(fc1f150dcbab8af865a8ea624dfdcc03301f05e6),
                                 ...
                                 "sndu21.dat", CRC(a0ae61f7) SHA1(c7b5766fda64642f77bdc03b2025cd84f29f4495)) DE_ROMEND
...
#define sBlinderMotor CORE_CUSTSOLNO(1) /* 33 */
    ...
    return (solNo == sBlinderMotor) ? (core_getSol(44) > 0) : 0;
}

static core_tGameData tommyGameData = {GEN_DEDMD32,
                                       de_128x32DMD,
                                       {FLIP6364, 0, 0, 1, // We need 1 custom solenoids!
                                        SNDBRD_DE2S, SNDBRD_DEDMD32, S11_PRINTERLINE, 0, tommy_getSol},
                                       NULL,
                                       {{0}},
                                       {10}};
...
DE_ROMSTARTx0(tomy_400, "tomcpua.400", CRC(d0310a1a) SHA1(5b14f5d6e271676b4ec93b64f1cde9607844b677))
    DE_DMD32ROM8x("tommydva.400", CRC(9e640d09) SHA1(d921fadeb728cf929c6bae2e79bd4d140192a4d2))
        DE2S_SOUNDROM14444("tommysnd.u7", CRC(ab0b4626) SHA1(31237b4f5e866710506f1336e3ca2dbd6a89385a), "tommysnd.u17",
                           CRC(11bb2aa7) SHA1(57b4867c109996861f45ead1ceedb7153aff852e), "tommysnd.u21",
                           CRC(bb4aeec3) SHA1(2ac6cd25b79584fa6ad2c8a36c3cc58ab8ec0206), "tommysnd.u36",
                           CRC(208d7aeb) SHA1(af8af2094d1a91c7b4ef8ac6d4f594728e97450f), "tommysnd.u37",
                           CRC(46180085) SHA1(f761c27532180de313f23b41f02341783be8938b)) DE_ROMEND
        ...
        DE_ROMSTARTx0(tomy_500, "tomcpua.500", CRC(902cfaa7) SHA1(0f2931d43d8effb7c8ab4e430dcb57a2ea8364c6))
            DE_DMD32ROM8x("tommydva.500", CRC(9ade47a0) SHA1(16b5600afc4dd22cf8a04997225cdac9edb685d8))
                DE2S_SOUNDROM14444("tommysnd.u7", CRC(ab0b4626) SHA1(31237b4f5e866710506f1336e3ca2dbd6a89385a),
                                   ...
                                   "tommysnd.u37",
                                   CRC(46180085) SHA1(f761c27532180de313f23b41f02341783be8938b)) DE_ROMEND
    CORE_CLONEDEF(tomy, 500, 400, "Tommy Pinball Wizard, The Who's (5.00 unofficial MOD)", 2016, "Data East",
                  de_mDEDMD32S2A, 0)
        ...
        DE_ROMSTARTx0(wwfr_106, "wwfcpua.106", CRC(5f1c7da2) SHA1(9188e0b9c26e4b6c92c63a58b52ee42bd3b77ca0))
            DE_DMD32ROM8x("wwfdispa.102", CRC(4b629a4f) SHA1(c301d0c785f7bc4d3c23cbda76ff955c742eaeef))
                DE2S_SOUNDROM1444("wfsndu7.512", CRC(eb01745c) SHA1(7222e39c52ed298b737aadaa5b57d2068d39287e),
                                  ...
                                  "wfsndu36.400",
                                  CRC(39db8d85) SHA1(a55dd88fd4d9154b523dca9160bf96119af1f94d)) DE_ROMEND
...
static core_tGameData gnrGameData = {GEN_DEDMD32,
                                     de_128x32DMD,
...
DE_ROMSTARTx0(gnr_300, "gnrcpua.300", CRC(faf0cc8c) SHA1(0e889ad6eed832d4ccdc6e379f9e4e58ae0e0b83))
    DE_DMD32ROM8x("gnrdispa.300", CRC(4abf29e3) SHA1(595328e0f92a6e1972d71c56505a5dd07a373ef5))
        DE2S_SOUNDROM14444("gnru7.snd", CRC(3b9de915) SHA1(a901a1f37bf5433c819393c4355f9d13164b32ce), "gnru17.snd",
                           CRC(3d3219d6) SHA1(ac4a6d3eff0cdd02b8c79dddcb8fec2e22faa9b9), "gnru21.snd",
                           CRC(d2ca17ab) SHA1(db7c4f74a2e2c099fe14f38de922fdc851bd4a6b), "gnru36.snd",
                           CRC(5b32396e) SHA1(66462a6a929c869d668968e057fac199d05df267), "gnru37.snd",
                           CRC(4930e1f2) SHA1(1569d0c7fea1af008acbdc492c3677ace7d1897a)) DE_ROMEND
        ...
        DE_ROMSTARTx0(gnr_300f, "gnrcpuf.300", CRC(7f9006b2) SHA1(429d90fa27ea39176b94d1293a313ec3d1033dbc))
            DE_DMD32ROM8x("gnrdispf.300", CRC(63e9761a) SHA1(05e5a61b66148da7728779d8e5fa14a489e09441))
                DE2S_SOUNDROM14444("gnru7.snd", CRC(3b9de915) SHA1(a901a1f37bf5433c819393c4355f9d13164b32ce),
                                   ...
                                   "gnru37.snd", CRC(4930e1f2) SHA1(1569d0c7fea1af008acbdc492c3677ace7d1897a)) DE_ROMEND
...
/------------------------------------------------------------*/
    ...
    INITGAMES11(mav, GEN_DEDMD64, de_192x64DMD, FLIP6364, SNDBRD_DE2S, SNDBRD_DEDMD64, S11_PRINTERLINE)
        DE_ROMSTARTx0(mav_402, "mavcpua.404", CRC(9f06bd8d) SHA1(3b931af5455ed9c40f2b6c884427a326bba8f75a))
            DE_DMD64ROM88("mavdisp0.402", CRC(4e643525) SHA1(30b91c91c2f1295cdd018023c5ac783570a0aeea), "mavdisp3.402",
                          CRC(8c5f9460) SHA1(6369b4c98ec6fd5e769275b44631b2b6dd5c411b))
                DE2S_SOUNDROM144("mavu7.dat", CRC(427e6ab9) SHA1(6ad9295097f3d498383c91adf4ca667f797f29b1),
                                 ...
                                 "mavu21.dat", CRC(be0c6a6f) SHA1(4fee912d9f0d4b196dbfacf06a4202b2fa3037b1)) DE_ROMEND
#define input_ports_mav input_ports_des11
    CORE_GAMEDEF(mav, 402, "Maverick, The Movie (4.04, Display 4.02)", 1994, "Sega", de_mDEDMD64S2A, 0)
        ...
        DE_ROMSTARTx0(mav_401, "mavcpua.404", CRC(9f06bd8d) SHA1(3b931af5455ed9c40f2b6c884427a326bba8f75a))
            DE_DMD64ROM88("mavdsar0.401", CRC(35b811af) SHA1(1e235a0f16ef0eecca5b6ec7a2234ed1dc4e4440), "mavdsar3.401",
    ...
    CORE_CLONEDEF(mav, 401, 402, "Maverick, The Movie (4.04, Display 4.01)", 1994, "Sega", de_mDEDMD64S2A, 0)
        ...
        DE_ROMSTARTx0(mav_400, "mavgc5.400", CRC(e2d0a88b) SHA1(d1571edba47aecc871ac0cfdaabca31774f70fa1))
            DE_DMD64ROM88("mavdisp0.400", CRC(b6069484) SHA1(2878d9a0151194bd4a0e12e2f75b02a5d7316b68), "mavdisp3.400",
                          CRC(149f871f) SHA1(e29a8bf149b77bccaeed202786cf76d9a4fd51df))
                DE2S_SOUNDROM144("mavu7.dat", CRC(427e6ab9) SHA1(6ad9295097f3d498383c91adf4ca667f797f29b1),
                                 "mavu17.dat", CRC(cba377b8) SHA1(b7551b6cb64357cdacf1a96cedfccbabf4bd070a),
                                 "mavu21.dat", CRC(be0c6a6f) SHA1(4fee912d9f0d4b196dbfacf06a4202b2fa3037b1)) DE_ROMEND
    CORE_CLONEDEF(mav, 400, 402, "Maverick, The Movie (4.00)", 1994, "Sega", de_mDEDMD64S2A, 0)
        ...
        DE_ROMSTARTx0(mav_200, "mavcpua.200", CRC(0d9e9bc3) SHA1(23342950c2343591bdf168e3bc92ca669a702ffa))
            DE_DMD64ROM88("mavdisp0.200", CRC(8a85785f) SHA1(af1b8b972359cce4bfd82743e90be8066fa57c31), "mavdisp3.200",
                          CRC(2098ad22) SHA1(2ccf9c455b89a6b439957199bca75e299e18ac62))
                DE2S_SOUNDROM144("mavu7.dat", CRC(427e6ab9) SHA1(6ad9295097f3d498383c91adf4ca667f797f29b1),
                                 "mavu17.dat", CRC(cba377b8) SHA1(b7551b6cb64357cdacf1a96cedfccbabf4bd070a),
                                 "mavu21.dat", CRC(be0c6a6f) SHA1(4fee912d9f0d4b196dbfacf06a4202b2fa3037b1)) DE_ROMEND
    CORE_CLONEDEF(mav, 200, 402, "Maverick, The Movie (2.00)", 1994, "Sega", de_mDEDMD64S2A, 0)

        DE_ROMSTARTx0(mav_100, "mavcpu.100",
                      CRC(13fdc959) SHA1(f8155f0fe5d4c3fe55000ab3b57f298fd9229fef)) // "Data East code"
    DE_DMD64ROM88("mavdsp0.100", CRC(3e01f5c8) SHA1(8e40f399c77aa17bebbefe04742ff2ff95508323), "mavdsp3.100",
                  CRC(e2b623f2) SHA1(7b5a6d0db30f3deedb8fe0e1731c81ec836a66f5))
        DE2S_SOUNDROM144(
            "mavu7.dat",
            CRC(427e6ab9) SHA1(
                6ad9295097f3d498383c91adf4ca667f797f29b1), //!! are there matching, old Data East sound roms as well?
            "mavu17.dat", CRC(cba377b8) SHA1(b7551b6cb64357cdacf1a96cedfccbabf4bd070a), "mavu21.dat",
            CRC(be0c6a6f) SHA1(4fee912d9f0d4b196dbfacf06a4202b2fa3037b1)) DE_ROMEND
...
/------------------------------------------------------------*/
    INITGAMES11(frankst, GEN_DEDMD64, de_192x64DMD, FLIP6364, SNDBRD_DE2S, SNDBRD_DEDMD64, S11_PRINTERLINE)
        DE_ROMSTARTx0(frankst, "franka.103", CRC(a9aba9be) SHA1(1cc22fcbc0f51a17037637c04e606579956c9cba))
            DE_DMD64ROM88("frdspr0a.103", CRC(9dd09c7d) SHA1(c5668e53d6c914667a59538f82222ec2efc6f187), "frdspr3a.103",
                          CRC(73b538bb) SHA1(07d7ae21f062d15711d72af03bfcd52608f75a5f))
                DE2S_SOUNDROM1444("frsnd.u7", CRC(084f856c) SHA1(c91331a32b565c2ed3f96156f44143dc22009e8e), "frsnd.u17",
                                  CRC(0da904d6) SHA1(e190f1a35147b2f39224832969ca7b1d4a30f6cc), "frsnd.u21",
                                  CRC(14d4bc12) SHA1(9e7005c5bd0afe7f9c9215b39878496640cdea77), "frsnd.u36",
                                  CRC(9964d721) SHA1(5ea0bc051d1909bee80d3feb6b7350b6307b6dcb)) DE_ROMEND
...
#define init_frankstg init_frankst
        DE_ROMSTARTx0(frankstg, "franka.103", CRC(a9aba9be) SHA1(1cc22fcbc0f51a17037637c04e606579956c9cba))
            DE_DMD64ROM88("frdspr0g.101", CRC(5e27ec02) SHA1(351d6f1b7d72e415f2bf5780b6533dbd67579261), "frdspr3g.101",
                          CRC(d6c607b5) SHA1(876d4bd2a5b89f1a28ff7cd45494c7245f147d27))
                DE2S_SOUNDROM1444("frsnd.u7", CRC(084f856c) SHA1(c91331a32b565c2ed3f96156f44143dc22009e8e), "frsnd.u17",
                                  CRC(0da904d6) SHA1(e190f1a35147b2f39224832969ca7b1d4a30f6cc), "frsnd.u21",
                                  CRC(14d4bc12) SHA1(9e7005c5bd0afe7f9c9215b39878496640cdea77), "frsnd.u36",
                                  CRC(9964d721) SHA1(5ea0bc051d1909bee80d3feb6b7350b6307b6dcb)) DE_ROMEND
...
/------------------------------------------------------------*/
    INITGAMES11(baywatch, GEN_DEDMD64, de_192x64DMD, FLIP6364, SNDBRD_DE2S, SNDBRD_DEDMD64, S11_PRINTERLINE)
        DE_ROMSTARTx0(baywatch, "baycpua.400", CRC(89facfda) SHA1(71720b1da227752b0e276390abd08c742bca9090))
            DE_DMD64ROM88("bayrom0a.400", CRC(43d615c6) SHA1(7c843b6d5215305b02a55c9fa1d62375ef0766ea), "bayrom3a.400",
                          CRC(41bcb66b) SHA1(e6f0a9236e14c2e919881ca1ffe3356aaa121730))
                DE2S_SOUNDROM144("bayw.u7", CRC(90d6d8a8) SHA1(482c5643453f21a078257aa13398845ef19cab3c), "bayw.u17",
                                 CRC(b20fde56) SHA1(2f2db49245e4a6a8251cbe896b2437fcec88d42d), "bayw.u21",
                                 CRC(b7598881) SHA1(19d1dde1cb6634a7c7b5cdb4fa01cd09cc7d7777)) DE_ROMEND
        ...
        DE_ROMSTARTx0(bay_e400, "baycpue.400", CRC(07b77fe2) SHA1(4f81a5b3d821907e06d6b547117ad39c238a900c))
            DE_DMD64ROM88("bayrom0a.400", CRC(43d615c6) SHA1(7c843b6d5215305b02a55c9fa1d62375ef0766ea), "bayrom3a.400",
                ...
                DE2S_SOUNDROM1444("bw-u7.bin", CRC(a5e57557) SHA1(a884c1118331b8724507b0a916127ce5df309fe4),
                                  ...
                                  "bw-u36.bin", CRC(1877abc5) SHA1(13ca231a486495a83cc1d9c6dde558a57eb4abe1)) DE_ROMEND
...
#define init_bay_d300 init_baywatch
        DE_ROMSTARTx0(bay_d300, "baycpud.300", CRC(c160f045) SHA1(d1f75d5ba292b25278539b01e0f4908276d34e34))
            DE_DMD64ROM88("bayrom0a.300", CRC(3f195829) SHA1(a10a1b7f125f239b0eff87ee6667c8250b7ffc87), "bayrom3a.300",
                          CRC(ae3d8585) SHA1(28b38ebc2755ffb3859f8091a9bf50d868794a3e))
                DE2S_SOUNDROM144("bayw.u7", CRC(90d6d8a8) SHA1(482c5643453f21a078257aa13398845ef19cab3c), "bayw.u17",
                                 CRC(b20fde56) SHA1(2f2db49245e4a6a8251cbe896b2437fcec88d42d), "bayw.u21",
                                 CRC(b7598881) SHA1(19d1dde1cb6634a7c7b5cdb4fa01cd09cc7d7777)) DE_ROMEND
...
#define init_bay_f201 init_baywatch
        DE_ROMSTARTx0(bay_f201, "baycpuf.201", CRC(d2fddeaa) SHA1(839baca46823dc72a7ef1421764815f69f0e7084))
            DE_DMD64ROM88("bayrom0f.200", CRC(6dc898b6) SHA1(087b043acf64b2a16c8e4c879b90dbea1d79c614), "bayrom3f.200",
                          CRC(9db1b94e) SHA1(056c1a0fd1c99c1c9426f2e2cdd68f4bbaa89d81))
                DE2S_SOUNDROM144("bayw.u7", CRC(90d6d8a8) SHA1(482c5643453f21a078257aa13398845ef19cab3c), "bayw.u17",
                                 CRC(b20fde56) SHA1(2f2db49245e4a6a8251cbe896b2437fcec88d42d), "bayw.u21",
                                 CRC(b7598881) SHA1(19d1dde1cb6634a7c7b5cdb4fa01cd09cc7d7777)) DE_ROMEND
...
/------------------------------------------------------------*/
    INITGAMES11(batmanf, GEN_DEDMD64, de_192x64DMD, FLIP6364, SNDBRD_DE2S, SNDBRD_DEDMD64, S11_PRINTERLINE)
        DE_ROMSTARTx0(batmanf, "batnova.401", CRC(4e62df4e) SHA1(6c3be65fc8825f47cd08755b58fdcf3652ede702))
            DE_DMD64ROM88("bfdrom0a.401", CRC(8a3c20ad) SHA1(37415ac7ba178981dffce3a17502f39ab29d90ea), "bfdrom3a.401",
                ...
                DE2S_SOUNDROM144("bmfu7.bin", CRC(58c0d144) SHA1(88a404d3625c7c154892282598b4949ac97de12b),
                                 ...
                                 "bmfu21.bin", CRC(e41a516d) SHA1(9c41803a01046e57f8bd8759fe5e62ad6abaa80c)) DE_ROMEND
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(batmanf3, "batcpua.302", CRC(5ae7ce69) SHA1(13409c7c993bd9940f3a72f3bac8c8c57a665b3f))
        DE_DMD64ROM88("bmfrom0a.300", CRC(764bb217) SHA1(2923d2d2924faa4bdc6e67087fb8ce694d27809a), "bmfrom3a.300",
                      CRC(b4e3b515) SHA1(0f8bf08bc480eed575da54bfc0135f38a86302d4))
            DE2S_SOUNDROM144("bmfu7.bin", CRC(58c0d144) SHA1(88a404d3625c7c154892282598b4949ac97de12b), "bmfu17.bin",
                             CRC(edcd5c10) SHA1(561f22fb7817f64e09ef6adda646f58f31b80bf4), "bmfu21.bin",
                             CRC(e41a516d) SHA1(9c41803a01046e57f8bd8759fe5e62ad6abaa80c)) DE_ROMEND
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(batmanf2, "batcpua.202", CRC(3e2fe40b) SHA1(afacbbc8af319110149b25c35ef03dcf019ca8da))
        DE_DMD64ROM88("bmfrom0.200", CRC(17086824) SHA1(37f2d463d7cc15739fb18000c81dbc1e79c1549a), "bmfrom3.200",
                      CRC(9c8a9a8f) SHA1(8dce048cac657da66478ae0b6bd000a2648a118a))
            DE2S_SOUNDROM144("bmfu7.bin", CRC(58c0d144) SHA1(88a404d3625c7c154892282598b4949ac97de12b), "bmfu17.bin",
                             CRC(edcd5c10) SHA1(561f22fb7817f64e09ef6adda646f58f31b80bf4), "bmfu21.bin",
                             CRC(e41a516d) SHA1(9c41803a01046e57f8bd8759fe5e62ad6abaa80c)) DE_ROMEND
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(batmanf1, "batcpua.102", CRC(aafba427) SHA1(485fa3b76569a8c9ed640e9fa8fd714fdd2268b8))
        DE_DMD64ROM88("bmfrom0.100", CRC(4d65a45c) SHA1(b4a112f8a70ad887e1a23291bcec1d55bd7277c1), "bmfrom3.100",
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(bmf_at, "batnovh.401", CRC(acba13d7) SHA1(b5e5dc5ffc926612ea3d592b6d4e8e02f6290bc7))
        DE_DMD64ROM88("bfdrom0g.401", CRC(3a2d7d53) SHA1(340107290d58bfb8b9a6613215eb556626fe2461), "bfdrom3g.401",
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(bmf_be, "batnovb.401", CRC(21309873) SHA1(cebd0c5c05dc5c0a2eb8563ad5c4759f78d6a4b9))
        DE_DMD64ROM88("bfdrom0f.401", CRC(e7473f6f) SHA1(f5951a9b6a8776073adf10e38b9d68d6d444240a), "bfdrom3f.401",
                      CRC(f7951709) SHA1(ace5b374d1e382d6f612b2bafc0e9fdde9e21014))
            DE2S_SOUNDROM144("bmfu7.bin", CRC(58c0d144) SHA1(88a404d3625c7c154892282598b4949ac97de12b), "bmfu17.bin",
                             CRC(edcd5c10) SHA1(561f22fb7817f64e09ef6adda646f58f31b80bf4), "bmfu21.bin",
                             CRC(e41a516d) SHA1(9c41803a01046e57f8bd8759fe5e62ad6abaa80c)) DE_ROMEND
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(bmf_it, "batnovi.401", CRC(7053ef9e) SHA1(918ab3e250b5965998ca0a38e1b8ba3cc012083f))
        DE_DMD64ROM88("bfdrom0i.401", CRC(23051253) SHA1(155669a3fecd6e67838b10e71a57a6b871c8762a), "bfdrom3i.401",
                      CRC(82b61a41) SHA1(818c8fdbf44e29fe0ec5362a34ac948e98002efa))
            DE2S_SOUNDROM144("bmfu7.bin", CRC(58c0d144) SHA1(88a404d3625c7c154892282598b4949ac97de12b), "bmfu17.bin",
                             CRC(edcd5c10) SHA1(561f22fb7817f64e09ef6adda646f58f31b80bf4), "bmfu21.bin",
                             CRC(e41a516d) SHA1(9c41803a01046e57f8bd8759fe5e62ad6abaa80c)) DE_ROMEND
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(bmf_sp, "batnova.401", CRC(4e62df4e) SHA1(6c3be65fc8825f47cd08755b58fdcf3652ede702))
        DE_DMD64ROM88("bfdrom0l.401", CRC(b22b10d9) SHA1(c8f5637b00b0701d47a3b6bc0fdae08ae1a8df64), "bfdrom3l.401",
                      CRC(016b8666) SHA1(c10b7fc2c1e5b8382ff5b021a6b70f3a550b190e))
            DE2S_SOUNDROM144("bmfu7.bin", CRC(58c0d144) SHA1(88a404d3625c7c154892282598b4949ac97de12b), "bmfu17.bin",
                             CRC(edcd5c10) SHA1(561f22fb7817f64e09ef6adda646f58f31b80bf4), "bmfu21.bin",
                             CRC(e41a516d) SHA1(9c41803a01046e57f8bd8759fe5e62ad6abaa80c)) DE_ROMEND
...
/------------------------------------------------------------*/
    DE_ROMSTARTx0(bmf_time, "batnova.401", CRC(4e62df4e) SHA1(6c3be65fc8825f47cd08755b58fdcf3652ede702))
        DE_DMD64ROM88("bfdrom0t.401", CRC(b83b8d28) SHA1(b90e6a6fa55dadbf0e752745b87d1e8e9d7ccfa7), "bfdrom3t.401",
