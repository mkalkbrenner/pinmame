...
#define MRGAME_COMPORTS                                                                                                \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BIT(0x0001, "Test Advance", KEYCODE_8) COREPORT_BIT(0x0002, "Test Return", KEYCODE_7)                 \
            COREPORT_BIT(0x0004, "Slam Tilt", KEYCODE_HOME) COREPORT_BIT(0x0008, "Credit Service", KEYCODE_9)          \
                COREPORT_BITDEF(0x0010, IPT_COIN1, KEYCODE_3) COREPORT_BITDEF(0x0020, IPT_COIN2, KEYCODE_4)            \
                    COREPORT_BITDEF(0x0040, IPT_COIN3, KEYCODE_5) /* Switch Column 2 */                                \
        COREPORT_BITDEF(0x0080, IPT_START1, IP_KEY_DEFAULT) COREPORT_BIT(0x0100, "Ball Tilt", KEYCODE_INSERT)          \
            PORT_START /* 1 */                                                                                         \
                COREPORT_DIPNAME(0x0001, 0x0001, "CPU SW1-1") COREPORT_DIPSET(0x0000, "0")                             \
                    COREPORT_DIPSET(0x0001, "1") COREPORT_DIPNAME(0x0002, 0x0000, "CPU SW1-2")                         \
                        COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0002, "1")                                      \
                            COREPORT_DIPNAME(0x0004, 0x0000, "CPU SW1-3") COREPORT_DIPSET(0x0000, "0")                 \
                                COREPORT_DIPSET(0x0004, "1") COREPORT_DIPNAME(0x0008, 0x0000, "CPU SW1-4")             \
                                    COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0008, "1") PORT_START /* 2 */       \
                                        COREPORT_DIPNAME(0x0001, 0x0001, "VID SW1-1") COREPORT_DIPSET(0x0000, "0")     \
                                            COREPORT_DIPSET(0x0001, "1") COREPORT_DIPNAME(0x0002, 0x0000, "VID SW1-2") \
                                                COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0002, "1")              \
