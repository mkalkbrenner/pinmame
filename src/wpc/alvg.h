...
#define ALVG_COMPORTS                                                                                                  \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0001, IPT_COIN1, KEYCODE_3) COREPORT_BITDEF(0x0002, IPT_COIN2, KEYCODE_4)                    \
            COREPORT_BITDEF(0x0004, IPT_COIN3, KEYCODE_5) COREPORT_BITDEF(0x0008, IPT_COIN4, KEYCODE_6)                \
                COREPORT_BIT(0x0010, "Slam Tilt", KEYCODE_HOME) /* Switch Column 2 */                                  \
        COREPORT_BITDEF(0x0020, IPT_START1, IP_KEY_DEFAULT) COREPORT_BIT(0x0040, "Ball Tilt", KEYCODE_INSERT)          \
            COREPORT_BIT(0x0800, "Volume +", KEYCODE_9) COREPORT_BIT(                                                  \
                0x1000, "Volume -",                                                                                    \
                KEYCODE_0) /* These are put in switch column 0 since they are not read in the regular switch matrix */ \
        COREPORT_BIT(0x0100, "Test", KEYCODE_7) COREPORT_BIT(0x0200, "Enter", KEYCODE_8)                               \
