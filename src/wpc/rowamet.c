...
static void
rowamet_init(struct sndbrdData* brdData) {
...
static MEMORY_READ_START(snd_readmem){0x0000, 0x0fff, MRA_ROM}, {0x1000, 0x17ff, MRA_RAM},
    MEMORY_END

    static MEMORY_WRITE_START(snd_writemem){0x1000, 0x17ff, MWA_RAM},
    MEMORY_END

    //Port map for sound CPU
    static PORT_READ_START(snd_readport){0x00, 0x00, snd_data_r},
    PORT_END

    static PORT_WRITE_START(snd_writeport){0x00, 0x00, mute_w},
...
/--------------------*/
    const
    struct sndbrdIntf rowametIntf = {"ROWAMET",      rowamet_init, NULL, NULL, rowamet_data_w,
                                     rowamet_data_w, NULL,         NULL, NULL, SNDBRD_NODATASYNC | SNDBRD_NOCTRLSYNC};
...
/ games start here
/--------------------*/
static core_tLCDLayout disp[] = {{0, 2, 24, 1, CORE_SEG7},
                                 {3, 0, 0, 6, CORE_SEG7},
                                 {5, 0, 6, 6, CORE_SEG7},
                                 {7, 0, 12, 6, CORE_SEG7},
                                 {9, 0, 18, 6, CORE_SEG7},
