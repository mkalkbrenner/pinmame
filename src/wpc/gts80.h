...
#define GTS80_COMPORTS                                                                                                 \
    PORT_START /* 0 */ /* switch column 8 */                                                                           \
        COREPORT_BIT(0x0001, "Test", KEYCODE_8) COREPORT_BITDEF(0x0002, IPT_COIN1, IP_KEY_DEFAULT)                     \
            COREPORT_BITDEF(0x0004, IPT_COIN2, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0008, IPT_COIN3, KEYCODE_3)           \
                COREPORT_BITDEF(0x0010, IPT_START1, IP_KEY_DEFAULT)                                                    \
                    COREPORT_BITDEF(0x0020, IPT_TILT, KEYCODE_INSERT) /* These are put in switch column 0 */           \
        COREPORT_BIT(0x8000, "Slam Tilt", KEYCODE_HOME) COREPORT_BIT(0x1000, "Sound Test", KEYCODE_9)
...
#define GTS80_DIPS                                                                                                                                     \
    PORT_START /* 1 */                                                                                                                                 \
        COREPORT_DIPNAME(0x0001, 0x0000, "S1") COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0001, DEF_STR(On)) COREPORT_DIPNAME(            \
            0x0002,                                                                                                                                    \
            0x0002,                                                                                                                                    \
            "S2") COREPORT_DIPSET(0x0000,                                                                                                              \
                                  DEF_STR(                                                                                                             \
                                      Off)) COREPORT_DIPSET(0x0002,                                                                                    \
                                                            DEF_STR(On)) COREPORT_DIPNAME(0x0004, 0x0000, "S3")                                        \
            COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0004, DEF_STR(On)) COREPORT_DIPNAME(0x0008, 0x0000, "S4") COREPORT_DIPSET(         \
                0x0000,                                                                                                                                \
                DEF_STR(                                                                                                                               \
                    Off)) COREPORT_DIPSET(0x0008,                                                                                                      \
                                          DEF_STR(                                                                                                     \
                                              On)) COREPORT_DIPNAME(0x0010, 0x0000, "S5") COREPORT_DIPSET(0x0000, DEF_STR(Off))                        \
                COREPORT_DIPSET(0x0010, DEF_STR(On)) COREPORT_DIPNAME(0x0020, 0x0000, "S6") COREPORT_DIPSET(                                           \
                    0x0000,                                                                                                                            \
                    DEF_STR(                                                                                                                           \
                        Off)) COREPORT_DIPSET(0x0020,                                                                                                  \
                                              DEF_STR(On)) COREPORT_DIPNAME(0x0040, 0x0000, "S7")                                                      \
                    COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0040, DEF_STR(On)) COREPORT_DIPNAME(0x0080, 0x0000, "S8") COREPORT_DIPSET( \
                        0x0000,                                                                                                                        \
                        DEF_STR(                                                                                                                       \
                            Off)) COREPORT_DIPSET(0x0080,                                                                                              \
                                                  DEF_STR(On)) COREPORT_DIPNAME(0x0100, 0x0100, "S9")                                                  \
                        COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0100, DEF_STR(On)) COREPORT_DIPNAME(                                   \
                            0x0200,                                                                                                                    \
                            0x0200,                                                                                                                    \
                            "S10") COREPORT_DIPSET(0x0000,                                                                                             \
                                                   DEF_STR(                                                                                            \
                                                       Off)) COREPORT_DIPSET(0x0200,                                                                   \
                                                                             DEF_STR(                                                                  \
                                                                                 On)) COREPORT_DIPNAME(0x0400, 0x0000,                                 \
                                                                                                       "S11")                                          \
                            COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0400, DEF_STR(On)) COREPORT_DIPNAME(                               \
                                0x0800,                                                                                                                \
                                0x0000,                                                                                                                \
                                "S12") COREPORT_DIPSET(0x0000,                                                                                         \
                                                       DEF_STR(                                                                                        \
                                                           Off)) COREPORT_DIPSET(0x0800,                                                               \
                                                                                 DEF_STR(                                                              \
                                                                                     On)) COREPORT_DIPNAME(0x1000,                                     \
                                                                                                           0x0000,                                     \
                                                                                                           "S13")                                      \
                                COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x1000, DEF_STR(On)) COREPORT_DIPNAME(                           \
                                    0x2000,                                                                                                            \
                                    0x0000,                                                                                                            \
                                    "S14") COREPORT_DIPSET(0x0000,                                                                                     \
                                                           DEF_STR(                                                                                    \
                                                               Off)) COREPORT_DIPSET(0x2000,                                                           \
                                                                                     DEF_STR(                                                          \
                                                                                         On)) COREPORT_DIPNAME(0x4000, 0x0000, "S15")                  \
                                    COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x4000, DEF_STR(On)) COREPORT_DIPNAME(                       \
                                        0x8000,                                                                                                        \
                                        0x8000,                                                                                                        \
                                        "S16") COREPORT_DIPSET(0x0000,                                                                                 \
                                                               DEF_STR(                                                                                \
                                                                   Off)) COREPORT_DIPSET(0x8000,                                                       \
                                                                                         DEF_STR(                                                      \
                                                                                             On)) PORT_START /* 2 */                                   \
                                        COREPORT_DIPNAME(                                                                                              \
                                            0x0001,                                                                                                    \
                                            ...
                                            "S17") COREPORT_DIPSET(0x0000,                                                                             \
                                                                   DEF_STR(                                                                            \
                                                                       Off)) COREPORT_DIPSET(0x0001,                                                   \
                                                                                             DEF_STR(                                                  \
                                                                                                 On)) COREPORT_DIPNAME(0x0002,                         \
                                                                                                                       0x0002,                         \
                                                                                                                       "S18")                          \
                                            COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(                                                     \
                                                0x0002,                                                                                                \
                                                DEF_STR(                                                                                               \
                                                    On)) COREPORT_DIPNAME(0x0004, 0x0000,                                                              \
                                                                          "S19") COREPORT_DIPSET(0x0000, DEF_STR(Off))                                 \
                                                COREPORT_DIPSET(0x0004, DEF_STR(On)) COREPORT_DIPNAME(0x0008, 0x0008, "S20") COREPORT_DIPSET(          \
                                                    0x0000,                                                                                            \
                                                    DEF_STR(                                                                                           \
                                                        Off)) COREPORT_DIPSET(0x0008,                                                                  \
                                                                              DEF_STR(                                                                 \
                                                                                  On)) COREPORT_DIPNAME(0x0010, 0x0010, "S21")                         \
                                                    COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(                                             \
                                                        0x0010,                                                                                        \
                                                        DEF_STR(                                                                                       \
                                                            On)) COREPORT_DIPNAME(0x0020, 0x0000,                                                      \
                                                                                  "S22") COREPORT_DIPSET(0x0000,                                       \
                                                                                                         DEF_STR(Off))                                 \
                                                        COREPORT_DIPSET(0x0020, DEF_STR(On)) COREPORT_DIPNAME(                                         \
                                                            0x0040,                                                                                    \
                                                            0x0040,                                                                                    \
                                                            "S23") COREPORT_DIPSET(0x0000, DEF_STR(Off))                                               \
                                                            COREPORT_DIPSET(0x0040, DEF_STR(On)) COREPORT_DIPNAME(                                     \
                                                                0x0080,                                                                                \
                                                                0x0080,                                                                                \
                                                                "S24") COREPORT_DIPSET(0x0000, DEF_STR(Off))                                           \
                                                                COREPORT_DIPSET(0x0080, DEF_STR(On)) COREPORT_DIPNAME(                                 \
                                                                    0x0100,                                                                            \
                                                                    0x0100,                                                                            \
                                                                    "S25") COREPORT_DIPSET(0x0000, DEF_STR(Off))                                       \
                                                                    COREPORT_DIPSET(0x0100, DEF_STR(On)) COREPORT_DIPNAME(                             \
                                                                        0x0200,                                                                        \
                                                                        0x0200,                                                                        \
                                                                        "S26") COREPORT_DIPSET(0x0000, DEF_STR(Off))                                   \
                                                                        COREPORT_DIPSET(0x0200, DEF_STR(On)) COREPORT_DIPNAME(                         \
                                                                            0x0400,                                                                    \
                                                                            0x0400,                                                                    \
                                                                            "S27") COREPORT_DIPSET(0x0000,                                             \
                                                                                                   DEF_STR(Off))                                       \
                                                                            COREPORT_DIPSET(0x0400, DEF_STR(On)) COREPORT_DIPNAME(                     \
                                                                                0x0800,                                                                \
                                                                                0x0800,                                                                \
                                                                                "S28") COREPORT_DIPSET(0x0000,                                         \
                                                                                                       DEF_STR(Off))                                   \
                                                                                COREPORT_DIPSET(0x0800, DEF_STR(On)) COREPORT_DIPNAME(                 \
                                                                                    0x1000,                                                            \
                                                                                    0x1000,                                                            \
                                                                                    "S29") COREPORT_DIPSET(0x0000,                                     \
                                                                                                           DEF_STR(                                    \
                                                                                                               Off))                                   \
                                                                                    COREPORT_DIPSET(0x1000, DEF_STR(On)) COREPORT_DIPNAME(             \
                                                                                        0x2000,                                                        \
                                                                                        0x2000,                                                        \
                                                                                        "S30") COREPORT_DIPSET(0x0000,                                 \
                                                                                                               DEF_STR(                                \
                                                                                                                   Off))                               \
                                                                                        COREPORT_DIPSET(                                               \
                                                                                            0x2000,                                                    \
                                                                                            DEF_STR(                                                   \
                                                                                                On)) COREPORT_DIPNAME(0x4000,                          \
                                                                                                                      0x4000,                          \
                                                                                                                      "S31")                           \
                                                                                            COREPORT_DIPSET(                                           \
                                                                                                0x0000,                                                \
...
#define GTS80_SNDDIPS                                                                                                  \
    PORT_START /* 3 */                                                                                                 \
        COREPORT_DIPNAME(0x0001, 0x0000, "SS:S1: Self Test") COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(    \
            0x0001, DEF_STR(On)) COREPORT_DIPNAME(0x0002, 0x0000, "SS:S2: Not Used") COREPORT_DIPSET(0x0000,           \
                                                                                                     DEF_STR(Off))     \
            COREPORT_DIPSET(0x0002, DEF_STR(On)) COREPORT_DIPNAME(0x000c, 0x0004, "SS:S3-S4: Attract Mode Speech")     \
                COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0004, "10s") COREPORT_DIPSET(0x0008, "2m")     \
                    COREPORT_DIPSET(0x000c, "4m") COREPORT_DIPNAME(0x0010, 0x0010, "SS:S5: Background Sound ")         \
                        COREPORT_DIPSET(0x0000, "Disabled") COREPORT_DIPSET(0x0010, "Enabled")                         \
                            COREPORT_DIPNAME(0x0020, 0x0020, "SS:S6: Speech") COREPORT_DIPSET(0x0000, "Disabled")      \
                                COREPORT_DIPSET(0x0020, "Enabled") COREPORT_DIPNAME(0x0040, 0x0000, "SS:S7: Not Used") \
                                    COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0040, DEF_STR(On))         \
                                        COREPORT_DIPNAME(0x0080, 0x0000, "SS:S8: Not Used")                            \
                                            COREPORT_DIPSET(0x0000, DEF_STR(Off)) COREPORT_DIPSET(0x0080, DEF_STR(On)) \
