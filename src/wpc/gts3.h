...
#define GTS3_COMPORTS                                                                                                  \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                           \
        COREPORT_BITDEF(0x0001, IPT_COIN2, KEYCODE_3) COREPORT_BITDEF(                                                 \
            0x0002, IPT_COIN1, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0004, IPT_COIN3,                                      \
                                                               KEYCODE_4) COREPORT_BITDEF(0x0008, IPT_START1,          \
                                                                                          IP_KEY_DEFAULT)              \
            COREPORT_BIT(0x0010, "Left Advance", KEYCODE_7) COREPORT_BIT(                                              \
                0x0020, "Right Advance",                                                                               \
                KEYCODE_8) /* These are put in switch column 0 since they are not read in the regular switch matrix */ \
        COREPORT_BIT(0x0100, "Diagnostic", KEYCODE_0) COREPORT_BIT(0x0200, "Ball Tilt", KEYCODE_INSERT)                \
...
#define GTS31_COMPORTS                                                                                                      \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                                \
        COREPORT_BITDEF(0x0001, IPT_COIN2, KEYCODE_3) COREPORT_BITDEF(                                                      \
            0x0002, IPT_COIN1, IP_KEY_DEFAULT) COREPORT_BITDEF(0x0004, IPT_COIN3, KEYCODE_4)                                \
            COREPORT_BITDEF(0x0008, IPT_COIN4, KEYCODE_6) COREPORT_BITDEF(                                                  \
                0x0010, IPT_START1,                                                                                         \
                IP_KEY_DEFAULT) /* These are put in switch column 0 since they are not read in the regular switch matrix */ \
        COREPORT_BIT(0x0100, "Diagnostic", KEYCODE_0) COREPORT_BIT(0x0200, "Ball Tilt", KEYCODE_INSERT)                     \
            COREPORT_BIT(0x0400, "Slam Tilt", KEYCODE_HOME)                                                                 \
...
#define GTS32_COMPORTS                                                                                                   \
    PORT_START /* 0 */ /* Switch Column 1 */                                                                             \
        COREPORT_BITDEF(0x0001, IPT_COIN2, KEYCODE_3) COREPORT_BITDEF(                                                   \
            0x0002, IPT_COIN1,                                                                                           \
            IP_KEY_DEFAULT) COREPORT_BITDEF(0x0004, IPT_COIN3,                                                           \
                                            KEYCODE_4) COREPORT_BITDEF(0x0008, IPT_COIN4,                                \
                                                                       KEYCODE_6) COREPORT_BITDEF(0x0010, IPT_START1,    \
                                                                                                  IP_KEY_DEFAULT)        \
            COREPORT_BITTOG(0x0020, "Tournament", KEYCODE_2) COREPORT_BITTOG(                                            \
                0x0040, "Coin Door",                                                                                     \
                KEYCODE_END) /* These are put in switch column 0 since they are not read in the regular switch matrix */ \
        COREPORT_BIT(0x0100, "Diagnostic", KEYCODE_0) COREPORT_BIT(0x0200, "Ball Tilt", KEYCODE_INSERT)                  \
            COREPORT_BIT(0x0400, "Slam Tilt", KEYCODE_HOME) COREPORT_BITTOG(0x0800, "Printer", KEYCODE_9)                \
    ...
    PORT_START /* 0 */ /* Switch Column 1 */                                                                                \
        COREPORT_BITDEF(0x0001, IPT_COIN2, KEYCODE_3) COREPORT_BITDEF(                                                      \
            ...
            COREPORT_BITDEF(0x0008, IPT_COIN4, KEYCODE_6) COREPORT_BITDEF(                                                  \
                0x0010, IPT_START1,                                                                                         \
                IP_KEY_DEFAULT) /* These are put in switch column 0 since they are not read in the regular switch matrix */ \
        COREPORT_BIT(0x0100, "Slam Tilt", KEYCODE_HOME) COREPORT_BIT(0x0200, "Ball Tilt", KEYCODE_INSERT)                   \
