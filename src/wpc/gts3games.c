...
/* Dot-Matrix display */
static struct core_dispLayout GTS3_dispDMD[] = {{0, 0, 32, 128, CORE_DMD | CORE_DMDNOAA, (genf*)gts3_dmd128x32, NULL},
                                                {0}};

/* 2 X 20 AlphaNumeric Rows */
static struct core_dispLayout GTS3_dispAlpha[] = {{0, 0, 0, 20, CORE_SEG16}, {2, 0, 20, 20, CORE_SEG16}, {0}};
/* 2 X 20 AlphaNumeric Rows, 4 X 2 7-seg displays */
static struct core_dispLayout GTS3_dispAlphaLED[] = {DISP_SEG_IMPORT(GTS3_dispAlpha), {5, 0, 40, 2, CORE_SEG7},
                                                     {5, 12, 42, 2, CORE_SEG7},       {5, 24, 44, 2, CORE_SEG7},
                                                     {5, 36, 46, 2, CORE_SEG7},       {0}};

#define INITGAME_IC(name, disptype, flippers, balls, sb, lamps)                                                        \
    GTS3_IC_INPUT_PORTS_START(name, balls)                                                                             \
    GTS3_INPUT_PORTS_END static core_tGameData name##GameData = {GEN_GTS3, disptype, {flippers, 4, lamps, 0, sb, 0}};  \
    static void init_##name(void) { core_gameData = &name##GameData; }

#define INITGAME(name, disptype, flippers, balls, sb, lamps)                                                           \
    GTS3_INPUT_PORTS_START(name, balls)                                                                                \
    GTS3_INPUT_PORTS_END static core_tGameData name##GameData = {GEN_GTS3, disptype, {flippers, 4, lamps, 0, sb, 0}};  \
    static void init_##name(void) { core_gameData = &name##GameData; }
...
static struct core_dispLayout dispToptronic[] = {DISP_SEG_IMPORT(GTS3_dispAlpha), {5, 12, 40, 8, CORE_SEG7}, {0}};
...
GTS3SOUND32128("yrom1.bin", NO_DUMP, "drom1.bin", NO_DUMP, "arom1.bin",
               CRC(b0983d90) SHA1(72e6a71f20fd5849543ca13813f062a3fc1d7dcf), "arom2.bin",
               CRC(3e31ce58) SHA1(a2ef72d7b2bb821d1f62dce7212e31a1df3e7791))
GTS3_ROMEND
...
GTS3SOUND32256IC("yrom1.bin", CRC(6e424e53) SHA1(90a9bf5ce84680972f9d12eb386215494c584b9b), "drom1.bin",
                 CRC(4480257e) SHA1(50b93d4496816ef7cdf007ac75c72c6aaa956aba), "arom1.bin",
                 CRC(f8cec60c) SHA1(e52f3a5890a3bb5eb6c932c3d0ed471ed76909c9))
GTS3_ROMEND
...
GTS3SOUND3232("yrom1.bin", CRC(20919ebb) SHA1(a2ea79863b41a04aa23ea596932825408cca64e3), "drom1.bin",
              CRC(a258d72d) SHA1(eeb4768c8b2f57509a088d3ac8d35aa34f2cfc2c))
GTS3_ROMEND
...
GTS3SOUND3232("br_yrom1.bin", CRC(d5aab379) SHA1(b3995f8aa2e54f91f2a0fd010c807fbfbf9ae847), "br_drom1.bin",
              CRC(99f38229) SHA1(f63d743e63e88728e8d53320b21b2fda1b6385f8))
GTS3_ROMEND
...
GTS3SOUND3232("yrom1.bin", CRC(20bc9797) SHA1(5d17b5f0423d8854fb7c4816d53a223ecc7c50c6), "drom1.bin",
              CRC(eac3e1cc) SHA1(2725457231854e4f3d54fbba745b8fc6f55b1688))
GTS3_ROMEND
...
static struct core_dispLayout dispVegas[] = {DISP_SEG_IMPORT(GTS3_dispAlpha),
                                             {5, 16, 40, 1, CORE_SEG16},
                                             {5, 19, 41, 1, CORE_SEG16},
                                             {5, 22, 42, 1, CORE_SEG16},
                                             {0}};
...
GTS3SOUND3232("yrom1.bin", CRC(af1095f1) SHA1(06609085cd74b969e4f2ec962c427c5c42ebc6ff), "drom1.bin",
              CRC(46eb5755) SHA1(94ec2d0cf41f68a8c3d7505186b11b4abb4803db))
GTS3_ROMEND
...
GTS3SOUND3232("yrom1.bin", CRC(93369ed3) SHA1(3340478ffc00cf9991beabd4f0ecd89d0c88965e), "drom1.bin",
              CRC(f55dd7ec) SHA1(fe306c40bf3d98e4076d0d8a935c3671469d4cff))
GTS3_ROMEND
...
GTS3SOUND3232("yrom1.bin", CRC(8591d421) SHA1(74402cf8b419e0cb05069851b0d5616e66b2f0a9), "drom1.bin",
              CRC(9514739f) SHA1(2794549f549d68e064a9a962a4e91fff7dcf0160))
GTS3_ROMEND
...
GTS3SOUND3232("yrom1.bin", CRC(65fc2e60) SHA1(6377c220753d9e4b5c76d445056409526d95772f), "drom1.bin",
              CRC(ae0c4b1d) SHA1(c8aa409c9b54fd8ecf70eb2926f4e98fc5eb11fe))
GTS3_ROMEND
...
GTS3SOUND3232("yrom1.bin", CRC(831ee812) SHA1(57056cde36b17cb7d7f34275b1bb5dc3d52bde4e), "drom1.bin",
              CRC(9dec74e7) SHA1(8234bdca5536d30dc1eabcb3a5505d2fd824ce0f))
GTS3_ROMEND
...
/-------------------------------------------------------------------*/
/* 2 X 20 AlphaNumeric Rows, 4 X 3 7-seg displays */
static struct core_dispLayout dispHoops[] = {DISP_SEG_IMPORT(GTS3_dispAlpha), {5, 0, 40, 3, CORE_SEG7},
                                             {5, 11, 43, 3, CORE_SEG7},       {5, 23, 46, 3, CORE_SEG7},
                                             {5, 34, 49, 3, CORE_SEG7},       {0}};
...
GTS3SOUND3232("yrom1.bin", CRC(9718b958) SHA1(bac806267bab4852c0f3fdb48f8d872992f61ace), "drom1.bin",
              CRC(e72c00eb) SHA1(5b9f85083b38d916afb0f9b72b061501504725ff))
GTS3_ROMEND
...
GTS3SOUND32128("yrom1.bin", CRC(4554ed0d) SHA1(df0a9225f961e0ee876c3e63ad54c6e4eac080ae), "drom1.bin",
               CRC(78c099e1) SHA1(953111237fdc3e20562d823eb2b6430e5a4afe4d), "arom1.bin",
               CRC(c890475f) SHA1(1cf6ed0dbd003a76a5cf889f62b489c0a62e9d25), "arom2.bin",
               CRC(aba8fd98) SHA1(81b8af4d2d8e40b5b44f114c095371afe5539549))
...
GTS3SOUND32128("yrom1.bin", CRC(4ecf6ecb) SHA1(92469ccdedcc8e61edcddaedd688ef990a9ad5ad), "drom1.bin",
               CRC(3863a9df) SHA1(1759abbfcb127a6909f70845f41daf3ac8e80cef), "arom1.bin",
               CRC(357b0069) SHA1(870b0b84c6b3754f89b4e4e0b4594613ef589204), "arom2.bin",
               CRC(5be02ff7) SHA1(51af73a26bbed0915ec57cde8f9cac552978b2dc))
GTS3_ROMEND
...
GTS3SOUND32256A("yrom1.bin", CRC(a0480418) SHA1(a982564d5dbf52275c2e7223687b07cf4ca0a115), "drom1.bin",
                CRC(ec8fc963) SHA1(247e76d87beb3339e7d55292f9eadd2351621cfa), "arom1.bin",
                CRC(38b569b2) SHA1(93be47916a92541d097233b60a42eb7ca587ce52), "arom2.bin",
                CRC(224c2021) SHA1(6b426097a2870b3b32d786be6e66ba6be9f54c29))
GTS3_ROMEND
...
GTS3SOUND32256A("yrom1.bin", CRC(169816d1) SHA1(d23b1d8d1b841ca065a485e80805ecc6342ce57b), "drom1.bin",
                CRC(db28be69) SHA1(6c505c34c8bdccc43dd8f310f01dd3a6b49e8059), "arom1.bin",
                CRC(0fbb130a) SHA1(a171c20f861dac5918c5b410e2a2bdd6e7c0553b), "arom2.bin",
                CRC(0f7632b3) SHA1(a122a062448139d5c1a9daa7d827c3073aa194f7))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(e1379106) SHA1(10c46bad7cbae528716c5ba0709bb1fd3574a0a8), "drom1.bin",
               CRC(6f1d0a3e) SHA1(c7f665d79b9073f28f90debde16cafa9ab57a47c), "arom1.bin",
               CRC(e9cef116) SHA1(5f710bc24e1a168f296a22417aebecbde3bfaa5c), "arom2.bin",
               CRC(0acdfd49) SHA1(0baabd32b546842bc5c76a61b509b558677b50f9))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(09712c37) SHA1(e2ee902ea6eac3e6257880949bd07a90de08e7b9), "drom1.bin",
               CRC(6f04a0ac) SHA1(53bbc182a3bd635ad18504692a4454994daef7ef), "arom1.bin",
               CRC(edce7951) SHA1(4a80d6367a5bebf9fee181456280619aa64b441f), "arom2.bin",
               CRC(dd7ea212) SHA1(adaf0262e315c26b1f4d6365e9d465c7afb6984d))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(c22f5cc5) SHA1(a5bfbc1824bc483eecc961851bd411cb0dbcdc4a), "drom1.bin",
               CRC(9fd04109) SHA1(27864fe4e9c248dce6221c9e56861967d089b216), "arom1.bin",
               CRC(476bb11c) SHA1(ce546df59933cc230a6671dec493bbbe71146dee), "arom2.bin",
               CRC(23708ad9) SHA1(156fcb19403f9845404af1a4ac4edfd3fcde601d))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(9009f461) SHA1(589d94a9ae2269175be9f71b1946107bb85620ee), "drom1.bin",
               CRC(f5c13e80) SHA1(4dd3d35c25e3cb92d6000e463ddce564e112c108), "arom1.bin",
               CRC(8518ff55) SHA1(b31678aa7c1b1240becf0ae0af05b30f7df4a491), "arom2.bin",
               CRC(85a304d9) SHA1(71141dea44e4117cad66089c7a0806de1be1a96a))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(c51d98d8) SHA1(9387a39a03ca90bc8eaddc0c2df8874067a22dea), "drom1.bin",
               CRC(3868e77a) SHA1(2db91c527803a369ca659eaae6022667a126d2ef), "arom1.bin",
               CRC(9e442b71) SHA1(889023af42a2527a51343ccee7f66b089b6e6d01), "arom2.bin",
               CRC(3dad9508) SHA1(70ed49fa82dbe7586bfca72c5020834f9173d563))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(f08e6d7f) SHA1(284214ac80735ddd36933ecd60debc7aea18403c), "drom1.bin",
               CRC(98ae6da4) SHA1(3842c2c4e708a5deae6b5d9407694d337b62384f), "arom1.bin",
               CRC(cccdf23a) SHA1(1b1e31f04cd60d64f0b9b8ab2c6169dacd0bce69), "arom2.bin",
               CRC(d4cc44a1) SHA1(c68264f00efa9f219fc257061ed39cd789e94126))
GTS3_ROMEND
...
GTS3_DMD512_ROMSTART(
    "dsprom.bin",
    CRC(cbdec3ab) SHA1(
        2d70d436783830bf074a7a0590d5c48432136595)) // all other ROMs were identical when dumped, only GPROM differed, but reports also as rev.2
GTS3SOUND32256("yrom1.bin", CRC(f08e6d7f) SHA1(284214ac80735ddd36933ecd60debc7aea18403c), "drom1.bin",
               CRC(98ae6da4) SHA1(3842c2c4e708a5deae6b5d9407694d337b62384f), "arom1.bin",
               CRC(cccdf23a) SHA1(1b1e31f04cd60d64f0b9b8ab2c6169dacd0bce69), "arom2.bin",
               CRC(d4cc44a1) SHA1(c68264f00efa9f219fc257061ed39cd789e94126))
...
GTS3SOUND32256("yrom1.bin", CRC(c5b72153) SHA1(c5d94f3fa815fc33952107c3a3ad698c3c443ce3), "drom1.bin",
               CRC(60779d60) SHA1(2fa09c65ddd6cf638382229062a48163e8972136), "arom1.bin",
               CRC(85cbdda7) SHA1(4eaea8866cb281034e30f425e864419fdb58081f), "arom2.bin",
               CRC(da2c1073) SHA1(faf58099e78dffdce5c15f393ffa3707ec80dd51))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(8b2795b0) SHA1(b838d4e410c815421099c65b0d3b22227dae17c6), "drom1.bin",
               CRC(18d5edf3) SHA1(7d0d46506cf9d4b96b9b93139e3c65643e120c28), "arom1.bin",
               CRC(ece4eebf) SHA1(78f882668967194bd547ace5d22083faeb29ef5e), "arom2.bin",
               CRC(4e466500) SHA1(78c4b41a174d82a7e0e7775713c76e679c8a7e89))
GTS3_ROMEND
...
GTS3SOUND32256("yrom1.bin", CRC(8b2795b0) SHA1(b838d4e410c815421099c65b0d3b22227dae17c6), "drom1.bin",
               ...
               CRC(4e466500) SHA1(78c4b41a174d82a7e0e7775713c76e679c8a7e89))
GTS3_ROMEND
CORE_CLONEDEFNV(wcsoccd2, wcsoccer, "World Challenge Soccer (rev. 1, display rev. 2)", 1994, "Gottlieb", mGTS3DMDS_4C_a,
                0)
...
GTS3SOUND32512256("yrom1.bin", CRC(14f86b56) SHA1(2364c284412eba719f88d50dcf47d5482365dbf3), "drom1.bin",
                  CRC(034c6bc3) SHA1(c483690a6e4ce533b8939e27547175c301316172), "arom1.bin",
                  CRC(f6daa16c) SHA1(be132072b27a94f61653de0a22eecc8b90db3077), "arom2.bin",
                  CRC(59374104) SHA1(8ad7f5f0109771dd5cebe13e80f8e1a9420f4447))
GTS3_ROMEND
...
GTS3SOUND32512256("yrom1.bin", CRC(4a748665) SHA1(9f08b6d0731390c306194808226d2e99fbe9122d), "drom1.bin",
                  CRC(d472210c) SHA1(4607e6f928cb9a5f41175210ba0427b6cd50fb83), "arom1.bin",
                  CRC(6bec0567) SHA1(510c0e5a5af7573761a69bad5ab36f0019767c48), "arom2.bin",
                  CRC(f0e9284d) SHA1(6ffe8286e27b0eecab9620ca613e3d72bb7f77ce))
GTS3_ROMEND
...
/ Shaq Attaq
/-------------------------------------------------------------------*/
static struct core_dispLayout dispShaq[] = {DISP_SEG_IMPORT(GTS3_dispDMD), {7, 1, 0, 3, CORE_SEG7},
                                            {7, 9, 3, 3, CORE_SEG7},       {7, 17, 6, 3, CORE_SEG7},
                                            {7, 25, 9, 3, CORE_SEG7},      {0}};
...
GTS3SOUND32512256("yrom1.bin", CRC(e81e2928) SHA1(4bfe57efa99bb762e4de6c7e88e79b8c5ff57626), "drom1.bin",
                  CRC(16a03261) SHA1(25f5a3d32d2ec80766381106445fd624360fea78), "arom1.bin",
                  CRC(019014ec) SHA1(808a8c3154fca6218fe991b46a2525926d8e51f9), "arom2.bin",
                  CRC(cc5f157d) SHA1(81c3dadff1bbf37a1f091ea77d9061879be7d99c))
GTS3_ROMEND
...
GTS3SOUND32512A("yrom1.bin", CRC(53123fd4) SHA1(77fd183a10eea2e04a07edf9da14ef7aadb65f91), "drom1.bin",
                CRC(781b2b27) SHA1(06decd22b9064ee4859618a043055e0b3e3b9e04), "arom1.bin",
                CRC(a0f62605) SHA1(8c39452367150f66271371ab02be2f5a812cb954))
GTS3_ROMEND
...
GTS3ROMSTART(stargat4, "gprom4.bin",
             CRC(7b8f6920)
                 SHA1(f354593e13c30e15c25580387ef2eb9b23622c89)) // fixes at least the 'Beeping and Garbled DMD' issue
GTS3_DMD512_ROMSTART("dsprom3.bin", CRC(db483524) SHA1(ea14e8b04c32fc403ce2ff060caed5562104a862))
GTS3SOUND32512A("yrom1.bin", CRC(53123fd4) SHA1(77fd183a10eea2e04a07edf9da14ef7aadb65f91), "drom1.bin",
                CRC(781b2b27) SHA1(06decd22b9064ee4859618a043055e0b3e3b9e04), "arom1.bin",
                CRC(a0f62605) SHA1(8c39452367150f66271371ab02be2f5a812cb954))
...
GTS3SOUND32512256("yrom1.bin", CRC(c58941ed) SHA1(3b3545b1e8986b06238576a0cef69d3e3a59a325), "drom1.bin",
                  CRC(d472210c) SHA1(4607e6f928cb9a5f41175210ba0427b6cd50fb83), "arom1.bin",
                  CRC(b3def376) SHA1(94553052cfe80774affebd5b0f99512055552786), "arom2.bin",
                  CRC(59789e66) SHA1(08b7f82f83c53f15cafefb009ab9833457c088cc))
GTS3_ROMEND
...
GTS3SOUND32512("yrom1.bin", CRC(6dddce0a) SHA1(6ad9b023ba8632dda0a4e04a4f66aac52ddd3b09), "drom1.bin",
               CRC(2a8c5d04) SHA1(1a6a698fc05a199923721e91e68aaaa8d3c6a3c2), "arom1.bin",
               CRC(3ee37668) SHA1(9ced05b4f060568bf686974bc2472ff7c05a87c6), "arom2.bin",
               CRC(a631bf12) SHA1(4784da1fabd2858b2c47af71784eb475cbbb4ab5))
GTS3_ROMEND
...
static struct core_dispLayout dispAndretti[] = {
    DISP_SEG_IMPORT(GTS3_dispDMD), {7, 0, 0, 2, CORE_SEG7}, {10, 0, 2, 2, CORE_SEG7}, {13, 0, 4, 2, CORE_SEG7}, {0}};
...
GTS3SOUND32512256("yrom1.bin", CRC(4ffb15b0) SHA1(de4e9b2ccca865deb2595320015a149246795260), "drom1.bin",
                  CRC(d472210c) SHA1(4607e6f928cb9a5f41175210ba0427b6cd50fb83), "arom1.bin",
                  CRC(918c3270) SHA1(aa57d3bfba01e701b02ca7e4f0946144cfb7d4b1), "arom2.bin",
                  CRC(3c61a2f7) SHA1(65cfb5d1261a1b0c219e1786b6635d7b0a188040))
GTS3_ROMEND
...
GTS3SOUND32512256("yrom1.bin", CRC(7c602a35) SHA1(66dbd7679973683c8346836c28c02ff922d17375), "drom1.bin",
                  CRC(ebde41b0) SHA1(38a132f815a5270dff58a5e34f5c73701d6e214d), "arom1.bin",
                  CRC(7171bc86) SHA1(d9b1f54d34400490c219ca3ba566cc40cac517d7), "arom2.bin",
                  CRC(ce83c6c3) SHA1(95a364844525548d28f78d54f9d058728cebf089))
GTS3_ROMEND
...
GTS3SOUND32512256("yrom1.bin", NO_DUMP, "drom1.bin", NO_DUMP, "arom1.bin", NO_DUMP, "arom2.bin", NO_DUMP)
GTS3_ROMEND
CORE_GAMEDEFNV(brooks, "Brooks & Dunn (rev. T1)", 1996, "Gottlieb", mGTS3DMDSA_4C_b,
               0) //!! check colors again if available (4_a, 4_b or 5?)
...
GTS3SOUND32512256("yrom1.bin", CRC(e81e2928) SHA1(4bfe57efa99bb762e4de6c7e88e79b8c5ff57626), "drom1.bin",
                  CRC(16a03261) SHA1(25f5a3d32d2ec80766381106445fd624360fea78), "arom1mz.bin",
                  CRC(68ceeb43) SHA1(debe5a0683b1806c9813ba89a6438afb3eecb188), "arom2mz.bin",
                  CRC(7dabc8ca) SHA1(ca6dc59891222f8534b0a2de8cd29c52e5b33efc))
GTS3_ROMEND
