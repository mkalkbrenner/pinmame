...
#define SAM_SOLENOID_OFF                                                                                               \
    WPCSAM_SOLENOID_OFF /* sol is deactivated and gets to it's rest position, should be used with WPCSAM_F_ONOFF */
