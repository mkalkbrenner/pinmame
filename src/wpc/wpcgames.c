...
DCS_SOUNDROM2m("ttt_s2.rom", CRC(faae93eb) SHA1(672758544b260d7751ac296f5beb2e271e77c50a), "ttt_s3.rom",
               CRC(371ba9b3) SHA1(de6a8cb78e08a434f6668dd4a93cad857acba310)) WPC_ROMEND
...
static core_tGameData phGameData = {GEN_WPC95,
                                    wpc_dispDMD64,
...
DCS_SOUNDROM4xm("S2_030.rom", CRC(bbeb510c) SHA1(05088b6fa89cd203099189c31d132cd062ab8357), "phs3_02.rom",
                CRC(710568a7) SHA1(8c7c28bacc2777722a54bee32375240c9a7441d8), "phs4_02.rom",
                CRC(390df0f2) SHA1(fdf1bb96e26c0245d04be610e1a84cd4e03059ff), "phs5_02.rom",
                CRC(b524513a) SHA1(5e372e409b4d1fc5bcda55af5dc2cbf1dc66e56b)) WPC_ROMEND INPUT_PORTS_START(ph)
CORE_PORTS
SIM_PORTS(0)
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Coin Acceptor 1", KEYCODE_1) COREPORT_BIT(0x0002, "Coin Acceptor 2", KEYCODE_2)
        COREPORT_BIT(0x0004, "Coin Acceptor 3", KEYCODE_3) COREPORT_BIT(0x0010, "Coin Acceptor 4", KEYCODE_4)
            COREPORT_BIT(0x0008, "Coin Acceptor 5", KEYCODE_5) COREPORT_BITTOG(0x0020, "Left Data Key", KEYCODE_DEL)
                COREPORT_BITTOG(0x0040, "Right Data Key", KEYCODE_END)
                    COREPORT_BIT(0x0080, "Change Language", KEYCODE_INSERT)
                        COREPORT_BIT(0x0200, "Cancel Collect", KEYCODE_7) COREPORT_BIT(0x0400, "Red", KEYCODE_8)
                            COREPORT_BIT(0x0800, "Blue", KEYCODE_9)
                                COREPORT_BIT(0x0100, "Super Game", KEYCODE_0) PORT_START /* 1 */
    COREPORT_DIPNAME(0x0001, 0x0001, "SW1") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0001, "1")
        COREPORT_DIPNAME(0x0002, 0x0002, "SW2") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0002, "1")
            COREPORT_DIPNAME(0x0004, 0x0000, "W20") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0004, "1")
                COREPORT_DIPNAME(0x0008, 0x0000, "W19") COREPORT_DIPSET(0x0000, "0") COREPORT_DIPSET(0x0008, "1")
                    COREPORT_DIPNAME(0x00f0, 0x0000, "Country") COREPORT_DIPSET(0x0000, "U.S.A. / Canada 1")
                        COREPORT_DIPSET(0x0010, "France/Coin 6-20F") COREPORT_DIPSET(0x0020, "Germany 1")
                            COREPORT_DIPSET(0x0030, "France 20F Door") COREPORT_DIPSET(0x0040, "Invalid 1")
                                COREPORT_DIPSET(0x0050, "Invalid 2") COREPORT_DIPSET(0x0060, "Invalid 3")
                                    COREPORT_DIPSET(0x0070, "Germany 2") COREPORT_DIPSET(0x0080, "Invalid 4")
                                        COREPORT_DIPSET(0x0090, "France Coin Setting 6")
                                            COREPORT_DIPSET(0x00a0, "Export") COREPORT_DIPSET(0x00b0, "France")
                                                COREPORT_DIPSET(0x00c0, "United Kingdom")
                                                    COREPORT_DIPSET(0x00d0, "Italy") COREPORT_DIPSET(0x00e0, "Spain")
                                                        COREPORT_DIPSET(0x00f0, "U.S.A. / Canada 2") INPUT_PORTS_END
...
/---------------*/
    static core_tGameData tfdmdGameData = {
        ...
        {"",
         ...
         {swStart, swTilt, swSlamTilt, swCoinDoor}}};
INITGAME(tfdmd)
WPC_ROMSTART(tfdmd, l3, "u6_l3.rom", 0x20000, CRC(bd43e28c) SHA1(df0a64a9fddbc59e3edde56ae12b68f76e44ba2e))
WPC_ROMEND
#define input_ports_tfdmd input_ports_wpc
    CORE_GAMEDEF(tfdmd, l3, "WPC Test Fixture: DMD (L-3)", 1991, "Bally", wpc_mDMD,
                 GAME_NO_SOUND) // Slugfest to Demolition Man
...
DCS_SOUNDROM1x("u2_10.rom", CRC(d705b41e) SHA1(a7811b4bb1b2b5f7e3d1a809da3363b97dfca680)) WPC_ROMEND
#define input_ports_tfs input_ports_wpc
    CORE_GAMEDEF(tfs, 12, "WPC Test Fixture: Security (1.2)", 1994, "Bally", wpc_mSecurityS,
                 0) // World Cup Soccer '94 to WhoDunnit
...
DCS_SOUNDROM1m("s2_10.rom", CRC(ceff7fe4) SHA1(ff2574f65e09d446b9e446abd58159a7d100059b)) WPC_ROMEND
...
/============*/
    static core_tGameData tfaGameData = {
        ...
        {"",
         ...
         {swStart, swTilt, swSlamTilt, swCoinDoor}}};
INITGAME(tfa)
WPC_ROMSTART(tfa, 13, "u6_l3.rom", 0x020000, CRC(bf4a37b5) SHA1(91b8bba6182e818a34252a4b2a0b86a2a44d9c42))
WPC_ROMEND
#define input_ports_tfa input_ports_wpc
    CORE_GAMEDEF(tfa, 13, "WPC Test Fixture: Alphanumeric (L-3)", 1990, "Bally", wpc_mAlpha,
                 GAME_NO_SOUND) // Funhouse and The Machine:Bride of Pinbot
