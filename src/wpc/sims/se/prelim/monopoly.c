...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "", KEYCODE_D) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Roll n Win Lane", KEYCODE_W) COREPORT_BIT(0x0080, "Roll n Win Saucer", KEYCODE_E)
                    COREPORT_BIT(0x0100, "Right Ramp", KEYCODE_R) COREPORT_BIT(0x0200, "", KEYCODE_T)
...
static sim_tState monopoly_stateDef[] = {{"Not Installed", 0, 0, 0, stDrain, 0, 0, 0, SIM_STNOTEXCL},
                                         {"Moving"},
...
static int
monopoly_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
        case stShooter:
...
/*--------------------
  ...
  --------------------*/
static void
monopoly_drawStatic(BMTYPE** line) {
...
DE_DMD32ROM8x("mondsp-a.301", CRC(c4e2e032) SHA1(691f7b6ed0616338683f7e3f316d64a70db58dd4))
    DE2S_SOUNDROM1888("mnsndu7.100", CRC(400442e7) SHA1(d6c075dc439d5366b7ae71b5a523b86543b1ecd6), "mnsndu17.100",
                      CRC(f9bc55e8) SHA1(7dc41521305021961927ebde4dcf22611e3d622d), "mnsndu21.100",
                      CRC(e0727e1f) SHA1(2093dba6e2f59cd1d1fc49c8d995b603ea0913ba), "mnsndu36.100",
                      CRC(c845aa97) SHA1(2632aa8c5576b7afcb96693fa524c7d0350ac9a8)) SE_ROMEND
    ...
    SE128_ROMSTART(monopolf, "moncpu.320", CRC(6c107c8b) SHA1(236d85b971c70a30e663787d643e6d589591d582))
        DE_DMD32ROM8x("mondsp-f.301", CRC(e78b1998) SHA1(bd022dc90b55374baed17360fad7bf0f89e2ee33))
            DE2S_SOUNDROM1888("mnsndu7.100", CRC(400442e7) SHA1(d6c075dc439d5366b7ae71b5a523b86543b1ecd6),
                              ...
                              "mnsndu36.100", CRC(c845aa97) SHA1(2632aa8c5576b7afcb96693fa524c7d0350ac9a8)) SE_ROMEND
                    ...
                    CORE_CLONEDEFNV(monopoll, monopoly, "Monopoly (3.20 Spanish)", 2002, "Stern", de_mSES1, GAME_NOCRC)
                        CORE_CLONEDEFNV(monopole, monopoly, "Monopoly (3.03)", 2002, "Stern", de_mSES1, GAME_NOCRC)
                            CORE_CLONEDEFNV(monop301, monopoly, "Monopoly (3.01)", 2002, "Stern", de_mSES1, GAME_NOCRC)
                                CORE_CLONEDEFNV(monop251, monopoly, "Monopoly (2.51)", 2002, "Stern", de_mSES1,
                                                GAME_NOCRC)
                                    CORE_CLONEDEFNV(monoi251, monopoly, "Monopoly (2.51 Italian)", 2002, "Stern",
                                                    de_mSES1, GAME_NOCRC)
                                        CORE_CLONEDEFNV(monop233, monopoly, "Monopoly (2.33)", 2002, "Stern", de_mSES1,
                                                        GAME_NOCRC)
...
static core_tGameData monopolyGameData = {
    GEN_WS,
    dispMonopoly,
    {FLIP_SW(FLIP_L) | FLIP_SOL(FLIP_L), 0, 2, 0, 0, SE_MINIDMD, 0, 0, 0, 0, monopoly_getMech, monopoly_drawMech},
    &monopolySimData,
    {
        "",
...
static WRITE_HANDLER(monopoly_w) {
    ...
    if (offset == 3) {
        ...
        if (data & 0x01) {                            // increase flipper speed if set
            if (locals.flipperSpeed < 4)
                locals.flipperSpeed++;
        } else { // decrease flipper speed if not set
            if (locals.flipperSpeed)
                locals.flipperSpeed--;
        }
        locals.flipperPos += locals.flipperDir * locals.flipperSpeed;
        if (locals.flipperPos < 0)
            locals.flipperPos += 5000;
        if (locals.flipperPos > 4999)
            locals.flipperPos -= 5000;
...
#ifndef PINMAME_NO_UNUSED // currently unused function (GCC 3.4)
static void
monopoly_handleMech(int mech) {}
#endif

static int
monopoly_getMech(int mechNo) {
    static int speedCnt;
    ...
    switch (mechNo) {
        ...
        case 1:
            ...
            speed = (oldSpeed[0] + oldSpeed[1] + oldSpeed[2] + oldSpeed[3] + oldSpeed[4] + oldSpeed[5] + oldSpeed[6]
                     + oldSpeed[7])
                    / 8;
            return speed / 3;
    }
