...
enum { MOTO_DIR_NONE, MOTO_DIR_UP, MOTO_DIR_DOWN };
...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "Launch Button", KEYCODE_ENTER) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "L/R Loop", KEYCODE_L) COREPORT_BIT(0x0080, "Traffic Lite", KEYCODE_T)
                    COREPORT_BIT(0x0100, "Ramp", KEYCODE_R) COREPORT_BIT(0x0200, "Moto Target 1", KEYCODE_W)
                        COREPORT_BIT(0x0400, "Moto Target 2", KEYCODE_E)
                            COREPORT_BIT(0x0800, "Ramp Target 1", KEYCODE_Y)
                                COREPORT_BIT(0x1000, "Ramp Target 2", KEYCODE_U) COREPORT_BIT(0x2000, "Jets", KEYCODE_B)
                                    COREPORT_BIT(0x4000, "Drain", KEYCODE_Q)
                                        COREPORT_BIT(0x8000, "Next City Scoop", KEYCODE_N)

                                            PORT_START /* 1 */
    COREPORT_BIT(0x0001, "L Drop Target", KEYCODE_A) COREPORT_BIT(0x0002, "I Drop Target", KEYCODE_S)
        COREPORT_BIT(0x0004, "V Drop Target", KEYCODE_D) COREPORT_BIT(0x0008, "E Drop Target", KEYCODE_F)
            COREPORT_BIT(0x0010, "R Drop Target", KEYCODE_G) COREPORT_BIT(0x0020, "I Drop Target", KEYCODE_H)
                COREPORT_BIT(0x0040, "D Drop Target", KEYCODE_J) COREPORT_BIT(0x0080, "E Drop Target", KEYCODE_K)
                    COREPORT_BIT(0x0100, "Motorcycle", KEYCODE_M) COREPORT_BIT(0x0200, "Spinner", KEYCODE_X)
                        COREPORT_BIT(0x0400, "", KEYCODE_C) COREPORT_BIT(0x0800, "", KEYCODE_V)
                            COREPORT_BIT(0x1000, "", KEYCODE_SLASH) COREPORT_BIT(0x2000, "", KEYCODE_Z)
                                COREPORT_BIT(0x4000, "", KEYCODE_BACKSPACE)
                                    COREPORT_BIT(0x8000, "", KEYCODE_COMMA) SE_INPUT_PORTS_END
...
static sim_tState harley_stateDef[] = {
    ...
    /*Line 2*/
    {"Shooter", 1, HARLEY_PF_SW_SHOOTER_LANE, HARLEY_COIL_AUTO_LAUNCH, stBallLane, 0, 0, 0,
     SIM_STNOTEXCL | SIM_STSHOOT},
...
static int
harley_handleBallState(sim_tBallStatus* ball, int* inports) {
    static int bumps = 0;
    static int wait = 0;
...
/------------------*/
#define HARLEY_SOUND                                                                                                   \
    DE2S_SOUNDROM18884("hdsnd.u7", CRC(b9accb75) SHA1(9575f1c372ec5603322255778fc003047acc8b01), "hdvc1.u17",          \
                       CRC(0265fe72) SHA1(7bd7b321bfa2a5092cdf273dfaf4ccdb043c06e8), "hdvc2.u21",                      \
                       CRC(89230898) SHA1(42d225e33ac1d679415e9dbf659591b7c4109740), "hdvc3.u36",                      \
                       CRC(41239811) SHA1(94fceff4dbefd3467ecb8b19e4b8baf24ddd68a3), "hdvc4.u37",                      \
                       CRC(a1bc39f6) SHA1(25af40cb3d8f774e1e37cbef9166e41753440460))

SE128_ROMSTART(harl_a13, "harcpu.103", CRC(2a812c75) SHA1(46e1f18e1c9992ca1823f7818b6d51c001f5a934))
DE_DMD32ROM8x("hddispa.104", CRC(fc7c2924) SHA1(172fceb4d3221608f48a4abe4c4c5f3043834957)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_u13, "harcpuk.103", CRC(e39130a7) SHA1(7854c885a82f42f35e266e3cb96a68969d49fbad))
        DE_DMD32ROM8x("hddispa.104",
                      CRC(fc7c2924) SHA1(172fceb4d3221608f48a4abe4c4c5f3043834957)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_a10, "harcpu.103", CRC(2a812c75) SHA1(46e1f18e1c9992ca1823f7818b6d51c001f5a934))
        DE_DMD32ROM8x("hddispa.100",
                      CRC(bdeac0fd) SHA1(5aa1392a13f3c632b660ea6cb3dee23327404d80)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_f13, "harcpu.103", CRC(2a812c75) SHA1(46e1f18e1c9992ca1823f7818b6d51c001f5a934))
        DE_DMD32ROM8x("hddispf.104",
                      CRC(5f80436e) SHA1(e89e561807670118c3d9e623d4aec2321c774576)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_g13, "harcpu.103", CRC(2a812c75) SHA1(46e1f18e1c9992ca1823f7818b6d51c001f5a934))
        DE_DMD32ROM8x("hddispg.104",
                      CRC(c7f197a0) SHA1(3b7f0699c08d387c67ff6cd185360e60fcd21b9e)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_i13, "harcpu.103", CRC(2a812c75) SHA1(46e1f18e1c9992ca1823f7818b6d51c001f5a934))
        DE_DMD32ROM8x("hddispi.104",
                      CRC(387a5aad) SHA1(a0eb99b240f6044db05668c4504e908aee205220)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_l13, "harcpu.103", CRC(2a812c75) SHA1(46e1f18e1c9992ca1823f7818b6d51c001f5a934))
        DE_DMD32ROM8x("hddisps.104",
                      CRC(2d26514a) SHA1(f15b22cad6329f29cd5cccfb91a2ba7ca2cd6d59)) HARLEY_SOUND SE_ROMEND

    CORE_GAMEDEF(harl, a13, "Harley-Davidson (Sega, 1.03, Display 1.04)", 1999, "Sega", de_mSES1,
                 0) CORE_CLONEDEF(harl, u13, a13, "Harley-Davidson (Sega, 1.03 English)", 1999, "Sega", de_mSES1, 0)
...
/-------------------------------------------------------------------*/
    SE128_ROMSTART(harl_a40, "harcpu.400", CRC(752ed258) SHA1(aea0ab3c45649178a3b0e17a2eacc516600a2b63))
        DE_DMD32ROM8x("hddispa.400",
                      CRC(e2c98397) SHA1(212ac1a509f608c490dc4dfdc5cc04187ed2fe10)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_f40, "harcpu.400", CRC(752ed258) SHA1(aea0ab3c45649178a3b0e17a2eacc516600a2b63))
        DE_DMD32ROM8x("hddispf.400",
                      CRC(d061c238) SHA1(cb29e58970d43c2845c96e149e8fdd0c16e501c9)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_g40, "harcpu.400", CRC(752ed258) SHA1(aea0ab3c45649178a3b0e17a2eacc516600a2b63))
        DE_DMD32ROM8x("hddispg.400",
                      CRC(4bc89a23) SHA1(fb7dcc61194560845e150bc1c032c098ffd026e8)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_i40, "harcpu.400", CRC(752ed258) SHA1(aea0ab3c45649178a3b0e17a2eacc516600a2b63))
        DE_DMD32ROM8x("hddispi.400",
                      CRC(c4fc4990) SHA1(79d501c3123b604becbb87c12aca9848675811ec)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_l40, "harcpu.400", CRC(752ed258) SHA1(aea0ab3c45649178a3b0e17a2eacc516600a2b63))
        DE_DMD32ROM8x("hddispl.400",
                      CRC(96096e73) SHA1(b22f03ab3f08ff192a55e92ebe85bafa893c6234)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_a30, "harcpu.300", CRC(c4ba9df5) SHA1(6bdcd555db946e396b630953db1ba50677177137))
        DE_DMD32ROM8x("hddispa.300",
                      CRC(61b274f8) SHA1(954e4b3527cefcb24376de9f6f7e5f9192ab3304)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_f30, "harcpu.300", CRC(c4ba9df5) SHA1(6bdcd555db946e396b630953db1ba50677177137))
        DE_DMD32ROM8x("hddispf.300",
                      CRC(106f7f1f) SHA1(92a8ab7d834439a2211208e0812cdb1199acb21d)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_g30, "harcpu.300", CRC(c4ba9df5) SHA1(6bdcd555db946e396b630953db1ba50677177137))
        DE_DMD32ROM8x("hddispg.300",
                      CRC(8f7da748) SHA1(fee1534b76769517d4e6dbed373583e573fb95b6)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_i30, "harcpu.300", CRC(c4ba9df5) SHA1(6bdcd555db946e396b630953db1ba50677177137))
        DE_DMD32ROM8x("hddispi.300",
                      CRC(686d3cf6) SHA1(fb27e2e4b39abb56deb1e66f012d151126971474)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_l30, "harcpu.300", CRC(c4ba9df5) SHA1(6bdcd555db946e396b630953db1ba50677177137))
        DE_DMD32ROM8x("hddispl.300",
                      CRC(4cc7251b) SHA1(7660fca37ac9fb442a059ddbafc2fa13f94dfae1)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_a18, "harcpu.108", CRC(a8e24328) SHA1(cc32d97521f706e3d8ddcf4117ec0c0e7424a378))
        DE_DMD32ROM8x("hddispa.105",
                      CRC(401a7b9f) SHA1(37e99a42738c1147c073585391772ecc55c9a759)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_f18, "harcpu.108", CRC(a8e24328) SHA1(cc32d97521f706e3d8ddcf4117ec0c0e7424a378))
        DE_DMD32ROM8x("hddispf.105",
                      CRC(31c77078) SHA1(8a0e2dbb698da77dffa1ab01df0f360fecf6c4c7)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_g18, "harcpu.108", CRC(a8e24328) SHA1(cc32d97521f706e3d8ddcf4117ec0c0e7424a378))
        DE_DMD32ROM8x("hddispg.105",
                      CRC(aed5a82f) SHA1(4c44b052a9b1fa702ff49c9b2fb7cf48173459d2)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_i18, "harcpu.108", CRC(a8e24328) SHA1(cc32d97521f706e3d8ddcf4117ec0c0e7424a378))
        DE_DMD32ROM8x("hddispi.105",
                      CRC(49c53391) SHA1(98f88eb8a49bbc59f78996d713c72ec495ba806f)) HARLEY_SOUND SE_ROMEND

    SE128_ROMSTART(harl_l18, "harcpu.108", CRC(a8e24328) SHA1(cc32d97521f706e3d8ddcf4117ec0c0e7424a378))
        DE_DMD32ROM8x("hddisps.105",
                      CRC(6d6f2a7c) SHA1(1609c69a1584398c3504bb5a0c46f878e8dd547c)) HARLEY_SOUND SE_ROMEND

    CORE_GAMEDEF(harl, a40, "Harley-Davidson (Stern, 4.00)", 2004, "Stern", de_mSES1,
                 0) CORE_CLONEDEF(harl, f40, a40, "Harley-Davidson (Stern, 4.00 French)", 2004, "Stern", de_mSES1, 0)
        CORE_CLONEDEF(harl, g40, a40, "Harley-Davidson (Stern, 4.00 German)", 2004, "Stern", de_mSES1, 0)
            CORE_CLONEDEF(harl, i40, a40, "Harley-Davidson (Stern, 4.00 Italian)", 2004, "Stern", de_mSES1, 0)
                CORE_CLONEDEF(harl, l40, a40, "Harley-Davidson (Stern, 4.00 Spanish)", 2004, "Stern", de_mSES1,
                              0) CORE_CLONEDEF(harl, a30, a40, "Harley-Davidson (Stern, 3.00)", 2004, "Stern", de_mSES1,
                                               0) CORE_CLONEDEF(harl, f30, a40, "Harley-Davidson (Stern, 3.00 French)",
                                                                2004, "Stern", de_mSES1, 0)
                    CORE_CLONEDEF(harl, g30, a40, "Harley-Davidson (Stern, 3.00 German)", 2004, "Stern", de_mSES1, 0)
                        CORE_CLONEDEF(harl, i30, a40, "Harley-Davidson (Stern, 3.00 Italian)", 2004, "Stern", de_mSES1,
                                      0) CORE_CLONEDEF(harl, l30, a40, "Harley-Davidson (Stern, 3.00 Spanish)", 2004,
                                                       "Stern", de_mSES1, 0)
                            CORE_CLONEDEF(harl, a18, a40, "Harley-Davidson (Stern, 1.08)", 2003, "Stern", de_mSES1, 0)
                                CORE_CLONEDEF(harl, f18, a40, "Harley-Davidson (Stern, 1.08 French)", 2003, "Stern",
                                              de_mSES1, 0)
                                    CORE_CLONEDEF(harl, g18, a40, "Harley-Davidson (Stern, 1.08 German)", 2003, "Stern",
                                                  de_mSES1, 0)
                                        CORE_CLONEDEF(harl, i18, a40, "Harley-Davidson (Stern, 1.08 Italian)", 2003,
                                                      "Stern", de_mSES1, 0)
                                            CORE_CLONEDEF(harl, l18, a40, "Harley-Davidson (Stern, 1.08 Spanish)", 2003,
                                                          "Stern", de_mSES1, 0)
...
static core_tGameData harlGameData = {
    GEN_WS,
    se_dmd128x32,
    {FLIP_SW(FLIP_L) | FLIP_SOL(FLIP_L), 0, 2, 0, 0, 0, 0, 0, 0, harley_handleMech, NULL, harley_drawMech},
    &harleySimData,
    {
        "",
...
static void
harley_drawMech(BMTYPE** line) {
    char temp[255];
    if (locals.motopos >= MOTO_UP)
        sprintf(temp, "Up");
    else if (locals.motopos <= MOTO_DOWN)
        sprintf(temp, "Down");
    else {
        if (locals.motodir == MOTO_DIR_UP)
            sprintf(temp, "Mov.Up");
        else if (locals.motodir == MOTO_DIR_DOWN)
