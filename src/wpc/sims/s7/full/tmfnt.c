...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "Lower Standups", KEYCODE_EQUALS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0080, "Right Jet", KEYCODE_E)
                    COREPORT_BIT(0x0100, "Bottom Jet", KEYCODE_R)
                        COREPORT_BIT(0x0200, "Middle Standups", KEYCODE_OPENBRACE) COREPORT_BIT(0x0400, "Top Standups",
                                                                                                KEYCODE_QUOTE)
                            COREPORT_BIT(0x0800, "LR/RL Loop", KEYCODE_L) COREPORT_BIT(0x1000, "Ramp Target", KEYCODE_K)
                                COREPORT_BIT(0x2000, "Left Lane", KEYCODE_L) COREPORT_BIT(0x4000, "Drain", KEYCODE_Q)

                                    PORT_START
    COREPORT_BIT(0x0001, "1", KEYCODE_T) COREPORT_BIT(0x0002, "2", KEYCODE_Y) COREPORT_BIT(0x0004, "3", KEYCODE_U)
        COREPORT_BIT(0x0008, "4", KEYCODE_I) COREPORT_BIT(0x0010, "5", KEYCODE_O) COREPORT_BIT(0x0020, "F", KEYCODE_A)
            COREPORT_BIT(0x0040, "A", KEYCODE_S) COREPORT_BIT(0x0080, "N", KEYCODE_D)
                COREPORT_BIT(0x0100, "T", KEYCODE_F) COREPORT_BIT(0x0200, "A", KEYCODE_G)
                    COREPORT_BIT(0x0400, "S", KEYCODE_H) COREPORT_BIT(0x0800, "Y", KEYCODE_J)
...
static sim_tState tmfnt_stateDef[] = {{"Not Installed", 0, 0, 0, stDrain, 0, 0, 0, SIM_STNOTEXCL},
                                      {"Moving"},
...
static int
tmfnt_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
/  ROM definitions
/------------------*/
S7_ROMSTART8088(tmfnt, l5, "ic14.716", CRC(56b8e5ad) SHA1(84d6ab59032282cdccb3bdce0365c1fc766d0e5b), "ic17.532",
                ...
                CRC(0f86947c) SHA1(e775f44b4ca5dae5ec2626fa84fae83c4f0c5c33))
...
static sim_tSimData tmfntSimData = {
    ...
    {stOuthole, stDrain, stDrain, stDrain, stDrain, stDrain,
...
static core_tGameData tmfntGameData = {
    GEN_S7,        s7_dispS7, {0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, tmfnt_drawMech, NULL, NULL},
    &tmfntSimData, {{0}},     {0, {33, 34, 37, 38, 35, 0, 0, 0}}};
