...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "L/R Inlane", KEYCODE_I) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Ramp", KEYCODE_R)
                COREPORT_BIT(0x0040, "L/R Upper Drop 1", KEYCODE_A) COREPORT_BIT(0x0080, "L/R Upper Drop 2", KEYCODE_S)
                                    ...
                                    COREPORT_BIT(0x1000, "Bumper", KEYCODE_B)
                                        COREPORT_BIT(0x2000, "Turnaround", KEYCODE_T)
                                            COREPORT_BIT(0x4000, "Drain", KEYCODE_Q)
                                                COREPORT_BIT(0x8000, "Lock", KEYCODE_L) PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Eject hole", KEYCODE_E) S7_INPUT_PORTS_END
...
static sim_tState bk_stateDef[] = {{"Not Installed", 0, 0, 0, stDrain, 0, 0, 0, SIM_STNOTEXCL},
                                   {"Moving"},
...
static void
bk_handleMech(int mech) {
    if (core_getSol(sLLDropReset)) {
        core_setSw(swLL1Drop, FALSE);
        core_setSw(swLL2Drop, FALSE);
        core_setSw(swLL3Drop, FALSE);
    }
    if (core_getSol(sLRDropReset)) {
        core_setSw(swLR1Drop, FALSE);
        core_setSw(swLR2Drop, FALSE);
        core_setSw(swLR3Drop, FALSE);
    }
    if (core_getSol(sULDropReset)) {
        core_setSw(swUL1Drop, FALSE);
        core_setSw(swUL2Drop, FALSE);
        core_setSw(swUL3Drop, FALSE);
    }
    if (core_getSol(sURDropReset)) {
        core_setSw(swUR1Drop, FALSE);
        core_setSw(swUR2Drop, FALSE);
        core_setSw(swUR3Drop, FALSE);
    }
}
...
static sim_tInportData bk_inportData[] = {
    /* Port 0 */
    {0, 0x0005, swLInlane},  {0, 0x0006, swRInlane},
    {0, 0x0009, stLOutlane}, {0, 0x000a, stROutlane},
    {0, 0x0011, swLSling},   {0, 0x0012, swRSling},
    {0, 0x0021, swLRamp},    {0, 0x0022, swRRamp},
    {0, 0x0041, stUL1Drop},  {0, 0x0081, stUL2Drop},
    {0, 0x0101, stUL3Drop},  {0, 0x0042, stUR1Drop},
    {0, 0x0082, stUR2Drop},  {0, 0x0102, stUR3Drop},
    {0, 0x0201, stLL1Drop},  {0, 0x0401, stLL2Drop},
    {0, 0x0801, stLL3Drop},  {0, 0x0202, stLR1Drop},
    {0, 0x0402, stLR2Drop},  {0, 0x0802, stLR3Drop},
    {0, 0x1000, swBumper},   {0, 0x2000, swTurnAround},
    {0, 0x4000, stDrain},    {0, 0x8000, stULock},
    {1, 0x0001, stEject},    {0}};
...
/  ROM definitions
/------------------*/
S7_ROMSTART8088(bk, l4, "ic14.716", CRC(fcbe3d44) SHA1(92ec4d41beea205ba29530624b68dd1139053535), "ic17.532",
                ...
                CRC(104b78da) SHA1(c3af2563b3b380fe0e154b737799f6beacf8998c))
S67S_SOUNDROMS8("sound12.716", CRC(6d454c0e) SHA1(21640b9ed3bdbae8bf27629891f355304e467c64))
S67S_SPEECHROMS0000("speech7.532", CRC(c7e229bf) SHA1(3b2ab41031f507963af828639f1690dc350737af), "speech5.532",
                    CRC(411bc92f) SHA1(6c8d26fd13ed5eeba5cc40886d39c65a64beb377), "speech6.532",
                    CRC(fc985005) SHA1(9df4ad12cf98a5a92b8f933e6b6788a292c8776b), "speech4.532",
                    CRC(f36f12e5) SHA1(24fb192ad029cd35c08f4899b76d527776a4895b))
S7_ROMEND

S7_ROMSTART8088(bk, f4, "ic14.716", CRC(fcbe3d44) SHA1(92ec4d41beea205ba29530624b68dd1139053535), "ic17.532",
                CRC(bb571a17) SHA1(fb0b7f247673dae0744d4188e1a03749a2237165), "ic20.716",
                CRC(dfb4b75a) SHA1(bcf017b01236f755cee419e398bbd8955ae3576a), "ic26.716",
                CRC(104b78da) SHA1(c3af2563b3b380fe0e154b737799f6beacf8998c))
S67S_SOUNDROMS8("sound12.716", CRC(6d454c0e) SHA1(21640b9ed3bdbae8bf27629891f355304e467c64))
S67S_SPEECHROMS0000("speech7f.532", CRC(01debff6) SHA1(dc02199b63ae3309fdac819985f7a40010831634), "speech5f.532",
                    CRC(2d310dce) SHA1(ad2ad3844659787ee9be4db50b17b8af6f5d0d42), "speech6f.532",
                    CRC(96bb719b) SHA1(d602129ce1af1902e46ca26645a9a51324a788d0), "speech4f.532",
                    CRC(8ee8fc3c) SHA1(ba7c00f16bdbd7413cec025c28f8b7e7bbcb12bb))
S7_ROMEND

S7_ROMSTART8088(bk, l3, "bkl3_14.bin", CRC(74c37e4f) SHA1(8946b110901d0660676fba0c204aa2bc78223508), "ic17.532",
                CRC(bb571a17) SHA1(fb0b7f247673dae0744d4188e1a03749a2237165), "ic20.716",
                CRC(dfb4b75a) SHA1(bcf017b01236f755cee419e398bbd8955ae3576a), "bkl3_26.bin",
                CRC(6acc34a0) SHA1(3adad61d27e6416630f96554687bb66d3016166a))
S67S_SOUNDROMS8("sound12.716", CRC(6d454c0e) SHA1(21640b9ed3bdbae8bf27629891f355304e467c64))
S67S_SPEECHROMS0000("speech7.532", CRC(c7e229bf) SHA1(3b2ab41031f507963af828639f1690dc350737af), "speech5.532",
                    CRC(411bc92f) SHA1(6c8d26fd13ed5eeba5cc40886d39c65a64beb377), "speech6.532",
                    CRC(fc985005) SHA1(9df4ad12cf98a5a92b8f933e6b6788a292c8776b), "speech4.532",
...
static core_tGameData bkGameData = {
    GEN_S7,     s7_dispS7, {0, 0, 0, 0, 0, 0, 0, 0, NULL, bk_handleMech, NULL, NULL, NULL, NULL},
    &bkSimData, {{0}},     {0, {21, 22, 36, 0, 0, 0}}};
