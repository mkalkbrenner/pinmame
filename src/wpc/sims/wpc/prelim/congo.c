...
static int
congo_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {}
    return 0;
}
...
DCS_SOUNDROM3m("cgs2v1_1.rom", CRC(2b7637ae) SHA1(5b5d7214c632a506b986c892b39b1356b2909598), "cgs3v1_0.rom",
               CRC(6cfd9fe0) SHA1(a76267f865c645648c8cb27aec2d05062a4a20b5), "cgs4v1_0.rom",
               CRC(2a1980e7) SHA1(0badf27c2b8bc7b0074dc5e606d64490470bc108)) WPC_ROMEND
    ...
    WPC_ROMSTART(congo, 20s10k, "cong2_00.rom", 0x80000, CRC(e1a256ac) SHA1(f1f7a1865b5a0220e2f2ef492059df158451ca5b))
        DCS_SOUNDROM6x("su2-100.rom", CRC(c4b59ac9) SHA1(a0bc5150120777c771a181496ced71bd3f92a311), "su3-100.rom",
                       CRC(1d4dbc9a) SHA1(3fac6ffb1af806d1dfcf71d85b0be21e7ea4b8d2), "su4-100.rom",
                       CRC(a3e9fd93) SHA1(7d767ddf22080f9886621a5130929d7afce90472), "su5-100.rom",
                       CRC(c397b3f6) SHA1(ef4cc5a08a55ae941f42d2b02213cc5c85d67b43), "su6-100.rom",
                       CRC(f89a29a2) SHA1(63f69ae6a886d9eac44627edd5ee561bdb3dd418), "su7-100.rom",
                       CRC(d1244d35) SHA1(7c5b3fcf8a35c417c778cd9bc741b92aaffeb444)) WPC_ROMEND
...
/---------------*/
    CORE_GAMEDEF(congo, 21, "Congo (2.1, DCS95 S1.1)", 1995, "Williams", wpc_m95S, 0)
        CORE_CLONEDEF(congo, 20, 21, "Congo (2.0, DCS95 S1.1)", 1995, "Williams", wpc_m95S, 0)
            CORE_CLONEDEF(congo, 20s10k, 21, "Congo (2.0, WPC-S S1.0-kit)", 1995, "Williams", wpc_m95DCSS,
...
static core_tGameData congoGameData = {
    GEN_WPC95,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L | FLIP_UL), 0, 0, 0, 0, 0, 1},
    &congoSimData,
    {
