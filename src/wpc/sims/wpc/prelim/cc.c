...
static int
cc_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
DCS_SOUNDROM6m("sav2_8.rom", CRC(94928841) SHA1(953586d6abe8222a6cd6b74e417fa4ce078efa43), "sav3_8.rom",
               CRC(a22b13f0) SHA1(5df6ea9d5059cd04bdb369c1c7255b09d64b3c65), "sav4_8.rom",
               CRC(fe8324e2) SHA1(72c56d094cb4185a083a7da81fd527a908ce9de0), "sav5_8.rom",
               CRC(1b2a1ff3) SHA1(2d9a5952c7ac000c47d87d198ff7ca62913ec73f), "sav6_8.rom",
               CRC(2cccf10e) SHA1(3b9b9c87ab3c0d74eaacde416d18f3357f8302bd), "sav7_8.rom",
               CRC(90fb1277) SHA1(502c920e1d54d285a4d4af401e574f785149da47)) WPC_ROMEND
        ...
        CORE_CLONEDEF(cc, 12, 13, "Cactus Canyon (1.2)", 1998, "Bally", wpc_m95S, 0)
            CORE_CLONEDEF(cc, 10, 13, "Cactus Canyon (1.0)", 1998, "Bally", wpc_m95S, 0)
                CORE_CLONEDEF(cc, 13k, 13, "Cactus Canyon (1.3 Real Knocker patch)", 1998, "Bally", wpc_m95S, 0)
                    CORE_CLONEDEF(cc, 104, 13, "Cactus Canyon (1.04 Test 0.2)", 1998, "Bally / The Pinball Factory",
                                  wpc_m95S, 0)
...
static core_tGameData ccGameData = {
    GEN_WPC95,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L), 0, 0, 0, 0, 0, 1, 0, NULL, NULL, NULL, NULL, &cc_lampPos, NULL},
    &ccSimData,
    {
