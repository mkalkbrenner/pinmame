    ...
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0080, "Bottom Jet", KEYCODE_E)
...
static sim_tState jm_stateDef[] = {{"Not Installed", 0, 0, 0, stDrain, 0, 0, 0, SIM_STNOTEXCL},
                                   {"Moving"},
...
static int
jm_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {}
    return 0;
}
...
DCS_SOUNDROM7x("jm_u2_s.1_0", CRC(4aeeff3d) SHA1(861b65b97715182385e2fe076af1fb2eb2ccc298), "jm_u3_s.1_0",
               CRC(9bf7bc43) SHA1(94fa83be84940a4db0143acc330aacded1d0d9ca), "jm_u4_s.1_0",
               CRC(2e044582) SHA1(0de30f6c223338a67f9332de038baf1398d9043e), "jm_u5_s.1_0",
               CRC(50cc06a7) SHA1(fa3072a8bc9be72fe974413094f0944d98cf3857), "jm_u6_s.1_0",
               CRC(bfc94707) SHA1(a1f4d35a4b1d80c8160e937458a8e5181f295f28), "jm_u7_s.1_0",
               CRC(9d4d9e9d) SHA1(d6e074806eed6fedc169c4849a9dd9ac2beed07e), "jm_u8_s.1_0",
               CRC(fc7af6c0) SHA1(a70dadf86d1af2122b58fdd85e938d50d113305f)) WPC_ROMEND
    ...
    WPC_ROMSTART(jm, 05r, "john0_5r.rom", 0x80000, CRC(57df5654) SHA1(b27c66dac592dd9db84ee86836216581b4cde3b1))
        DCS_SOUNDROM7x("jm_u2_s.038", CRC(3b291732) SHA1(d0ce122b2a8c1ce04fe4ad1bef633514bb0c8f9f), "jm_u3_s.038",
                       CRC(653c2fc5) SHA1(8d462314394f8babed89f7cf70ce2df534cae13e), "jm_u4_s.038",
                       CRC(d0cfd604) SHA1(3844667135645653f1766d12d40752ddac2ec830), "jm_u5_s.038",
                       CRC(58d5276d) SHA1(8b74b9fc87c6df015f32201499e25c0135a65568), "jm_u6_s.038",
                       CRC(534ef536) SHA1(9706ca9f422f10f85e81cea965c31c96c662bc34), "jm_u7_s.038",
                       CRC(ce07e128) SHA1(b65e2bd1263f597320b53300868343ce9b6bd395), "jm_u8_s.038",
                       CRC(f463d70a) SHA1(7fd701dcdd8672d7e4d45f400d507cc0f4db2578)) WPC_ROMEND
...
/---------------*/
    CORE_GAMEDEF(jm, 12r, "Johnny Mnemonic (1.2R)", 1995, "Williams", wpc_mSecurityS, 0)
        CORE_CLONEDEF(jm, 12b, 12r, "Johnny Mnemonic (1.2B Belgian)", 1995, "Williams", wpc_mSecurityS, 0)
            CORE_CLONEDEF(jm, 05r, 12r, "Johnny Mnemonic (0.5R Prototype)", 1995, "Williams", wpc_mSecurityS,
                          0) // is this actually the 0.4 mentioned in the version history?
...
static int
jm_getMech(int mechNo) {
    switch (mechNo) {
        case 0:
            return locals.xPos + 64;
        case 1:
            return locals.yPos + 300;
    }
    return 0;
}

static void
jm_drawMech(BMTYPE** line) {
...
static core_tGameData jmGameData = {
    GEN_WPCSECURITY,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L) | FLIP_BUT(FLIP_L | FLIP_U), 0, 0, 0, 0, 0, 0, 0, 0, jm_handleMech,
     jm_getMech, jm_drawMech, 0, NULL},
    &jmSimData,
    {
