...
static int
dw_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {}
    return 0;
}
...
WPCS_SOUNDROM288(
    "dw_u18.l2",
    CRC(b9120ce9) SHA1(
        a2bb7443939358590ce1cb56d739fafbad4baf4d), // this one actually came from an otherwise prototype machine that had the dw_p5.u6 on it! unknown why that one also had this L2 sound ROM
    "dw_u15.l1", CRC(9b87ff26) SHA1(483206ca0abdad4557843f83f245a1c20234af64), "dw_u14.l1",
    CRC(71f7d55b) SHA1(c3a22cfce2d10fe94a9749af7018e17e5e3bf4b3))
WPC_ROMEND
WPC_ROMSTART(dw, d2, "drwho_d2.rom", 0x80000, CRC(7d00b039) SHA1(2dcd1afbdf88dd9ebf974f62c8a82603c7256e40))
WPCS_SOUNDROM288("dw_u18.l2", CRC(b9120ce9) SHA1(a2bb7443939358590ce1cb56d739fafbad4baf4d), "dw_u15.l1",
                 CRC(9b87ff26) SHA1(483206ca0abdad4557843f83f245a1c20234af64), "dw_u14.l1",
                 CRC(71f7d55b) SHA1(c3a22cfce2d10fe94a9749af7018e17e5e3bf4b3))
WPC_ROMEND

WPC_ROMSTART(dw, l1, "dw_l1.u6", 0x80000, CRC(af8279af) SHA1(89651689156c0bf4abe35a538dc35c69f6575d4a))
WPCS_SOUNDROM288("dw_u18.l1", CRC(1ca78024) SHA1(e652b07e21b59c8c497a20dfddcb9ddd8cad228d), "dw_u15.l1",
                 CRC(9b87ff26) SHA1(483206ca0abdad4557843f83f245a1c20234af64), "dw_u14.l1",
                 CRC(71f7d55b) SHA1(c3a22cfce2d10fe94a9749af7018e17e5e3bf4b3))
WPC_ROMEND
...
WPCS_SOUNDROM288("dw_u18.p4", CRC(357e0b6f) SHA1(9e65823dc001b9347776e4e806d11f094f60c259), "dw_u15.l1",
                 CRC(9b87ff26) SHA1(483206ca0abdad4557843f83f245a1c20234af64), // a dumped u15 p4 was the same as l1
                 "dw_u14.l1",
                 CRC(71f7d55b) SHA1(c3a22cfce2d10fe94a9749af7018e17e5e3bf4b3)) // a dumped u14 p4 was the same as l1
WPC_ROMEND
...
static core_tGameData dwGameData = {
    GEN_WPCFLIPTRON,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L | FLIP_UL), 0, 0, 0, 0, 0, 0, 0, NULL, dw_handleMech, NULL, NULL, NULL,
     NULL},
    &dwSimData,
    {
        "",
...
/*
  ...
  */
void
dw_wpc_proc_solenoid_handler(int solNum, int enabled, int smoothed) {
