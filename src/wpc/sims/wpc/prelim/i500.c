...
/*-----------------------
 ...
 ------------------------*/
static struct { int turboPos, speedCount, speed; } locals;
...
static int
i500_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {}
    return 0;
}

static void
i500_handleMech(int mech) {
    if (mech & 0x01) {
...
static int
i500_getMech(int mechNo) {
    return mechNo ? locals.turboPos : locals.speed;
}

static void
i500_drawMech(BMTYPE** line) {
...
DCS_SOUNDROM6x("su2", CRC(d2f9ab24) SHA1(ac96fdce6545d1017fa3ed7567061ae2e0653750), "su3",
               CRC(067f4df6) SHA1(0adc116bfebefb17f27718bdd2401c336b07078f), "su4",
               CRC(229b96c2) SHA1(77eda81fd011fc818c3fde5e1094cfb3f12372c6), "su5",
               CRC(f0c006a5) SHA1(ead07bb131bd581c41ab0833f6269de7e574017c), "su6",
               CRC(a2b60d31) SHA1(0e0ddb310ec78e0963794994edd0c6bbc4863f4f), "su7",
               CRC(94eea5a4) SHA1(afb00e799dbc01c67ed2c4aa399e8a7365ca3dd3)) WPC_ROMEND
...
static core_tGameData i500GameData = {
    GEN_WPCSECURITY,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L | FLIP_UR), 0, 0, 0, 0, 0, 0, 0, NULL, i500_handleMech, i500_getMech,
     i500_drawMech, NULL, NULL},
    &i500SimData,
    {
