...
static sim_tState mb_stateDef[] = {{"Not Installed", 0, 0, 0, stDrain, 0, 0, 0, SIM_STNOTEXCL},
                                   {"Moving"},
...
static int
mb_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {}
    return 0;
}
...
DCS_SOUNDROM6xm("mb_s2.rom", CRC(9152f559) SHA1(68d455d8b875101caedafd21b59c447f326566dd), "mb_s3.rom",
                CRC(c3cd6e81) SHA1(b041979c8955907090b30960780cecb19258bd5e), "mb_s4.rom",
                CRC(00b88352) SHA1(5da75e0b400eb71583681e06088eb97fc12e7f17), "mb_s5.rom",
                CRC(dae16105) SHA1(15878ef8685f3e9fc8eb2a2401581d30fe706e89), "mb_s6.rom",
                CRC(3975d5da) SHA1(6dbb34a827c0956e6aef1401c12cba88ae370e1f), "mb_s7.rom",
                CRC(c242fb78) SHA1(c5a2a37ff3414d1e946cddb69b5e8f067b50bcc6)) WPC_ROMEND
...
static core_tGameData mbGameData = {
    GEN_WPC95,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L), 0, 0, 0, 0, 0, 1, 0, NULL, mb_handleMech, mb_getMech, mb_drawMech,
     NULL, NULL},
    &mbSimData,
    {
...
static mech_tInitData mb_mech[] = {{28,
                                    0,
                                    MECH_LINEAR | MECH_REVERSE | MECH_ONESOL,
                                    BANKTIME,
                                    BANKTIME,
