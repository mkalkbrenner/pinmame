    ...
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0080, "Middle Jet", KEYCODE_E)
                    COREPORT_BIT(0x0100, "Right Jet", KEYCODE_R) COREPORT_BIT(0x0200, "", KEYCODE_T)
...
static int
nbaf_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {}
    return 0;
}
...
#define NBAF_SOUND                                                                                                     \
    DCS_SOUNDROM5xm("fb-s2.1_0", CRC(32f42a82) SHA1(387636c8e9f8525e7442ccdced735392db113044), "fb-s3.1_0",            \
                    CRC(033aa54a) SHA1(9221f3013f204a9a857aced5d774c606a7e48648), "fb-s4.1_0",                         \
                    CRC(6965a7c5) SHA1(7e72bbd3bad9accc8da1754c57c24ebdf13e57b9), "fb-s5.1_0",                         \
                    CRC(db50b79a) SHA1(9753d599cd822b55ed64bcf64955f625dc51997d), "fb-s6.1_0",                         \
                    CRC(f1633371) SHA1(a707748d3298ffb6d10d8308f4dae7982b540fa0))

/*-----------------
/  ROM definitions
/------------------*/
WPC_ROMSTART(nbaf, 31, "fb_g11.3_1", 0x80000, CRC(acd84ec2) SHA1(bd641b26e7a577be9f8705b21de4a694400945ce))
DCS_SOUNDROM5m("fb-s2.3_0", CRC(4594abd3) SHA1(d14654f0c2d29c28cae604e2dbcc9adf361b28a9), "fb-s3.1_0",
               CRC(033aa54a) SHA1(9221f3013f204a9a857aced5d774c606a7e48648), "fb-s4.1_0",
               CRC(6965a7c5) SHA1(7e72bbd3bad9accc8da1754c57c24ebdf13e57b9), "fb-s5.1_0",
               CRC(db50b79a) SHA1(9753d599cd822b55ed64bcf64955f625dc51997d), "fb-s6.1_0",
               CRC(f1633371) SHA1(a707748d3298ffb6d10d8308f4dae7982b540fa0)) WPC_ROMEND
    WPC_ROMSTART(nbaf, 31a, "fb_g11.3_1", 0x80000,
                 CRC(acd84ec2) SHA1(bd641b26e7a577be9f8705b21de4a694400945ce)) NBAF_SOUND WPC_ROMEND

    WPC_ROMSTART(nbaf, 11, "g11-11.rom", 0x80000,
                 CRC(debfb64a) SHA1(7f50246f5fde1e7fc295be6b6bbd455e244e4c99)) NBAF_SOUND WPC_ROMEND
    WPC_ROMSTART(nbaf, 11a, "g11-11.rom", 0x80000, CRC(debfb64a) SHA1(7f50246f5fde1e7fc295be6b6bbd455e244e4c99))
        DCS_SOUNDROM5m("fb-s2.2_0", CRC(f950f481) SHA1(8d7c54c5f27a85889179ee690512fa69b1357bb6), "fb-s3.1_0",
                       CRC(033aa54a) SHA1(9221f3013f204a9a857aced5d774c606a7e48648), "fb-s4.1_0",
                       CRC(6965a7c5) SHA1(7e72bbd3bad9accc8da1754c57c24ebdf13e57b9), "fb-s5.1_0",
                       CRC(db50b79a) SHA1(9753d599cd822b55ed64bcf64955f625dc51997d), "fb-s6.1_0",
                       CRC(f1633371) SHA1(a707748d3298ffb6d10d8308f4dae7982b540fa0)) WPC_ROMEND
    WPC_ROMSTART(nbaf, 11s, "g11-11.rom", 0x80000, CRC(debfb64a) SHA1(7f50246f5fde1e7fc295be6b6bbd455e244e4c99))
        DCS_SOUNDROM5xm("fb-s2.0_4", CRC(6a96f42b) SHA1(b6019bccdf62c9cf044a88d35019ebf0593b24d7), "fb-s3.1_0",
                        CRC(033aa54a) SHA1(9221f3013f204a9a857aced5d774c606a7e48648), "fb-s4.1_0",
                        CRC(6965a7c5) SHA1(7e72bbd3bad9accc8da1754c57c24ebdf13e57b9), "fb-s5.1_0",
                        CRC(db50b79a) SHA1(9753d599cd822b55ed64bcf64955f625dc51997d), "fb-s6.1_0",
                        CRC(f1633371) SHA1(a707748d3298ffb6d10d8308f4dae7982b540fa0)) WPC_ROMEND
    WPC_ROMSTART(nbaf, 115, "g11-115", 0x80000,
                 CRC(c0ed9848) SHA1(196d13cf93fe61db36d3bd936549210875a88948)) NBAF_SOUND WPC_ROMEND

    WPC_ROMSTART(nbaf, 21, "g11-21.rom", 0x80000,
                 CRC(598d33d0) SHA1(98c2bfcca573a6e790a4d3ba306953ff0fb3b042)) NBAF_SOUND WPC_ROMEND
    WPC_ROMSTART(nbaf, 22, "g11-22.rom", 0x80000,
                 CRC(2e7a9685) SHA1(2af250a947089469c942cf2c570063bdebd4abe4)) NBAF_SOUND WPC_ROMEND
    WPC_ROMSTART(nbaf, 23, "g11-23.rom", 0x80000,
                 CRC(a6ceb6de) SHA1(055387ee7da57e1a8fbce803a0dd9e67d6dbb1bd)) NBAF_SOUND WPC_ROMEND
...
static struct core_dispLayout nbaf_dispDMD[] = {{0, 0, 32, 128, CORE_DMD, (genf*)wpcdmd_update, NULL},
