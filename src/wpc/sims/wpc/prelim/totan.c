        ...
        COREPORT_BIT(0x0004, "", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0080, "Right Jet", KEYCODE_E)
                    COREPORT_BIT(0x0100, "Middle Jet", KEYCODE_R) COREPORT_BIT(0x0200, "", KEYCODE_T)
...
static int
totan_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
DCS_SOUNDROM4mx("ans2v1_1.rom", CRC(0d023f90) SHA1(e411f7824df89374cf3385a2660d5bc91e0e9ef0), "ans3v1_0.rom",
                CRC(3f677813) SHA1(b1e67c74b927c0c8cb76be8794a04a53fdf643d4), "ans4v1_0.rom",
                CRC(c26dff5f) SHA1(d86323f0df15cf7abd4480d173e6b217ef715396), "ans5v1_0.rom",
                CRC(32ca1602) SHA1(e4c7235b5d387bdde16ebef4d3aeeb7276c69d6d)) WPC_ROMEND
    ...
    WPC_ROMSTART(totan, 13, "arab1_3.rom", 0x80000, CRC(2e4b9439) SHA1(ba564c5984d3b68eaeba27d06f3acd95d26073ee))
        DCS_SOUNDROM4mx("ans2v1_0.rom", CRC(1b78fe52) SHA1(2ad394c2d0f05eac3c32c9957f327d680a734451), "ans3v1_0.rom",
                        CRC(3f677813) SHA1(b1e67c74b927c0c8cb76be8794a04a53fdf643d4), "ans4v1_0.rom",
                        CRC(c26dff5f) SHA1(d86323f0df15cf7abd4480d173e6b217ef715396), "ans5v1_0.rom",
                        CRC(32ca1602) SHA1(e4c7235b5d387bdde16ebef4d3aeeb7276c69d6d)) WPC_ROMEND
...
/---------------*/
    CORE_GAMEDEF(totan, 14, "Tales of the Arabian Nights (1.4 / S1.1)", 1996, "Williams", wpc_m95S, 0)
        CORE_CLONEDEF(totan, 15c, 14, "Tales of the Arabian Nights (1.5C Competition MOD / S1.1)", 2016, "Williams",
                      wpc_m95S, 0)
            CORE_CLONEDEF(totan, 13, 14, "Tales of the Arabian Nights (1.3 / S1.0)", 1996, "Williams", wpc_m95S, 0)
                CORE_CLONEDEF(totan, 12, 14, "Tales of the Arabian Nights (1.2 / S1.0)", 1996, "Williams", wpc_m95S, 0)
                    CORE_CLONEDEF(totan, 04, 14, "Tales of the Arabian Nights (0.4 Prototype / S1.0)", 1996, "Williams",
                                  wpc_m95S, 0)
