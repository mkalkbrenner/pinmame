...
#define IJ_CAPTUREDBALL                                                                                                \
    1 /* the first ball will be used to simulate the captured ball  /
...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BITIMP(0x0004, "L/R Ramp", KEYCODE_R) COREPORT_BITIMP(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "R Outlane NE", KEYCODE_O) COREPORT_BITIMP(0x0020, "L/R Loop", KEYCODE_L)
                COREPORT_BIT(0x0040, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0080, "L/R Inlane", KEYCODE_I)
                                    ...
                                    COREPORT_BITIMP(0x1000, "Totem Target/Ball", KEYCODE_B)
                                        COREPORT_BITIMP(0x2000, "Center Hole", KEYCODE_C)
                                            COREPORT_BIT(0x4000, "Center Target", KEYCODE_0_PAD)
                                                COREPORT_BITIMP(0x8000, "Mode Start", KEYCODE_M) PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0002, "Right Jet", KEYCODE_E)
        COREPORT_BIT(0x0004, "Bottom Jet", KEYCODE_S) COREPORT_BIT(0x0008, "(I)NDY", KEYCODE_G)
            COREPORT_BIT(0x0010, "I(N)DY", KEYCODE_H) COREPORT_BIT(0x0020, "IN(D)Y", KEYCODE_J)
                COREPORT_BIT(0x0040, "IND(Y)", KEYCODE_K) COREPORT_BIT(0x0080, "(A)DVENTURE", KEYCODE_7_PAD)
                                    ...
                                    COREPORT_BITIMP(0x1000, "ADVEN(T)URE", KEYCODE_6_PAD)
                                        COREPORT_BIT(0x2000, "ADVENT(U)RE", KEYCODE_1_PAD)
                                            COREPORT_BIT(0x4000, "ADVENTU(R)E", KEYCODE_2_PAD)
                                                COREPORT_BIT(0x8000, "ADVENTUR(E)", KEYCODE_3_PAD) PORT_START /* 2 */
    COREPORT_BITIMP(0x1000, "PoA Pit", KEYCODE_I) COREPORT_BITIMP(0x2000, "PoA EB", KEYCODE_N)
        COREPORT_BIT(0x4000, "Buy-In", KEYCODE_2) COREPORT_BITIMP(0x8000, "Drain", KEYCODE_Q) WPC_INPUT_PORTS_END
...
static int
ij_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
        case stEnterIdol:
...
static void
ij_initSim(sim_tBallStatus* balls, int* inports, int noOfBalls) {
...
/----------------------------*/
static sim_tInportData ij_inportData[] = {{0, 0x0005, stLRampEnter},
...
/ Drawing information
/---------------------*/
static core_tLampDisplay ij_lampPos = {{0, 0},   /* top left */
                                       {43, 26}, /* size */
                                       {/* 11 */ {1, {{20, 6, YELLOW}}},  /* 12 */ {1, {{21, 7, WHITE}}},
                                        /* 13 */ {1, {{22, 8, ORANGE}}},  /* 14 */ {1, {{25, 5, ORANGE}}},
                                        /* 15 */ {1, {{27, 5, ORANGE}}},  /* 16 */ {1, {{29, 5, ORANGE}}},
                                        /* 17 */ {1, {{31, 6, RED}}},     /* 18 */ {1, {{32, 7, RED}}},
                                        /* 21 */ {1, {{24, 10, RED}}},    /* 22 */ {1, {{21, 13, ORANGE}}},
                                        /* 23 */ {1, {{19, 11, ORANGE}}}, /* 24 */ {1, {{20, 12, ORANGE}}},
                                        /* 25 */ {1, {{27, 10, RED}}},    /* 26 */ {1, {{25, 12, GREEN}}},
                                        /* 27 */ {1, {{31, 10, RED}}},    /* 28 */ {1, {{29, 12, RED}}},
                                        /* 31 */ {1, {{21, 9, YELLOW}}},  /* 32 */ {1, {{25, 7, RED}}},
                                        /* 33 */ {1, {{27, 7, GREEN}}},   /* 34 */ {1, {{28, 7, RED}}},
                                        /* 35 */ {1, {{31, 7, GREEN}}},   /* 36 */ {1, {{35, 12, GREEN}}},
                                        /* 37 */ {1, {{35, 10, YELLOW}}}, /* 38 */ {1, {{35, 7, GREEN}}},
                                        /* 41 */ {1, {{27, 14, RED}}},    /* 42 */ {1, {{33, 12, RED}}},
                                        /* 43 */ {1, {{32, 17, RED}}},    /* 44 */ {1, {{31, 17, GREEN}}},
                                        /* 45 */ {1, {{35, 14, YELLOW}}}, /* 46 */ {1, {{35, 17, GREEN}}},
                                        /* 47 */ {1, {{31, 14, RED}}},    /* 48 */ {1, {{21, 4, YELLOW}}},
                                        /* 51 */ {1, {{25, 17, RED}}},    /* 52 */ {1, {{27, 17, GREEN}}},
                                        /* 53 */ {1, {{28, 17, RED}}},    /* 54 */ {1, {{27, 20, ORANGE}}},
                                        /* 55 */ {1, {{29, 20, ORANGE}}}, /* 56 */ {1, {{31, 20, ORANGE}}},
                                        /* 57 */ {1, {{24, 14, RED}}},    /* 58 */ {1, {{22, 21, YELLOW}}},
                                        /* 61 */ {1, {{4, 10, ORANGE}}},  /* 62 */ {1, {{3, 12, ORANGE}}},
                                        /* 63 */ {1, {{2, 14, ORANGE}}},  /* 64 */ {1, {{1, 16, ORANGE}}},
                                        /* 65 */ {1, {{37, 9, GREEN}}},   /* 66 */ {1, {{39, 8, YELLOW}}},
                                        /* 67 */ {1, {{41, 8, GREEN}}},   /* 68 */ {1, {{21, 19, YELLOW}}},
                                        /* 71 */ {1, {{3, 4, YELLOW}}},   /* 72 */ {1, {{3, 6, YELLOW}}},
                                        /* 73 */ {1, {{7, 4, YELLOW}}},   /* 74 */ {1, {{7, 6, YELLOW}}},
                                        /* 75 */ {1, {{8, 5, GREEN}}},    /* 76 */ {1, {{37, 15, GREEN}}},
                                        /* 77 */ {1, {{39, 16, YELLOW}}}, /* 78 */ {1, {{41, 16, GREEN}}},
                                        /* 81 */ {1, {{11, 4, YELLOW}}},  /* 82 */ {1, {{11, 6, YELLOW}}},
                                        /* 83 */ {1, {{14, 4, YELLOW}}},  /* 84 */ {1, {{14, 6, YELLOW}}},
                                        /* 85 */ {1, {{15, 5, GREEN}}},   /* 86 */ {1, {{9, 19, YELLOW}}},
                                        /* 87 */ {1, {{18, 14, GREEN}}},  /* 88 */ {1, {{43, 1, YELLOW}}}}};
...
static wpc_tSamSolMap ij_SamSolMap[] = {
    ...
    /*Channel #1*/
    {sDivPower, 1, SAM_SOLENOID_ON},
    {sDivHold, 1, SAM_SOLENOID_OFF, WPCSAM_F_ONOFF},
    ...
    /*Channel #2*/
    {sTotemDropDown, 2, SAM_SOLENOID},
    {sTotemDropUp, 2, SAM_SOLENOID},
    {sL_PoA, 2, SAM_MOTOR_1, WPCSAM_F_CONT},
    {sR_PoA, 2, SAM_MOTOR_2, WPCSAM_F_CONT},
    ...
    /*Channel #4*/
    {sTopPostPower, 4, SAM_SOLENOID_ON},
    {sTopPostHold, 4, SAM_SOLENOID_OFF, WPCSAM_F_ONOFF},
    {sCenterDropUp, 4, SAM_SOLENOID},

    {sIdolRelease, 4, SAM_SOLENOID_ON},
    {sIdolRelease, 4, SAM_SOLENOID_OFF, WPCSAM_F_ONOFF},
    {-1}};

static void
ij_drawMech(BMTYPE** line) {
...
DCS_SOUNDROM7x("ijsnd_l3.u2", CRC(fbd91a0d) SHA1(8d9a74f04f6088f18dfbb578893410abc21a0e42), "ijsnd_l3.u3",
               CRC(3f12a996) SHA1(5f5d2853e671d13fafdb2972f52a823e18f27643), "ijsnd_l3.u4",
               CRC(05a92937) SHA1(e4e53e2899a7e7cbcd6ce7e3331bb8aa13321aa6), "ijsnd_l3.u5",
               CRC(e6fe417c) SHA1(d990ed218fe296ad9a015d77519b8d954d252035), "ijsnd_l3.u6",
               CRC(975f3e48) SHA1(16c56500b18e551bcd2e0c7e4c55ddab4791ac84), "ijsnd_l3.u7",
               CRC(2d9cd098) SHA1(8d26c84cbd4ab2a5c9f4be3ea95a79fd125248e3), "ijsnd_l3.u8",
               CRC(45e35bd7) SHA1(782b406be341d55d22a96acb8c2459f3058940df)) WPC_ROMEND
    ...
    WPC_ROMSTART(ij, l5, "ijone_l5.rom", 0x80000, CRC(bf46ff92) SHA1(1afb1aadf115ae7d7f54bfea1fcca71a9de6ebb0))
        DCS_SOUNDROM7x("ijsnd_l2.u2", CRC(508d27c5) SHA1(da9787905c6f11d16e9a62047f15c5780017b551), "ijsnd_l3.u3",
                       CRC(3f12a996) SHA1(5f5d2853e671d13fafdb2972f52a823e18f27643), "ijsnd_l3.u4",
                       CRC(05a92937) SHA1(e4e53e2899a7e7cbcd6ce7e3331bb8aa13321aa6), "ijsnd_l3.u5",
                       CRC(e6fe417c) SHA1(d990ed218fe296ad9a015d77519b8d954d252035), "ijsnd_l3.u6",
                       CRC(975f3e48) SHA1(16c56500b18e551bcd2e0c7e4c55ddab4791ac84), "ijsnd_l3.u7",
    ...
    WPC_ROMSTART(ij, l3, "ijone_l3.rom", 0x80000, CRC(0555c593) SHA1(1a73946fff9ae40e5499fcfa2d9f8330a25b8bae))
        DCS_SOUNDROM7x("ijsnd_l1.u2", CRC(89061ade) SHA1(0bd5ec961c780c4d46296aee7f2cb63b72e990f5), "ijsnd_l3.u3",
                       CRC(3f12a996) SHA1(5f5d2853e671d13fafdb2972f52a823e18f27643), "ijsnd_l3.u4",
                       CRC(05a92937) SHA1(e4e53e2899a7e7cbcd6ce7e3331bb8aa13321aa6), "ijsnd_l3.u5",
                       CRC(e6fe417c) SHA1(d990ed218fe296ad9a015d77519b8d954d252035), "ijsnd_l3.u6",
                       CRC(975f3e48) SHA1(16c56500b18e551bcd2e0c7e4c55ddab4791ac84), "ijsnd_l3.u7",
...
/  Game drivers
/---------------*/
    CORE_GAMEDEF(ij, l7, "Indiana Jones: The Pinball Adventure (L-7)", 1993, "Williams", wpc_mDCSS,
                 0) CORE_CLONEDEF(ij, d7, l7, "Indiana Jones: The Pinball Adventure (D-7 LED Ghost Fix)", 1993,
                                  "Williams", wpc_mDCSS,
                                  0) CORE_CLONEDEF(ij, h1, l7,
                                                   "Indiana Jones: The Pinball Adventure (HK-1 No Hate Speech)", 1993,
                                                   "Williams", wpc_mDCSS, 0)
        CORE_CLONEDEF(ij, i1, l7, "Indiana Jones: The Pinball Adventure (I-1 No Hate Speech LED Ghost Fix)", 1993,
                      "Williams", wpc_mDCSS,
                      0) CORE_CLONEDEF(ij, lg7, l7, "Indiana Jones: The Pinball Adventure (LG-7 German)", 1993,
                                       "Williams", wpc_mDCSS, 0)
            CORE_CLONEDEF(ij, dg7, l7, "Indiana Jones: The Pinball Adventure (DG-7 LED Ghost Fix)", 1993, "Williams",
                          wpc_mDCSS, 0) CORE_CLONEDEF(ij, l6, l7, "Indiana Jones: The Pinball Adventure (L-6)", 1993,
                                                      "Williams", wpc_mDCSS, 0)
                CORE_CLONEDEF(ij, d6, l7, "Indiana Jones: The Pinball Adventure (D-6 LED Ghost Fix)", 1993, "Williams",
                              wpc_mDCSS, 0) CORE_CLONEDEF(ij, l5, l7, "Indiana Jones: The Pinball Adventure (L-5)",
                                                          1993, "Williams", wpc_mDCSS, 0)
                    CORE_CLONEDEF(ij, d5, l7, "Indiana Jones: The Pinball Adventure (D-5 LED Ghost Fix)", 1993,
                                  "Williams", wpc_mDCSS,
                                  0) CORE_CLONEDEF(ij, l4, l7, "Indiana Jones: The Pinball Adventure (L-4)", 1993,
                                                   "Williams", wpc_mDCSS, 0)
                        CORE_CLONEDEF(ij, d4, l7, "Indiana Jones: The Pinball Adventure (D-4 LED Ghost Fix)", 1993,
                                      "Williams", wpc_mDCSS, 0)
                            CORE_CLONEDEF(ij, l3, l7, "Indiana Jones: The Pinball Adventure (L-3)", 1993, "Williams",
                                          wpc_mDCSS, 0)
                                CORE_CLONEDEF(ij, d3, l7, "Indiana Jones: The Pinball Adventure (D-3 LED Ghost Fix)",
                                              1993, "Williams", wpc_mDCSS, 0)
                                    CORE_CLONEDEF(ij, p2, l7, "Indiana Jones: The Pinball Adventure (P-2 Prototype)",
                                                  1993, "Williams", wpc_mDCSS, 0)
...
static core_tGameData ijGameData = {
    GEN_WPCDCS,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L) | FLIP_SOL(FLIP_L), 1, 0, 7, 0, 0, 0, 0, ij_getSol, ij_handleMech, ij_getMech, ij_drawMech,
...
init_ij(void) {
    ...
    install_mem_read_handler(WPC_CPUNO, WPC_SWROWREAD + WPC_BASE, WPC_SWROWREAD + WPC_BASE, ij_ijRowRead);
}
...
static void
ij_handleMech(int mech) {
    /*---------------------------------
  /  handle Adv(ent)ure Drop Targets
  /----------------------------------*/
    if ((mech & 0x01) && core_getSol(sCenterDropUp)) {
        core_setSw(swCLDrop, 0);
        core_setSw(swCMDrop, 0);
        core_setSw(swCRDrop, 0);
    }
  ...
  /--------------*/
    if (mech & 0x04) {
        if ((locals.PoAPos > 0) && core_getPulsedSol(sL_PoA))
            locals.PoAPos--;
        if ((locals.PoAPos < 359) && core_getPulsedSol(sR_PoA))
            locals.PoAPos++;
  ...
  /--------------*/
    if (mech & 0x08) {
        if (core_getSol(sWheelMotor))
            locals.idolPos = (locals.idolPos + IJ_IDOLTICK) % 360;
        switch (locals.idolPos / 60) {
            case 0:
                core_setSw(swIdolPos2, FALSE);
                break;
            case 1:
                core_setSw(swIdolPos3, TRUE);
                break;
            case 2:
                core_setSw(swIdolPos1, FALSE);
                break;
            case 3:
                core_setSw(swIdolPos2, TRUE);
                break;
            case 4:
                core_setSw(swIdolPos3, FALSE);
                break;
            case 5:
                core_setSw(swIdolPos1, TRUE);
                break;
        }
    }
}
...
static int
ij_getMech(int mechNo) {
    if (mechNo == 2)
        return locals.PoAPos;
