...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "Ramp", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0100, "Bottom Jet", KEYCODE_E)
                    COREPORT_BIT(0x0200, "Right Jet", KEYCODE_R) COREPORT_BIT(0x0400, "Top Hole", KEYCODE_T)
                        COREPORT_BIT(0x0800, "Top Kickout Hole", KEYCODE_Y) COREPORT_BIT(0x1000, "Rope Loop", KEYCODE_U)
                            COREPORT_BIT(0x2000, "Pineapple Target 1", KEYCODE_A)
                                COREPORT_BIT(0x4000, "Pineapple Target 2", KEYCODE_S)
                                    COREPORT_BIT(0x8000, "Pineapple Target 3", KEYCODE_D)
                                        ...
                                        PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Coconuts Target 1", KEYCODE_F) COREPORT_BIT(0x0002, "Coconuts Target 2", KEYCODE_G)
        COREPORT_BIT(0x0004, "Coconuts Target 3", KEYCODE_H) COREPORT_BIT(0x0008, "Shrunken Head Target", KEYCODE_J)
            COREPORT_BIT(0x0010, "Bananas Target", KEYCODE_K) COREPORT_BIT(0x0020, "Turtle Eggs Loop", KEYCODE_L)
                COREPORT_BIT(0x0040, "Lagoon", KEYCODE_Z) COREPORT_BIT(0x0100, "lAgoon", KEYCODE_X)
                    COREPORT_BIT(0x0200, "laGoon", KEYCODE_C) COREPORT_BIT(0x0400, "lagOon", KEYCODE_V)
                        COREPORT_BIT(0x0800, "lagoOn", KEYCODE_B) COREPORT_BIT(0x1000, "lagooN", KEYCODE_N)
...
static int
gi_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
static wpc_tSamSolMap gi_samsolmap[] = {
    ...
    {sBallPopper, 2, SAM_POPPER},

    /*Channel #2*/
    {sLeftLock, 2, SAM_POPPER},
    {sLeftSling, 2, SAM_LSLING},
    {sRightSling, 2, SAM_RSLING},
    {sKickBack, 2, SAM_SOLENOID},

    /*Channel #3*/
    {sRampUp, 3, SAM_FLAPOPEN},
    {sRampDown, 3, SAM_FLAPCLOSE},
    {sTopEject, 3, SAM_SOLENOID_ON},

    /*Channel #4*/
    {sJungleMotor, 4, SAM_MOTOR_1, WPCSAM_F_CONT},
    {-1}};
...
/------------------*/
#define GI_SOUND                                                                                                       \
    WPCS_SOUNDROM222("gi_u18.l2", CRC(ea53e196) SHA1(5dcf3f44d2d658f6a7b130fa9e48d3cd616b4300), "gi_u15.l2",           \
                     CRC(f8241dc9) SHA1(118a65555b9fff6f94e5e8324ed97d6ddec3d82b), "gi_u14.l2",                        \
                     CRC(0e7a4140) SHA1(c6408794120b5e45a48b35c380333879e1f0be78))

WPC_ROMSTART(gi, l9, "gilli_l9.rom", 0x40000, CRC(af07a757) SHA1(29c4f4ac2aed5b36e1d22490d656b1c4acba7f4c))
GI_SOUND WPC_ROMEND WPC_ROMSTART(gi, d9, "gilli_d9.rom", 0x40000,
                                 CRC(1a899d4d) SHA1(01cb56052c1ccf7334c884a44eb9ae91ca71942a)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, l3, "gi_l3.u6", 0x40000,
                 CRC(d4e26140) SHA1(c2a9f02217071768ec1ef9169d2922c0e1585bee)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, d3, "gi_d3.u6", 0x40000,
                 CRC(0a2ca705) SHA1(92b34b252d23dfe7022e9e66fc6091183a262149)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, l4, "gi_l4.u6", 0x40000,
                 CRC(2313986d) SHA1(6e0dd293b869ea986ac9cb65b020463a86d955d4)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, d4, "gi_d4.u6", 0x40000,
                 CRC(93d0cc30) SHA1(1a1fc8d4ddb0c0aebe9688a6bc750c90c7b22cad)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, l6, "gi_l6.u6", 0x40000,
                 CRC(7b73eef2) SHA1(fade23019600d84492d5a0fc6f4f5be52ec319be)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, d6, "gi_d6.u6", 0x40000,
                 CRC(44bc3aa6) SHA1(4450605331f8891d9415893f869e9b2f40938abe)) GI_SOUND WPC_ROMEND
    WPC_ROMSTART(gi, l8, "Gilligans_L8_U6.bin", 0x40000,
                 CRC(d21d3bf8) SHA1(d41447a35b710297786d35aefe235ebd8b354b29)) GI_SOUND WPC_ROMEND
                    ...
                    CORE_CLONEDEF(gi, l4, l9, "Gilligan's Island (L-4)", 1991, "Bally", wpc_mDMDS, 0)
                        CORE_CLONEDEF(gi, d4, l9, "Gilligan's Island (D-4 LED Ghost Fix)", 1991, "Bally", wpc_mDMDS, 0)
                            CORE_CLONEDEF(gi, l6, l9, "Gilligan's Island (L-6)", 1991, "Bally", wpc_mDMDS, 0)
                                CORE_CLONEDEF(gi, d6, l9, "Gilligan's Island (D-6 LED Ghost Fix)", 1991, "Bally",
                                              wpc_mDMDS, 0)
...
static core_tGameData giGameData = {
    GEN_WPCDMD,
    wpc_dispDMD,
    {FLIP_SWNO(12, 11), 0, 0, 0, 0, 0, 0, 0, NULL, gi_handleMech, NULL, gi_drawMech, &gi_lampPos, gi_samsolmap},
    &giSimData,
    {
        {0}, /* sNO */
