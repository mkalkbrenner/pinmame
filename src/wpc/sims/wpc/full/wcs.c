            ...
            COREPORT_BITIMP(0x0010, "L/R Light Free Kick", KEYCODE_F)
                COREPORT_BITIMP(0x0020, "L/R Buy Ticket lanes", KEYCODE_X)
                    COREPORT_BIT(0x0040, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0080, "L/R Inlane", KEYCODE_I)
                        COREPORT_BIT(0x0100, "Free Kick", KEYCODE_F) COREPORT_BIT(0x0200, "Rollover 1", KEYCODE_Y)
                            COREPORT_BIT(0x0400, "Rollover 2", KEYCODE_U) COREPORT_BIT(0x0800, "Rollover 3", KEYCODE_I)
                                COREPORT_BIT(0x1000, "Rollover 4", KEYCODE_O)
                                    COREPORT_BIT(0x2000, "Striker 1", KEYCODE_Z)
                                        COREPORT_BIT(0x4000, "Striker 2", KEYCODE_X)
                                            COREPORT_BIT(0x8000, "Striker 3", KEYCODE_C) PORT_START /* 1 */
    COREPORT_BITIMP(0x0001, "Left Loop", KEYCODE_L) COREPORT_BITIMP(0x0002, "Assist", KEYCODE_A)
        COREPORT_BITIMP(0x0004, "Spinner", KEYCODE_W) COREPORT_BIT(0x0008, "Light Kickback", KEYCODE_OPENBRACE)
            COREPORT_BIT(0x0010, "Light Mag Goalie", KEYCODE_CLOSEBRACE) COREPORT_BITIMP(0x0020, "TV Scoop", KEYCODE_T)
                COREPORT_BIT(0x0040, "Tackle", KEYCODE_E) COREPORT_BITIMP(0x0080, "Striker's Hideout", KEYCODE_S)
                    COREPORT_BIT(0x0100, "Jet 1", KEYCODE_V) COREPORT_BIT(0x0200, "Jet 2", KEYCODE_B)
                        COREPORT_BIT(0x0400, "Jet 3", KEYCODE_N) COREPORT_BITIMP(0x0800, "Goal", KEYCODE_G)
                            COREPORT_BIT(0x1000, "Keeper", KEYCODE_K) COREPORT_BITIMP(0x2000, "Header Save", KEYCODE_H)
                                COREPORT_BITIMP(0x4000, "Drain", KEYCODE_Q)
                                    COREPORT_BIT(0x8000, "Magna Goalie", KEYCODE_M) WPC_INPUT_PORTS_END
...
static sim_tState wcs_stateDef[] = {{"Not Installed", 0, 0, 0, stDrain, 0, 0, 0, SIM_STNOTEXCL},
                                    {
                                        "Moving",
                                    },
...
static int
wcs_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
        case stAssist:
            if (mech_getPos(0) > WCS_GOALIESLACK)
                return setState(stGoal, 15);
            else
                return setState(stGoalie, 15);
        case stSLane:
            if (ball->speed > 40)
                return setState(stSkillF, 5);
            if (ball->speed > 30)
                return setState(stSkillC, 5);
            if (ball->speed > 20)
                return setState(stSkillR, 5);
            break;
        case stMagLock:
            if (!core_getSol(sMagLock))
                return setState(stULock, 10);
            break;
    }
    return 0;
}
...
static int
wcs_getSol(int solNo) {
    if (solNo == sLRampDiv)
        return (core_getSol(sDivHold) || core_getSol(sRampDiv));
    return 0;
}
...
/----------------------------*/
static sim_tInportData wcs_inportData[] = {{0, 0x0005, stLRampEnt},
                                           {0, 0x0006, stRRampEnt},
                                           {0, 0x0009, stLOut},
                                           {0, 0x000a, stROut},
                                           {0, 0x0011, stLHole},
...
/---------------------*/
static void
wcs_drawMech(BMTYPE** line) {
    static const char* goalie[] = {" * ", "*  ", "  *"};
    static const char ball[] = {'|', '/', '-', '\\'};
    core_textOutf(50, 0, BLACK, "Goalie: [%s]", goalie[core_getSw(swGoalieL) ? 1 : (core_getSw(swGoalieR) ? 2 : 0)]);
    core_textOutf(50, 10, BLACK, "Ball: %c %3d  ", ball[mech_getPos(1)], mech_getSpeed(1));
}

/* Help */
static void
wcs_drawStatic(BMTYPE** line) {
...
static core_tLampDisplay wcs_lampPos = {{0, 0},   /* top left */
                                        {45, 25}, /* size */
                                        {/* 11 */ {1, {{39, 12, RED}}},    /* 12 */ {1, {{37, 11, RED}}},
                                         /* 13 */ {1, {{35, 10, RED}}},    /* 14 */ {1, {{33, 9, RED}}},
                                         /* 15 */ {1, {{31, 8, RED}}},     /* 16 */ {1, {{29, 7, RED}}},
                                         /* 17 */ {1, {{27, 6, RED}}},     /* 18 */ {1, {{25, 5, RED}}},
                                         /* 21 */ {1, {{36, 13, YELLOW}}}, /* 22 */ {1, {{34, 13, YELLOW}}},
                                         /* 23 */ {1, {{32, 13, YELLOW}}}, /* 24 */ {1, {{30, 13, YELLOW}}},
                                         /* 25 */ {1, {{27, 12, WHITE}}},  /* 26 */ {1, {{25, 11, WHITE}}},
                                         /* 27 */ {1, {{23, 12, WHITE}}},  /* 28 */ {1, {{21, 11, ORANGE}}},
                                         /* 31 */ {1, {{16, 16, YELLOW}}}, /* 32 */ {1, {{17, 18, WHITE}}},
                                         /* 33 */ {1, {{31, 16, WHITE}}},  /* 34 */ {1, {{29, 17, WHITE}}},
                                         /* 35 */ {1, {{26, 14, WHITE}}},  /* 36 */ {1, {{24, 14, WHITE}}},
                                         /* 37 */ {1, {{21, 13, ORANGE}}}, /* 38 */ {1, {{14, 9, GREEN}}},
                                         /* 41 */ {1, {{38, 1, GREEN}}},   /* 42 */ {1, {{36, 1, GREEN}}},
                                         /* 43 */ {1, {{34, 1, GREEN}}},   /* 44 */ {1, {{19, 20, WHITE}}},
                                         /* 45 */ {1, {{21, 19, YELLOW}}}, /* 46 */ {1, {{25, 18, WHITE}}},
                                         /* 47 */ {1, {{27, 18, WHITE}}},  /* 48 */ {1, {{3, 15, RED}}},
                                         /* 51 */ {1, {{8, 12, RED}}},     /* 52 */ {1, {{7, 14, ORANGE}}},
                                         /* 53 */ {1, {{6, 11, YELLOW}}},  /* 54 */ {1, {{5, 15, WHITE}}},
                                         /* 55 */ {1, {{29, 21, YELLOW}}}, /* 56 */ {1, {{35, 22, GREEN}}},
                                         /* 57 */ {1, {{43, 17, ORANGE}}}, /* 58 */ {1, {{38, 24, RED}}},
                                         /* 61 */ {1, {{19, 6, WHITE}}},   /* 62 */ {1, {{19, 2, WHITE}}},
                                         /* 63 */ {1, {{21, 3, ORANGE}}},  /* 64 */ {1, {{23, 4, RED}}},
                                         /* 65 */ {1, {{21, 7, YELLOW}}},  /* 66 */ {1, {{1, 17, GREEN}}},
                                         /* 67 */ {1, {{1, 19, GREEN}}},   /* 68 */ {1, {{30, 25, YELLOW}}},
                                         /* 71 */ {1, {{16, 4, RED}}},     /* 72 */ {1, {{19, 17, WHITE}}},
                                         /* 73 */ {1, {{43, 7, ORANGE}}},  /* 74 */ {1, {{35, 3, ORANGE}}},
                                         /* 75 */ {1, {{30, 4, GREEN}}},   /* 76 */ {1, {{16, 6, YELLOW}}},
                                         /* 77 */ {1, {{16, 20, YELLOW}}}, /* 78 */ {1, {{16, 5, YELLOW}}},
                                         /* 81 */ {1, {{10, 13, RED}}},    /* 82 */ {1, {{13, 12, RED}}},
                                         /* 83 */ {1, {{16, 13, RED}}},    /* 84 */ {1, {{19, 14, RED}}},
                                         /* 85 */ {1, {{26, 25, YELLOW}}}, /* 86 */ {1, {{28, 25, YELLOW}}},
                                         /* 87 */ {1, {{45, 21, GREEN}}},  /* 88 */ {1, {{45, 3, YELLOW}}}}};

WPC_ROMSTART(wcs, l2, "wcup_lx2.rom", 0x80000, CRC(0e4514e8) SHA1(4ef8b78777b8caf1a1ab8f63383c8a7a74d5189a))
DCS_SOUNDROM7x("wcup_u2.rom", CRC(92252f28) SHA1(962a58ea910bcb90c82c81456a888d45f23fcd9a), "wcup_u3.rom",
               CRC(83f541ad) SHA1(2d81d89e43f350caba60d5bec8a66560f8556ad8), "wcup_u4.rom",
               CRC(1540c505) SHA1(aca5a421a0fd067f5411fae2fc3c7c3bcfa1b12f), "wcup_u5.rom",
               CRC(bddad8d4) SHA1(ae6bb1ca3d97a56d1ba984060a1c1ef6c7a00159), "wcup_u6.rom",
               CRC(00f46c12) SHA1(64e99eb32908dbb7b90ee8fa92a20aacf800aeac), "wcup_u7.rom",
               CRC(fff01703) SHA1(fb8d7212fe562e9933941b7bfc707aed1eb74e79), "wcup_u8.rom",
               CRC(670cd382) SHA1(89548420c3b6b8a3d7621b10c538ee1dc6a7be62)) WPC_ROMEND
    ...
    CORE_GAMEDEF(wcs, l2, "World Cup Soccer (LX-2)", 1994, "Bally", wpc_mSecurityS, 0)
        CORE_CLONEDEF(wcs, l3c, l2, "World Cup Soccer (LX-3C Competition MOD)", 2016, "Bally", wpc_mSecurityS,
                      0) CORE_CLONEDEF(wcs, la2, l2, "World Cup Soccer (LA-2)", 1994, "Bally", wpc_mSecurityS, 0)
            CORE_CLONEDEF(wcs, l1, l2, "World Cup Soccer (LX-1)", 1994, "Bally", wpc_mSecurityS, 0)
                CORE_CLONEDEF(wcs, d2, l2, "World Cup Soccer (DX-2 LED Ghost Fix)", 1994, "Bally", wpc_mSecurityS, 0)
                    CORE_CLONEDEF(wcs, p2, l2, "World Cup Soccer (PA-2 Prototype)", 1994, "Bally", wpc_mSecurityS, 0)
                        CORE_CLONEDEF(wcs, p5, l2, "World Cup Soccer (PA-5 LED Ghost Fix)", 1994, "Bally",
                                      wpc_mSecurityS, 0) CORE_CLONEDEF(wcs, p3, l2, "World Cup Soccer (PX-3 Prototype)",
                                                                       1994, "Bally", wpc_mSecurityS, 0)
                            CORE_CLONEDEF(wcs, p6, l2, "World Cup Soccer (PX-6 LED Ghost Fix)", 1994, "Bally",
                                          wpc_mSecurityS, 0)
                                CORE_CLONEDEF(wcs, f10, l2, "World Cup Soccer (FreeWPC 0.10)", 1994, "FreeWPC",
                                              wpc_mSecurityS, 0)
                                    CORE_CLONEDEF(wcs, f50, l2, "World Cup Soccer (FreeWPC 0.50)", 1994, "FreeWPC",
                                                  wpc_mSecurityS, 0)
                                        CORE_CLONEDEF(wcs, f62, l2, "World Cup Soccer (FreeWPC 0.62)", 1994, "FreeWPC",
                                                      wpc_mSecurityS, 0)
                                            CORE_CLONEDEF(wcs, f62b, l2, "World Cup Soccer (FreeWPC 0.62b)", 2020,
                                                          "FreeWPC", wpc_mSecurityS, 0)
...
static core_tGameData wcsGameData = {
    GEN_WPCSECURITY,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L), 0, 0, 0, 0, 0, 0, 0, wcs_getSol, wcs_handleMech, wcs_getMech,
     wcs_drawMech, &wcs_lampPos, NULL},
    &wcsSimData,
