...
--------------------------------------------------------------------------------------------------*/
static struct { int droptargetPos; /* Skull Drop Target Position */ } locals;
    ...
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BITIMP(0x0004, "L/R Ramp", KEYCODE_R) COREPORT_BITIMP(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BITIMP(0x0010, "L/R Loop", KEYCODE_L) COREPORT_BIT(0x0040, "L/R Slingshot", KEYCODE_MINUS)
                COREPORT_BIT(0x0080, "L/R Inlane", KEYCODE_I) COREPORT_BITIMP(0x0100, "Kickb Drop Targ. 1", KEYCODE_W)
                    COREPORT_BITIMP(0x0200, "Kickb Drop Targ. 2", KEYCODE_E)
                        COREPORT_BITIMP(0x0400, "Kickb Drop Targ. 3", KEYCODE_R)
                            COREPORT_BITIMP(0x0800, "Skull Drop Target", KEYCODE_T)
                                COREPORT_BIT(0x1000, "Left Lock", KEYCODE_Z) COREPORT_BIT(0x2000, "Jet 1", KEYCODE_H)
                                    COREPORT_BITIMP(0x4000, "Jet 2", KEYCODE_J) COREPORT_BIT(0x8000, "Jet 3", KEYCODE_K)

                                        PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Mid. Drop Targ. 1", KEYCODE_X) COREPORT_BIT(0x0002, "Mid. Drop Targ. 2", KEYCODE_C)
        COREPORT_BIT(0x0004, "Mid. Drop Targ. 3", KEYCODE_V) COREPORT_BIT(0x0008, "Rollover 1'", KEYCODE_A)
            COREPORT_BIT(0x0010, "Rollover 2", KEYCODE_S) COREPORT_BIT(0x0020, "Rollover 3", KEYCODE_D)
                COREPORT_BIT(0x0040, "L. Drop Targ. 1", KEYCODE_N) COREPORT_BIT(0x0100, "L. Drop Targ. 2", KEYCODE_M)
...
static int
t2_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
        /*-----------------
		  Skull Drop Target
		-------------------*/
...
static sim_tInportData t2_inportData[] = {{0, 0x0005, stLRampEnt},
                                          {0, 0x0006, stRRampEnt},
                                          {0, 0x0009, stLOut},
                                          {0, 0x000a, stROut},
                                          {0, 0x0011, stLLoopUp},
...
static core_tLampDisplay t2_lampPos = {
    ...
    {         /*Start of lamps array*/
     ...
     {1, {{2, 13, GREEN}}},
     {1, {{2, 15, GREEN}}},
     {1, {{2, 17, GREEN}}}} /*End of lamps array*/
};
...
static wpc_tSamSolMap t2_SamSolMap[] = {
    ...
    /*Channel #2*/
    {sGunKicker, 2, SAM_SOLENOID},
    {sKickBack, 2, SAM_SOLENOID},
    {sPlunger, 2, SAM_SOLENOID},
    {sTopLock, 2, SAM_SOLENOID},

    /*Channel #3*/
    {sLeftLock, 3, SAM_SOLENOID},
    {sKnockDown, 3, SAM_FLAPCLOSE},
...
WPCS_SOUNDROM222("t2_u18.l3", CRC(2280bdd0) SHA1(ea94265cb8291ee427e0a2119d901ba1eb50d8ee), "t2_u15.l3",
                 CRC(dad03ad1) SHA1(7c200f9a6564d751e5aa9b1ba84363b221502770), "t2_u14.l3",
                 CRC(9addc9dc) SHA1(847bb027f6b9167cbbaa13f1af50d61e0c69f01f))
WPC_ROMEND
...
WPCS_SOUNDROM222("t2_u18.l3", CRC(2280bdd0) SHA1(ea94265cb8291ee427e0a2119d901ba1eb50d8ee), "t2_u15.l3",
                 CRC(dad03ad1) SHA1(7c200f9a6564d751e5aa9b1ba84363b221502770), "u14-nsty.rom",
                 CRC(b4d64152) SHA1(03a828cef8b067d4da058fd3a1e972265a72f10a))
WPC_ROMEND
...
CORE_CLONEDEF(t2, l83, l8, "Terminator 2: Judgement Day (L-83 Profanity, bugfix/MOD, LED Ghost Fix)", 2022, "Williams",
              wpc_mDMDS, 0)
...
CORE_CLONEDEF(t2, p2f, l8, "Terminator 2: Judgement Day (P-2F Profanity)", 1991, "Williams", wpc_mDMDS,
              0) // Prototype ??
CORE_CLONEDEF(t2, p2g, l8, "Terminator 2: Judgement Day (P-2G Profanity, LED Ghost Fix)", 1991, "Williams", wpc_mDMDS,
              0)
...
static core_tGameData t2GameData = {
    GEN_WPCDMD,
    wpc_dispDMD,
    {FLIP_SWNO(12, 11), 0, 0, 0, 0, 0, 0, 0, NULL, t2_handleMech, t2_getMech, t2_drawMech, &t2_lampPos, t2_SamSolMap},
    &t2SimData,
    {{0},
     {0x00, 0x00, 0x00, 0x02}, /* No inverted switches */
...
init_t2(void) {
    ...
    mech_addLong(0, sGunMotor, 0, MECH_NONLINEAR | MECH_REVERSE | MECH_ONESOL, 200, 200, gunSw, 0);
