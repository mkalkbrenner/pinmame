    ...
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "L/R Ramp", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Jet Bumpers Loop", KEYCODE_W) COREPORT_BIT(0x0100, "Lock", KEYCODE_E)
                    COREPORT_BIT(0x0200, "Ship Ramp", KEYCODE_R) COREPORT_BIT(0x0400, "Top Ramp Loop", KEYCODE_T)
                        COREPORT_BIT(0x0800, "Left Jet", KEYCODE_Y) COREPORT_BIT(0x1000, "Right Jet", KEYCODE_U)
                            COREPORT_BIT(0x2000, "Bottom Jet", KEYCODE_I) COREPORT_BIT(0x4000, "Broadside", KEYCODE_B)
                                COREPORT_BIT(0x8000, "Drain", KEYCODE_Q)

                                    PORT_START /* 1 */
    COREPORT_BIT(0x0001, "BotBot", KEYCODE_A) COREPORT_BIT(0x0002, "BotMid", KEYCODE_S)
        COREPORT_BIT(0x0004, "BotTop", KEYCODE_D) COREPORT_BIT(0x0008, "MidBot", KEYCODE_F)
            COREPORT_BIT(0x0010, "MidMid", KEYCODE_G) COREPORT_BIT(0x0020, "MidTop", KEYCODE_H)
                COREPORT_BIT(0x0040, "TopBot", KEYCODE_J) COREPORT_BIT(0x0100, "TopMid", KEYCODE_K)
                    COREPORT_BIT(0x0200, "TopTop", KEYCODE_L) COREPORT_BIT(0x0400, "FIRE", KEYCODE_ENTER)
...
static int
br_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
static wpc_tSamSolMap br_samsolmap[] = {
    ...
    {sCannonMotor, 1, SAM_MOTOR_1, WPCSAM_F_CONT},

    /*Channel #2*/
    {sCannonKicker, 2, SAM_POPPER},
    {sLeftSling, 2, SAM_LSLING},
    {sRightSling, 2, SAM_RSLING},
    {sBallPopper, 2, SAM_POPPER},

    /*Channel #3*/
    {sBallLockup, 3, SAM_SOLENOID_ON},
    {sBallLockup, 3, SAM_SOLENOID_OFF, WPCSAM_F_ONOFF},
...
WPCS_SOUNDROM224("br_u18.l1", CRC(7d446e7d) SHA1(2b03235aecbea0f6f5efad5aff9da194b0981130), "br_u15.l1",
                 CRC(10250e96) SHA1(769c9a8c7e2bf4af312345d885afa000c4aedf3d), "br_u14.l1",
                 CRC(490bb87f) SHA1(2e4c0bf776b82e2b5fb60c651edd34ab65d6c5aa))
WPC_ROMEND
...
WPCS_SOUNDROM224("u18-sp1.rom", CRC(01fb319d) SHA1(881180fbf524823cc3a89efe6dd6a444b40552ee), "br_u15.l1",
                 CRC(10250e96) SHA1(769c9a8c7e2bf4af312345d885afa000c4aedf3d), "br_u14.l1",
                 CRC(490bb87f) SHA1(2e4c0bf776b82e2b5fb60c651edd34ab65d6c5aa))
WPC_ROMEND
...
static core_tGameData brGameData = {
    GEN_WPCFLIPTRON,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_UR) | FLIP_SOL(FLIP_L | FLIP_UR), 0, 0, 0, 0, 0, 0, 0, NULL, br_handleMech, br_getMech,
     br_drawMech, NULL, br_samsolmap},
    &brSimData,
    {
        "",
