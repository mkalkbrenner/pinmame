                ...
                COREPORT_BIT(0x0040, "Heart Target", KEYCODE_J) COREPORT_BIT(0x0080, "Magnet", KEYCODE_K)
                    COREPORT_BIT(0x0100, "Big Shot", KEYCODE_L) COREPORT_BIT(0x0200, "LPopper", KEYCODE_Z)
                        COREPORT_BIT(0x0400, "RPopper", KEYCODE_X) COREPORT_BIT(0x0800, "Rt Loop", KEYCODE_C)
                            COREPORT_BIT(0x1000, "LCoin", KEYCODE_3) COREPORT_BIT(0x2000, "CCoin", KEYCODE_4)
...
/  Game drivers
/---------------*/
static MACHINE_DRIVER_START(wpc_a1_one) MDRV_IMPORT_FROM(wpc_alpha1S) MDRV_SCREEN_SIZE(640, 400)
...
/----------------------*/
static core_tLCDLayout disp16oneline[] = {{0, 0, 0, 16, CORE_SEG16R}, {0, 33, 20, 16, CORE_SEG16R}, {0}};
static core_tGameData ddGameData = {
    GEN_WPCALPHA_1,
    disp16oneline, /* generation */
    {FLIP_SWNO(82, 81), 0, 0, 0, 0, 0, 0, 0, NULL, dd_handleMech, NULL, NULL, &dd_lampPos, dd_samsolmap},
    &ddSimData,
    {
        {0}, /* no serial number */
