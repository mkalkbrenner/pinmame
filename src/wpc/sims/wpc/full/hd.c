...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "Top L/R Hole", KEYCODE_H) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Loop", KEYCODE_L)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0080, "Right Jet", KEYCODE_E)
                    COREPORT_BIT(0x0100, "Bottom Jet", KEYCODE_R) COREPORT_BIT(0x0200, "Bike", KEYCODE_T)
                        COREPORT_BIT(0x0400, "bIke", KEYCODE_Y) COREPORT_BIT(0x0800, "biKe", KEYCODE_U)
                            COREPORT_BIT(0x1000, "bikE", KEYCODE_I) COREPORT_BIT(0x2000, "Usa", KEYCODE_A)
                                COREPORT_BIT(0x4000, "uSa", KEYCODE_S) COREPORT_BIT(0x8000, "usA", KEYCODE_D)

                                    PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Harley", KEYCODE_F) COREPORT_BIT(0x0002, "hArley", KEYCODE_G)
        COREPORT_BIT(0x0004, "haRley", KEYCODE_H) COREPORT_BIT(0x0008, "harLey", KEYCODE_J)
            COREPORT_BIT(0x0010, "harlEy", KEYCODE_K) COREPORT_BIT(0x0020, "harleY", KEYCODE_L)
                COREPORT_BIT(0x0040, "Davidson", KEYCODE_Z) COREPORT_BIT(0x0080, "dAvidson", KEYCODE_X)
                    COREPORT_BIT(0x0100, "daVidson", KEYCODE_C) COREPORT_BIT(0x0200, "davIdson", KEYCODE_V)
                        COREPORT_BIT(0x0400, "daviDson", KEYCODE_B) COREPORT_BIT(0x0800, "davidSon", KEYCODE_N)
                            COREPORT_BIT(0x1000, "davidsOn", KEYCODE_M) COREPORT_BIT(0x2000, "davidsoN", KEYCODE_COMMA)
                                COREPORT_BIT(0x4000, "LR Eject", KEYCODE_O) COREPORT_BIT(0x8000, "Drain", KEYCODE_Q)
...
static int
hd_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
static wpc_tSamSolMap hd_samsolmap[] = {
    ...
    {sLDrop, 2, SAM_SOLENOID},
    {sCDrop, 2, SAM_SOLENOID},

    /*Channel #3*/
    {sTLEject, 3, SAM_POPPER},
    {sTREject, 3, SAM_POPPER},
    {sLREject, 3, SAM_POPPER},
    {-1}};
...
WPCS_SOUNDROM22x("hd_u18.rom", CRC(810d98c0) SHA1(8080cbbe0f346020b2b2b8e97015dbb615dbadb3), "hd_u15.rom",
                 CRC(e7870938) SHA1(b4f28146a5e7baa8522db65b41311afaf49604c6)) WPC_ROMEND
    ...
    WPC_ROMSTART(hd, l1, "u6-l1.rom", 0x020000, CRC(a0bdcfbf) SHA1(f906ffa2d4d04e87225bf711a07dd3bee1655a40))
        WPCS_SOUNDROM22x("u18-sp1.rom", CRC(708aa419) SHA1(cfc2692fb3bcbacceb85021e282bfbc8dcdf8fcc), "hd_u15.rom",
                         CRC(e7870938) SHA1(b4f28146a5e7baa8522db65b41311afaf49604c6)) WPC_ROMEND
...
/  Game drivers
/---------------*/
    static MACHINE_DRIVER_START(hd) MDRV_IMPORT_FROM(wpc_alpha2S) MDRV_SCREEN_SIZE(640, 400)
...
#define input_ports_che_cho input_ports_hd
                            CORE_GAMEDEFNV(che_cho, "Cheech & Chong: Road-Trip'pin (Harley-Davidson unofficial MOD)",
                                           2021, "Bally/watacaractr", hd, 0)
...
/----------------------*/
static core_tLCDLayout disphd[] = {{0, 0, 0, 16, CORE_SEG16R}, {0, 33, 20, 16, CORE_SEG16R}, {0}};

static core_tGameData hdGameData = {
    GEN_WPCALPHA_2,
    disphd,
    {FLIP_SWNO(12, 11), 0, 0, 0, 0, 0, 0, 0, NULL, hd_handleMech, NULL, NULL, NULL, hd_samsolmap},
    &hdSimData,
    {
        "",
