    ...
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BITIMP(0x0004, "L/R Ramp", KEYCODE_R) COREPORT_BITIMP(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BITIMP(0x0010, "L/R Loop", KEYCODE_L) COREPORT_BIT(0x0040, "L/R Slingshot", KEYCODE_MINUS)
                COREPORT_BIT(0x0080, "L/R Inlane", KEYCODE_I) COREPORT_BIT(0x0100, "Drain", KEYCODE_Q)
                    COREPORT_BIT(0x0200, "Left Fire", KEYCODE_LALT) COREPORT_BIT(0x0400, "Buy In", KEYCODE_2)
                        COREPORT_BIT(0x0800, "Super Game", KEYCODE_E) COREPORT_BIT(0x1000, "Air Rade Ramp", KEYCODE_A)
                            COREPORT_BIT(0x2000, "L.Shooter", KEYCODE_T) COREPORT_BIT(0x4000, "Small Loop", KEYCODE_Y)
                                COREPORT_BIT(0x8000, "Sniper Tower", KEYCODE_U)

                                    PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Subway", KEYCODE_S) COREPORT_BIT(0x0002, "Adv Crime DT", KEYCODE_H)
        COREPORT_BIT(0x0004, "EB Left DT", KEYCODE_D) COREPORT_BIT(0x0008, "EB Right DT", KEYCODE_F)
            COREPORT_BIT(0x0010, "'?' Target", KEYCODE_G) COREPORT_BIT(0x0020, "Captive Ball", KEYCODE_W)
                COREPORT_BIT(0x0040, "'J'udge", KEYCODE_Z) COREPORT_BIT(0x0080, "J'u'dge", KEYCODE_X)
                    COREPORT_BIT(0x0100, "Ju'd'ge", KEYCODE_C) COREPORT_BIT(0x0200, "Jud'g'e", KEYCODE_V)
                        COREPORT_BIT(0x0400, "Judg'e'", KEYCODE_B) WPC_INPUT_PORTS_END
...
static int
jd_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
        case st_Judge:
...
static int
jd_keyCond(int cond, int ballState, int* inports) {
    switch (cond) {
        case JD_DROPCOND:
...
static sim_tInportData jd_inportData[] = {{0, 0x0005, stLRampEnt},
                                          {0, 0x0006, stRRampEnt},
                                          {0, 0x0004, stCRampEnt},
                                          {0, 0x0009, stLOut},
                                          {0, 0x000a, stROut},
...
/------------------*/
#define JD_SOUND_L1                                                                                                    \
    DCS_SOUNDROM8x("jdsnd_u2.bin", CRC(d8f453c6) SHA1(5dd677fde46436dbf2d2e9058f06dd3048600234), "jdsnd_u3.bin",       \
                   CRC(0a11f673) SHA1(ab556477a25e3493555b8a281ca86677caec8947), "jdsnd_u4.bin",                       \
                   CRC(93f6ebc1) SHA1(5cb306afa693e60887069745588dfd5b930c5951), "jdsnd_u5.bin",                       \
                   CRC(c9f28ba6) SHA1(8447372428e3b9fc86a98286c05f95a13abe26b0), "jdsnd_u6.bin",                       \
                   CRC(ef0bf094) SHA1(c0860cecd436d352fe2c2208533ff6dc71bfced1), "jdsnd_u7.bin",                       \
                   CRC(aebab88b) SHA1(d3f1be60a6840d9d085e22b43aafea1354771980), "jdsnd_u8.bin",                       \
                   CRC(77604893) SHA1(a9a4a66412096edd88ee7adfd960eef6f5d16476), "jdsnd_u9.bin",                       \
                   CRC(885b7c70) SHA1(be3bb42aeda3020a72c527f52c5330d0bafa9966))
...
*/
#define JD_SOUND_L3                                                                                                    \
    DCS_SOUNDROM8x("jdsu2_l3.bin", CRC(7a59ec18) SHA1(ee073d4bea198fd66de3508f67061b7d19f12edc), "jdsu3_l3.bin",       \
                   CRC(42f52faa) SHA1(3fac9d3ddfe21877929eaa4cb7101a690745b163), "jdsnd_u4.bin",                       \
                   CRC(93f6ebc1) SHA1(5cb306afa693e60887069745588dfd5b930c5951), "jdsnd_u5.bin",                       \
                   CRC(c9f28ba6) SHA1(8447372428e3b9fc86a98286c05f95a13abe26b0), "jdsnd_u6.bin",                       \
                   CRC(ef0bf094) SHA1(c0860cecd436d352fe2c2208533ff6dc71bfced1), "jdsnd_u7.bin",                       \
                   CRC(aebab88b) SHA1(d3f1be60a6840d9d085e22b43aafea1354771980), "jdsnd_u8.bin",                       \
...
JD_SOUND_L3 WPC_ROMEND WPC_ROMSTART(jd, d7, "jdrd_d7.rom", 0x80000,
                                    CRC(75d71d08) SHA1(10e63b8eb57a800fe0eeb89b175d01576d79ee1a)) JD_SOUND_L3 WPC_ROMEND
    WPC_ROMSTART(jd, l1, "jd_l1.u6", 0x80000,
                 CRC(09a4b1d8) SHA1(9f941bbeb6e58d918d374694c7ff2a67f1084cc0)) JD_SOUND_L1 WPC_ROMEND
    WPC_ROMSTART(jd, d1, "jd_d1.u6", 0x80000,
                 CRC(307fdfa0) SHA1(0ad083cf1e35334caa0854375406e06672bf587d)) JD_SOUND_L1 WPC_ROMEND
    WPC_ROMSTART(jd, l1at, "jd_l1at.u6", 0x80000,
                 CRC(7af2ca76) SHA1(67c5241d6080e4c2bd81aefc61a1220e4c49d25b)) JD_SOUND_L1 WPC_ROMEND
    ...
    WPC_ROMSTART(jd, l1d, "jd_l1d.u6", 0x80000,
                 CRC(c37d8fed) SHA1(05d85c9c6a59866de4a7a5bb2258b69a1964efa3)) JD_SOUND_L1 WPC_ROMEND
    WPC_ROMSTART(jd, l4, "jd_l4.u6", 0x80000,
                 CRC(cc6f1068) SHA1(aef2a2eeb9110074eebff91318179ce97aba14ba)) JD_SOUND_L3 WPC_ROMEND
    WPC_ROMSTART(jd, d4, "jd_d4.u6", 0x80000,
                 CRC(4b7b350f) SHA1(5c827532ffa1e3b102cc6e2ec9446f2d1fc2ef84)) JD_SOUND_L3 WPC_ROMEND
    WPC_ROMSTART(jd, l5, "jd_l5.u6", 0x80000,
                 CRC(879b091e) SHA1(eaf1c86c0e72e8cdfa9ac942fc54ef4f70a65175)) JD_SOUND_L3 WPC_ROMEND
    WPC_ROMSTART(jd, d5, "jd_d5.u6", 0x80000,
                 CRC(4a04b45a) SHA1(84d20fa3beff412862e07a7092407159cc0567b5)) JD_SOUND_L3 WPC_ROMEND
    WPC_ROMSTART(jd, l6, "jd_l6.u6", 0x80000,
                 CRC(0a74cba4) SHA1(1872fd86bbfa772eac9cc2ef2634a90b72b3d5e2)) JD_SOUND_L3 WPC_ROMEND
    WPC_ROMSTART(jd, d6, "jd_d6.u6", 0x80000,
                 CRC(fa17dd22) SHA1(e71c9c0f504a793d4e9c76aaad85f71c4e41a15e)) JD_SOUND_L3 WPC_ROMEND
        ...
        CORE_CLONEDEF(jd, d7, l7, "Judge Dredd (D-7 LED Ghost Fix)", 1993, "Bally", wpc_mDCSS, 0)
            CORE_CLONEDEF(jd, l1, l7, "Judge Dredd (L-1)", 1993, "Bally", wpc_mDCSS, 0)
                CORE_CLONEDEF(jd, d1, l7, "Judge Dredd (D-1 LED Ghost Fix)", 1993, "Bally", wpc_mDCSS, 0)
                    CORE_CLONEDEF(jd, l1at, l7, "Judge Dredd (L-1AT MOD)", 1993, "Bally", wpc_mDCSS,
                                  0) // additional MOD for the aftermarket Deadworld HW-MOD
...
static core_tGameData jdGameData = {
    GEN_WPCDCS,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L | FLIP_U), 0, 0, 1, 0, 0, 0, 0, jd_getSol, jd_handleMech, jd_getMech,
     jd_drawMech, NULL, NULL},
    &jdSimData,
    {
        {0}, /* sNO */
...
static int
jd_getMech(int mechNo) {
    if (mechNo == 0)
        return locals.globePos;
    if (mechNo == 1)
        return locals.armPos;
    return 0;
}
...
DispDT() {
    static char buf[100];
    sprintf(buf, "%c%c%c%c%c", (locals.jdtPos == DT_UP) ? 'J' : '_', (locals.udtPos == DT_UP) ? 'U' : '_',
            (locals.ddtPos == DT_UP) ? 'D' : '_', (locals.gdtPos == DT_UP) ? 'G' : '_',
