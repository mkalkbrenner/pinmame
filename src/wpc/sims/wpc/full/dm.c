...
const char* dm_claw_drop[] = {"Elevator", "Simon", "Jets", "Prison", "Freeze", "Acmag"};
...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BITIMP(0x0004, "L/R Ramp", KEYCODE_R) COREPORT_BITIMP(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BITIMP(0x0010, "L/R Loop", KEYCODE_L) COREPORT_BITIMP(0x0040, "L/R Slingshot", KEYCODE_MINUS)
                COREPORT_BITIMP(0x0080, "L/R Inlane", KEYCODE_I)

                    COREPORT_BITIMP(0x0100, "Standup 1", KEYCODE_Z) COREPORT_BITIMP(0x0200, "Standup 2", KEYCODE_X)
                        COREPORT_BITIMP(0x0400, "Standup 3", KEYCODE_C) COREPORT_BITIMP(0x0800, "Standup 4", KEYCODE_V)
                            COREPORT_BITIMP(0x1000, "Standup 5", KEYCODE_B) COREPORT_BITIMP(0x2000, "Jet 1", KEYCODE_H)
                                COREPORT_BITIMP(0x4000, "Jet 2", KEYCODE_J) COREPORT_BITIMP(0x8000, "Jet 3", KEYCODE_K)

                                    PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Eyeball", KEYCODE_E) COREPORT_BIT(0x0002, "Retina Eject", KEYCODE_R)
        COREPORT_BIT(0x0004, "Car Crash", KEYCODE_W) COREPORT_BIT(0x0008, "Center Ramp", KEYCODE_Y)
            COREPORT_BIT(0x0010, "Underground", KEYCODE_U) COREPORT_BIT(0x0020, "Side Ramp", KEYCODE_T)
                COREPORT_BIT(0x0100, "Left Thumb", KEYCODE_OPENBRACE)
    /* map both CLOSEBRACE and SPACE to ball launch button */
    COREPORT_BIT(0x0200, "Right Thumb", KEYCODE_CLOSEBRACE) COREPORT_BIT(0x0200, "Ball Launch", KEYCODE_SPACE)
        COREPORT_BIT(0x0800, "Buy-In", KEYCODE_2) COREPORT_BITIMP(0x1000, "M Lane", KEYCODE_M)
            COREPORT_BITIMP(0x2000, "T Lane", KEYCODE_COMMA) COREPORT_BITIMP(0x4000, "L Lane", KEYCODE_STOP)
...
static int
dm_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
        case stRRampDivert:
        ...
        case stInElevator:
            ...
            if (locals.magnetCount && abs(locals.elevatorPos - DM_ELEVATOR_TIME / 2) <= (DM_ELEVATOR_TIME / 20)) {
...
/*--------------------
  Drawing information
  --------------------*/
static core_tLampDisplay dm_lampPos = {{0, 0},   /* top left */
                                       {25, 25}, /* size */
                                       {         /* Lamp 11; Ball Save */
...
/------------------*/
#define DM_SOUND_P4                                                                                                    \
    DCS_SOUNDROM6x("dmsndp4.u2", CRC(8581116b) SHA1(ab24fa4aadf27761c9013adb84cfef9bfda27d44), "dmsndp4.u3",           \
                   CRC(fe79fc89) SHA1(4ef1ef0d66d43fa66af1ecb17c14141760859084), "dmsndp4.u4",                         \
                   CRC(18407309) SHA1(499d62e4b434d48870fe532bb85106868df17c9b), "dmsndp4.u5",                         \
                   CRC(f2006c93) SHA1(16656ae6ff18aad0965c5a14882138508925313a), "dmsndp4.u6",                         \
                   CRC(bc17ba11) SHA1(a794599bc334762ddb79e1d0219ad20383139728), "dmsndp4.u7",                         \
                   CRC(8760ed90) SHA1(cf8808f7cd347c47fa12e73a6bb5a54303fb7c49))

#define DM_SOUND_L2                                                                                                    \
    DCS_SOUNDROM6x("dm_u2_s.l2", CRC(85fb8bce) SHA1(f2e912113d08b230e32aeeb4143485f266574fa2), "dm_u3_s.l2",           \
                   CRC(2b65a66e) SHA1(7796082ecd7af29a240190aff654320375502a8b), "dm_u4_s.l2",                         \
                   CRC(9d6815fe) SHA1(fb4be63dee54a883884f1600565011cb9740a866), "dm_u5_s.l2",                         \
                   CRC(9f614c27) SHA1(f8f2f083b644517582a748bda0a3f69c14583f13), "dm_u6_s.l2",                         \
                   CRC(3efc2c0e) SHA1(bc4efdee44ff635771629a2bde79e230b7643f31), "dm_u7_s.l2",                         \
                   CRC(75066af1) SHA1(4d70bce8a96343afcf02c89240b11faf19e11f02))

#define DM_SOUND_H1                                                                                                    \
    DCS_SOUNDROM8x("dm.2", CRC(03dae358) SHA1(e6ab35a0c530eda90bd2d65af7bff82af08c39f3), "dm.3",                       \
                   CRC(3b924d3f) SHA1(5bd6126cc6a6c662de0bc311c047441bc29919b2), "dm.4",                               \
                   CRC(ff8985da) SHA1(b382c301744ce208f4710b3dd2342457d02f0ce9), "dm.5",                               \
                   CRC(76f09bd0) SHA1(1e4861ddc12069733f7e1d25192df97b0d9b09ee), "dm.6",                               \
                   CRC(2897aca8) SHA1(d910289e10422e22b4a3e1e296a4a167da1eaa5b), "dm.7",                               \
                   CRC(6b1b9137) SHA1(4064f4fc230ba17b68819ff889335d9b6d9bba3e), "dm.8",                               \
                   CRC(5b333818) SHA1(007b8c117516b6023b376f95ff13831111f4dc20), "dm.9",                               \
                   CRC(4c1a34e8) SHA1(3eacc3c63b2d9db57fc86447f1408635b987ef69))

WPC_ROMSTART(dm, pa2, "u6-pa2.rom", 0x80000, CRC(862be56a) SHA1(95e1f899963762cb1a9de4eb5d6d57183ed1da38))
DM_SOUND_P4 WPC_ROMEND WPC_ROMSTART(dm, pa3, "u6-pa3.rom", 0x80000,
                                    CRC(deaa034e) SHA1(ebb13368e76c3ff9b1a0cad5502fa3db8e7cc864)) DM_SOUND_P4 WPC_ROMEND
    WPC_ROMSTART(dm, px5, "dman_px5.rom", 0x80000,
                 CRC(42673371) SHA1(77570902c1ca13956fa65214184bce79bcc67173)) DM_SOUND_P4 WPC_ROMEND
    WPC_ROMSTART(dm, px6, "dman_px6.rom", 0x80000,
                 CRC(d9c31096) SHA1(7146a3693287f3f2d6bc9bbf5c8f5270d2aa10e6)) DM_SOUND_P4 WPC_ROMEND

    WPC_ROMSTART(dm, la1, "dman_la1.rom", 0x80000, CRC(be7c1965) SHA1(ed3b1016febc819b8c9f34953067bf0cdf3f33e6))
        DCS_SOUNDROM6x("dm_u2_s.l1", CRC(f72dc72e) SHA1(a1267c32f70b4bfe6058d7e28d82006541fe3d6c), "dm_u3_s.l2",
                       CRC(2b65a66e) SHA1(7796082ecd7af29a240190aff654320375502a8b), "dm_u4_s.l2",
                       CRC(9d6815fe) SHA1(fb4be63dee54a883884f1600565011cb9740a866), "dm_u5_s.l2",
                       CRC(9f614c27) SHA1(f8f2f083b644517582a748bda0a3f69c14583f13), "dm_u6_s.l2",
                       CRC(3efc2c0e) SHA1(bc4efdee44ff635771629a2bde79e230b7643f31), "dm_u7_s.l2",
                       CRC(75066af1) SHA1(4d70bce8a96343afcf02c89240b11faf19e11f02)) WPC_ROMEND
    ...
    WPC_ROMSTART(dm, lx3, "dman_lx3.rom", 0x80000,
                 CRC(5aa57674) SHA1(e02d91a705799866bd741b998d93413ec5bced25)) DM_SOUND_L2 WPC_ROMEND
    WPC_ROMSTART(dm, dx3, "dman_dx3.rom", 0x80000,
                 CRC(aede7ca6) SHA1(874aca191ca7bbee108f2f0204a060966b66623e)) DM_SOUND_L2 WPC_ROMEND
    WPC_ROMSTART(dm, lx4, "dman_lx4.rom", 0x80000,
                 CRC(c2d0f493) SHA1(26ee970827dd96f3b3c56aa548cf7629ed6a16c1)) DM_SOUND_L2 WPC_ROMEND
    WPC_ROMSTART(dm, dx4, "dman_dx4.rom", 0x80000,
                 CRC(6974789d) SHA1(9cf2c49f879fa1f2547e1e7c853e12dc4a35b97d)) DM_SOUND_L2 WPC_ROMEND
    ...
    WPC_ROMSTART(dm, lx4c, "Demolition Man U6 game ROM rev LX-4 patch 00c6.rom", 0x80000,
                 CRC(f669f92d) SHA1(0dc1c746c8a6ebcbcbc3866bbdcd5471a1d626ba)) DM_SOUND_L2 WPC_ROMEND //L-4X patch 00c6
    WPC_ROMSTART(dm, h5, "dman_h5.rom", 0x80000,
                 CRC(bdcc62f7) SHA1(d6f3181970f3f71a876e9a2166156eb8fc405af0)) DM_SOUND_H1 WPC_ROMEND
    WPC_ROMSTART(dm, dh5, "dman_dh5.rom", 0x80000,
                 CRC(91388e13) SHA1(b09a628afd921e34b99d0db3005ab12bbec189b5)) DM_SOUND_H1 WPC_ROMEND
    WPC_ROMSTART(dm, h5b, "dman_h5b.rom", 0x80000,
                 CRC(b7d0e138) SHA1(5533f36f9eab8626bc1240bdea11ae7757db5244)) DM_SOUND_H1 WPC_ROMEND
    WPC_ROMSTART(dm, dh5b, "dmandh5b.rom", 0x80000,
                 CRC(e2e77372) SHA1(df1384f57339c077d98bda5e6ad8ca1d38e3e6ce)) DM_SOUND_H1 WPC_ROMEND
    ...
    WPC_ROMSTART(dm, h6, "dman_h6.rom", 0x80000,
                 CRC(3a079b80) SHA1(94a7ee94819ec878ced5e07745bf52b6c65e06c9)) DM_SOUND_H1 WPC_ROMEND
    WPC_ROMSTART(dm, h6b, "dman_h6b.rom", 0x80000,
                 CRC(047711de) SHA1(7a62b5862f7b5414e3eabe75f117866e6921efaf)) DM_SOUND_H1 WPC_ROMEND
    ...
    WPC_ROMSTART(dm, h6c, "Demolition Man U6 game ROM rev LH-6 patch 4d2b.rom", 0x80000,
                 CRC(19e764a9) SHA1(333e422d2f641952a3e4fddf2a70fdba7268b4e0)) DM_SOUND_H1 WPC_ROMEND //L-6H patch 4d2b
    ...
    WPC_ROMSTART(dm, dt099, "dm_dt099.rom", 0x100000,
                 CRC(64428b78) SHA1(ac0b0174dcecd1b1cd467c4369cb78c2430e9e4b)) DM_SOUND_H1 WPC_ROMEND
    WPC_ROMSTART(dm, dt101, "dm_dt101.rom", 0x100000,
                 CRC(ce36910f) SHA1(45902edd6d8ac2bff95d0c7f65e0f80c4c17b8f2)) DM_SOUND_H1 WPC_ROMEND
...
/---------------*/
    CORE_GAMEDEF(dm, lx4, "Demolition Man (LX-4)", 1994, "Williams", wpc_mDCSS, 0)
        CORE_CLONEDEF(dm, dx4, lx4, "Demolition Man (DX-4 LED Ghost Fix)", 1994, "Williams", wpc_mDCSS, 0)
            CORE_CLONEDEF(dm, lx4c, lx4, "Demolition Man (LX-4C Competition + LED Ghost MOD)", 2020, "Williams",
                          wpc_mDCSS, 0) //L-4X patch 00c6
    CORE_CLONEDEF(dm, pa2, lx4, "Demolition Man (PA-2 Prototype)", 1994, "Williams", wpc_mDCSS,
                  0) CORE_CLONEDEF(dm, pa3, lx4, "Demolition Man (PA-3 LED Ghost Fix)", 1994, "Williams", wpc_mDCSS, 0)
        CORE_CLONEDEF(dm, px5, lx4, "Demolition Man (PX-5 Prototype)", 1994, "Williams", wpc_mDCSS, 0)
            CORE_CLONEDEF(dm, px6, lx4, "Demolition Man (PX-6 LED Ghost Fix)", 1994, "Williams", wpc_mDCSS,
                          0) CORE_CLONEDEF(dm, la1, lx4, "Demolition Man (LA-1)", 1994, "Williams", wpc_mDCSS, 0)
                CORE_CLONEDEF(dm, da1, lx4, "Demolition Man (DA-1 LED Ghost Fix)", 1994, "Williams", wpc_mDCSS,
                              0) CORE_CLONEDEF(dm, lx3, lx4, "Demolition Man (LX-3)", 1994, "Williams", wpc_mDCSS, 0)
                    CORE_CLONEDEF(dm, dx3, lx4, "Demolition Man (DX-3 LED Ghost Fix)", 1994, "Williams", wpc_mDCSS, 0)
                        CORE_CLONEDEF(dm, h5, lx4, "Demolition Man (H-5)", 1995, "Williams", wpc_mDCSS, 0)
                            CORE_CLONEDEF(dm, dh5, lx4, "Demolition Man (DH-5 LED Ghost Fix)", 1995, "Williams",
                                          wpc_mDCSS, 0) CORE_CLONEDEF(dm, h5b, lx4, "Demolition Man (H-5B Coin Play)",
                                                                      1995, "Williams", wpc_mDCSS, 0)
                                CORE_CLONEDEF(dm, dh5b, lx4, "Demolition Man (DH-5B Coin Play LED Ghost Fix)", 1995,
    ...
    CORE_CLONEDEF(dm, h6, lx4, "Demolition Man (H-6)", 1995, "Williams", wpc_mDCSS, 0)
        CORE_CLONEDEF(dm, h6b, lx4, "Demolition Man (H-6B Coin Play)", 1995, "Williams", wpc_mDCSS, 0)
            CORE_CLONEDEF(dm, h6c, lx4, "Demolition Man (H-6C Competition MOD)", 2019, "Williams", wpc_mDCSS,
                          0) //L-6H patch 4d2b
    ...
    if (coreGlobals.simAvail) {
        ...
        core_textOutf(30, 0, BLACK, "Claw: %3u%c %-9s%c", locals.clawPos, locals.magnetCount > 0 ? 'M' : ' ',
                      dm_claw_drop[DM_CLAW_DROP_INDEX], locals.diverterPos == NORMAL ? ' ' : '*');
        // Elevator position and switch indicators (INDEX and HOLD).
        core_textOutf(30, 10, BLACK, "Elev: %3u %-5s %-5s", locals.elevatorPos,
                      core_getSw(swElevatorIndex) ? "INDEX" : "", core_getSw(swElevatorHold) ? "HOLD" : "");
    }
}
...
static sim_tSimData dmSimData = {
    ...
    {stTrough1, stTrough2, stTrough3, stTrough4, stTrough5, stDrain,
...
static core_tGameData dmGameData = {
    GEN_WPCDCS,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L | FLIP_UL), 0, 0, 8, 0, 0, 0, 0, dm_getSol, dm_handleMech, NULL,
     dm_drawMech, &dm_lampPos},
    &dmSimData,
    {
        "",
...
/*
  ...
  */
void
procConfigureFlipperSwitchRules_dm(int enabled) {
    ...
    for (i = 0; i < 2; ++i) {
        ConfigureWPCFlipperSwitchRule(PRDecode(kPRMachineWPC, sw_right[i]), &coils[0], enabled ? 2 : 0);
        ConfigureWPCFlipperSwitchRule(PRDecode(kPRMachineWPC, sw_left[i]), &coils[2], enabled ? 4 : 0);
    }
...
void
dm_wpc_proc_solenoid_handler(int solNum, int enabled, int smoothed) {
