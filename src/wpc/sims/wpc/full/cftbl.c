...
/*-----------------------
 ...
 ------------------------*/
static struct { int creaturerampPos; /* Creature Ramp Position */ } locals;
...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "L/R Ramp", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Paid - P", KEYCODE_W) COREPORT_BIT(0x0100, "Paid - A", KEYCODE_E)
                    COREPORT_BIT(0x0200, "Paid - I", KEYCODE_R) COREPORT_BIT(0x0400, "Paid - D", KEYCODE_T)
    ...
    COREPORT_BIT(0x0001, "Left Jet Bumper", KEYCODE_A) COREPORT_BIT(0x0002, "Right Jet Bumper", KEYCODE_S)
        COREPORT_BIT(0x0004, "Bottom Jet Bumper", KEYCODE_D) COREPORT_BIT(0x0008, "Left Subway", KEYCODE_L)
            COREPORT_BIT(0x0010, "Right Subway", KEYCODE_Z) COREPORT_BIT(0x0020, "Creature Bowl", KEYCODE_C)
                COREPORT_BIT(0x0040, "Move Your Car Lane", KEYCODE_M) COREPORT_BIT(0x0100, "Drain", KEYCODE_Q)
...
static int
cftbl_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
static wpc_tSamSolMap cftbl_samsolmap[] = {
    ...
    {sMirrorMotor, 1, SAM_MOTOR_1, WPCSAM_F_CONT},

    /*Channel #2*/
    {sLeftSling, 2, SAM_LSLING},
    {sRightSling, 3, SAM_RSLING},

    /*Channel #3*/
    {sRampUp, 3, SAM_FLAPOPEN},
    {sRampDown, 3, SAM_FLAPCLOSE},
    {sLowRPopper, 3, SAM_POPPER},
    {sRightPopper, 2, SAM_POPPER},
    {-1}};
...
WPCS_SOUNDROM288("bl_u18.l1", CRC(87267bcc) SHA1(3e733437bce3491c216a8627810897f6123f0679), "bl_u15.l1",
                 CRC(15477d6f) SHA1(3ed7942828630bc9111d2e602fee931ef67db2ce), "bl_u14.l1",
                 CRC(6b02bee4) SHA1(4f852b897dbf0ec2d5b17eed2ff70d9360b12213))
WPC_ROMEND
...
WPC_ROMSTART(cftbl, l4c, "Creature From The Black Lagoon U6 game ROM rev L-4 patch eccc.rom", 0x80000,
             CRC(14a1d90a) SHA1(864acf529fbf953c47feecd9a98810fa04a0223c)) //patch eccc
WPCS_SOUNDROM288("bl_u18.l1", CRC(87267bcc) SHA1(3e733437bce3491c216a8627810897f6123f0679), "bl_u15.l1",
                 CRC(15477d6f) SHA1(3ed7942828630bc9111d2e602fee931ef67db2ce), "bl_u14.l1",
                 CRC(6b02bee4) SHA1(4f852b897dbf0ec2d5b17eed2ff70d9360b12213))
WPC_ROMEND
...
WPCS_SOUNDROM288("u18-sp1.rom", CRC(07198d93) SHA1(d91eb7ae7bd11340b0daf4edd2cd2e87acadeda4), "bl_u15.l1",
                 CRC(15477d6f) SHA1(3ed7942828630bc9111d2e602fee931ef67db2ce), "bl_u14.l1",
                 CRC(6b02bee4) SHA1(4f852b897dbf0ec2d5b17eed2ff70d9360b12213))
WPC_ROMEND
...
CORE_CLONEDEF(cftbl, l4c, l4, "Creature from the Black Lagoon (L-4C Competition + LED Ghost MOD)", 2020, "Bally",
              wpc_mFliptronS, 0)
...
static core_tGameData cftblGameData = {
    GEN_WPCFLIPTRON,
    wpc_dispDMD,
    {FLIP_SW(FLIP_L | FLIP_U) | FLIP_SOL(FLIP_L), 0, 1, 0, 0, 0, 0,
     0, // 8 (or 12?) ramp lights; the pattern repeats every 4 lamps, so 1 extra column is enough
     NULL, cftbl_handleMech, NULL, cftbl_drawMech, NULL, cftbl_samsolmap},
    &cftblSimData,
    {
        "",
