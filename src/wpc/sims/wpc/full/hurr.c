...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "C/R Ramp", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Jet1", KEYCODE_W) COREPORT_BIT(0x0100, "Jet2", KEYCODE_E)
                    COREPORT_BIT(0x0200, "Jet3", KEYCODE_R) COREPORT_BIT(0x0400, "LDropT", KEYCODE_Z)
                        COREPORT_BIT(0x0800, "LDropM", KEYCODE_X) COREPORT_BIT(0x1000, "LDropB", KEYCODE_C)
                            COREPORT_BIT(0x2000, "Ferris", KEYCODE_F) COREPORT_BIT(0x4000, "Juggler", KEYCODE_J)
                                COREPORT_BIT(0x8000, "Drain", KEYCODE_Q)

                                    PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Cat1", KEYCODE_V) COREPORT_BIT(0x0002, "Cat2", KEYCODE_B)
        COREPORT_BIT(0x0004, "Cat3", KEYCODE_N) COREPORT_BIT(0x0008, "Cat4", KEYCODE_M)
...
static int
hurr_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
/*--------------------
  Drawing information
  --------------------*/
static core_tLampDisplay hurr_lampPos = {{0, 0},   /* top left */
                                         {39, 28}, /* size */
                                         {{1, {{30, 12, YELLOW}}},
                                          {1, {{30, 16, YELLOW}}},
                                          {1, {{33, 10, ORANGE}}},
...
static wpc_tSamSolMap hurr_samsolmap[] = {
    ...
    /*Channel #3*/
    {sLeftJuggler, 3, SAM_POPPER},
    {sRightJuggler, 3, SAM_SOLENOID},
    {-1}};
...
WPCS_SOUNDROM222("u18.pp", CRC(63944b37) SHA1(045f8046ba5bf1c88b65a80737e2d3d017271c04), "u15.pp",
                 CRC(93d02c62) SHA1(203cd6b933822d6d3f70c63e051237e3587568f1), "u14.pp",
                 CRC(51c82899) SHA1(aa6c3d9e7efa3708727b06fb3372638d5245a510))
WPC_ROMEND
...
static core_tGameData hurrGameData = {
    GEN_WPCFLIPTRON,
    wpc_dispDMD,
    {FLIP_SWNO(12, 11), 0, 0, 0, 0, 0, 0, 0, NULL, hurr_handleMech, NULL, NULL, &hurr_lampPos, hurr_samsolmap},
    &hurrSimData,
    {
        {0}, /* sNO */
...
hurr_handleMech(int mech) {
    ...
    if ((mech & 0x01) && core_getSol(sLeftBank)) {
        core_setSw(swLDropT, 0);
        core_setSw(swLDropM, 0);
        core_setSw(swLDropB, 0);
    }
}
