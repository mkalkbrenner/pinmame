...
/*--------------------
  ...
  --------------------*/
static void
pstm_drawMech(unsigned char** line) {
...
/* ... */
, pstm_getSol, NULL, NULL, NULL, pstm_drawMech, /* Function to Draw the Status of Mechanical Objects on Screen */
