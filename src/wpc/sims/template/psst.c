...
PORT_START /* 0 */
    WPCPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) WPCPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        WPCPORT_BIT(0x0004, "", KEYCODE_R) WPCPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            WPCPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) WPCPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                WPCPORT_BIT(0x0040, "Left Jet", KEYCODE_W) WPCPORT_BIT(0x0080, "Right Jet", KEYCODE_E)
                    WPCPORT_BIT(0x0100, "Bottom Jet", KEYCODE_R) WPCPORT_BIT(0x0200, "", KEYCODE_T)
                        WPCPORT_BIT(0x0400, "", KEYCODE_Y) WPCPORT_BIT(0x0800, "", KEYCODE_U)
                            WPCPORT_BIT(0x1000, "", KEYCODE_I) WPCPORT_BIT(0x2000, "", KEYCODE_O)
                                WPCPORT_BIT(0x4000, "", KEYCODE_A) WPCPORT_BIT(0x8000, "Drain", KEYCODE_Q)

                                    PORT_START /* 1 */
    WPCPORT_BIT(0x0001, "", KEYCODE_S) WPCPORT_BIT(0x0002, "", KEYCODE_D) WPCPORT_BIT(0x0004, "", KEYCODE_F)
        WPCPORT_BIT(0x0008, "", KEYCODE_G) WPCPORT_BIT(0x0010, "", KEYCODE_H) WPCPORT_BIT(0x0020, "", KEYCODE_J)
            WPCPORT_BIT(0x0040, "", KEYCODE_K) WPCPORT_BIT(0x0080, "", KEYCODE_L) WPCPORT_BIT(0x0100, "", KEYCODE_Z)
                WPCPORT_BIT(0x0200, "", KEYCODE_X) WPCPORT_BIT(0x0400, "", KEYCODE_C) WPCPORT_BIT(0x0800, "", KEYCODE_V)
                    WPCPORT_BIT(0x1000, "", KEYCODE_B) WPCPORT_BIT(0x2000, "", KEYCODE_N)
                        WPCPORT_BIT(0x4000, "", KEYCODE_M) WPCPORT_BIT(0x8000, "", KEYCODE_COMMA)
...
/----------------------*/
    ...
    stShooter,
    stBallLane, stNotEnough, stRightOutlane, stLeftOutlane, stRightInlane, stLeftInlane, stLeftSling,
    stRightSling, stLeftJet, stRightJet, stBottomJet,
}
;
...
static int
xxx_handleBallState(wpcsim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
/*--------------------
  ...
  --------------------*/
static void
xxx_drawMech(unsigned char** line) {
