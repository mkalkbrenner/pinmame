...
PORT_START /* 0 */
    COREPORT_BIT(0x0001, "Left Qualifier", KEYCODE_LCONTROL) COREPORT_BIT(0x0002, "Right Qualifier", KEYCODE_RCONTROL)
        COREPORT_BIT(0x0004, "MixMaster", KEYCODE_R) COREPORT_BIT(0x0008, "L/R Outlane", KEYCODE_O)
            COREPORT_BIT(0x0010, "L/R Slingshot", KEYCODE_MINUS) COREPORT_BIT(0x0020, "L/R Inlane", KEYCODE_I)
                COREPORT_BIT(0x0040, "Left Jet", KEYCODE_W) COREPORT_BIT(0x0100, "Right Jet", KEYCODE_E)
                    COREPORT_BIT(0x0200, "Bottom Jet", KEYCODE_R) COREPORT_BIT(0x0400, "Top Target", KEYCODE_T)
                        COREPORT_BIT(0x0800, "RDrop1", KEYCODE_Y) COREPORT_BIT(0x1000, "RDrop2", KEYCODE_U)
                            COREPORT_BIT(0x2000, "RDrop3", KEYCODE_I) COREPORT_BIT(0x4000, "RDrop4", KEYCODE_O)
                                COREPORT_BIT(0x8000, "Drain", KEYCODE_Q)

                                    PORT_START /* 1 */
    COREPORT_BIT(0x0001, "Reflex", KEYCODE_A) COREPORT_BIT(0x0002, "rEflex", KEYCODE_S)
        COREPORT_BIT(0x0004, "reFlex", KEYCODE_D) COREPORT_BIT(0x0008, "refLex", KEYCODE_F)
            COREPORT_BIT(0x0010, "reflEx", KEYCODE_G) COREPORT_BIT(0x0020, "refleX", KEYCODE_H)
                COREPORT_BIT(0x0040, "Heart Target", KEYCODE_J) COREPORT_BIT(0x0080, "Magnet", KEYCODE_K)
                    COREPORT_BIT(0x0100, "Big Shot", KEYCODE_L) COREPORT_BIT(0x0200, "LPopper", KEYCODE_Z)
                        COREPORT_BIT(0x0400, "RPopper", KEYCODE_X) COREPORT_BIT(0x0800, "Rt Loop", KEYCODE_C)
...
static int
dd_handleBallState(sim_tBallStatus* ball, int* inports) {
    switch (ball->state) {
...
static wpc_tSamSolMap dd_samsolmap[] = {
    ...
    {sBigShot, 1, SAM_SOLENOID},

    /*Channel #2*/
    {sRDrop, 2, SAM_SOLENOID},
    {sLeftSling, 2, SAM_LSLING},
    {sRightSling, 2, SAM_RSLING},

    /*Channel #3*/
    {sLPopper, 3, SAM_POPPER},
    {sRPopper, 3, SAM_POPPER},
    {-1}};

/*-----------------
/  ROM definitions
/------------------*/
S11_ROMSTART48(dd, lu1, "dude_u26.lu1", CRC(6f6a6e22) SHA1(2d8a1b472eb06a9f7aeea4b2f9a82f83eb4ee08a), "dude_u27.lu1",
               CRC(43c2d4f3) SHA1(d61d855fa06394bdc1142e21624bdaac1ee9ca20))
S11CS_SOUNDROM000("dude_u4.l1", CRC(3eeef714) SHA1(74dcc83958cb62819e0ac36ca83001694faafec7), "dude_u19.l1",
                  CRC(dc7b985b) SHA1(f672d1f1fe1d1d887113ea6ccd745a78f7760526), "dude_u20.l1",
                  CRC(a83d53dd) SHA1(92a81069c42c7760888201fb0787fa7ddfbf1658))
S11_ROMEND

S11_ROMSTART48(dd, l2, "dude_u26.l2", CRC(d1e19fc2) SHA1(800329b5fd563fcd27add14da4522082c01eb86e), "dude_u27.l2",
               CRC(654b5d4c) SHA1(e73834dbb35cf78eab68a5966e4049640e16dddf))
S11CS_SOUNDROM000("dude_u4.l1", CRC(3eeef714) SHA1(74dcc83958cb62819e0ac36ca83001694faafec7), "dude_u19.l1",
                  CRC(dc7b985b) SHA1(f672d1f1fe1d1d887113ea6ccd745a78f7760526), "dude_u20.l1",
                  CRC(a83d53dd) SHA1(92a81069c42c7760888201fb0787fa7ddfbf1658))
S11_ROMEND

S11_ROMSTART48(dd, l3c, "dude_u26.l3c", CRC(08192d8b) SHA1(9a2f0347a611663fdc12dcd9f952a6b8415add04), "dude_u27.l3c",
               CRC(95976170) SHA1(a35f6d64edf922bd018199601f0a8f407cc89031))
S11CS_SOUNDROM000("dude_u4.l1", CRC(3eeef714) SHA1(74dcc83958cb62819e0ac36ca83001694faafec7), "dude_u19.l1",
                  CRC(dc7b985b) SHA1(f672d1f1fe1d1d887113ea6ccd745a78f7760526), "dude_u20.l1",
                  CRC(a83d53dd) SHA1(92a81069c42c7760888201fb0787fa7ddfbf1658))
S11_ROMEND

S11_ROMSTART48(dd, p6, "u26-pa6.11c", CRC(6f6a6e22) SHA1(2d8a1b472eb06a9f7aeea4b2f9a82f83eb4ee08a), "u27-pa6.11c",
               CRC(26022273) SHA1(ca66139c3bd0c313d41a396c484d2c1b8f4ae536))
S11CS_SOUNDROM000("dude_u4.l1", CRC(3eeef714) SHA1(74dcc83958cb62819e0ac36ca83001694faafec7), "dude_u19.l1",
                  CRC(dc7b985b) SHA1(f672d1f1fe1d1d887113ea6ccd745a78f7760526), "dude_u20.l1",
                  CRC(a83d53dd) SHA1(92a81069c42c7760888201fb0787fa7ddfbf1658))
S11_ROMEND
...
static core_tGameData ddGameData = {GEN_S11C,
                                    disp16oneline,
                                    {FLIP_SWNO(swLFlip, swRFlip), 0, 0, 0, 0, S11_LOWALPHA | S11_DISPINV, S11_MUXSW2, 0,
                                     NULL, dd_handleMech, NULL, NULL, &dd_lampPos, dd_samsolmap},
                                    &ddSimData,
                                    {{0}},
                                    {12}};
