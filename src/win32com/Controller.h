...
class CController
  ...
  public:
    ...
    STDMETHOD(get_ChangedLEDsState)
    (/*[in]*/ int nHigh, int nLow, int nnHigh, int nnLow, int** buf, /*[out, retval]*/ int* pVal);
    ...
    STDMETHOD(get_updateDmdPixels)
    (/*[in]*/ int** buf, /*[in]*/ int width, /*[in]*/ int height, /*[out, retval]*/ int* pVal);
    ...
    STDMETHOD(CheckROMS)
    (/*[in,defaultvalue(0)]*/ int nShowOptions, /*[in,defaultvalue(0)]*/ LONG_PTR hParentWnd,
