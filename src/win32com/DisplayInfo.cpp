...
// Helper methods
void
CopyString(char** dest, const char* src) {
    if (src == NULL) {
        *dest = NULL;
    } else {
 ...
 * Public Constructors
 ***********************************************/
CDisplayInfo::CDisplayInfo() { InitData(); }
...
// Copy Constructor
CDisplayInfo::CDisplayInfo(const CDisplayInfo& ob) { CopyData(ob); }

/************************************************
 * Destructors
 ***********************************************/
CDisplayInfo::~CDisplayInfo(void) {
    if (mDriverDescription != NULL)
        delete mDriverDescription;
    if (mDriverName != NULL)
        delete mDriverName;
    if (mFriendlyName != NULL)
        delete mFriendlyName;
}
 ...
 ***********************************************/
void
CDisplayInfo::CopyData(const CDisplayInfo& ob) {
 ...
 ***********************************************/
CDisplayInfo
CDisplayInfo::operator=(const CDisplayInfo& ob) {
    CopyData(ob);
