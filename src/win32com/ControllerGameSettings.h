...
/////////////////////////////////////////////////////////////////////////////
// CGameSettings
class ATL_NO_VTABLE CGameSettings : public CComObjectRootEx<CComSingleThreadModel>,
  ...
  public:
    ...
    STDMETHOD(SetDisplayPosition)
    (/*[in]*/ VARIANT newValX, /*[in]*/ VARIANT newValY, /* [in,defaultvalue(0)] */ LONG_PTR hWnd);
