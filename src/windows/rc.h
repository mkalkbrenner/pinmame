...
enum {
    ...
    rc_file,
    rc_use_function,
    rc_use_function_no_arg,
    rc_link
};

typedef int (*rc_func)(struct rc_option* option, const char* arg, int priority);
...
int rc_load(struct rc_struct* rc, const char* name, int priority, int continue_on_errors);
int rc_save(struct rc_struct* rc, const char* name, int append);
int osd_rc_read(struct rc_struct* rc, mame_file* f, const char* description, int priority, int continue_on_errors);
int osd_rc_write(struct rc_struct* rc, mame_file* f, const char* description);
int rc_read(struct rc_struct* rc, FILE* f, const char* description, int priority, int continue_on_errors);
int rc_write(struct rc_struct* rc, FILE* f, const char* description);

/* commandline handling */
int rc_parse_commandline(struct rc_struct* rc, int argc, char* argv[], int priority, int (*arg_callback)(char* arg));
...
int rc_verify_power_of_2(struct rc_option* option, const char* arg, int priority);
...
int rc_set_option(struct rc_struct* rc, const char* name, const char* arg, int priority);
int rc_set_option2(struct rc_option* option, const char* name, const char* arg, int priority);
