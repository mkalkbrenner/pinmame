...
static void fmtstr(char* buffer, size_t* currlen, size_t maxlen, const char* value, int flags, int min, int max);
...
static void
fmtstr(char* buffer, size_t* currlen, size_t maxlen, const char* value, int flags, int min, int max) {
...
main(void) {
    ...
    double fp_nums[] = {-1.5, 134.21, 91340.2, 341.1234, 0203.9, 0.96, 0.996, 0.9996, 1.996, 4.136, 1.05, 0};
