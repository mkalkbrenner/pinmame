...
INLINE UINT16
win_color16(UINT8 r, UINT8 g, UINT8 b) {
...
INLINE UINT32
win_color32(UINT8 r, UINT8 g, UINT8 b) {
    return (r << win_color32_rdst_shift) | (g << win_color32_gdst_shift) | (b << win_color32_bdst_shift);
}

INLINE UINT8
win_red32(UINT32 color) {
    return color >> win_color32_rdst_shift;
}

INLINE UINT8
win_green32(UINT32 color) {
    return color >> win_color32_gdst_shift;
}

INLINE UINT8
win_blue32(UINT32 color) {
