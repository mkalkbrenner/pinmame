...
typedef struct _D3DTLVERTEX2 {
    ...
    _D3DTLVERTEX2(const D3DVECTOR& v, float _rhw, D3DCOLOR _color, D3DCOLOR _specular, float _tu, float _tv, float _tu1,
                  float _tv1) {
        sx = v.x;
        sy = v.y;
        sz = v.z;
...
typedef struct _D3DLVERTEX2 {
    ...
    _D3DLVERTEX2(const D3DVECTOR& v, D3DCOLOR _color, D3DCOLOR _specular, float _tu, float _tv, float _tu1,
                 float _tv1) {
        x = v.x;
        y = v.y;
        z = v.z;
...
#define D3DFVF_LVERTEX2                                                                                                \
    (D3DFVF_XYZ | D3DFVF_RESERVED1 | D3DFVF_DIFFUSE | D3DFVF_SPECULAR | D3DFVF_TEX2 | D3DFVF_TEXCOORDSIZE2(0)          \
