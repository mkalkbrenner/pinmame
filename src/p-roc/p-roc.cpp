...
PRMachineType
procLoadMachineYAML(char* filename) {
    try {
...
void
setMachineType(char* yaml_filename) {
...
std::string
procGetYamlPinmameSettingString(const char* key, const char* defaultValue) {
    std::string retval;
...
int
procGetYamlPinmameSettingInt(const char* key, int defaultValue) {
    int retval;
...
int
procInitialize(char* yaml_filename) {
